...
public abstract class AbstractVerifier implements X509HostnameVerifier {
    ...
    public protected static final String[] BAD_COUNTRY_2LDS = {"ac", "co", "com", "ed", "edu", "go", "gouv", "gov", DocumentsContract.EXTRA_INFO, "lg", "ne", "net", "or", "org"};
    ...
    private static synchronized boolean isIPv4Address(String input) {

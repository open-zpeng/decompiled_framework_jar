...
public class SSLSocketFactory implements LayeredSocketFactory {
    ...
    public protected X509HostnameVerifier hostnameVerifier;
    public protected final HostNameResolver nameResolver;
    public protected final javax.net.ssl.SSLSocketFactory socketfactory;
    public protected final SSLContext sslcontext;
    ...
    private static class NoPreloadHolder {
        ...
        private synchronized NoPreloadHolder() {
        }
    }
    ...
    public protected SSLSocketFactory() {
        this.hostnameVerifier = BROWSER_COMPATIBLE_HOSTNAME_VERIFIER;
        this.sslcontext = null;
    ...
    public protected static KeyManager[] createKeyManagers(KeyStore keystore, String password) throws KeyStoreException, NoSuchAlgorithmException, UnrecoverableKeyException {
        if (keystore == null) {
    ...
    public protected static TrustManager[] createTrustManagers(KeyStore keystore) throws KeyStoreException, NoSuchAlgorithmException {
        if (keystore == null) {
            throw new IllegalArgumentException("Keystore may not be null");
        }

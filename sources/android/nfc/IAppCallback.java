...
public interface IAppCallback extends IInterface {
    synchronized BeamShareData createBeamShareData(byte b) throws RemoteException;

    synchronized void onNdefPushComplete(byte b) throws RemoteException;

    synchronized void onTagDiscovered(Tag tag) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IAppCallback {
        ...
        public static synchronized IAppCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements IAppCallback {
            ...
            public synchronized BeamShareData createBeamShareData(byte peerLlcpVersion) throws RemoteException {
            ...
            @Override // android.nfc.IAppCallback
            public synchronized void onNdefPushComplete(byte peerLlcpVersion) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeByte(peerLlcpVersion);

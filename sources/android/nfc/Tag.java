...
public final class Tag implements Parcelable {
    ...
    public private protected final byte[] mId;
    ...
    public synchronized Tag(byte[] id, int[] techList, Bundle[] techListExtras, int serviceHandle, INfcTag tagService) {
        if (techList == null) {
    ...
    public static synchronized Tag createMockTag(byte[] id, int[] techList, Bundle[] techListExtras) {
        return new Tag(id, techList, techListExtras, 0, null);
    }

    private synchronized String[] generateTechStringList(int[] techList) {
    ...
    public static synchronized int[] getTechCodesFromStrings(String[] techStringList) throws IllegalArgumentException {
    ...
    private static synchronized HashMap<String, Integer> getTechStringToCodeMap() {
    ...
    public synchronized int[] getTechCodeList() {
    ...
    public synchronized Tag rediscover() throws IOException {
    ...
    public synchronized boolean hasTech(int techType) {
        int[] iArr;
    ...
    public synchronized Bundle getTechExtras(int tech) {
        int pos = -1;
        int idx = 0;
        while (true) {
    ...
    static synchronized byte[] readBytesWithNull(Parcel in) {
        int len = in.readInt();
        if (len < 0) {
            return null;
        }
    ...
    static synchronized void writeBytesWithNull(Parcel out, byte[] b) {
        if (b == null) {
            out.writeInt(-1);
            return;
        }
    ...
    public synchronized int getConnectedTechnology() {

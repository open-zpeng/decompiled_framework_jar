...
public final class NdefFormatable extends BasicTagTechnology {
    ...
    public synchronized NdefFormatable(Tag tag) throws RemoteException {
        super(tag, 7);
    }
    ...
    synchronized void format(NdefMessage firstMessage, boolean makeReadOnly) throws IOException, FormatException {
        checkConnected();
        try {

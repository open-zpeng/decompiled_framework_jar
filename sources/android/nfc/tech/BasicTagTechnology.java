...
public abstract class BasicTagTechnology implements TagTechnology {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BasicTagTechnology(Tag tag, int tech) throws RemoteException {
        this.mTag = tag;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized int getMaxTransceiveLengthInternal() {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized byte[] transceive(byte[] data, boolean raw) throws IOException {
        checkConnected();
        try {

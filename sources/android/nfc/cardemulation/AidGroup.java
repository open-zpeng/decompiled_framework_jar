...
public final class AidGroup implements Parcelable {
    private protected static final Parcelable.Creator<AidGroup> CREATOR = new Parcelable.Creator<AidGroup>() { // from class: android.nfc.cardemulation.AidGroup.1
    ...
    public private protected final List<String> aids;
    public private protected final String category;
    public private protected final String description;

    public synchronized AidGroup(List<String> aids, String category) {
    ...
    public private protected AidGroup(String category, String description) {
    ...
    private protected static AidGroup createFromXml(XmlPullParser parser) throws XmlPullParserException, IOException {
    ...
    private protected void writeAsXml(XmlSerializer out) throws IOException {
    ...
    static synchronized boolean isValidCategory(String category) {

...
public final class NfcFCardEmulation {
    ...
    private synchronized NfcFCardEmulation(Context context, INfcFCardEmulation service) {
    ...
    public synchronized List<NfcFServiceInfo> getNfcFServices() {
        try {
    ...
    public synchronized int getMaxNumOfRegisterableSystemCodes() {
        try {
    ...
    public static synchronized boolean isValidSystemCode(String systemCode) {
        if (systemCode == null) {
            return false;
        }
    ...
    public static synchronized boolean isValidNfcid2(String nfcid2) {
        if (nfcid2 == null) {
            return false;
        }
        if (nfcid2.length() != 16) {

...
public final class KeyGenParameterSpec implements AlgorithmParameterSpec, UserAuthArgs {
    ...
    public synchronized KeyGenParameterSpec(String keyStoreAlias, int uid, int keySize, AlgorithmParameterSpec spec, X500Principal certificateSubject, BigInteger certificateSerialNumber, Date certificateNotBefore, Date certificateNotAfter, Date keyValidityStart, Date keyValidityForOriginationEnd, Date keyValidityForConsumptionEnd, int purposes, String[] digests, String[] encryptionPaddings, String[] signaturePaddings, String[] blockModes, boolean randomizedEncryptionRequired, boolean userAuthenticationRequired, int userAuthenticationValidityDurationSeconds, boolean userPresenceRequired, byte[] attestationChallenge, boolean uniqueIdIncluded, boolean userAuthenticationValidWhileOnBody, boolean invalidatedByBiometricEnrollment, boolean isStrongBoxBacked, boolean userConfirmationRequired, boolean unlockedDeviceRequired) {
    ...
    @Override // android.security.keystore.UserAuthArgs
    public synchronized long getBoundToSpecificSecureUserId() {
        return 0L;
    }
    ...
    public static final class Builder {
        ...
        public synchronized Builder(KeyGenParameterSpec sourceSpec) {
        ...
        public synchronized Builder setUid(int uid) {
            this.mUid = uid;
            return this;
        }

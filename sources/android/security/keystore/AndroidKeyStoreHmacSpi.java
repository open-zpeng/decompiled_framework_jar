...
public abstract class AndroidKeyStoreHmacSpi extends MacSpi implements KeyStoreCryptoOperation {
    ...
    public static class HmacSHA224 extends AndroidKeyStoreHmacSpi {
        public synchronized HmacSHA224() {
            super(3);
        }
    }
    ...
    public static class HmacSHA256 extends AndroidKeyStoreHmacSpi {
        public synchronized HmacSHA256() {
            super(4);
        }
    }
    ...
    public static class HmacSHA384 extends AndroidKeyStoreHmacSpi {
        public synchronized HmacSHA384() {
            super(5);
        }
    }
    ...
    public static class HmacSHA512 extends AndroidKeyStoreHmacSpi {
        public synchronized HmacSHA512() {
            super(6);
        }
    }

    protected synchronized AndroidKeyStoreHmacSpi(int keymasterDigest) {
    ...
    private synchronized void init(Key key, AlgorithmParameterSpec params) throws InvalidKeyException, InvalidAlgorithmParameterException {
        if (key == null) {
    ...
    private synchronized void resetWhilePreservingInitState() {
        IBinder operationToken = this.mOperationToken;
        if (operationToken != null) {
            this.mKeyStore.abort(operationToken);
        }
    ...
    private synchronized void ensureKeystoreOperationInitialized() throws InvalidKeyException {
    ...
    public synchronized long getOperationHandle() {

...
public abstract class AttestationUtils {
    ...
    private synchronized AttestationUtils() {
    }

    public static synchronized X509Certificate[] parseCertificateChain(KeymasterCertificateChain kmChain) throws KeyAttestationException {
    ...
    private static synchronized KeymasterArguments prepareAttestationArgumentsForDeviceId(Context context, int[] idTypes, byte[] attestationChallenge) throws DeviceIdAttestationException {
        if (idTypes == null) {
    ...
    public static synchronized KeymasterArguments prepareAttestationArguments(Context context, int[] idTypes, byte[] attestationChallenge) throws DeviceIdAttestationException {
    ...
    private static boolean isPotentiallyMisprovisionedDevice(Context context) {
        ...
        resources.getString(R.string.config_misprovisionedBrandValue);
    ...
    public static synchronized boolean isChainValid(KeymasterCertificateChain chain) {

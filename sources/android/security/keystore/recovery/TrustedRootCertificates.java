...
public final class TrustedRootCertificates {
    ...
    public static synchronized X509Certificate getTestOnlyInsecureCertificate() {
        return parseBase64Certificate(TEST_ONLY_INSECURE_CERTIFICATE_BASE64);
    }

    public static synchronized Map<String, X509Certificate> getRootCertificates() {
        return new ArrayMap(ALL_ROOT_CERTIFICATES);
    }

    public static synchronized X509Certificate getRootCertificate(String alias) {
        return ALL_ROOT_CERTIFICATES.get(alias);
    }

    private static synchronized ArrayMap<String, X509Certificate> constructRootCertificateMap() {
    ...
    private static synchronized X509Certificate parseBase64Certificate(String base64Certificate) {
        try {
    ...
    private synchronized TrustedRootCertificates() {
    }
}

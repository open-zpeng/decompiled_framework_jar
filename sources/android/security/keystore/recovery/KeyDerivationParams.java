...
public final class KeyDerivationParams implements Parcelable {
    ...
    private synchronized KeyDerivationParams(int algorithm, byte[] salt) {
        this(algorithm, salt, -1);
    }

    private synchronized KeyDerivationParams(int algorithm, byte[] salt, int memoryDifficulty) {
    ...
    protected synchronized KeyDerivationParams(Parcel in) {

...
public final class KeyChainSnapshot implements Parcelable {
    ...
    private synchronized KeyChainSnapshot() {
    ...
    @Deprecated
    private protected byte[] getTrustedHardwarePublicKey() {
    ...
    public static class Builder {
        ...
        public synchronized Builder setSnapshotVersion(int snapshotVersion) {
            this.mInstance.mSnapshotVersion = snapshotVersion;
            return this;
        }

        public synchronized Builder setMaxAttempts(int maxAttempts) {
            this.mInstance.mMaxAttempts = maxAttempts;
            return this;
        }

        public synchronized Builder setCounterId(long counterId) {
            this.mInstance.mCounterId = counterId;
            return this;
        }

        public synchronized Builder setServerParams(byte[] serverParams) {
            this.mInstance.mServerParams = serverParams;
            return this;
        }

        @Deprecated
        public synchronized Builder setTrustedHardwarePublicKey(byte[] publicKey) {
            throw new UnsupportedOperationException();
        }

        public synchronized Builder setTrustedHardwareCertPath(CertPath certPath) throws CertificateException {
            this.mInstance.mCertPath = RecoveryCertPath.createRecoveryCertPath(certPath);
            return this;
        }

        public synchronized Builder setKeyChainProtectionParams(List<KeyChainProtectionParams> keyChainProtectionParams) {
            this.mInstance.mKeyChainProtectionParams = keyChainProtectionParams;
            return this;
        }

        public synchronized Builder setWrappedApplicationKeys(List<WrappedApplicationKey> entryRecoveryData) {
            this.mInstance.mEntryRecoveryData = entryRecoveryData;
            return this;
        }

        public synchronized Builder setEncryptedRecoveryKeyBlob(byte[] encryptedRecoveryKeyBlob) {
            this.mInstance.mEncryptedRecoveryKeyBlob = encryptedRecoveryKeyBlob;
            return this;
        }

        public synchronized KeyChainSnapshot build() {
    ...
    protected synchronized KeyChainSnapshot(Parcel in) {
        this.mMaxAttempts = 10;
        this.mCounterId = 1L;

...
public class AndroidKeyStoreECPublicKey extends AndroidKeyStorePublicKey implements ECPublicKey {
    ...
    public synchronized AndroidKeyStoreECPublicKey(String alias, int uid, byte[] x509EncodedForm, ECParameterSpec params, ECPoint w) {
        super(alias, uid, "EC", x509EncodedForm);
        this.mParams = params;
        this.mW = w;
    }

    public synchronized AndroidKeyStoreECPublicKey(String alias, int uid, ECPublicKey info) {

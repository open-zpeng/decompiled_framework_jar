...
abstract class AndroidKeyStoreCipherSpiBase extends CipherSpi implements KeyStoreCryptoOperation {
    ...
    protected abstract synchronized void addAlgorithmSpecificParametersToBegin(KeymasterArguments keymasterArguments);

    @Override // javax.crypto.CipherSpi
    protected abstract AlgorithmParameters engineGetParameters();

    protected abstract synchronized int getAdditionalEntropyAmountForBegin();

    protected abstract synchronized int getAdditionalEntropyAmountForFinish();

    protected abstract synchronized void initAlgorithmSpecificParameters() throws InvalidKeyException;

    protected abstract synchronized void initAlgorithmSpecificParameters(AlgorithmParameters algorithmParameters) throws InvalidAlgorithmParameterException;

    protected abstract synchronized void initAlgorithmSpecificParameters(AlgorithmParameterSpec algorithmParameterSpec) throws InvalidAlgorithmParameterException;

    protected abstract synchronized void initKey(int i, Key key) throws InvalidKeyException;

    protected abstract synchronized void loadAlgorithmSpecificParametersFromBeginResult(KeymasterArguments keymasterArguments);
    ...
    private synchronized void init(int opmode, Key key, SecureRandom random) throws InvalidKeyException {
        switch (opmode) {
            case 1:
            case 3:
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized void resetWhilePreservingInitState() {
        IBinder operationToken = this.mOperationToken;
        if (operationToken != null) {
            this.mKeyStore.abort(operationToken);
        }
    ...
    private synchronized void ensureKeystoreOperationInitialized() throws InvalidKeyException, InvalidAlgorithmParameterException {
        int i;
    ...
    protected synchronized KeyStoreCryptoOperationStreamer createMainDataStreamer(KeyStore keyStore, IBinder operationToken) {
    ...
    protected synchronized KeyStoreCryptoOperationStreamer createAdditionalAuthenticationDataStreamer(KeyStore keyStore, IBinder operationToken) {
        return null;
    }
    ...
    private synchronized void flushAAD() throws KeyStoreException {
    ...
    public final synchronized long getOperationHandle() {
        return this.mOperationHandle;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized void setKey(AndroidKeyStoreKey key) {
        this.mKey = key;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized void setKeymasterPurposeOverride(int keymasterPurpose) {
        this.mKeymasterPurposeOverride = keymasterPurpose;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized int getKeymasterPurposeOverride() {
        return this.mKeymasterPurposeOverride;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized boolean isEncrypting() {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized long getConsumedInputSizeBytes() {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized long getProducedOutputSizeBytes() {
        if (this.mMainDataStreamer == null) {
            throw new IllegalStateException("Not initialized");
        }
    ...
    public static synchronized String opmodeToString(int opmode) {
        switch (opmode) {
            case 1:
                return "ENCRYPT_MODE";
            case 2:

...
public class AndroidKeyStoreSecretKeyFactorySpi extends SecretKeyFactorySpi {
    ...
    protected synchronized KeySpec engineGetKeySpec(SecretKey key, Class keySpecClass) throws InvalidKeySpecException {
        String entryAlias;
    ...
    public static synchronized KeyInfo getKeyInfo(KeyStore keyStore, String entryAlias, String keyAliasInKeystore, int keyUid) {
        ...
        try {
            ...
            if (keymasterSwEnforcedUserAuthenticators == 2 || keymasterHwEnforcedUserAuthenticators == 2) {
                if (keymasterSecureUserIds == null || keymasterSecureUserIds.isEmpty() || keymasterSecureUserIds.contains(getGateKeeperSecureUserId())) {
    ...
    private static synchronized BigInteger getGateKeeperSecureUserId() throws ProviderException {
        try {

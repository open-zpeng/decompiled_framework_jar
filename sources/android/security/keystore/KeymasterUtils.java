...
public abstract class KeymasterUtils {
    private synchronized KeymasterUtils() {
    }

    public static synchronized int getDigestOutputSizeBits(int keymasterDigest) {
    ...
    public static synchronized boolean isKeymasterBlockModeIndCpaCompatibleWithSymmetricCrypto(int keymasterBlockMode) {
    ...
    public static synchronized boolean isKeymasterPaddingSchemeIndCpaCompatibleWithAsymmetricCrypto(int keymasterPadding) {
    ...
    public static synchronized void addUserAuthArgs(KeymasterArguments args, UserAuthArgs spec) {
        long sid;
        long sid2;
    ...
    public static synchronized void addMinMacLengthAuthorizationIfNecessary(KeymasterArguments args, int keymasterAlgorithm, int[] keymasterBlockModes, int[] keymasterDigests) {
    ...
    private static synchronized long getRootSid() {

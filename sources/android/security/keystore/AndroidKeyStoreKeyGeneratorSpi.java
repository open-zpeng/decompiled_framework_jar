...
public abstract class AndroidKeyStoreKeyGeneratorSpi extends KeyGeneratorSpi {
    ...
    protected static abstract class HmacBase extends AndroidKeyStoreKeyGeneratorSpi {
        protected synchronized HmacBase(int keymasterDigest) {
    ...
    protected synchronized AndroidKeyStoreKeyGeneratorSpi(int keymasterAlgorithm, int defaultKeySizeBits) {
        this(keymasterAlgorithm, -1, defaultKeySizeBits);
    }

    protected synchronized AndroidKeyStoreKeyGeneratorSpi(int keymasterAlgorithm, int keymasterDigest, int defaultKeySizeBits) {

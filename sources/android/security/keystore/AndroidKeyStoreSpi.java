...
public class AndroidKeyStoreSpi extends KeyStoreSpi {
    ...
    public Certificate[] engineGetCertificateChain(String alias) {
        ...
        byte[] caBytes = keyStore.get("CACERT_" + alias, this.mUid);
        int i = 1;
        if (caBytes != null) {
    ...
    private synchronized Certificate getCertificateForTrustedCertificateEntry(byte[] encodedCert) {
        return toCertificate(encodedCert);
    }

    private synchronized Certificate getCertificateForPrivateKeyEntry(String alias, byte[] encodedCert) {
    ...
    private static synchronized KeyStoreX509Certificate wrapIntoKeyStoreCertificate(String privateKeyAlias, int uid, X509Certificate certificate) {
        if (certificate != null) {
    ...
    private static synchronized X509Certificate toCertificate(byte[] bytes) {
        try {
    ...
    private static synchronized Collection<X509Certificate> toCertificates(byte[] bytes) {
        try {
            CertificateFactory certFactory = CertificateFactory.getInstance("X.509");
    ...
    private synchronized Date getModificationDate(String alias) {
    ...
    private static synchronized KeyProtection getLegacyKeyProtectionParameter(PrivateKey key) throws KeyStoreException {
    ...
    */
    private synchronized void setPrivateKeyEntry(java.lang.String r26, java.security.PrivateKey r27, java.security.cert.Certificate[] r28, java.security.KeyStore.ProtectionParameter r29) throws java.security.KeyStoreException {
        /*
    ...
    private synchronized void setSecretKeyEntry(String entryAlias, SecretKey key, KeyStore.ProtectionParameter param) throws KeyStoreException {
    ...
    private synchronized void setWrappedKeyEntry(String alias, WrappedKeyEntry entry, KeyStore.ProtectionParameter param) throws KeyStoreException {
        if (param != null) {
    ...
    private synchronized Set<String> getUniqueAliases() {
    ...
    private synchronized boolean isKeyEntry(String alias) {
        android.security.KeyStore keyStore = this.mKeyStore;
        if (!keyStore.contains("USRPKEY_" + alias, this.mUid)) {
            android.security.KeyStore keyStore2 = this.mKeyStore;
            if (!keyStore2.contains("USRSKEY_" + alias, this.mUid)) {
    ...
    private synchronized boolean isCertificateEntry(String alias) {
        if (alias == null) {
            throw new NullPointerException("alias == null");
        }
        android.security.KeyStore keyStore = this.mKeyStore;
    ...
    public static class KeyStoreX509Certificate extends DelegatingX509Certificate {
        ...
        synchronized KeyStoreX509Certificate(String privateKeyAlias, int privateKeyUid, X509Certificate delegate) {
            super(delegate);

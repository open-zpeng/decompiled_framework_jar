...
public final class ParcelableKeyGenParameterSpec implements Parcelable {
    ...
    public synchronized ParcelableKeyGenParameterSpec(KeyGenParameterSpec spec) {
        this.mSpec = spec;
    }
    ...
    private static synchronized void writeOptionalDate(Parcel out, Date date) {
        if (date != null) {
    ...
    private static synchronized Date readDateOrNull(Parcel in) {
    ...
    private synchronized ParcelableKeyGenParameterSpec(Parcel in) {
    ...
    public synchronized KeyGenParameterSpec getSpec() {
        return this.mSpec;
    }
}

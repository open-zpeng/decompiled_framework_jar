...
public class Credentials {
    ...
    */
    public static synchronized java.util.List<java.security.cert.X509Certificate> convertFromPem(byte[] r9) throws java.io.IOException, java.security.cert.CertificateException {
        /*
    ...
    private protected static Credentials getInstance() {
        if (singleton == null) {
    ...
    private protected void unlock(Context context) {
        try {
    ...
    private protected void install(Context context, KeyPair pair) {
        try {
            Intent intent = KeyChain.createInstallIntent();
    ...
    private protected void install(Context context, String type, byte[] value) {
        try {
            Intent intent = KeyChain.createInstallIntent();
    ...
    public static synchronized boolean deleteAllTypesForAlias(KeyStore keystore, String alias) {
        return deleteAllTypesForAlias(keystore, alias, -1);
    }

    public static synchronized boolean deleteAllTypesForAlias(KeyStore keystore, String alias, int uid) {
        return deleteUserKeyTypeForAlias(keystore, alias, uid) & deleteCertificateTypesForAlias(keystore, alias, uid);
    }

    public static synchronized boolean deleteCertificateTypesForAlias(KeyStore keystore, String alias) {
        return deleteCertificateTypesForAlias(keystore, alias, -1);
    }

    public static synchronized boolean deleteCertificateTypesForAlias(KeyStore keystore, String alias, int uid) {
        boolean delete = keystore.delete("USRCERT_" + alias, uid);
        return delete & keystore.delete("CACERT_" + alias, uid);
    }

    public static synchronized boolean deleteUserKeyTypeForAlias(KeyStore keystore, String alias) {
        return deleteUserKeyTypeForAlias(keystore, alias, -1);
    }

    public static synchronized boolean deleteUserKeyTypeForAlias(KeyStore keystore, String alias, int uid) {
    ...
    public static synchronized boolean deleteLegacyKeyForAlias(KeyStore keystore, String alias, int uid) {

...
public final class SystemCertificateSource extends DirectoryCertificateSource {
    ...
    private synchronized SystemCertificateSource() {
    ...
    public static synchronized SystemCertificateSource getInstance() {
        return NoPreloadHolder.INSTANCE;
    }

    @Override // android.security.net.config.DirectoryCertificateSource
    protected synchronized boolean isCertMarkedAsRemoved(String caFile) {

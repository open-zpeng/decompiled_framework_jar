...
public class ResourceCertificateSource implements CertificateSource {
    ...
    public synchronized ResourceCertificateSource(int resourceId, Context context) {
    ...
    @Override // android.security.net.config.CertificateSource
    public synchronized X509Certificate findBySubjectAndPublicKey(X509Certificate cert) {
        ensureInitialized();
    ...
    @Override // android.security.net.config.CertificateSource
    public synchronized X509Certificate findByIssuerAndSignature(X509Certificate cert) {
        ensureInitialized();
    ...
    @Override // android.security.net.config.CertificateSource
    public synchronized Set<X509Certificate> findAllByIssuerAndSignature(X509Certificate cert) {
        ensureInitialized();

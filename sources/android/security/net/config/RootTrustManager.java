...
public class RootTrustManager extends X509ExtendedTrustManager {
    ...
    public synchronized RootTrustManager(ApplicationConfig config) {
        if (config == null) {
    ...
    private protected List<X509Certificate> checkServerTrusted(X509Certificate[] certs, String authType, String hostname) throws CertificateException {
    ...
    public synchronized boolean isSameTrustConfiguration(String hostname1, String hostname2) {

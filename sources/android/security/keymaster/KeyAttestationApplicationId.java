...
public class KeyAttestationApplicationId implements Parcelable {
    ...
    public synchronized KeyAttestationApplicationId(KeyAttestationPackageInfo[] mAttestationPackageInfos) {
        this.mAttestationPackageInfos = mAttestationPackageInfos;
    }

    public synchronized KeyAttestationPackageInfo[] getAttestationPackageInfos() {
    ...
    synchronized KeyAttestationApplicationId(Parcel source) {

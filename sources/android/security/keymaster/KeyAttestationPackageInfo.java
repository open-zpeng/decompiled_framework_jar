...
public class KeyAttestationPackageInfo implements Parcelable {
    ...
    public synchronized KeyAttestationPackageInfo(String mPackageName, long mPackageVersionCode, Signature[] mPackageSignatures) {
    ...
    private synchronized KeyAttestationPackageInfo(Parcel source) {

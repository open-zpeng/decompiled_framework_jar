...
public class ExportResult implements Parcelable {
    private protected static final Parcelable.Creator<ExportResult> CREATOR = new Parcelable.Creator<ExportResult>() { // from class: android.security.keymaster.ExportResult.1
    ...
    protected synchronized ExportResult(Parcel in) {

...
public interface IKeyChainAliasCallback extends IInterface {
    synchronized void alias(String str) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IKeyChainAliasCallback {
        ...
        public static synchronized IKeyChainAliasCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IKeyChainAliasCallback {
            ...
            public synchronized void alias(String alias) throws RemoteException {

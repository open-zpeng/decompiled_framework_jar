...
public class NetworkSecurityPolicy {
    ...
    private synchronized NetworkSecurityPolicy() {
    }
    ...
    public synchronized void setCleartextTrafficPermitted(boolean permitted) {
    ...
    public static synchronized ApplicationConfig getApplicationConfigForPackage(Context context, String packageName) throws PackageManager.NameNotFoundException {

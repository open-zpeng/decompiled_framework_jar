...
public final class KeyPairGeneratorSpec implements AlgorithmParameterSpec {
    ...
    public synchronized KeyPairGeneratorSpec(Context context, String keyStoreAlias, String keyType, int keySize, AlgorithmParameterSpec spec, X500Principal subjectDN, BigInteger serialNumber, Date startDate, Date endDate, int flags) {
        if (context == null) {

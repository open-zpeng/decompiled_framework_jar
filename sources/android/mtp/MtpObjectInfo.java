...
public final class MtpObjectInfo {
    ...
    private synchronized MtpObjectInfo() {
        this.mName = "";
        this.mKeywords = "";
    }
    ...
    private static synchronized long uint32ToLong(int value) {
        return value < 0 ? ProtoOutputStream.FIELD_TYPE_DOUBLE + value : value;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized int longToUint32(long value, String valueName) {

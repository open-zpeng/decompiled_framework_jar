...
public abstract class RecognitionService extends Service {
    ...
    public void dispatchInitRecognizer(Bundle params, final IRecognitionListener listener, int callingUid) {
        if (this.mCurrentCallback == null || this.mCurrentCallback.mListener.asBinder() == listener.asBinder()) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void dispatchStartListening(Intent intent, final IRecognitionListener listener, int callingUid) {
        if (this.mCurrentCallback == null || this.mCurrentCallback.mListener.asBinder() == listener.asBinder()) {
            Log.d(TAG, "created new mCurrentCallback, listener = " + listener.asBinder());
            if (this.mCurrentCallback == null) {
                try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void dispatchStopListening(IRecognitionListener listener) {
        try {
            if (this.mCurrentCallback == null) {
                listener.onError(5);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void dispatchCancel(IRecognitionListener listener) {
        if (this.mCurrentCallback == null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void dispatchClearCallback() {
        this.mCurrentCallback = null;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean checkPermissions(IRecognitionListener listener) {
    ...
    private static final class RecognitionServiceBinder extends IRecognitionService.Stub {
        ...
        public synchronized RecognitionServiceBinder(RecognitionService service) {
        ...
        @Override // android.speech.IRecognitionService
        public synchronized void startListening(Intent recognizerIntent, IRecognitionListener listener) {
        ...
        @Override // android.speech.IRecognitionService
        public synchronized void stopListening(IRecognitionListener listener) {
        ...
        @Override // android.speech.IRecognitionService
        public synchronized void cancel(IRecognitionListener listener) {

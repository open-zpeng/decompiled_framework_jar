...
public final class SynthesisRequest {
    ...
    public synchronized void setLanguage(String language, String country, String variant) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setVoiceName(String voiceName) {
        this.mVoiceName = voiceName;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setSpeechRate(int speechRate) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setCallerUid(int uid) {
        this.mCallerUid = uid;
    }
}

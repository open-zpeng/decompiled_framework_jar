...
public abstract class UtteranceProgressListener {
    ...
    @Deprecated
    private protected void onUtteranceRangeStart(String utteranceId, int start, int end) {
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized UtteranceProgressListener from(final TextToSpeech.OnUtteranceCompletedListener listener) {

...
public class EventLogTags {
    ...
    public static synchronized void writeTtsSpeakSuccess(String engine, int callerUid, int callerPid, int length, String locale, int rate, int pitch, long engineLatency, long engineTotal, long audioLatency) {
    ...
    public static synchronized void writeTtsSpeakFailure(String engine, int callerUid, int callerPid, int length, String locale, int rate, int pitch) {
    ...
    public static synchronized void writeTtsV2SpeakSuccess(String engine, int callerUid, int callerPid, int length, String requestConfig, long engineLatency, long engineTotal, long audioLatency) {
    ...
    public static synchronized void writeTtsV2SpeakFailure(String engine, int callerUid, int callerPid, int length, String requestConfig, int statuscode) {

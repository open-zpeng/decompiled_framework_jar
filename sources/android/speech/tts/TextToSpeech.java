...
public class TextToSpeech {
    ...
    private static final int NOT_REMOVE = 1;
    ...
    public static final int TTS_MODE_HYBIRD = 3;
    public static final int TTS_MODE_LOCAL = 1;
    public static final int TTS_ONLINE_FORMAT_MP3 = 1;
    public static final int TTS_ONLINE_FORMAT_WAV = 0;
    ...
    public static final int VOICE_POSITION_AUTO = 1;
    public static final int VOICE_POSITION_DISABLE = 0;
    private CallbackHandler mCallbackHandler;
    private HandlerThread mCallbackThread;
    public protected Connection mConnectingServiceConnection;
    private final Context mContext;
    public protected volatile String mCurrentEngine;
    private ArrayList<String> mCurrentUidList;
    private final Map<String, Uri> mEarcons;
    private final TtsEngines mEnginesHelper;
    public protected OnInitListener mInitListener;
    ...
    public interface Action<R> {
        synchronized R run(ITextToSpeechService iTextToSpeechService) throws RemoteException;
    }
    ...
    public synchronized TextToSpeech(Context context, OnInitListener listener, String engine, String packageName, boolean useFallback) {
    ...
    private synchronized <R> R runActionNoReconnect(Action<R> action, R errorResult, String method, boolean onlyEstablishedConnection) {
        return (R) runAction(action, errorResult, method, false, onlyEstablishedConnection);
    }

    private synchronized <R> R runAction(Action<R> action, R errorResult, String method) {
        return (R) runAction(action, errorResult, method, true, true);
    }

    private synchronized <R> R runAction(Action<R> action, R errorResult, String method, boolean reconnect, boolean onlyEstablishedConnection) {
        synchronized (this.mStartLock) {
    ...
    private synchronized boolean connectToEngine(String engine) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void dispatchOnInit(int result) {
        synchronized (this.mStartLock) {
            ...
            if (result == 0) {
                ...
                if (isReConnectEngineNeeded()) {
                    ...
                    Message msg = this.mCallbackHandler.obtainMessage(7, 0, 0, "");
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized IBinder getCallerIdentity() {
    ...
    private synchronized Uri makeResourceUri(String packageName, int resourceId) {
    ...
    public int speak(final CharSequence text, final int queueMode, final Bundle params, final String utteranceId) {
        ...
        if (ret == -1) {
            Message msg = this.mCallbackHandler.obtainMessage(2, -4, 0, utteranceId);
            this.mCallbackHandler.sendMessage(msg);
        }
        return ret;
    }
    ...
    private protected String getCurrentEngine() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized Voice getVoice(ITextToSpeechService service, String voiceName) throws RemoteException {
        List<Voice> voices = service.getVoices();
        if (voices == null) {
    ...
    private synchronized Bundle convertParamsHashMaptoBundle(HashMap<String, String> params) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized Bundle getParams(Bundle params) {
        if (params != null && !params.isEmpty()) {
    ...
    private static synchronized boolean verifyIntegerBundleParam(Bundle bundle, String key) {
    ...
    private static synchronized boolean verifyStringBundleParam(Bundle bundle, String key) {
    ...
    private static synchronized boolean verifyBooleanBundleParam(Bundle bundle, String key) {
    ...
    private static synchronized boolean verifyFloatBundleParam(Bundle bundle, String key) {
    ...
    private synchronized void copyStringParam(Bundle bundle, HashMap<String, String> params, String key) {
    ...
    private synchronized void copyIntParam(Bundle bundle, HashMap<String, String> params, String key) {
    ...
    private synchronized void copyFloatParam(Bundle bundle, HashMap<String, String> params, String key) {
        String valueString = params.get(key);
        if (!TextUtils.isEmpty(valueString)) {
            try {
    ...
    public int setOnStateChangedListener(OnStateChangedListener listener) {
        ...
        return ((Integer) runAction(new Action<Integer>() { // from class: android.speech.tts.TextToSpeech.18
            ...
            @Override // android.speech.tts.TextToSpeech.Action
            public Integer run(ITextToSpeechService service) throws RemoteException {
                return Integer.valueOf(service.setListenOnStateChanged(TextToSpeech.this.getCallerIdentity()));
            }
    ...
    public int setSoloMode(final boolean on) {
        return ((Integer) runAction(new Action<Integer>() { // from class: android.speech.tts.TextToSpeech.19
            /* JADX WARN: Can't rename method to resolve collision */
            @Override // android.speech.tts.TextToSpeech.Action
            public Integer run(ITextToSpeechService service) throws RemoteException {
                return Integer.valueOf(service.setSoloMode(TextToSpeech.this.getCallerIdentity(), on));
            }
    ...
    public class Connection implements ServiceConnection {
        ...
        private Connection() {
            this.mCallback = new ITextToSpeechCallback.Stub() { // from class: android.speech.tts.TextToSpeech.Connection.1
                ...
                public void onStop(String utteranceId, boolean isStarted) throws RemoteException {
                    Message msg = TextToSpeech.this.mCallbackHandler.obtainMessage(0, isStarted ? 1 : 0, 0, utteranceId);
                    TextToSpeech.this.mCallbackHandler.sendMessage(msg);
                }

                @Override // android.speech.tts.ITextToSpeechCallback
                public void onSuccess(String utteranceId) {
                    Message msg = TextToSpeech.this.mCallbackHandler.obtainMessage(1, utteranceId);
                    TextToSpeech.this.mCallbackHandler.sendMessage(msg);
                }

                @Override // android.speech.tts.ITextToSpeechCallback
                public void onError(String utteranceId, int errorCode) {
                    Message msg = TextToSpeech.this.mCallbackHandler.obtainMessage(2, errorCode, 0, utteranceId);
                    TextToSpeech.this.mCallbackHandler.sendMessage(msg);
                }

                @Override // android.speech.tts.ITextToSpeechCallback
                public void onStart(String utteranceId) {
                    Message msg = TextToSpeech.this.mCallbackHandler.obtainMessage(3, utteranceId);
                    TextToSpeech.this.mCallbackHandler.sendMessage(msg);
                }
                ...
                public void onStateChanged(String name, int state) {
                    Message msg = TextToSpeech.this.mCallbackHandler.obtainMessage(7, state, 0, name);
                    TextToSpeech.this.mCallbackHandler.sendMessage(msg);
                }
            };
        }
        ...
        public class SetupConnectionAsyncTask extends AsyncTask<Void, Void, Integer> {
            ...
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // android.os.AsyncTask
            public synchronized void onPostExecute(Integer result) {
                synchronized (TextToSpeech.this.mStartLock) {
            ...
            synchronized (TextToSpeech.this.mStartLock) {
                ...
                if (!TextToSpeech.this.mCurrentUidList.isEmpty()) {
                    ...
                    while (it.hasNext()) {
                        ...
                        Message msg = TextToSpeech.this.mCallbackHandler.obtainMessage(2, -4, 1, uid);
                        TextToSpeech.this.mCallbackHandler.sendMessage(msg);
                    }
        ...
        private synchronized boolean clearServiceConnection() {
            boolean result;
            synchronized (TextToSpeech.this.mStartLock) {
                result = false;
                if (this.mOnSetupConnectionAsyncTask != null) {
        ...
        public synchronized <R> R runAction(Action<R> action, R errorResult, String method, boolean reconnect, boolean onlyEstablishedConnection) {
            synchronized (TextToSpeech.this.mStartLock) {
                try {
                    try {
    ...
    public class CallbackHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    String utteranceId = (String) msg.obj;
                    boolean isStarted = msg.arg1 == 1;
                    Log.d(TextToSpeech.TAG, "onStop " + utteranceId + " isStarted " + isStarted);
                    try {
                        synchronized (TextToSpeech.this.mStartLock) {
                    ...
                    return;
                case 1:
                    String utteranceId2 = (String) msg.obj;
                    Log.d(TextToSpeech.TAG, "onDone " + utteranceId2);
                    try {
                        synchronized (TextToSpeech.this.mStartLock) {
                    ...
                    if (listener2 != null) {
                        listener2.onDone(utteranceId2);
                        return;
                    }
                    return;
                case 2:
                    String utteranceId3 = (String) msg.obj;
                    int errorCode = msg.arg1;
                    Log.d(TextToSpeech.TAG, "onError " + utteranceId3 + " errorCode " + errorCode);
                    if (msg.arg2 != 1) {
                        try {
                            synchronized (TextToSpeech.this.mStartLock) {
                    ...
                    if (listener3 != null) {
                        listener3.onError(utteranceId3, errorCode);
                        return;
                    }
                    return;
                case 3:
                    String utteranceId4 = (String) msg.obj;
                    Log.d(TextToSpeech.TAG, "onStart " + utteranceId4);
                    UtteranceProgressListener listener4 = TextToSpeech.this.mUtteranceProgressListener;
                    if (listener4 != null) {
                        listener4.onStart(utteranceId4);
                        return;
                    }
                    return;
                case 4:
                ...
                case 7:
                    ...
                    int state = msg.arg1;
                    Log.d(TextToSpeech.TAG, "onStateChanged " + name + WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + state);
                    OnStateChangedListener listener8 = TextToSpeech.this.mStateChangedListener;
                    if (listener8 != null) {
                        try {
                            listener8.onStateChanged(name, state);
                            return;
                        } catch (Exception e4) {
    ...
    public boolean isReConnectEngineNeeded() {
        if (this.mCurrentEngine == null) {
            ...
            return true;
        } else if (this.mRequestedEngine != null && this.mEnginesHelper.isEngineInstalled(this.mRequestedEngine)) {

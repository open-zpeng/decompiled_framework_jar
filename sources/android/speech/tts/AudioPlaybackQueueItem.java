...
class AudioPlaybackQueueItem extends PlaybackQueueItem {
    ...
    public synchronized AudioPlaybackQueueItem(TextToSpeechService.UtteranceProgressDispatcher dispatcher, Object callerIdentity, Context context, Uri uri, TextToSpeechService.AudioOutputParams audioParams) {
    ...
    private static synchronized void setupVolume(MediaPlayer player, float volume, float pan) {
    ...
    private static final synchronized float clip(float value, float min, float max) {

...
public class ImageFormat {
    ...
    public static synchronized MutableFrameFormat create(int width, int height, int colorspace, int bytesPerSample, int target) {
    ...
    public static synchronized int bytesPerSampleForColorspace(int colorspace) {
        switch (colorspace) {
            case 1:
                return 1;
            case 2:

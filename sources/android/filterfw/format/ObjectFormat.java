...
public class ObjectFormat {
    public static synchronized MutableFrameFormat fromClass(Class clazz, int count, int target) {
    ...
    public static synchronized MutableFrameFormat fromClass(Class clazz, int target) {
        return fromClass(clazz, 0, target);
    }

    public static synchronized MutableFrameFormat fromObject(Object object, int target) {
        if (object == null) {
    ...
    public static synchronized MutableFrameFormat fromObject(Object object, int count, int target) {
        if (object == null) {
            return new MutableFrameFormat(8, target);
        }
    ...
    private static synchronized int bytesPerSampleForClass(Class clazz, int target) {
        if (target == 2) {
    ...
    private static synchronized Class getBoxedClass(Class type) {
        if (type.isPrimitive()) {

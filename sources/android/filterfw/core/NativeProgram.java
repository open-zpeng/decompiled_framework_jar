...
public class NativeProgram extends Program {
    ...
    public synchronized NativeProgram(String nativeLibName, String nativeFunctionPrefix) {
    ...
    public synchronized void process(Frame[] inputs, Frame output) {
        if (this.mTornDown) {
    ...
    public synchronized void setHostValue(String variableName, Object value) {
        if (this.mTornDown) {
            throw new RuntimeException("NativeProgram already torn down!");
        }

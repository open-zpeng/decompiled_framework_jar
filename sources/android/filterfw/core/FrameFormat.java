...
public class FrameFormat {
    ...
    public synchronized FrameFormat() {
        this.mBaseType = 0;
    ...
    public synchronized FrameFormat(int baseType, int target) {
        this.mBaseType = 0;
        this.mBytesPerSample = 1;
        this.mSize = -1;
        this.mTarget = 0;
    ...
    public static synchronized FrameFormat unspecified() {
    ...
    public synchronized boolean isBinaryDataType() {
    ...
    public synchronized int getValuesPerSample() {
    ...
    public synchronized int getDimension(int i) {
        return this.mDimensions[i];
    }

    public synchronized int getDimensionCount() {
    ...
    public synchronized boolean hasMetaKey(String key) {
    ...
    public synchronized boolean hasMetaKey(String key, Class expectedClass) {
    ...
    public synchronized Object getMetaValue(String key) {
        if (this.mMetaData != null) {
    ...
    public synchronized int getNumberOfDimensions() {
        if (this.mDimensions != null) {
            return this.mDimensions.length;
        }
        return 0;
    ...
    */
    public synchronized boolean isCompatibleWith(android.filterfw.core.FrameFormat r7) {
        /*
            r6 = this;
    ...
    public synchronized boolean mayBeCompatibleWith(FrameFormat specification) {
    ...
    public static synchronized int bytesPerSampleOf(int baseType) {
        switch (baseType) {
            case 1:
            case 2:
                return 1;
    ...
    public static synchronized String dimensionsToString(int[] dimensions) {
    ...
    public static synchronized String baseTypeToString(int baseType) {
        switch (baseType) {
            case 0:
                return "unspecified";
            case 1:
    ...
    public static synchronized String targetToString(int target) {
        switch (target) {
            case 0:
                return "unspecified";
            case 1:
    ...
    public static synchronized String metaDataToString(KeyValueMap metaData) {
        if (metaData == null) {
            return "";
        }
        StringBuffer buffer = new StringBuffer();
    ...
    public static synchronized int readTargetString(String targetString) {
    ...
    synchronized int calcSize(int[] dimensions) {
    ...
    public synchronized boolean isReplaceableBy(FrameFormat format) {

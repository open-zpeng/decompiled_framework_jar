...
public class SyncRunner extends GraphRunner {
    ...
    public synchronized SyncRunner(FilterContext context, FilterGraph graph, Class schedulerClass) {
        super(context);
    ...
    public synchronized void setDoneCallback(GraphRunner.OnRunnerDoneListener listener) {
    ...
    public synchronized void waitUntilWake() {
        this.mWakeCondition.block();
    }

    protected synchronized void processFilterNode(Filter filter) {
        if (this.mLogVerbose) {
    ...
    protected synchronized void scheduleFilterWake(final Filter filter, int delay) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized int determinePostRunState() {
    ...
    public synchronized boolean performStep() {
        if (this.mLogVerbose) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void assertReadyToStep() {
        if (this.mScheduler == null) {

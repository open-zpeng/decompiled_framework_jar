...
public class FilterSurfaceView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public synchronized FilterSurfaceView(Context context) {
        super(context);
    ...
    public synchronized FilterSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mState = STATE_ALLOCATED;
        this.mSurfaceId = -1;
        getHolder().addCallback(this);
    ...
    private synchronized void registerSurface() {
    ...
    private synchronized void unregisterSurface() {

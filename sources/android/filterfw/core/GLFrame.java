...
public class GLFrame extends Frame {
    ...
    public synchronized GLFrame(FrameFormat format, FrameManager frameManager) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized GLFrame(FrameFormat format, FrameManager frameManager, int bindingType, long bindingId) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void init(GLEnvironment glEnv) {
    ...
    private synchronized void initNew(boolean isExternal) {
        if (isExternal) {
    ...
    private synchronized void initWithTexture(int texId) {
    ...
    private synchronized void initWithFbo(int fboId) {
        int width = getFormat().getWidth();
        int height = getFormat().getHeight();
    ...
    synchronized void flushGPU(String message) {
    ...
    private protected void setBitmap(Bitmap bitmap) {
        assertFrameMutable();
        assertGLEnvValid();
    ...
    public synchronized void setViewport(Rect rect) {
        assertFrameMutable();
    ...
    public synchronized int getFboId() {
    ...
    private synchronized void assertGLEnvValid() {

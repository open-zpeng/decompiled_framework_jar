...
public class FilterContext {
    ...
    public interface OnFrameReceivedListener {
        synchronized void onFrameReceived(Filter filter, Frame frame, Object obj);
    }
    ...
    public synchronized void setFrameManager(FrameManager manager) {
        if (manager == null) {
    ...
    public synchronized void initGLEnvironment(GLEnvironment environment) {
    ...
    public final synchronized void addGraph(FilterGraph graph) {

...
public class FilterFunction {
    ...
    public synchronized FilterFunction(FilterContext context, Filter filter) {
        this.mFilterContext = context;
        this.mFilter = filter;
    }

    public synchronized Frame execute(KeyValueMap inputMap) {
    ...
    public synchronized void setInputFrame(String input, Frame frame) {
        this.mFilter.setInputFrame(input, frame);
    }

    public synchronized void setInputValue(String input, Object value) {
    ...
    private synchronized void connectFilterOutputs() {
        int i = 0;

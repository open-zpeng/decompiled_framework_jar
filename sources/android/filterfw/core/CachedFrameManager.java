...
public class CachedFrameManager extends SimpleFrameManager {
    ...
    @Override // android.filterfw.core.SimpleFrameManager
    ...
    private synchronized boolean storeFrame(Frame frame) {
    ...
    private synchronized void dropOldestFrame() {
    ...
    private synchronized Frame findAvailableFrame(FrameFormat format, int bindingType, long bindingId) {
        synchronized (this.mAvailableFrames) {

...
public class FilterFactory {
    ...
    public static synchronized void addFilterLibrary(String libraryPath) {
        if (mLogVerbose) {
    ...
    public synchronized Filter createFilterByClassName(String className, String filterName) {
        if (mLogVerbose) {
    ...
    public synchronized Filter createFilterByClass(Class filterClass, String filterName) {
        try {

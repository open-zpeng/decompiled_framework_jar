...
public final class CompanionDeviceManager {
    ...
    public synchronized CompanionDeviceManager(ICompanionDeviceManager service, Context context) {
    ...
    private synchronized boolean checkFeaturePresent() {
    ...
    public class CallbackProxy extends IFindDeviceCallback.Stub implements Application.ActivityLifecycleCallbacks {
        ...
        public synchronized void onSuccess(PendingIntent launcher) {
        ...
        public synchronized void onFailure(CharSequence reason) {
        ...
        synchronized <T> void lockAndPost(final BiConsumer<Callback, T> action, final T payload) {

...
public final class WifiDeviceFilter implements DeviceFilter<ScanResult> {
    ...
    private synchronized WifiDeviceFilter(Pattern namePattern) {
        this.mNamePattern = namePattern;
    }

    @SuppressLint({"ParcelClassLoader"})
    private synchronized WifiDeviceFilter(Parcel in) {
    ...
    public synchronized String getDeviceDisplayName(ScanResult device) {

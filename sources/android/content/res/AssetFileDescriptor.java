...
public class AssetFileDescriptor implements Parcelable, Closeable {
    ...
    public protected final ParcelFileDescriptor mFd;
    public protected final long mLength;
    public protected final long mStartOffset;
    ...
    synchronized AssetFileDescriptor(Parcel src) {

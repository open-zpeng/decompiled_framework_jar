...
public final class XmlBlock implements AutoCloseable {
    ...
    private protected XmlBlock(byte[] data) {
        this.mOpen = true;
        this.mOpenCount = 1;
        this.mAssets = null;
    ...
    public synchronized XmlBlock(byte[] data, int offset, int size) {
        this.mOpen = true;
        this.mOpenCount = 1;
        this.mAssets = null;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void decOpenCountLocked() {
        this.mOpenCount--;
    ...
    public final class Parser implements XmlResourceParser {
        public protected final XmlBlock mBlock;
        public private protected long mParseState;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public final synchronized CharSequence getPooledString(int id) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized XmlBlock(AssetManager assets, long xmlBlock) {
        this.mOpen = true;
        this.mOpenCount = 1;
        this.mAssets = assets;

...
public class FontResourcesParser {
    ...
    public static final class ProviderResourceEntry implements FamilyResourceEntry {
        ...
        public synchronized ProviderResourceEntry(String authority, String pkg, String query, List<List<String>> certs) {
        ...
        public synchronized List<List<String>> getCerts() {
            return this.mCerts;
        }
    }
    ...
    public static final class FontFileResourceEntry {
        ...
        public synchronized FontFileResourceEntry(String fileName, int weight, int italic, String variationSettings, int ttcIndex) {
        ...
        public synchronized int getItalic() {
            return this.mItalic;
        }

        public synchronized String getVariationSettings() {
            return this.mVariationSettings;
        }

        public synchronized int getTtcIndex() {
    ...
    public static final class FontFamilyFilesResourceEntry implements FamilyResourceEntry {
        ...
        public synchronized FontFamilyFilesResourceEntry(FontFileResourceEntry[] entries) {
            this.mEntries = entries;
        }

        public synchronized FontFileResourceEntry[] getEntries() {
            return this.mEntries;
        }
    }

    public static synchronized FamilyResourceEntry parse(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        int type;
        do {
            type = parser.next();
            if (type == 2) {
    ...
    private static synchronized FamilyResourceEntry readFamilies(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
    ...
    private static synchronized FamilyResourceEntry readFamily(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
    ...
    private static synchronized FontFileResourceEntry readFont(XmlPullParser parser, Resources resources) throws XmlPullParserException, IOException {
        AttributeSet attrs = Xml.asAttributeSet(parser);

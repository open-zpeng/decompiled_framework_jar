...
public class ColorStateList extends ComplexColor implements Parcelable {
    ...
    public protected int mDefaultColor;
    public protected ColorStateListFactory mFactory;
    private boolean mIsOpaque;
    public protected int[][] mStateSpecs;
    ...
    public protected ColorStateList() {
    }
    ...
    private synchronized ColorStateList(ColorStateList orig) {
        if (orig != null) {
    ...
    public static synchronized ColorStateList createFromXmlInner(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        while (true) {
            ...
            if (type != 2 || i2 > innerDepth2) {
                ...
                while (true) {
                    ...
                    int numAttrs3 = attrs.getAttributeNameResource(i3);
                    if (numAttrs3 != 16843173 && numAttrs3 != 16843551) {
                        int j3 = j + 1;
                        stateSpec[j] = attrs.getAttributeBooleanValue(i3, false) ? numAttrs3 : -numAttrs3;
                        j = j3;
                    }
                    j2 = i3 + 1;
                    i2 = depth2;
    ...
    public ColorStateList mo19obtainForTheme(Resources.Theme t) {
    ...
    private synchronized int modulateColorAlpha(int baseColor, float alphaMod) {
        if (alphaMod == 1.0f) {
            return baseColor;
        }
    ...
    public protected void onColorsChanged() {
        int defaultColor = -65536;
    ...
    public static class ColorStateListFactory extends ConstantState<ComplexColor> {
        ...
        private protected ColorStateListFactory(ColorStateList src) {
            this.mSrc = src;
        }

...
public class Resources {
    ...
    private boolean isCachedSupport;
    public private protected final ClassLoader mClassLoader;
    public protected DrawableInflater mDrawableInflater;
    public protected ResourcesImpl mResourcesImpl;
    private final ArrayList<WeakReference<Theme>> mThemeRefs;
    private int mThemeRefsNextFlushSize;
    public protected TypedValue mTmpValue;
    private final Object mTmpValueLock;
    public private protected final Pools.SynchronizedPool<TypedArray> mTypedArrayPool;
    private static final Object sSync = new Object();
    public private protected static Resources mSystem = null;

    /* JADX INFO: Access modifiers changed from: private */
    public static int selectDefaultTheme(int curTheme, int targetSdkVersion) {
        return selectSystemTheme(curTheme, targetSdkVersion, R.style.Theme, 16973931, 16974120, 16974143);
    }

    public static synchronized int selectSystemTheme(int curTheme, int targetSdkVersion, int orig, int holo, int dark, int deviceDefault) {
        if (curTheme != 0) {
            return curTheme;
        }
    ...
    public Resources(ClassLoader classLoader) {
        ...
        this.isCachedSupport = SystemProperties.getInt("persist.sys.res.cached", 1) == 1;
    ...
    public synchronized Typeface getFont(TypedValue value, int id) throws NotFoundException {
        return this.mResourcesImpl.loadFont(this, value, id);
    }

    public synchronized void preloadFonts(int id) {
    ...
    public private protected Drawable loadDrawable(TypedValue value, int id, int density, Theme theme) throws NotFoundException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized ColorStateList loadColorStateList(TypedValue value, int id, Theme theme) throws NotFoundException {
        return this.mResourcesImpl.loadColorStateList(this, value, id, theme);
    }

    public synchronized ComplexColor loadComplexColor(TypedValue value, int id, Theme theme) {
    ...
    private synchronized TypedValue obtainTempTypedValue() {
    ...
    private synchronized void releaseTempTypedValue(TypedValue value) {
        synchronized (this.mTmpValueLock) {
            if (this.mTmpValue == null) {
    ...
    public final class Theme {
        public protected ResourcesImpl.ThemeImpl mThemeImpl;

        private Theme() {
        }

        synchronized void setImpl(ResourcesImpl.ThemeImpl impl) {
        ...
        synchronized long getNativeTheme() {
            return this.mThemeImpl.getNativeTheme();
        }

        synchronized int getAppliedStyleResId() {
            return this.mThemeImpl.getAppliedStyleResId();
        }

        public synchronized ThemeKey getKey() {
            return this.mThemeImpl.getKey();
        }

        private synchronized String getResourceNameFromHexString(String hexString) {
    ...
    public static class ThemeKey implements Cloneable {
        ...
        public synchronized void append(int resId, boolean force) {
            if (this.mResId == null) {
            ...
            this.mCount++;
            this.mHashCode = (31 * ((this.mHashCode * 31) + resId)) + (force ? 1 : 0);
        }

        public synchronized void setTo(ThemeKey other) {
    ...
    @VisibleForTesting
    private protected void setCompatibilityInfo(CompatibilityInfo ci) {
        if (ci != null) {
    ...
    public static synchronized boolean resourceHasPackage(int resid) {
        return (resid >>> 24) != 0;
    }
    ...
    private protected LongSparseArray<Drawable.ConstantState> getPreloadedDrawables() {
        return this.mResourcesImpl.getPreloadedDrawables();
    }

    public private protected XmlResourceParser loadXmlResourceParser(int id, String type) throws NotFoundException {
        TypedValue value = obtainTempTypedValue();
        try {
            ResourcesImpl impl = this.mResourcesImpl;
            impl.getValue(id, value, true);
    ...
    public private protected XmlResourceParser loadXmlResourceParser(String file, int id, int assetCookie, String type) throws NotFoundException {
    ...
    public static synchronized TypedArray obtainAttributes(Resources res, Theme theme, AttributeSet set, int[] attrs) {
        if (theme == null) {
    ...
    public void setColorCacheEnabled(boolean enabled) {
        if (this.isCachedSupport && this.mResourcesImpl != null) {
            this.mResourcesImpl.setColorCacheEnabled(enabled);
        }
    }

    public void setDrawableCacheEnabled(boolean enabled) {
        if (this.isCachedSupport && this.mResourcesImpl != null) {
            this.mResourcesImpl.setDrawableCacheEnabled(enabled);
        }
    }
}

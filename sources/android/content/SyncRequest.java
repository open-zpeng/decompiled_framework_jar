...
public class SyncRequest implements Parcelable {
    ...
    public protected final Account mAccountToSync;
    public protected final String mAuthority;
    private final boolean mDisallowMetered;
    public protected final Bundle mExtras;
    private final boolean mIsAuthority;
    private final boolean mIsExpedited;
    public protected final boolean mIsPeriodic;
    private final long mSyncFlexTimeSecs;
    public protected final long mSyncRunTimeSecs;
    ...
    public synchronized long getSyncFlexTime() {
        return this.mSyncFlexTimeSecs;
    }

    public synchronized long getSyncRunTime() {
    ...
    private synchronized SyncRequest(Parcel in) {
    ...
    protected synchronized SyncRequest(Builder b) {
    ...
    public static class Builder {
        ...
        private synchronized void setupInterval(long at, long before) {
            if (before > at) {

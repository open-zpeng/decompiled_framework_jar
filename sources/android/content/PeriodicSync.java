...
public class PeriodicSync implements Parcelable {
    ...
    public synchronized PeriodicSync(PeriodicSync other) {
    ...
    public synchronized PeriodicSync(Account account, String authority, Bundle extras, long period, long flexTime) {
        this.account = account;
        this.authority = authority;
        this.extras = new Bundle(extras);
        this.period = period;
    ...
    private synchronized PeriodicSync(Parcel in) {
    ...
    */
    public static synchronized boolean syncExtrasEquals(android.os.Bundle r6, android.os.Bundle r7) {
        /*
            int r0 = r6.size()
            int r1 = r7.size()
            r2 = 0

...
public class SyncActivityTooManyDeletes extends Activity implements AdapterView.OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ListAdapter adapter = new ArrayAdapter(this, 17367043, (int) android.R.id.text1, options);
    ...
    private synchronized void startSyncReallyDelete() {
    ...
    private synchronized void startSyncUndoDeletes() {
        Bundle extras = new Bundle();

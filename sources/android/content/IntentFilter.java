...
public class IntentFilter implements Parcelable {
    ...
    public protected final ArrayList<String> mActions;
    ...
    private static synchronized int findStringInSet(String[] set, String string, int[] lengths, int lenPos) {
        if (set == null) {
            return -1;
        }
    ...
    private static synchronized String[] addStringToSet(String[] set, String string, int[] lengths, int lenPos) {
    ...
    private static synchronized String[] removeStringFromSet(String[] set, String string, int[] lengths, int lenPos) {
    ...
    public final synchronized boolean getAutoVerify() {
        return (this.mVerifyState & 1) == 1;
    }

    public final synchronized boolean handleAllWebDataURI() {
        return hasCategory(Intent.CATEGORY_APP_BROWSER) || (handlesWebUris(false) && countDataAuthorities() == 0);
    }

    public final synchronized boolean handlesWebUris(boolean onlyWebSchemes) {
    ...
    public final synchronized boolean needsVerification() {
        return getAutoVerify() && handlesWebUris(true);
    }

    private protected final boolean isVerified() {
    ...
    public synchronized void setVisibilityToInstantApp(int visibility) {
        this.mInstantAppVisibility = visibility;
    }

    public synchronized int getVisibilityToInstantApp() {
        return this.mInstantAppVisibility;
    }

    public synchronized boolean isVisibleToInstantApp() {
        return this.mInstantAppVisibility != 0;
    }

    public synchronized boolean isExplicitlyVisibleToInstantApp() {
        return this.mInstantAppVisibility == 1;
    }

    public synchronized boolean isImplicitlyVisibleToInstantApp() {
    ...
    private protected final boolean hasExactDataType(String type) {
    ...
    public static final class AuthorityEntry {
        ...
        synchronized AuthorityEntry(Parcel src) {
        ...
        synchronized void writeToParcel(Parcel dest) {
        ...
        synchronized void writeToProto(ProtoOutputStream proto, long fieldId) {
        ...
        public synchronized boolean match(AuthorityEntry other) {
    ...
    public final synchronized void addDataSchemeSpecificPart(PatternMatcher ssp) {
    ...
    private protected final boolean hasDataSchemeSpecificPart(PatternMatcher ssp) {
        if (this.mDataSchemeSpecificParts == null) {
            return false;
        }
        int numDataSchemeSpecificParts = this.mDataSchemeSpecificParts.size();
    ...
    public final synchronized void addDataAuthority(AuthorityEntry ent) {
    ...
    private protected final boolean hasDataAuthority(AuthorityEntry auth) {
        if (this.mDataAuthorities == null) {
            return false;
        }
    ...
    public final synchronized void addDataPath(PatternMatcher path) {
    ...
    private protected final boolean hasDataPath(PatternMatcher path) {
        if (this.mDataPaths == null) {
            return false;
        }
        int numDataPaths = this.mDataPaths.size();
    ...
    public synchronized boolean debugCheck() {
        return true;
    }

    public synchronized IntentFilter(Parcel source) {
        this.mCategories = null;
        this.mDataSchemes = null;
        this.mDataSchemeSpecificParts = null;
        this.mDataAuthorities = null;
    ...
    private final synchronized boolean findMimeType(String type) {
    ...
    public synchronized ArrayList<String> getHostsList() {

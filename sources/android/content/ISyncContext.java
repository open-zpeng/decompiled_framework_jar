...
public interface ISyncContext extends IInterface {
    synchronized void onFinished(SyncResult syncResult) throws RemoteException;

    synchronized void sendHeartbeat() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ISyncContext {
        ...
        private static class Proxy implements ISyncContext {
            ...
            @Override // android.content.ISyncContext
            public synchronized void onFinished(SyncResult result) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

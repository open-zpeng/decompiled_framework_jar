...
public class EventLogTags {
    ...
    public static synchronized void writeContentQuerySample(String uri, String projection, String selection, String sortorder, int time, String blockingPackage, int samplePercent) {
    ...
    public static synchronized void writeContentUpdateSample(String uri, String operation, String selection, int time, String blockingPackage, int samplePercent) {
    ...
    public static synchronized void writeBinderSample(String descriptor, int methodNum, int time, String blockingPackage, int samplePercent) {

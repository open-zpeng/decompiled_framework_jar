...
public class SyncAdapterType implements Parcelable {
    ...
    public protected final boolean allowParallelSyncs;
    public final String authority;
    public protected final boolean isAlwaysSyncable;
    public final boolean isKey;
    private final String packageName;
    public protected final String settingsActivity;
    public protected final boolean supportsUploading;
    public protected final boolean userVisible;
    ...
    public synchronized SyncAdapterType(String authority, String accountType, boolean userVisible, boolean supportsUploading, boolean isAlwaysSyncable, boolean allowParallelSyncs, String settingsActivity, String packageName) {
        if (TextUtils.isEmpty(authority)) {
            throw new IllegalArgumentException("the authority must not be empty: " + authority);
        } else if (TextUtils.isEmpty(accountType)) {
            throw new IllegalArgumentException("the accountType must not be empty: " + accountType);
    ...
    public protected SyncAdapterType(String authority, String accountType) {
        if (TextUtils.isEmpty(authority)) {
            throw new IllegalArgumentException("the authority must not be empty: " + authority);
        } else if (TextUtils.isEmpty(accountType)) {
            throw new IllegalArgumentException("the accountType must not be empty: " + accountType);

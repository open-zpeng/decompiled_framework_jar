...
public abstract class AsyncTaskLoader<D> extends Loader<D> {
    ...
    public protected final Executor mExecutor;
    Handler mHandler;
    ...
    public final class LoadTask extends AsyncTask<Void, Void, D> implements Runnable {
        ...
        @Override // android.os.AsyncTask
        protected synchronized void onPostExecute(D data) {
            try {
        ...
        @Override // android.os.AsyncTask
        protected synchronized void onCancelled(D data) {
            try {
        ...
        public synchronized void waitForLoader() {
            try {
                this.mDone.await();
    ...
    public synchronized AsyncTaskLoader(Context context, Executor executor) {
        super(context);
    ...
    synchronized void executePendingTask() {
    ...
    synchronized void dispatchOnCancelled(AsyncTaskLoader<D>.LoadTask task, D data) {
        onCanceled(data);
    ...
    synchronized void dispatchOnLoadComplete(AsyncTaskLoader<D>.LoadTask task, D data) {
        if (this.mTask != task) {
    ...
    private protected void waitForLoader() {

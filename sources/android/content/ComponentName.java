...
public final class ComponentName implements Parcelable, Cloneable, Comparable<ComponentName> {
    ...
    public interface WithComponentName {
        synchronized ComponentName getComponentName();
    }
    ...
    private static synchronized void appendShortClassName(StringBuilder sb, String packageName, String className) {
        int PN;
        int CN;
    ...
    private static synchronized void printShortClassName(PrintWriter pw, String packageName, String className) {
        int PN;
        int CN;
        if (className.startsWith(packageName) && (CN = className.length()) > (PN = packageName.length()) && className.charAt(PN) == '.') {
    ...
    public synchronized void appendShortString(StringBuilder sb) {
        appendShortString(sb, this.mPackage, this.mClass);
    }
    ...
    private synchronized ComponentName(String pkg, Parcel in) {
        this.mPackage = pkg;
        this.mClass = in.readString();
    }
}

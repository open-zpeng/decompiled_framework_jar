...
public class IntentSender implements Parcelable {
    ...
    public protected final IIntentSender mTarget;
    ...
    public static class FinishedDispatcher extends IIntentReceiver.Stub implements Runnable {
        ...
        synchronized FinishedDispatcher(IntentSender pi, OnFinished who, Handler handler) {
    ...
    private protected IntentSender(IIntentSender target) {
        this.mTarget = target;
    }

    public synchronized IntentSender(IIntentSender target, IBinder whitelistToken) {
        this.mTarget = target;
        this.mWhitelistToken = whitelistToken;
    }

    public synchronized IntentSender(IBinder target) {

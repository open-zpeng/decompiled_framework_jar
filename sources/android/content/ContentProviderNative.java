...
public abstract class ContentProviderNative extends Binder implements IContentProvider {
    public abstract synchronized String getProviderName();

    public synchronized ContentProviderNative() {
            ...
            if (code != 10) {
                ...
                switch (code) {
                    case 1:
                        ...
                        Cursor cursor = query(callingPkg, url, projection2, queryArgs, cancellationSignal);
                        if (cursor != null) {
                            ...
                            default:
                                switch (code) {
                                    case 20:
                                        ...
                                        ContentProviderResult[] results = applyBatch(callingPkg7, operations);
                                        reply.writeNoException();
                                    ...
                                    case 21:
                                        ...
                                        Bundle responseBundle = call(callingPkg8, method, stringArg, args);
                                        reply.writeNoException();

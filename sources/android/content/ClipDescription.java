...
public class ClipDescription implements Parcelable {
    ...
    public synchronized boolean toShortString(StringBuilder b) {
    ...
    public synchronized boolean toShortStringTypesOnly(StringBuilder b) {
        int size = this.mMimeTypes.size();
        boolean first = true;
        for (int i = 0; i < size; i++) {
            if (!first) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized ClipDescription(Parcel in) {

...
public class RestrictionsManager {
    ...
    public protected final IRestrictionsManager mService;

    public synchronized RestrictionsManager(Context context, IRestrictionsManager service) {
    ...
    private synchronized List<RestrictionEntry> loadManifestRestrictions(String packageName, XmlResourceParser xml) {
        try {
    ...
    private synchronized RestrictionEntry loadRestrictionElement(Context appContext, XmlResourceParser xml) throws IOException, XmlPullParserException {
    ...
    private synchronized RestrictionEntry loadRestriction(Context appContext, TypedArray a, XmlResourceParser xml) throws IOException, XmlPullParserException {
            ...
            switch (restrictionType) {
                ...
                case 8:
                    ...
                    while (XmlUtils.nextElementWithin(xmlResourceParser, outerDepth)) {
                        RestrictionEntry childEntry = loadRestrictionElement(appContext, xmlResourceParser);
                        if (childEntry == null) {
    ...
    private static synchronized Bundle addRestrictionToBundle(Bundle bundle, RestrictionEntry entry) {

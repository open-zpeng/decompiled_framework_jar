...
public interface ISyncAdapterUnsyncableAccountCallback extends IInterface {
    synchronized void onUnsyncableAccountDone(boolean z) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ISyncAdapterUnsyncableAccountCallback {
        ...
        public static synchronized ISyncAdapterUnsyncableAccountCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ISyncAdapterUnsyncableAccountCallback {
            ...
            public synchronized void onUnsyncableAccountDone(boolean isReady) throws RemoteException {

...
public final class AuxiliaryResolveInfo {
    ...
    public synchronized AuxiliaryResolveInfo(String token, boolean needsPhase2, Intent failureIntent, List<AuxiliaryFilter> filters) {
        this.token = token;
    ...
    public synchronized AuxiliaryResolveInfo(ComponentName failureActivity, Intent failureIntent, List<AuxiliaryFilter> filters) {
    ...
    public synchronized AuxiliaryResolveInfo(ComponentName failureActivity, String packageName, long versionCode, String splitName) {
    ...
    public static final class AuxiliaryFilter extends IntentFilter {
        ...
        public synchronized AuxiliaryFilter(IntentFilter orig, InstantAppResolveInfo resolveInfo, String splitName, Bundle extras) {
            super(orig);
        ...
        public synchronized AuxiliaryFilter(InstantAppResolveInfo resolveInfo, String splitName, Bundle extras) {
            this.resolveInfo = resolveInfo;
            this.packageName = resolveInfo.getPackageName();
            this.versionCode = resolveInfo.getLongVersionCode();
            this.splitName = splitName;
        ...
        public synchronized AuxiliaryFilter(String packageName, long versionCode, String splitName) {

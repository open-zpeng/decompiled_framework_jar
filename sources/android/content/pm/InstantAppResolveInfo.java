...
public final class InstantAppResolveInfo implements Parcelable {
    ...
    private synchronized InstantAppResolveInfo(InstantAppDigest digest, String packageName, List<InstantAppIntentFilter> filters, long versionCode, Bundle extras, boolean shouldLetInstallerDecide) {
    ...
    synchronized InstantAppResolveInfo(Parcel in) {
    ...
    public static final class InstantAppDigest implements Parcelable {
        ...
        public synchronized InstantAppDigest(String hostName, int maxDigests) {
            if (hostName == null) {
                throw new IllegalArgumentException();
            }
        ...
        private synchronized InstantAppDigest(byte[][] digestBytes, int[] prefix) {
            this.mDigestPrefix = prefix;
            this.mDigestBytes = digestBytes;
        }

        private static synchronized byte[][] generateDigest(String hostName, int maxDigests) {
        ...
        synchronized InstantAppDigest(Parcel in) {
        ...
        public synchronized int[] getDigestPrefixSecure() {
            if (this == UNDEFINED) {

...
public class AppsQueryHelper {
    ...
    public synchronized AppsQueryHelper(IPackageManager packageManager) {
        this.mPackageManager = packageManager;
    }

    public synchronized AppsQueryHelper() {
        this(AppGlobals.getPackageManager());
    }

    public synchronized List<String> queryApps(int flags, boolean systemAppsOnly, UserHandle user) {
    ...
    @VisibleForTesting
    protected synchronized List<ApplicationInfo> getAllApps(int userId) {
        try {
    ...
    @VisibleForTesting
    protected synchronized List<ResolveInfo> queryIntentActivitiesAsUser(Intent intent, int userId) {
        try {
    ...
    @VisibleForTesting
    protected synchronized List<ResolveInfo> queryIntentServicesAsUser(Intent intent, int userId) {
        try {
    ...
    @VisibleForTesting
    protected synchronized List<PackageInfo> getPackagesHoldingPermission(String perm, int userId) {
        try {

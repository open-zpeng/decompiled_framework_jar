...
public class ShortcutManager {
    ...
    public protected final IShortcutService mService;

    public synchronized ShortcutManager(Context context, IShortcutService service) {
    ...
    public synchronized void disableShortcuts(List<String> shortcutIds, int disabledMessageResId) {
        try {
    ...
    public synchronized void disableShortcuts(List<String> shortcutIds, String disabledMessage) {
    ...
    public synchronized int getMaxShortcutCountForActivity() {
    ...
    public synchronized int getRemainingCallCount() {
        try {
    ...
    public synchronized long getRateLimitResetTime() {
        try {
    ...
    public synchronized void onApplicationActive(String packageName, int userId) {
        try {
    ...
    @VisibleForTesting
    protected synchronized int injectMyUserId() {

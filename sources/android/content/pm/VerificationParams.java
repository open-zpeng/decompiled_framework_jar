...
public class VerificationParams implements Parcelable {
    ...
    public synchronized VerificationParams(Uri verificationURI, Uri originatingURI, Uri referrer, int originatingUid) {
    ...
    public synchronized Uri getVerificationURI() {
        return this.mVerificationURI;
    }

    public synchronized Uri getOriginatingURI() {
        return this.mOriginatingURI;
    }

    public synchronized Uri getReferrer() {
        return this.mReferrer;
    }

    public synchronized int getOriginatingUid() {
        return this.mOriginatingUid;
    }

    public synchronized int getInstallerUid() {
        return this.mInstallerUid;
    }

    public synchronized void setInstallerUid(int uid) {
    ...
    public int hashCode() {
        ...
        return hash + (7 * (this.mOriginatingURI == null ? 1 : this.mOriginatingURI.hashCode())) + (11 * (this.mReferrer != null ? this.mReferrer.hashCode() : 1)) + (13 * this.mOriginatingUid) + (17 * this.mInstallerUid);
    }
    ...
    private synchronized VerificationParams(Parcel source) {

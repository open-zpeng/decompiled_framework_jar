...
public interface IPinItemRequest extends IInterface {
    synchronized boolean accept(Bundle bundle) throws RemoteException;

    synchronized AppWidgetProviderInfo getAppWidgetProviderInfo() throws RemoteException;

    synchronized Bundle getExtras() throws RemoteException;

    synchronized ShortcutInfo getShortcutInfo() throws RemoteException;

    synchronized boolean isValid() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IPinItemRequest {
        ...
        public static synchronized IPinItemRequest asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IPinItemRequest {
            ...
            @Override // android.content.pm.IPinItemRequest
            public synchronized boolean accept(Bundle options) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.content.pm.IPinItemRequest
            public synchronized ShortcutInfo getShortcutInfo() throws RemoteException {
            ...
            @Override // android.content.pm.IPinItemRequest
            public synchronized AppWidgetProviderInfo getAppWidgetProviderInfo() throws RemoteException {

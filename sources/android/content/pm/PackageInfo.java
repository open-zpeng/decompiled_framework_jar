...
public class PackageInfo implements Parcelable {
    ...
    private protected static final int INSTALL_LOCATION_UNSPECIFIED = -1;
    public static final int REQUESTED_PERMISSION_GRANTED = 2;
    private protected static final int REQUESTED_PERMISSION_REQUIRED = 1;
    ...
    private protected boolean coreApp;
    ...
    private protected String overlayTarget;
    ...
    public static synchronized long composeLongVersionCode(int major, int minor) {
    ...
    public synchronized boolean isOverlayPackage() {
        return this.overlayTarget != null;
    }

    public synchronized boolean isStaticOverlayPackage() {
    ...
    public protected PackageInfo(Parcel source) {
        this.installLocation = 1;
    ...
    private synchronized void propagateApplicationInfo(ApplicationInfo appInfo, ComponentInfo[] components) {
        if (components != null) {

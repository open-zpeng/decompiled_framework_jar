...
public class ResolveInfo implements Parcelable {
    ...
    private protected boolean handleAllWebDataURI;
    public int icon;
    public int iconResourceId;
    @Deprecated
    private protected boolean instantAppAvailable;
    ...
    private protected boolean system;
    private protected int targetUserId;

    private protected ComponentInfo getComponentInfo() {
    ...
    public synchronized int resolveLabelResId() {
        if (this.labelRes != 0) {
    ...
    public synchronized int resolveIconResId() {
        if (this.icon != 0) {
            return this.icon;
        }
        ComponentInfo componentInfo = getComponentInfo();
    ...
    final synchronized int getIconResourceInternal() {
    ...
    private synchronized ResolveInfo(Parcel source) {
        this.specificIndex = -1;

...
public class DexMetadataHelper {
    ...
    private synchronized DexMetadataHelper() {
    }

    public static synchronized boolean isDexMetadataFile(File file) {
        return isDexMetadataPath(file.getName());
    }

    private static synchronized boolean isDexMetadataPath(String path) {
        return path.endsWith(DEX_METADATA_FILE_EXTENSION);
    }

    public static synchronized long getPackageDexMetadataSize(PackageParser.PackageLite pkg) {
        long sizeBytes = 0;
    ...
    public static synchronized File findDexMetadataForFile(File targetFile) {
    ...
    public static synchronized Map<String, String> getPackageDexMetadata(PackageParser.Package pkg) {
        return buildPackageApkToDexMetadataMap(pkg.getAllCodePaths());
    }

    private static synchronized Map<String, String> getPackageDexMetadata(PackageParser.PackageLite pkg) {
        return buildPackageApkToDexMetadataMap(pkg.getAllCodePaths());
    }

    private static synchronized Map<String, String> buildPackageApkToDexMetadataMap(List<String> codePaths) {
    ...
    public static synchronized String buildDexMetadataPathForApk(String codePath) {
    ...
    private static synchronized String buildDexMetadataPathForFile(File targetFile) {
    ...
    public static synchronized void validatePackageDexMetadata(PackageParser.Package pkg) throws PackageParser.PackageParserException {
    ...
    private static synchronized void validateDexMetadataFile(String dmaPath) throws PackageParser.PackageParserException {
        ...
        try {
            ...
            throw new PackageParser.PackageParserException(PackageManager.INSTALL_FAILED_BAD_DEX_METADATA, "Error opening " + dmaPath, e3);
        }
    }

    public static synchronized void validateDexPaths(String[] paths) {

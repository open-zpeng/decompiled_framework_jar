...
public class StringParceledListSlice extends BaseParceledListSlice<String> {
    ...
    public synchronized StringParceledListSlice(List<String> list) {
        super(list);
    }

    private synchronized StringParceledListSlice(Parcel in, ClassLoader loader) {
        super(in, loader);
    }

    public static synchronized StringParceledListSlice emptyList() {
    ...
    @Override // android.content.pm.BaseParceledListSlice
    public synchronized void writeElement(String parcelable, Parcel reply, int callFlags) {
        reply.writeString(parcelable);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized void writeParcelableCreator(String parcelable, Parcel dest) {
    }

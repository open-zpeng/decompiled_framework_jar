        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    _arg2 = data.readInt() != 0;
                    onPackagesUnavailable(_arg05, _arg15, _arg2);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onPackagesSuspended(_arg06, _arg16, _arg22);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 8:
                    ...
                    if (data.readInt() != 0) {
                        _arg23 = ParceledListSlice.CREATOR.createFromParcel(data);
                    } else {
                        _arg23 = null;
                    }
                    onShortcutChanged(_arg08, _arg18, _arg23);
                    return true;
                default:

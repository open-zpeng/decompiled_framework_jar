...
public class PermissionInfo extends PackageItemInfo implements Parcelable {
    ...
    public static synchronized int fixProtectionLevel(int level) {
        if (level == 3) {
            level = 18;
        }
    ...
    private protected static String protectionToString(int level) {
        String protLevel = "????";
        switch (level & 15) {
            case 0:
                protLevel = "normal";
    ...
    private synchronized PermissionInfo(Parcel source) {
        super(source);

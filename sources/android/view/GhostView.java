...
public class GhostView extends View {
    ...
    private synchronized GhostView(View view) {
    ...
    public static synchronized void calculateMatrix(View view, ViewGroup host, Matrix matrix) {
    ...
    private protected static GhostView addGhost(View view, ViewGroup viewGroup) {
    ...
    public static synchronized GhostView getGhost(View view) {
        return view.mGhostView;
    }

    private static synchronized void copySize(View from, View to) {
        to.setLeft(0);
        to.setTop(0);
    ...
    private static synchronized int moveGhostViewsToTop(ViewGroup viewGroup, ArrayList<View> tempViews) {
    ...
    private static synchronized void insertIntoOverlay(ViewGroup viewGroup, ViewGroup wrapper, GhostView ghostView, ArrayList<View> tempParents, int firstGhost) {
        if (firstGhost == -1) {
    ...
    private static synchronized int getInsertIndex(ViewGroup overlayViewGroup, ArrayList<View> viewParents, ArrayList<View> tempParents, int firstGhost) {
        int low = firstGhost;
    ...
    private static synchronized boolean isGhostWrapper(View view) {
    ...
    private static synchronized boolean isOnTop(ArrayList<View> viewParents, ArrayList<View> comparedWith) {
    ...
    private static synchronized void getParents(View view, ArrayList<View> parents) {
    ...
    private static synchronized boolean isOnTop(View view, View comparedWith) {
        ViewGroup parent = (ViewGroup) view.getParent();

...
public class RenderNodeAnimator extends Animator {
    ...
    private static void callOnFinished(final RenderNodeAnimator animator) {
        ...
        if (handler != null) {
            ...
            handler.post(new Runnable() { // from class: android.view.-$$Lambda$1kvF4JuyM42-wmyDVPAIYdPz1jE
                @Override // java.lang.Runnable
        ...
        Objects.requireNonNull(animator);
        handler2.post(new Runnable() { // from class: android.view.-$$Lambda$1kvF4JuyM42-wmyDVPAIYdPz1jE
            @Override // java.lang.Runnable
            public final void run() {
                RenderNodeAnimator.this.onFinished();
            }

...
public class RemoteAnimationAdapter implements Parcelable {
    ...
    private protected RemoteAnimationAdapter(IRemoteAnimationRunner runner, long duration, long statusBarTransitionDelay) {
        this.mRunner = runner;
        this.mDuration = duration;
        this.mStatusBarTransitionDelay = statusBarTransitionDelay;
    }

    public synchronized RemoteAnimationAdapter(Parcel in) {
        this.mRunner = IRemoteAnimationRunner.Stub.asInterface(in.readStrongBinder());
        this.mDuration = in.readLong();
        this.mStatusBarTransitionDelay = in.readLong();
    }

    public synchronized IRemoteAnimationRunner getRunner() {
        return this.mRunner;
    }
    ...
    public synchronized long getStatusBarTransitionDelay() {
    ...
    public synchronized int getCallingPid() {

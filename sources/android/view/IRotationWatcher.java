...
public interface IRotationWatcher extends IInterface {
    private protected void onRotationChanged(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IRotationWatcher {
        ...
        public static synchronized IRotationWatcher asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IRotationWatcher {
            ...
            public synchronized void onRotationChanged(int rotation) throws RemoteException {

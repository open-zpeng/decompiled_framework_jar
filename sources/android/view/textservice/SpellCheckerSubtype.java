...
public final class SpellCheckerSubtype implements Parcelable {
    ...
    public synchronized SpellCheckerSubtype(int nameId, String locale, String languageTag, String extraValue, int subtypeId) {
    ...
    synchronized SpellCheckerSubtype(Parcel source) {
    ...
    private static synchronized int hashCodeInternal(String locale, String extraValue) {
        return Arrays.hashCode(new Object[]{locale, extraValue});
    }

    public static synchronized List<SpellCheckerSubtype> sort(Context context, int flags, SpellCheckerInfo sci, List<SpellCheckerSubtype> subtypeList) {
        if (sci == null) {
            return subtypeList;
        }

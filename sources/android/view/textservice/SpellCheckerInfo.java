...
public final class SpellCheckerInfo implements Parcelable {
    ...
    public synchronized SpellCheckerInfo(Context context, ResolveInfo service) throws XmlPullParserException, IOException {
        int i;
        Resources res;
    ...
    public synchronized SpellCheckerInfo(Parcel source) {

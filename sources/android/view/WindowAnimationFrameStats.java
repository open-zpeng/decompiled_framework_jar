...
public final class WindowAnimationFrameStats extends FrameStats implements Parcelable {
    ...
    public synchronized WindowAnimationFrameStats() {
    }

    private protected void init(long refreshPeriodNano, long[] framesPresentedTimeNano) {
        this.mRefreshPeriodNano = refreshPeriodNano;
        this.mFramesPresentedTimeNano = framesPresentedTimeNano;
    }

    private synchronized WindowAnimationFrameStats(Parcel parcel) {

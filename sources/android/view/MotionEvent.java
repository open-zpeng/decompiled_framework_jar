...
public final class MotionEvent extends InputEvent implements Parcelable {
    ...
    public protected static final int HISTORY_CURRENT = Integer.MIN_VALUE;
    ...
    @FastNative
    public protected static native float nativeGetRawAxisValue(long j, int i, int i2, int i3);
    ...
    private static final synchronized void ensureSharedTempPointerCapacity(int desiredCapacity) {
    ...
    private synchronized MotionEvent() {
    }
    ...
    public protected static MotionEvent obtain() {
    ...
    public final synchronized boolean isTouchEvent() {
    ...
    public final synchronized boolean isTargetAccessibilityFocus() {
        int flags = getFlags();
        return (1073741824 & flags) != 0;
    }

    public final synchronized void setTargetAccessibilityFocus(boolean targetsFocus) {
        int i;
        int flags = getFlags();
    ...
    public final synchronized boolean isHoverExitPending() {
        int flags = getFlags();
        return (flags & 4) != 0;
    }

    public synchronized void setHoverExitPending(boolean hoverExitPending) {
        int i;
        int flags = getFlags();
        long j = this.mNativePtr;
        if (hoverExitPending) {
    ...
    private protected final void setDownTime(long downTime) {
    ...
    private protected final long getEventTimeNano() {
    ...
    public final synchronized long getHistoricalEventTimeNano(int pos) {
    ...
    private protected final boolean addBatch(MotionEvent event) {
        int pointerCount;
    ...
    public final synchronized boolean isWithinBoundsNoHistory(float left, float top, float right, float bottom) {
    ...
    private static final synchronized float clamp(float value, float low, float high) {
        if (value < low) {
            return low;
        }
        if (value > high) {
    ...
    public final synchronized MotionEvent clampNoHistory(float left, float top, float right, float bottom) {
        MotionEvent ev = obtain();
        synchronized (gSharedTempLock) {
            try {
                int pointerCount = nativeGetPointerCount(this.mNativePtr);
        ...
        synchronized (obj2) {
            ...
            if (oldActionMasked == 5 || oldActionMasked == 6) {
                if (newActionPointerIndex < 0) {
                    ...
                    newAction = newPointerCount2;
                } else {
                    newAction = (newActionPointerIndex << 8) | oldActionMasked;
                }
                newAction2 = newAction;
            } else {
                newAction2 = oldAction;
            }
            ...
            while (true) {
                ...
                if (h3 == 0) {
                    ...
                    try {
                        ...
                        ev = ev4;
                        ev.mNativePtr = nativeInitialize(j, nativeGetDeviceId(this.mNativePtr), nativeGetSource(this.mNativePtr), newAction2, nativeGetFlags(this.mNativePtr), nativeGetEdgeFlags(this.mNativePtr), nativeGetMetaState(this.mNativePtr), nativeGetButtonState(this.mNativePtr), nativeGetXOffset(this.mNativePtr), nativeGetYOffset(this.mNativePtr), nativeGetXPrecision(this.mNativePtr), nativeGetYPrecision(this.mNativePtr), nativeGetDownTimeNanos(this.mNativePtr), eventTimeNanos, historySize2, pp, pc);
                    } catch (Throwable th4) {
                        th = th4;
                    }
                } else {
    ...
    public String toString() {
        ...
        appendUnless("0", msg, ", buttonState=", buttonStateToString(getButtonState()));
    ...
    private static synchronized <T> void appendUnless(T defValue, StringBuilder sb, String key, T value) {
        sb.append(key);
        sb.append(value);
    }
    ...
    public static synchronized String buttonStateToString(int buttonState) {
        if (buttonState == 0) {
            return "0";
        }
    ...
    public static synchronized String toolTypeToString(int toolType) {
    ...
    public static synchronized MotionEvent createFromParcelBody(Parcel in) {
        MotionEvent ev = obtain();
    ...
    public static final class PointerCoords {
        ...
        public protected long mPackedAxisBits;
        public protected float[] mPackedAxisValues;
        ...
        private protected static PointerCoords[] createArray(int size) {
    ...
    public static final class PointerProperties {
        ...
        private protected static PointerProperties[] createArray(int size) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public synchronized boolean equals(PointerProperties other) {

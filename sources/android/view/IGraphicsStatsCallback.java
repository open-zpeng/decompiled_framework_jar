...
public interface IGraphicsStatsCallback extends IInterface {
    synchronized void onRotateGraphicsStatsBuffer() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IGraphicsStatsCallback {
        ...
        public static synchronized IGraphicsStatsCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IGraphicsStatsCallback {
            ...
            public synchronized void onRotateGraphicsStatsBuffer() throws RemoteException {

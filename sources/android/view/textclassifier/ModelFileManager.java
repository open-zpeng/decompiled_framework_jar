        ...
        public List<ModelFile> get() {
            ...
            if (this.mFactoryModelDir.exists() && this.mFactoryModelDir.isDirectory()) {
                ...
                for (File file : files) {
                    ...
                    if (matcher.matches() && file.isFile() && (model = createModelFile(file)) != null) {
        ...
        private ModelFile createModelFile(File file) {
            ...
            if (file.exists()) {
                ...
                try {
                    ...
                    return new ModelFile(file, version, supportedLocales, supportedLocalesStr, "*".equals(supportedLocalesStr));
    ...
    public static final class ModelFile {
        ...
        public boolean isPreferredTo(ModelFile model) {
            ...
            if (this.mLanguageIndependent || !model.mLanguageIndependent) {
                return (!this.mLanguageIndependent || model.mLanguageIndependent) && this.mVersion > model.getVersion();
            }
            return true;
        }

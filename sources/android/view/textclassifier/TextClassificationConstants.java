...
public final class TextClassificationConstants {
    ...
    private synchronized TextClassificationConstants(String settings) {
        ...
        this.mGenerateLinksMaxTextLength = parser.getInt(GENERATE_LINKS_MAX_TEXT_LENGTH, GENERATE_LINKS_MAX_TEXT_LENGTH_DEFAULT);
    ...
    public static synchronized TextClassificationConstants loadFromString(String settings) {
        return new TextClassificationConstants(settings);
    }

    public synchronized boolean isLocalTextClassifierEnabled() {
        return this.mLocalTextClassifierEnabled;
    }

    public synchronized boolean isSystemTextClassifierEnabled() {
        return this.mSystemTextClassifierEnabled;
    }

    public synchronized boolean isModelDarkLaunchEnabled() {
        return this.mModelDarkLaunchEnabled;
    }

    public synchronized boolean isSmartSelectionEnabled() {
        return this.mSmartSelectionEnabled;
    }

    public synchronized boolean isSmartTextShareEnabled() {
        return this.mSmartTextShareEnabled;
    }

    public synchronized boolean isSmartLinkifyEnabled() {
        return this.mSmartLinkifyEnabled;
    }

    public synchronized boolean isSmartSelectionAnimationEnabled() {
        return this.mSmartSelectionAnimationEnabled;
    }

    public synchronized int getSuggestSelectionMaxRangeLength() {
        return this.mSuggestSelectionMaxRangeLength;
    }

    public synchronized int getClassifyTextMaxRangeLength() {
        return this.mClassifyTextMaxRangeLength;
    }

    public synchronized int getGenerateLinksMaxTextLength() {
        return this.mGenerateLinksMaxTextLength;
    }

    public synchronized int getGenerateLinksLogSampleRate() {
        return this.mGenerateLinksLogSampleRate;
    }

    public synchronized List<String> getEntityListDefault() {
        return this.mEntityListDefault;
    }

    public synchronized List<String> getEntityListNotEditable() {
        return this.mEntityListNotEditable;
    }

    public synchronized List<String> getEntityListEditable() {
        return this.mEntityListEditable;
    }

    private static synchronized List<String> parseEntityList(String listStr) {

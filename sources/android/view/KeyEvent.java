...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int KEYCODE_CAR_HOME = 1019;
    ...
    static final boolean DEBUG = DebugOption.DEBUG_APP_INPUT;
    ...
    public static final boolean isWakeKey(int keyCode) {
        if (keyCode == 4 || keyCode == 82 || keyCode == 224 || keyCode == 225) {
            return true;
        }
        switch (keyCode) {
            case 265:

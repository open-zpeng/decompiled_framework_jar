...
public class KeyEvent extends InputEvent implements Parcelable {
    ...
    public static final int FLAG_RESYNTHESIZED = 2048;
    ...
    public static final int KEYCODE_BOSS = 1094;
    ...
    public static final int KEYCODE_CAR_DOUBLE_ENTER = 1207;
    public static final int KEYCODE_CAR_DOUBLE_MEDIA_NEXT = 1202;
    public static final int KEYCODE_CAR_DOUBLE_MEDIA_PREVIOUS = 1201;
    public static final int KEYCODE_CAR_DOUBLE_VOLUME_DOWN = 1204;
    public static final int KEYCODE_CAR_DOUBLE_VOLUME_UP = 1203;
    public static final int KEYCODE_CAR_ENTER = 1015;
    public static final int KEYCODE_CAR_LONG_ENTER = 1035;
    public static final int KEYCODE_CAR_LONG_MEDIA_NEXT = 1034;
    public static final int KEYCODE_CAR_LONG_MEDIA_PREVIOUS = 1033;
    public static final int KEYCODE_CAR_LONG_VOLUME_DOWN = 1032;
    public static final int KEYCODE_CAR_LONG_VOLUME_UP = 1031;
    public static final int KEYCODE_CAR_LT_CUSTOM = 1066;
    public static final int KEYCODE_CAR_LT_ENTER = 1075;
    public static final int KEYCODE_CAR_LT_MEDIA_NEXT = 1074;
    public static final int KEYCODE_CAR_LT_MEDIA_PREVIOUS = 1073;
    public static final int KEYCODE_CAR_LT_SPEECH = 1065;
    public static final int KEYCODE_CAR_LT_VOLUME_DOWN = 1072;
    public static final int KEYCODE_CAR_LT_VOLUME_UP = 1071;
    public static final int KEYCODE_CAR_MEDIA_NEXT = 1014;
    public static final int KEYCODE_CAR_MEDIA_PREVIOUS = 1013;
    public static final int KEYCODE_CAR_SLIDE_DOWN = 1084;
    public static final int KEYCODE_CAR_SLIDE_DOWN_EVENT = 1088;
    public static final int KEYCODE_CAR_SLIDE_UP = 1083;
    public static final int KEYCODE_CAR_SLIDE_UP_EVENT = 1087;
    public static final int KEYCODE_CAR_ST_CUSTOM = 1046;
    public static final int KEYCODE_CAR_ST_ENTER = 1055;
    public static final int KEYCODE_CAR_ST_MEDIA_NEXT = 1054;
    public static final int KEYCODE_CAR_ST_MEDIA_PREVIOUS = 1053;
    public static final int KEYCODE_CAR_ST_SPEECH = 1045;
    public static final int KEYCODE_CAR_ST_VOLUME_DOWN = 1052;
    public static final int KEYCODE_CAR_ST_VOLUME_UP = 1051;
    public static final int KEYCODE_CAR_VOLUME_DOWN = 1012;
    public static final int KEYCODE_CAR_VOLUME_UP = 1011;
    ...
    public static final int KEYCODE_CUSTOM = 1006;
    public static final int KEYCODE_CUT = 277;
    public static final int KEYCODE_D = 32;
    public static final int KEYCODE_DEL = 67;
    public static final int KEYCODE_DOUBLE_BACK = 1208;
    public static final int KEYCODE_DOUBLE_CUSTOM = 1206;
    public static final int KEYCODE_DOUBLE_SPEECH = 1205;
    ...
    public static final int KEYCODE_EMERGENCY_IGOFF = 1209;
    ...
    public static final int KEYCODE_GROUP_LOGGER = 1210;
    ...
    public static final int KEYCODE_HVAC = 800;
    public static final int KEYCODE_HVAC_DOWN = 802;
    public static final int KEYCODE_HVAC_UP = 801;
    public static final int KEYCODE_HW_VOLUME_DOWN = 805;
    public static final int KEYCODE_HW_VOLUME_MUTE = 803;
    public static final int KEYCODE_HW_VOLUME_UP = 804;
    public static final int KEYCODE_I = 37;
    public static final int KEYCODE_ICM_DOUBLE_ENTER = 1200;
    public static final int KEYCODE_ICM_DOUBLE_MULTI_DOWN = 1218;
    public static final int KEYCODE_ICM_DOUBLE_MULTI_UP = 1217;
    public static final int KEYCODE_ICM_DOWN = 1001;
    public static final int KEYCODE_ICM_ENTER = 1004;
    public static final int KEYCODE_ICM_LEFT = 1002;
    public static final int KEYCODE_ICM_LONG_DOWN = 1021;
    public static final int KEYCODE_ICM_LONG_ENTER = 1024;
    public static final int KEYCODE_ICM_LONG_LEFT = 1022;
    public static final int KEYCODE_ICM_LONG_MULTI_DOWN = 1118;
    public static final int KEYCODE_ICM_LONG_MULTI_UP = 1117;
    public static final int KEYCODE_ICM_LONG_RIGHT = 1023;
    public static final int KEYCODE_ICM_LONG_UP = 1020;
    public static final int KEYCODE_ICM_LT_DOWN = 1061;
    public static final int KEYCODE_ICM_LT_ENTER = 1064;
    public static final int KEYCODE_ICM_LT_LEFT = 1062;
    public static final int KEYCODE_ICM_LT_RIGHT = 1063;
    public static final int KEYCODE_ICM_LT_UP = 1060;
    public static final int KEYCODE_ICM_MULTI_DOWN = 1018;
    public static final int KEYCODE_ICM_MULTI_UP = 1017;
    public static final int KEYCODE_ICM_RIGHT = 1003;
    public static final int KEYCODE_ICM_SLIDE_DOWN = 1082;
    public static final int KEYCODE_ICM_SLIDE_DOWN_EVENT = 1086;
    public static final int KEYCODE_ICM_SLIDE_UP = 1081;
    public static final int KEYCODE_ICM_SLIDE_UP_EVENT = 1085;
    public static final int KEYCODE_ICM_ST_DOWN = 1041;
    public static final int KEYCODE_ICM_ST_ENTER = 1044;
    public static final int KEYCODE_ICM_ST_LEFT = 1042;
    public static final int KEYCODE_ICM_ST_RIGHT = 1043;
    public static final int KEYCODE_ICM_ST_UP = 1040;
    public static final int KEYCODE_ICM_UP = 1000;
    ...
    public static final int KEYCODE_LONG_BOSS = 1095;
    public static final int KEYCODE_LONG_CUSTOM = 1026;
    public static final int KEYCODE_LONG_MUTE = 1037;
    public static final int KEYCODE_LONG_REAR_LEFT_BOSS = 1091;
    public static final int KEYCODE_LONG_REAR_MID_BOSS = 1098;
    public static final int KEYCODE_LONG_REAR_RIGHT_BOSS = 1093;
    public static final int KEYCODE_LONG_SPEECH = 1025;
    public static final int KEYCODE_LT_BACK = 1076;
    public static final int KEYCODE_LT_MUTE = 1077;
    ...
    public static final int KEYCODE_RAW_LEFT_DOWN = 1221;
    public static final int KEYCODE_RAW_LEFT_LEFT = 1222;
    public static final int KEYCODE_RAW_LEFT_RIGHT = 1223;
    public static final int KEYCODE_RAW_LEFT_UP = 1220;
    public static final int KEYCODE_RAW_RIGHT_DOWN = 1225;
    public static final int KEYCODE_RAW_RIGHT_LEFT = 1226;
    public static final int KEYCODE_RAW_RIGHT_RIGHT = 1227;
    public static final int KEYCODE_RAW_RIGHT_UP = 1224;
    public static final int KEYCODE_REAR_LEFT_BOSS = 1090;
    public static final int KEYCODE_REAR_MID_BOSS = 1097;
    public static final int KEYCODE_REAR_RIGHT_BOSS = 1092;
    ...
    public static final int KEYCODE_SPEECH = 1005;
    ...
    public static final int KEYCODE_ST_BACK = 1056;
    public static final int KEYCODE_ST_MUTE = 1057;
    ...
    private static final int LAST_KEYCODE = 1227;
    @Deprecated
    public static final int MAX_KEYCODE = 84;
    private static final int MAX_RECYCLED = 10;
    public protected static final int META_ALL_MASK = 7827711;
    public static final int META_ALT_LEFT_ON = 16;
    private protected static final int META_ALT_LOCKED = 512;
    public static final int META_ALT_MASK = 50;
    public static final int META_ALT_ON = 2;
    public static final int META_ALT_RIGHT_ON = 32;
    public static final int META_CAPS_LOCK_ON = 1048576;
    private protected static final int META_CAP_LOCKED = 256;
    ...
    public protected static final int META_INVALID_MODIFIER_MASK = 7343872;
    public protected static final int META_LOCK_MASK = 7340032;
    ...
    public protected static final int META_MODIFIER_MASK = 487679;
    public static final int META_NUM_LOCK_ON = 2097152;
    public static final int META_SCROLL_LOCK_ON = 4194304;
    private protected static final int META_SELECTING = 2048;
    public static final int META_SHIFT_LEFT_ON = 64;
    public static final int META_SHIFT_MASK = 193;
    public static final int META_SHIFT_ON = 1;
    public static final int META_SHIFT_RIGHT_ON = 128;
    private protected static final int META_SYM_LOCKED = 1024;
    public static final int META_SYM_ON = 4;
    public protected static final int META_SYNTHETIC_MASK = 3840;
    static final String TAG = "KeyEvent";
    private static KeyEvent gRecyclerTop;
    private static int gRecyclerUsed;
    public protected int mAction;
    public protected String mCharacters;
    public protected int mDeviceId;
    public protected long mDownTime;
    public protected long mEventTime;
    public protected int mFlags;
    public protected int mKeyCode;
    public protected int mMetaState;
    private KeyEvent mNext;
    public protected int mRepeatCount;
    public protected int mScanCode;
    ...
    private static synchronized KeyEvent obtain() {
    ...
    public static synchronized KeyEvent obtain(KeyEvent other) {
        KeyEvent ev = obtain();
    ...
    public synchronized KeyEvent copy() {
        return obtain(this);
    }
    ...
    @Override // android.view.InputEvent
    public final synchronized void recycleIfNeededAfterDispatch() {
    }
    ...
    private synchronized KeyEvent(KeyEvent origEvent, int action) {
        this.mDownTime = origEvent.mDownTime;
        this.mEventTime = origEvent.mEventTime;
        this.mAction = action;
        this.mKeyCode = origEvent.mKeyCode;
    ...
    @Override // android.view.InputEvent
    public final synchronized boolean isTainted() {
        return (this.mFlags & Integer.MIN_VALUE) != 0;
    }

    @Override // android.view.InputEvent
    public final synchronized void setTainted(boolean tainted) {
        this.mFlags = tainted ? this.mFlags | Integer.MIN_VALUE : this.mFlags & Integer.MAX_VALUE;
    }

    @Deprecated
    private protected final boolean isDown() {
    ...
    public final synchronized boolean isWakeKey() {
    ...
    public static final synchronized boolean isMediaKey(int keyCode) {
    ...
    public static final synchronized boolean isSystemKey(int keyCode) {
    ...
    public static final synchronized boolean isWakeKey(int keyCode) {
    ...
    public static final synchronized boolean isMetaKey(int keyCode) {
        return keyCode == 117 || keyCode == 118;
    }

    public static final synchronized boolean isAltKey(int keyCode) {
    ...
    private static synchronized int metaStateFilterDirectionalModifiers(int metaState, int modifiers, int basic, int left, int right) {
    ...
    @Override // android.view.InputEvent
    public final synchronized long getEventTimeNano() {
        return this.mEventTime * 1000000;
    }

    @Deprecated
    public final synchronized int getKeyboardDevice() {
        return this.mDeviceId;
    }
    ...
    public static synchronized String metaStateToString(int metaState) {
        if (metaState == 0) {
            return "0";
        }
    ...
    public static synchronized KeyEvent createFromParcelBody(Parcel in) {
        return new KeyEvent(in);
    }

    private synchronized KeyEvent(Parcel in) {

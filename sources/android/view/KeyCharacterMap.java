...
public class KeyCharacterMap implements Parcelable {
    ...
    private static synchronized void addCombining(int combining, int accent) {
        sCombiningToAccent.append(combining, accent);
        sAccentToCombining.append(accent, combining);
    }

    private static synchronized void addDeadKey(int accent, int c, int result) {
    ...
    private synchronized KeyCharacterMap(Parcel in) {
        if (in == null) {
    ...
    public protected KeyCharacterMap(long ptr) {
        this.mPtr = ptr;
    }
    ...
    public synchronized FallbackAction getFallbackAction(int keyCode, int metaState) {
    ...
    public static final class FallbackAction {
        ...
        private protected int keyCode;
        private protected int metaState;
        private FallbackAction next;

        private synchronized FallbackAction() {
        }

        public static synchronized FallbackAction obtain() {

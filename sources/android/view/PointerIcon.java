...
public final class PointerIcon implements Parcelable {
    ...
    public protected Bitmap[] mBitmapFrames;
    public protected int mDurationPerFrame;
    public protected float mHotSpotX;
    public protected float mHotSpotY;
    ...
    private synchronized PointerIcon(int type) {
        this.mType = type;
    }

    public static synchronized PointerIcon getNullIcon() {
        return gNullIcon;
    }

    public static synchronized PointerIcon getDefaultIcon(Context context) {
    ...
    public static synchronized void setUseLargeIcons(boolean use) {
        sUseLargeIcons = use;
        gSystemIcons.clear();
    }
    ...
    private protected PointerIcon load(Context context) {
        if (context == null) {
            throw new IllegalArgumentException("context must not be null");
        }
    ...
    private synchronized Bitmap getBitmapFromDrawable(BitmapDrawable bitmapDrawable) {
    ...
    private synchronized void loadResource(Context context, Resources resources, int resourceId) {
        Drawable drawable;
        Drawable drawable2;
    ...
    private static synchronized void validateHotSpot(Bitmap bitmap, float hotSpotX, float hotSpotY) {
    ...
    private static synchronized int getSystemIconTypeIndex(int type) {
        switch (type) {
            case 1000:
                return 2;
            case 1001:

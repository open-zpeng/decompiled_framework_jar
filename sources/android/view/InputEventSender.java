...
public abstract class InputEventSender {
    ...
    public synchronized InputEventSender(InputChannel inputChannel, Looper looper) {
    ...
    public final synchronized boolean sendInputEvent(int seq, InputEvent event) {
        if (event == null) {
    ...
    public protected void dispatchInputEventFinished(int seq, boolean handled) {

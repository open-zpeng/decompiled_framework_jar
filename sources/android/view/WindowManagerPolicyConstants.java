...
public interface WindowManagerPolicyConstants {
    ...
    public interface PointerEventListener {
        synchronized void onPointerEvent(MotionEvent motionEvent);

        synchronized default void onPointerEvent(MotionEvent motionEvent, int displayId) {
            if (displayId == 0) {
    ...
    static synchronized String offReasonToString(int why) {
        switch (why) {
            case 1:

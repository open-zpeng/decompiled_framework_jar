        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    addClient(_arg03, _arg1, _arg23, _arg33);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    ...
                    restoreSession(_arg07, _arg15, _arg24, _arg34);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 7:
                    ...
                    setAutofillFailure(_arg09, _arg16, _arg25);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 10:
                    ...
                    setAuthenticationResult(_arg0, _arg19, _arg26, _arg35);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setHasCallback(_arg012, _arg110, _arg27);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IAutoFillManager {
            ...
            public void startSession(IBinder activityToken, IBinder appCallback, AutofillId autoFillId, Rect bounds, AutofillValue value, int userId, boolean hasCallback, int flags, ComponentName componentName, boolean compatMode, IResultReceiver result) throws RemoteException {
                ...
                try {
                    ...
                    boolean _status = this.mRemote.transact(3, _data2, null, 1);
                    if (_status || Stub.getDefaultImpl() == null) {
                        _data2.recycle();
                        return;
                    }

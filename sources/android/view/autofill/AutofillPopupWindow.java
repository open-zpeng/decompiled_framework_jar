...
public class AutofillPopupWindow extends PopupWindow {
    ...
    public synchronized AutofillPopupWindow(IAutofillWindowPresenter presenter) {
    ...
    @Override // android.widget.PopupWindow
    protected synchronized boolean hasDecorView() {
        return true;
    }

    @Override // android.widget.PopupWindow
    protected synchronized WindowManager.LayoutParams getDecorViewLayoutParams() {
        return this.mWindowLayoutParams;
    }

    public synchronized void update(final View anchor, int offsetX, int offsetY, int width, int height, Rect virtualBounds) {
        View actualAnchor;
    ...
    @Override // android.widget.PopupWindow
    protected synchronized boolean findDropDownPosition(View anchor, WindowManager.LayoutParams outParams, int xOffset, int yOffset, int width, int height, int gravity, boolean allowScroll) {
        if (this.mFullScreen) {
            outParams.x = xOffset;
            outParams.y = yOffset;
    ...
    @Override // android.widget.PopupWindow
    protected synchronized void attachToAnchor(View anchor, int xoff, int yoff, int gravity) {
        super.attachToAnchor(anchor, xoff, yoff, gravity);
        anchor.addOnAttachStateChangeListener(this.mOnAttachStateChangeListener);
    }

    @Override // android.widget.PopupWindow
    protected synchronized void detachFromAnchor() {
    ...
    public class WindowPresenter {
        ...
        synchronized void show(WindowManager.LayoutParams p, Rect transitionEpicenter, boolean fitsSystemWindows, int layoutDirection) {
            try {
        ...
        synchronized void hide(Rect transitionEpicenter) {
            try {

...
public final class SparseRectFArray implements Parcelable {
    ...
    public synchronized SparseRectFArray(Parcel source) {
    ...
    public static final class SparseRectFArrayBuilder {
        ...
        private synchronized void checkIndex(int key) {
        ...
        public synchronized SparseRectFArrayBuilder append(int key, float left, float top, float right, float bottom, int flags) {
            checkIndex(key);
            ensureBufferSize();
        ...
        public synchronized SparseRectFArray build() {
    ...
    private synchronized SparseRectFArray(SparseRectFArrayBuilder builder) {
        if (builder.mCount != 0) {
    ...
    public synchronized RectF get(int index) {
        int arrayIndex;
    ...
    public synchronized int getFlags(int index, int valueIfKeyNotFound) {
        if (this.mKeys == null) {

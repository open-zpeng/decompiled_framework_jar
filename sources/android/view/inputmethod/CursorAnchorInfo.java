...
public final class CursorAnchorInfo implements Parcelable {
    ...
    private static synchronized boolean areSameFloatImpl(float a, float b) {
    ...
    private synchronized CursorAnchorInfo(Builder builder) {
        ...
        this.mHashCode = (hash * 31) + Arrays.hashCode(this.mMatrixValues);
    }

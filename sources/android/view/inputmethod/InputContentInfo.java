...
public final class InputContentInfo implements Parcelable {
    ...
    private static synchronized boolean validateInternal(Uri contentUri, ClipDescription description, Uri linkUri, boolean throwException) {
        if (contentUri == null) {
            if (!throwException) {
                return false;
            }
    ...
    public synchronized void setUriToken(IInputContentUriToken token) {
    ...
    private synchronized InputContentInfo(Parcel source) {

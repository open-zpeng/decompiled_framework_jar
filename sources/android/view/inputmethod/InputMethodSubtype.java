...
public final class InputMethodSubtype implements Parcelable {
    ...
    private static synchronized InputMethodSubtypeBuilder getBuilder(int nameId, int iconId, String locale, String mode, String extraValue, boolean isAuxiliary, boolean overridesImplicitlyEnabledSubtype, int id, boolean isAsciiCapable) {
    ...
    private synchronized InputMethodSubtype(InputMethodSubtypeBuilder builder) {
    ...
    synchronized InputMethodSubtype(Parcel source) {
        this.mLock = new Object();
    ...
    private static synchronized Locale getLocaleFromContext(Context context) {
    ...
    private static synchronized String getLocaleDisplayName(Locale displayLocale, Locale localeToDisplay, DisplayContext displayContext) {
    ...
    private synchronized HashMap<String, String> getExtraValueHashMap() {
    ...
    public final synchronized boolean hasSubtypeId() {
        return this.mSubtypeId != 0;
    }

    public final synchronized int getSubtypeId() {
    ...
    private static synchronized int hashCodeInternal(String locale, String mode, String extraValue, boolean isAuxiliary, boolean overridesImplicitlyEnabledSubtype, boolean isAsciiCapable) {
    ...
    public static synchronized List<InputMethodSubtype> sort(Context context, int flags, InputMethodInfo imi, List<InputMethodSubtype> subtypeList) {
        if (imi == null) {
            return subtypeList;
        }

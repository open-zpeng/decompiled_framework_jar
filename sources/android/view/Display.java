...
public final class Display {
    ...
    private protected static final int TYPE_HDMI = 2;
    public static final int TYPE_OVERLAY = 4;
    private protected static final int TYPE_UNKNOWN = 0;
    private protected static final int TYPE_VIRTUAL = 5;
    private protected static final int TYPE_WIFI = 3;
    private final String mAddress;
    private int mCachedAppHeightCompat;
    private int mCachedAppWidthCompat;
    private DisplayAdjustments mDisplayAdjustments;
    private final int mDisplayId;
    public protected DisplayInfo mDisplayInfo;
    ...
    public synchronized Display(DisplayManagerGlobal global, int displayId, DisplayInfo displayInfo, DisplayAdjustments daj) {
        this(global, displayId, displayInfo, daj, null);
    }

    public synchronized Display(DisplayManagerGlobal global, int displayId, DisplayInfo displayInfo, Resources res) {
        this(global, displayId, displayInfo, null, res);
    }

    private synchronized Display(DisplayManagerGlobal global, int displayId, DisplayInfo displayInfo, DisplayAdjustments daj, Resources res) {
    ...
    public synchronized int getLayerStack() {
    ...
    public synchronized int getOwnerUid() {
        return this.mOwnerUid;
    }

    private protected String getOwnerPackageName() {
    ...
    public synchronized void getOverscanInsets(Rect outRect) {
        updateDisplayInfoLocked();
    ...
    public synchronized void requestColorMode(int colorMode) {
    ...
    public synchronized int getRemoveMode() {
    ...
    public synchronized int[] getSupportedColorModes() {
        int[] colorModes;
        updateDisplayInfoLocked();
        colorModes = this.mDisplayInfo.supportedColorModes;
    ...
    public static synchronized boolean hasAccess(int uid, int flags, int ownerUid) {
        return (flags & 4) == 0 || uid == ownerUid || uid == 1000 || uid == 0;
    }

    public synchronized boolean isPublicPresentation() {
        return (this.mFlags & 12) == 8;
    }

    private synchronized void updateDisplayInfoLocked() {
    ...
    private synchronized void updateCachedAppSizeIfNeededLocked() {
    ...
    public static synchronized String typeToString(int type) {
        switch (type) {
            case 0:
    ...
    public static synchronized boolean isSuspendedState(int state) {
        return state == 1 || state == 4 || state == 6;
    }

    public static synchronized boolean isDozeState(int state) {
    ...
    public static final class Mode implements Parcelable {
        ...
        private protected Mode(int modeId, int width, int height, float refreshRate) {
            this.mModeId = modeId;
            this.mWidth = width;
            this.mHeight = height;
        ...
        public synchronized boolean matches(int width, int height, float refreshRate) {
        ...
        private synchronized Mode(Parcel in) {
    ...
    public static final class HdrCapabilities implements Parcelable {
        ...
        public synchronized HdrCapabilities() {
        ...
        private protected HdrCapabilities(int[] supportedHdrTypes, float maxLuminance, float maxAverageLuminance, float minLuminance) {
            this.mSupportedHdrTypes = new int[0];
            this.mMaxLuminance = -1.0f;
            this.mMaxAverageLuminance = -1.0f;
            this.mMinLuminance = -1.0f;
        ...
        private synchronized HdrCapabilities(Parcel source) {
            this.mSupportedHdrTypes = new int[0];
            this.mMaxLuminance = -1.0f;
            this.mMaxAverageLuminance = -1.0f;
            this.mMinLuminance = -1.0f;

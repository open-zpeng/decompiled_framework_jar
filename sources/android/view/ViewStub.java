...
public final class ViewStub extends View {
    ...
    public synchronized Runnable setInflatedIdAsync(int inflatedId) {
        this.mInflatedId = inflatedId;
        return null;
    }
    ...
    public synchronized Runnable setLayoutResourceAsync(int layoutResource) {
        this.mLayoutResource = layoutResource;
        return null;
    }
    ...
    public synchronized Runnable setVisibilityAsync(int visibility) {
        if (visibility == 0 || visibility == 4) {
    ...
    private synchronized View inflateViewNoAdd(ViewGroup parent) {
    ...
    public synchronized void replaceSelfWithView(View view, ViewGroup parent) {

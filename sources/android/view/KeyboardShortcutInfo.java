...
public final class KeyboardShortcutInfo implements Parcelable {
    ...
    public synchronized KeyboardShortcutInfo(CharSequence label, Icon icon, int keycode, int modifiers) {
        this.mLabel = label;
        this.mIcon = icon;
        boolean z = false;
    ...
    private synchronized KeyboardShortcutInfo(Parcel source) {

...
public final class DisplayInfo implements Parcelable {
    ...
    public void getAppMetrics(DisplayMetrics outMetrics, DisplayAdjustments displayAdjustments) {
        xpDisplayInfo.getMetricsWithSize(this, outMetrics, displayAdjustments.getCompatibilityInfo(), displayAdjustments.getConfiguration(), this.appWidth, this.appHeight);
    }

    public void getAppMetrics(DisplayMetrics outMetrics, CompatibilityInfo ci, Configuration configuration) {
        xpDisplayInfo.getMetricsWithSize(this, outMetrics, ci, configuration, this.appWidth, this.appHeight);
    }

    public void getLogicalMetrics(DisplayMetrics outMetrics, CompatibilityInfo compatInfo, Configuration configuration) {
        xpDisplayInfo.getMetricsWithSize(this, outMetrics, compatInfo, configuration, this.logicalWidth, this.logicalHeight);
    }

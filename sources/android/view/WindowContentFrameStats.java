...
public final class WindowContentFrameStats extends FrameStats implements Parcelable {
    ...
    public synchronized WindowContentFrameStats() {
    }

    private protected void init(long refreshPeriodNano, long[] framesPostedTimeNano, long[] framesPresentedTimeNano, long[] framesReadyTimeNano) {
    ...
    private synchronized WindowContentFrameStats(Parcel parcel) {

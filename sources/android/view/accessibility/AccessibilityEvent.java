...
public final class AccessibilityEvent extends AccessibilityRecord implements Parcelable {
    ...
    public private protected int mAction;
    int mContentChangeTypes;
    private long mEventTime;
    public protected int mEventType;
    ...
    private synchronized AccessibilityEvent() {
    }

    synchronized void init(AccessibilityEvent event) {
    ...
    private static synchronized String contentChangeTypesToString(int types) {
    ...
    public static synchronized String singleContentChangeTypeToString(int type) {
        if (type != 4) {
            if (type == 8) {
    ...
    public synchronized void setWindowChanges(int changes) {
        this.mWindowChangeTypes = changes;
    }

    private static synchronized String windowChangeTypesToString(int types) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized String singleWindowChangeTypeToString(int type) {
        if (type != 4) {
            if (type != 8) {
                if (type != 16) {
                    if (type != 32) {
    ...
    public static synchronized AccessibilityEvent obtainWindowsChangedEvent(int windowId, int windowChangeTypes) {
    ...
    private synchronized void readAccessibilityRecordFromParcel(AccessibilityRecord record, Parcel parcel) {
    ...
    private synchronized void writeAccessibilityRecordToParcel(AccessibilityRecord record, Parcel parcel, int flags) {
    ...
    private static synchronized String singleEventTypeToString(int eventType) {
        switch (eventType) {
            case 1:

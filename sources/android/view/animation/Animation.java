...
public abstract class Animation implements Cloneable {
    ...
    public private protected AnimationListener mListener;
    ...
    public private protected RectF mPreviousRegion = new RectF();
    public private protected RectF mRegion = new RectF();
    public private protected Transformation mTransformation = new Transformation();
    public private protected Transformation mPreviousTransformation = new Transformation();
    ...
    @Override // 
    /* renamed from: clone */
    public Animation mo62clone() throws CloneNotSupportedException {
    ...
    public synchronized void setShowWallpaper(boolean showWallpaper) {
    ...
    public synchronized boolean getShowWallpaper() {
    ...
    private synchronized void fireAnimationStart() {
    ...
    private synchronized void fireAnimationRepeat() {
        if (this.mListener != null) {
            if (this.mListenerHandler != null) {
    ...
    private synchronized void fireAnimationEnd() {
        if (this.mListener != null) {
            if (this.mListenerHandler != null) {
    ...
    protected static class Description {
        ...
        public static synchronized Description parseValue(TypedValue value) {

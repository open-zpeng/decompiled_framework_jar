...
public class AnticipateOvershootInterpolator extends BaseInterpolator implements NativeInterpolatorFactory {
    ...
    public synchronized AnticipateOvershootInterpolator(Resources res, Resources.Theme theme, AttributeSet attrs) {
        TypedArray a;
        if (theme != null) {
    ...
    private static synchronized float a(float t, float s) {
        return t * t * (((1.0f + s) * t) - s);
    }

    private static synchronized float o(float t, float s) {
        return t * t * (((1.0f + s) * t) + s);
    }

    @Override // android.animation.TimeInterpolator
    public float getInterpolation(float t) {
        return t < 0.5f ? 0.5f * a(2.0f * t, this.mTension) : 0.5f * (o((t * 2.0f) - 2.0f, this.mTension) + 2.0f);
    }

...
public class TranslateXAnimation extends TranslateAnimation {
    ...
    public synchronized TranslateXAnimation(float fromXDelta, float toXDelta) {
        super(fromXDelta, toXDelta, 0.0f, 0.0f);
        this.mTmpValues = new float[9];
    }

    public synchronized TranslateXAnimation(int fromXType, float fromXValue, int toXType, float toXValue) {

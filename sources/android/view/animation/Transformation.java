...
public class Transformation {
    ...
    public synchronized void postCompose(Transformation t) {
        this.mAlpha *= t.getAlpha();
    ...
    public synchronized void setClipRect(Rect r) {
        setClipRect(r.left, r.top, r.right, r.bottom);
    }

    public synchronized void setClipRect(int l, int t, int r, int b) {
        this.mClipRect.set(l, t, r, b);
        this.mHasClipRect = true;
    }

    public synchronized Rect getClipRect() {
        return this.mClipRect;
    }

    public synchronized boolean hasClipRect() {
    ...
    private protected void printShortString(PrintWriter pw) {
        pw.print("{alpha=");

...
public class GridLayoutAnimationController extends LayoutAnimationController {
    ...
    private synchronized int getTransformedColumnIndex(AnimationParameters params) {
        int index;
        switch (getOrder()) {
            case 1:
    ...
    private synchronized int getTransformedRowIndex(AnimationParameters params) {
        int index;
        switch (getOrder()) {
            case 1:

...
public class ClipRectAnimation extends Animation {
    ...
    public synchronized ClipRectAnimation(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public synchronized ClipRectAnimation(Rect fromClip, Rect toClip) {
        this.mFromRect = new Rect();
        this.mToRect = new Rect();
        this.mFromLeftType = 0;
        this.mFromTopType = 0;
    ...
    public synchronized ClipRectAnimation(int fromL, int fromT, int fromR, int fromB, int toL, int toT, int toR, int toB) {

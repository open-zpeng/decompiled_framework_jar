...
public class AnimationSet extends Animation {
    ...
    /* renamed from: clone */
    public AnimationSet mo42clone() throws CloneNotSupportedException {
        AnimationSet animation = (AnimationSet) super.mo42clone();
        ...
        for (int i = 0; i < count; i++) {
            animation.mAnimations.add(animations.get(i).mo42clone());
        }
        return animation;
    }

...
public interface IInputFilterHost extends IInterface {
    synchronized void sendInputEvent(InputEvent inputEvent, int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IInputFilterHost {
        ...
        public static synchronized IInputFilterHost asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IInputFilterHost {
            ...
            public synchronized void sendInputEvent(InputEvent event, int policyFlags) throws RemoteException {

...
public final class ImageTransformation extends InternalTransformation implements Transformation, Parcelable {
    ...
    private synchronized ImageTransformation(Builder builder) {
    ...
    public static class Builder {
        ...
        private synchronized void addOptionInternal(Pattern regex, int resId, CharSequence contentDescription) {
            throwIfDestroyed();
    ...
    public static final class Option {
        ...
        synchronized Option(Pattern pattern, int resId, CharSequence contentDescription) {

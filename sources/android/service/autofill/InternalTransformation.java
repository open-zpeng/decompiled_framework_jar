...
public abstract class InternalTransformation implements Transformation, Parcelable {
    ...
    abstract synchronized void apply(ValueFinder valueFinder, RemoteViews remoteViews, int i) throws Exception;

    public static synchronized boolean batchApply(ValueFinder finder, RemoteViews template, ArrayList<Pair<Integer, InternalTransformation>> transformations) {

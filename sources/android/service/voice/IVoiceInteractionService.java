...
public interface IVoiceInteractionService extends IInterface {
    ...
    synchronized void ready() throws RemoteException;

    synchronized void shutdown() throws RemoteException;

    synchronized void soundModelsChanged() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IVoiceInteractionService {
        ...
        public static synchronized IVoiceInteractionService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IVoiceInteractionService {
            ...
            @Override // android.service.voice.IVoiceInteractionService
            public synchronized void soundModelsChanged() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

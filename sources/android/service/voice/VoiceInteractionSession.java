...
public class VoiceInteractionSession implements KeyEvent.Callback, ComponentCallbacks2 {
    ...
    public static class Request {
        ...
        synchronized Request(String packageName, int uid, IVoiceInteractorCallback callback, VoiceInteractionSession session, Bundle extras) {
        ...
        synchronized void dump(String prefix, FileDescriptor fd, PrintWriter writer, String[] args) {
            writer.print(prefix);
    ...
    public static final class ConfirmationRequest extends Request {
        ...
        synchronized ConfirmationRequest(String packageName, int uid, IVoiceInteractorCallback callback, VoiceInteractionSession session, VoiceInteractor.Prompt prompt, Bundle extras) {
    ...
    public static final class PickOptionRequest extends Request {
        ...
        synchronized PickOptionRequest(String packageName, int uid, IVoiceInteractorCallback callback, VoiceInteractionSession session, VoiceInteractor.Prompt prompt, VoiceInteractor.PickOptionRequest.Option[] options, Bundle extras) {
            super(packageName, uid, callback, session, extras);
            this.mPrompt = prompt;
        ...
        synchronized void sendPickOptionResult(boolean finished, VoiceInteractor.PickOptionRequest.Option[] selections, Bundle result) {
            if (finished) {
                try {
                    finishRequest();
                } catch (RemoteException e) {
    ...
    public static final class CompleteVoiceRequest extends Request {
        ...
        synchronized CompleteVoiceRequest(String packageName, int uid, IVoiceInteractorCallback callback, VoiceInteractionSession session, VoiceInteractor.Prompt prompt, Bundle extras) {
            super(packageName, uid, callback, session, extras);
            this.mPrompt = prompt;
        }
    ...
    public static final class AbortVoiceRequest extends Request {
        ...
        synchronized AbortVoiceRequest(String packageName, int uid, IVoiceInteractorCallback callback, VoiceInteractionSession session, VoiceInteractor.Prompt prompt, Bundle extras) {
            super(packageName, uid, callback, session, extras);
            this.mPrompt = prompt;
        }
    ...
    public static final class CommandRequest extends Request {
        ...
        synchronized CommandRequest(String packageName, int uid, IVoiceInteractorCallback callback, VoiceInteractionSession session, String command, Bundle extras) {
            super(packageName, uid, callback, session, extras);
        ...
        synchronized void sendCommandResult(boolean finished, Bundle result) {
            if (finished) {
                try {
                    finishRequest();
                } catch (RemoteException e) {
    ...
    synchronized void addRequest(Request req) {
        this.mActiveRequests.put(req.mInterface.asBinder(), req);
    }

    synchronized boolean isRequestActive(IBinder reqInterface) {
        return this.mActiveRequests.containsKey(reqInterface);
    }

    synchronized Request removeRequest(IBinder reqInterface) {
        return this.mActiveRequests.remove(reqInterface);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void doCreate(IVoiceInteractionManagerService service, IBinder token) {
        this.mSystemService = service;
        this.mToken = token;
        onCreate();
    }

    synchronized void doShow(Bundle args, int flags, final IVoiceInteractionSessionShowCallback showCallback) {
    ...
    synchronized void ensureWindowCreated() {
        if (this.mInitialized) {
            return;
        }
        if (!this.mUiEnabled) {
    ...
    synchronized void ensureWindowAdded() {
    ...
    synchronized void ensureWindowHidden() {
    ...
    private synchronized void doOnCreate() {
    ...
    synchronized void doOnHandleAssist(Bundle data, AssistStructure structure, Throwable failure, AssistContent content) {
        if (failure != null) {
    ...
    synchronized void doOnHandleAssistSecondary(Bundle data, AssistStructure structure, Throwable failure, AssistContent content, int index, int count) {
        if (failure != null) {
            onAssistStructureFailure(failure);
        }

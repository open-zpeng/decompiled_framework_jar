...
public interface IResolverRankerResult extends IInterface {
    synchronized void sendResult(List<ResolverTarget> list) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IResolverRankerResult {
        ...
        public static synchronized IResolverRankerResult asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IResolverRankerResult {
            ...
            public synchronized void sendResult(List<ResolverTarget> results) throws RemoteException {

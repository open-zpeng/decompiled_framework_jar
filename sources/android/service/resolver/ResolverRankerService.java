...
public abstract class ResolverRankerService extends Service {
    ...
    public static synchronized void sendResult(List<ResolverTarget> targets, IResolverRankerResult result) {
        try {
    ...
    private class ResolverRankerServiceWrapper extends IResolverRankerService.Stub {
        ...
        public synchronized void predict(final List<ResolverTarget> targets, final IResolverRankerResult result) throws RemoteException {
        ...
        @Override // android.service.resolver.IResolverRankerService
        public synchronized void train(final List<ResolverTarget> targets, final int selectedPosition) throws RemoteException {

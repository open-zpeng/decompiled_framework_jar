...
public class DreamService extends Service implements Window.Callback {
    ...
    private void updateDoze() {
        ...
        if (iDreamManager != null && this.mDozing) {
            try {
                iDreamManager.startDozing(iBinder, this.mDozeScreenState, this.mDozeScreenBrightness);
    ...
    public void stopDozing() {
        if (this.mDozing) {
            ...
            try {
                iDreamManager.stopDozing(this.mWindowToken);
            } catch (RemoteException e) {
            }
        }
    }
    ...
    public void wakeUp(boolean fromSystem) {
        ...
        if (!this.mWaking && !this.mFinished) {
            ...
            if (!fromSystem && !this.mFinished) {
                ...
                try {
                    iDreamManager.finishSelf(iBinder, false);
                } catch (RemoteException e) {
                }
            }
        }
    ...
    public final void attach(IBinder windowToken, boolean canDoze, final IRemoteCallback started) {
        if (this.mWindowToken != null) {
            ...
            try {
                iDreamManager.finishSelf(windowToken, true);
            } catch (RemoteException e) {
            }
        } else {

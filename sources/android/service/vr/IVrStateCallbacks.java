...
public interface IVrStateCallbacks extends IInterface {
    synchronized void onVrStateChanged(boolean z) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IVrStateCallbacks {
        ...
        public static synchronized IVrStateCallbacks asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IVrStateCallbacks {
            ...
            public synchronized void onVrStateChanged(boolean enabled) throws RemoteException {

...
public abstract class MediaBrowserService extends Service {
    ...
    private protected static final String KEY_MEDIA_ITEM = "media_item";
    ...
    public class Result<T> {
        ...
        synchronized void setFlags(int flags) {
            this.mFlags = flags;
        }

        synchronized void onResultSent(T result, int flags) {
        }
    }
    ...
    private class ServiceBinder extends IMediaBrowserService.Stub {
        ...
        public synchronized void connect(final String pkg, final Bundle rootHints, final IMediaBrowserServiceCallbacks callbacks) {
        ...
        @Override // android.service.media.IMediaBrowserService
        public synchronized void disconnect(final IMediaBrowserServiceCallbacks callbacks) {
        ...
        @Override // android.service.media.IMediaBrowserService
        public synchronized void addSubscriptionDeprecated(String id, IMediaBrowserServiceCallbacks callbacks) {
        }

        @Override // android.service.media.IMediaBrowserService
        public synchronized void addSubscription(final String id, final IBinder token, final Bundle options, final IMediaBrowserServiceCallbacks callbacks) {
        ...
        @Override // android.service.media.IMediaBrowserService
        public synchronized void removeSubscriptionDeprecated(String id, IMediaBrowserServiceCallbacks callbacks) {
        }

        @Override // android.service.media.IMediaBrowserService
        public synchronized void removeSubscription(final String id, final IBinder token, final IMediaBrowserServiceCallbacks callbacks) {
        ...
        @Override // android.service.media.IMediaBrowserService
        public synchronized void getMediaItem(final String mediaId, final ResultReceiver receiver, final IMediaBrowserServiceCallbacks callbacks) {
    ...
    private synchronized void notifyChildrenChangedInternal(final String parentId, final Bundle options) {
        if (parentId == null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean isValidPackage(String pkg, int uid) {
        if (pkg == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void addSubscription(String id, ConnectionRecord connection, IBinder token, Bundle options) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean removeSubscription(String id, ConnectionRecord connection, IBinder token) {
        if (token == null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void performLoadChildren(final String parentId, final ConnectionRecord connection, final Bundle options) {
        Result<List<MediaBrowser.MediaItem>> result = new Result<List<MediaBrowser.MediaItem>>(parentId) { // from class: android.service.media.MediaBrowserService.3
            ...
            public void onResultSent(List<MediaBrowser.MediaItem> list, int flag) {
                ...
                ParceledListSlice<MediaBrowser.MediaItem> pls = filteredList == null ? null : new ParceledListSlice<>(filteredList);
                try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized List<MediaBrowser.MediaItem> applyOptions(List<MediaBrowser.MediaItem> list, Bundle options) {
        if (list == null) {
            return null;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void performLoadItem(final String itemId, final ConnectionRecord connection, final ResultReceiver receiver) {

...
public interface IGetOtaStatusCallback extends IInterface {
    synchronized void onSuccess(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IGetOtaStatusCallback {
        ...
        public static synchronized IGetOtaStatusCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IGetOtaStatusCallback {
            ...
            public synchronized void onSuccess(int status) throws RemoteException {

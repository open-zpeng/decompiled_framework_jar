...
public final class EuiccProfileInfo implements Parcelable {
    ...
    @Deprecated
    private protected EuiccProfileInfo(String iccid, UiccAccessRule[] accessRules, String nickname) {
    ...
    private synchronized EuiccProfileInfo(Parcel in) {
    ...
    private synchronized EuiccProfileInfo(String iccid, String nickname, String serviceProviderName, String profileName, int profileClass, int state, CarrierIdentifier carrierIdentifier, int policyRules, List<UiccAccessRule> accessRules) {
        this.mIccid = iccid;
        this.mNickname = nickname;
    ...
    public int hashCode() {
        int result = (31 * 1) + Objects.hashCode(this.mIccid);
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * result) + Objects.hashCode(this.mNickname))) + Objects.hashCode(this.mServiceProviderName))) + Objects.hashCode(this.mProfileName))) + this.mProfileClass)) + this.mState)) + Objects.hashCode(this.mCarrierIdentifier))) + this.mPolicyRules)) + Arrays.hashCode(this.mAccessRules);
    }

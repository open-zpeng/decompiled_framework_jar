...
public abstract class EuiccService extends Service {
    ...
    private class IEuiccServiceWrapper extends IEuiccService.Stub {
        ...
        public synchronized void downloadSubscription(final int slotId, final DownloadableSubscription subscription, final boolean switchAfterDownload, final boolean forceDeactivateSim, final IDownloadSubscriptionCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void getEid(final int slotId, final IGetEidCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void startOtaIfNecessary(final int slotId, final IOtaStatusChangedCallback statusChangedCallback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void getOtaStatus(final int slotId, final IGetOtaStatusCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void getDownloadableSubscriptionMetadata(final int slotId, final DownloadableSubscription subscription, final boolean forceDeactivateSim, final IGetDownloadableSubscriptionMetadataCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void getDefaultDownloadableSubscriptionList(final int slotId, final boolean forceDeactivateSim, final IGetDefaultDownloadableSubscriptionListCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void getEuiccProfileInfoList(final int slotId, final IGetEuiccProfileInfoListCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void getEuiccInfo(final int slotId, final IGetEuiccInfoCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void deleteSubscription(final int slotId, final String iccid, final IDeleteSubscriptionCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void switchToSubscription(final int slotId, final String iccid, final boolean forceDeactivateSim, final ISwitchToSubscriptionCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void updateSubscriptionNickname(final int slotId, final String iccid, final String nickname, final IUpdateSubscriptionNicknameCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void eraseSubscriptions(final int slotId, final IEraseSubscriptionsCallback callback) {
        ...
        @Override // android.service.euicc.IEuiccService
        public synchronized void retainSubscriptionsForFactoryReset(final int slotId, final IRetainSubscriptionsForFactoryResetCallback callback) {

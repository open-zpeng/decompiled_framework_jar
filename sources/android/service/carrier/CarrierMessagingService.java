...
public abstract class CarrierMessagingService extends Service {
    ...
    private class ICarrierMessagingWrapper extends ICarrierMessagingService.Stub {
        ...
        public synchronized void filterSms(MessagePdu pdu, String format, int destPort, int subId, final ICarrierMessagingCallback callback) {
        ...
        public synchronized void sendTextSms(String text, int subId, String destAddress, int sendSmsFlag, final ICarrierMessagingCallback callback) {
        ...
        @Override // android.service.carrier.ICarrierMessagingService
        public synchronized void sendDataSms(byte[] data, int subId, String destAddress, int destPort, int sendSmsFlag, final ICarrierMessagingCallback callback) {
        ...
        @Override // android.service.carrier.ICarrierMessagingService
        public synchronized void sendMultipartTextSms(List<String> parts, int subId, String destAddress, int sendSmsFlag, final ICarrierMessagingCallback callback) {
        ...
        @Override // android.service.carrier.ICarrierMessagingService
        public synchronized void sendMms(Uri pduUri, int subId, Uri location, final ICarrierMessagingCallback callback) {
        ...
        @Override // android.service.carrier.ICarrierMessagingService
        public synchronized void downloadMms(Uri pduUri, int subId, Uri location, final ICarrierMessagingCallback callback) {

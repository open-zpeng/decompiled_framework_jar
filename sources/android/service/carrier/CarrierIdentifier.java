...
public class CarrierIdentifier implements Parcelable {
    ...
    public synchronized CarrierIdentifier(Parcel parcel) {
    ...
    public int hashCode() {
        int result = (31 * 1) + Objects.hashCode(this.mMcc);
        return (31 * ((31 * ((31 * ((31 * ((31 * result) + Objects.hashCode(this.mMnc))) + Objects.hashCode(this.mSpn))) + Objects.hashCode(this.mImsi))) + Objects.hashCode(this.mGid1))) + Objects.hashCode(this.mGid2);
    }

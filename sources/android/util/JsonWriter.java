...
public final class JsonWriter implements Closeable {
    ...
    private synchronized JsonWriter open(JsonScope empty, String openBracket) throws IOException {
        beforeValue(true);
    ...
    private synchronized JsonWriter close(JsonScope empty, JsonScope nonempty, String closeBracket) throws IOException {
    ...
    private synchronized JsonScope peek() {
        return this.stack.get(this.stack.size() - 1);
    }

    private synchronized void replaceTop(JsonScope topOfStack) {
    ...
    private synchronized void string(String value) throws IOException {
        this.out.write("\"");
    ...
    private synchronized void beforeName() throws IOException {
        JsonScope context = peek();
    ...
    private synchronized void beforeValue(boolean root) throws IOException {
        switch (peek()) {
            case EMPTY_DOCUMENT:

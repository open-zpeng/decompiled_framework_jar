...
public class StatsLogInternal {
    ...
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_BLUETOOTH = 3;
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_CELLULAR = 1;
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_ETHERNET = 4;
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_LOWPAN = 7;
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_UNKNOWN = 0;
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_VPN = 5;
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_WIFI = 2;
    public static final int NETWORK_DNS_EVENT_REPORTED__NETWORK_TYPE__NT_WIFI_AWARE = 6;
    ...
    public static native int write(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, byte[] bArr, int i9);
    ...
    public static native int write(int i, int i2, int i3, boolean z, int i4, int i5, int i6, int i7, boolean z2, long j);
    ...
    public static native int write(int i, int i2, String str, int i3, int i4, String str2);
    ...
    public static native int write(int i, String str, int i2, int i3, int i4, boolean z, boolean z2, int i5);

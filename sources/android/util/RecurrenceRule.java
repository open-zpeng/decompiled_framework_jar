...
public class RecurrenceRule implements Parcelable {
    ...
    private protected final ZonedDateTime start;
    ...
    public synchronized RecurrenceRule(ZonedDateTime start, ZonedDateTime end, Period period) {
        this.start = start;
        this.end = end;
        this.period = period;
    }
    ...
    @Deprecated
    public static synchronized RecurrenceRule buildNever() {
    ...
    private synchronized RecurrenceRule(Parcel source) {
    ...
    public synchronized RecurrenceRule(DataInputStream in) throws IOException {
    ...
    @Deprecated
    public synchronized boolean isMonthly() {
    ...
    private class RecurringIterator implements Iterator<Range<ZonedDateTime>> {
        ...
        private synchronized void updateCycle() {
        ...
        private synchronized ZonedDateTime roundBoundaryTime(ZonedDateTime boundary) {
    ...
    public static synchronized String convertZonedDateTime(ZonedDateTime time) {
        if (time != null) {
    ...
    public static synchronized ZonedDateTime convertZonedDateTime(String time) {
        if (time != null) {
    ...
    public static synchronized String convertPeriod(Period period) {
        if (period != null) {
    ...
    public static synchronized Period convertPeriod(String period) {
        if (period != null) {

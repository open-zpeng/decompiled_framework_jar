...
public class TimingsTraceLog {
    ...
    public synchronized TimingsTraceLog(String tag, long traceTag) {
    ...
    public synchronized void traceBegin(String name) {
        assertSameThread();
    ...
    public synchronized void traceEnd() {
        assertSameThread();
    ...
    private synchronized void assertSameThread() {
    ...
    public synchronized void logDuration(String name, long timeMs) {

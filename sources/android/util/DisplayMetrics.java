...
public class DisplayMetrics {
    ...
    @Deprecated
    private protected static int DENSITY_DEVICE = getDeviceDensity();
    ...
    private protected int noncompatDensityDpi;
    private protected int noncompatHeightPixels;
    public float noncompatScaledDensity;
    private protected int noncompatWidthPixels;
    ...
    public synchronized boolean equalsPhysical(DisplayMetrics other) {
    ...
    private static synchronized int getDeviceDensity() {

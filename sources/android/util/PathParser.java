...
public class PathParser {
    ...
    public static synchronized void createPathFromPathData(Path outPath, PathData data) {
        nCreatePathFromPathData(outPath.mNativePath, data.mNativePathData);
    }

    public static synchronized boolean canMorph(PathData pathDataFrom, PathData pathDataTo) {
    ...
    public static class PathData {
        ...
        public synchronized PathData() {
            this.mNativePathData = 0L;
            this.mNativePathData = PathParser.access$000();
        }

        public synchronized PathData(PathData data) {
            this.mNativePathData = 0L;
            this.mNativePathData = PathParser.nCreatePathData(data.mNativePathData);
        }

        public synchronized PathData(String pathString) {
            this.mNativePathData = 0L;
        ...
        public synchronized void setPathData(PathData source) {
    ...
    public static synchronized boolean interpolatePathData(PathData outData, PathData fromData, PathData toData, float fraction) {

...
public final class Half extends Number implements Comparable<Half> {
    ...
    public static int compare(short x, short y) {
        ...
        short yBits = NaN;
        short xBits = i > FP16_EXPONENT_MAX ? (short) 32256 : x;
    ...
    public static short ceil(short h) {
        ...
        int result = bits;
        if (e < 15360) {
            result = (result & 32768) | (15360 & (-((e == 0 ? 0 : 1) & (~(bits >> 15)))));
        } else if (e < 25600) {
    ...
    public static boolean less(short x, short y) {
        if ((x & Short.MAX_VALUE) <= FP16_EXPONENT_MAX && (y & Short.MAX_VALUE) <= FP16_EXPONENT_MAX) {
            return ((x & NEGATIVE_ZERO) != 0 ? 32768 - (x & HostEndPoint.BROADCAST) : x & HostEndPoint.BROADCAST) < ((y & NEGATIVE_ZERO) != 0 ? 32768 - (65535 & y) : y & HostEndPoint.BROADCAST);
        }
        return false;
    }
    ...
    public static short toHalf(float f) {
        ...
        if (e == 255) {
            ...
            int e2 = e + AdvertisingSetParameters.TX_POWER_MIN + 15;
            if (e2 >= 31) {
                outE = 49;
            } else if (e2 <= 0) {
                if (e2 >= -10) {
    ...
    public static String toHexString(short h) {
        ...
        if (e == 31) {
            ...
            if (e == 0) {
                ...
                o.append("0x1.");
                String significand2 = Integer.toHexString(m);
                o.append(significand2.replaceFirst("0{2,}$", ""));
                o.append('p');
                o.append(Integer.toString(e - 15));
            }
        }
        String significand3 = o.toString();
        return significand3;
    }
}

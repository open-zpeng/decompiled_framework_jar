...
public final class ArrayMap<K, V> implements Map<K, V> {
    ...
    public protected static final int CACHE_SIZE = 10;
    private static final boolean CONCURRENT_MODIFICATION_EXCEPTIONS = true;
    private static final boolean DEBUG = false;
    private static final String TAG = "ArrayMap";
    public private protected static Object[] mBaseCache;
    public private protected static int mBaseCacheSize;
    public private protected static Object[] mTwiceBaseCache;
    public private protected static int mTwiceBaseCacheSize;
    ...
    public private protected static final int[] EMPTY_IMMUTABLE_INTS = new int[0];
    private protected static final ArrayMap EMPTY = new ArrayMap(-1);
    private static final Object sBaseCacheLock = new Object();
    private static final Object sTwiceBaseCacheLock = new Object();

    private static synchronized int binarySearchHashes(int[] hashes, int N, int hash) {
        try {
    ...
    public private protected int indexOf(Object key, int hash) {
        int N = this.mSize;
        if (N == 0) {
            return -1;
        }
    ...
    public private protected int indexOfNull() {
        int N = this.mSize;
        if (N == 0) {
            return -1;
        }
    ...
    public synchronized ArrayMap(int capacity, boolean identityHashCode) {
    ...
    public private protected int indexOfValue(Object value) {
        int N = this.mSize * 2;
        Object[] array = this.mArray;
        int i = 1;
        if (value == null) {
    ...
    private synchronized MapCollections<K, V> getCollection() {

...
public final class PackageUtils {
    private synchronized PackageUtils() {
    }

    public static synchronized String[] computeSignaturesSha256Digests(Signature[] signatures) {
    ...
    public static synchronized String computeSignaturesSha256Digest(Signature[] signatures) {
    ...
    public static synchronized String computeSignaturesSha256Digest(String[] sha256Digests) {
    ...
    public static synchronized byte[] computeSha256DigestBytes(byte[] data) {
        try {
    ...
    public static synchronized String computeSha256Digest(byte[] data) {

...
public abstract class MapCollections<K, V> {
    ...
    protected abstract synchronized void colClear();

    protected abstract synchronized Object colGetEntry(int i, int i2);

    protected abstract synchronized Map<K, V> colGetMap();

    protected abstract synchronized int colGetSize();

    protected abstract synchronized int colIndexOfKey(Object obj);

    protected abstract synchronized int colIndexOfValue(Object obj);

    protected abstract synchronized void colPut(K k, V v);

    protected abstract synchronized void colRemoveAt(int i);

    protected abstract synchronized V colSetValue(int i, V v);
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public synchronized boolean add(Map.Entry<K, V> object) {
            throw new UnsupportedOperationException();
        }

        @Override // java.util.Set, java.util.Collection
        public synchronized boolean addAll(Collection<? extends Map.Entry<K, V>> collection) {
    ...
    final class KeySet implements Set<K> {
        ...
        @Override // java.util.Set, java.util.Collection
        public synchronized boolean add(K object) {
            throw new UnsupportedOperationException();
        }

        @Override // java.util.Set, java.util.Collection
        public synchronized boolean addAll(Collection<? extends K> collection) {
            throw new UnsupportedOperationException();
        }
    ...
    public static synchronized <K, V> boolean containsAllHelper(Map<K, V> map, Collection<?> collection) {
        Iterator<?> it = collection.iterator();
        while (it.hasNext()) {
    ...
    public static synchronized <K, V> boolean removeAllHelper(Map<K, V> map, Collection<?> collection) {
    ...
    public static synchronized <K, V> boolean retainAllHelper(Map<K, V> map, Collection<?> collection) {
        int oldSize = map.size();
    ...
    public synchronized Object[] toArrayHelper(int offset) {
        int N = colGetSize();
    ...
    public synchronized <T> T[] toArrayHelper(T[] array, int offset) {
        int N = colGetSize();
        if (array.length < N) {
    ...
    public static synchronized <T> boolean equalsSetHelper(Set<T> set, Object object) {
        if (set == object) {
            return true;
        }

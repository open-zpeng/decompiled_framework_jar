...
public final class StatsLog extends StatsLogInternal {
    ...
    public static boolean logWatchdogRollbackOccurred(int rollbackType, String packageName, long packageVersionCode, int rollbackReason, String failingPackageName) {
        synchronized (sLogLock) {
            try {
                try {
                    IStatsManager service = getIStatsManagerLocked();
                    ...
                    service.sendWatchdogRollbackOccurredAtom(rollbackType, packageName, packageVersionCode, rollbackReason, failingPackageName);
                    return true;
                } catch (RemoteException e) {
                    sService = null;
                    return false;

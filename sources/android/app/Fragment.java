...
public class Fragment implements ComponentCallbacks2, View.OnCreateContextMenuListener {
    ...
    public private protected FragmentManagerImpl mChildFragmentManager;
    FragmentManagerNonConfig mChildNonConfig;
    ViewGroup mContainer;
    int mContainerId;
    boolean mDeferStart;
    boolean mDetached;
    public private protected int mFragmentId;
    public private protected FragmentManagerImpl mFragmentManager;
    boolean mFromLayout;
    boolean mHasMenu;
    boolean mHidden;
    boolean mHiddenChanged;
    public private protected FragmentHostCallback mHost;
    boolean mInLayout;
    boolean mIsCreated;
    boolean mIsNewlyAdded;
    LayoutInflater mLayoutInflater;
    LoaderManagerImpl mLoaderManager;
    public private protected boolean mLoadersStarted;
    ...
    boolean mRetaining;
    public private protected Bundle mSavedFragmentState;
    SparseArray<Parcelable> mSavedViewState;
    String mTag;
    Fragment mTarget;
    int mTargetRequestCode;
    public private protected View mView;
    public private protected String mWho;
    public protected static final ArrayMap<String, Class<?>> sClassMap = new ArrayMap<>();
    private static final Transition USE_DEFAULT_TRANSITION = new TransitionSet();
    int mState = 0;
    public private protected int mIndex = -1;
    int mTargetIndex = -1;
    ...
    public interface OnStartEnterTransitionListener {
        synchronized void onStartEnterTransition();
    ...
    public static class SavedState implements Parcelable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized SavedState(Bundle state) {
            this.mState = state;
        }

        synchronized SavedState(Parcel in, ClassLoader loader) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void restoreViewState(Bundle savedInstanceState) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void setIndex(int index, Fragment parent) {
        this.mIndex = index;
        if (parent != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized boolean isInBackStack() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized LayoutInflater performGetLayoutInflater(Bundle savedInstanceState) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void restoreChildFragmentState(Bundle savedInstanceState, boolean provideNonConfig) {
        Parcelable p;
        if (savedInstanceState != null && (p = savedInstanceState.getParcelable(Activity.FRAGMENTS_TAG)) != null) {
            if (this.mChildFragmentManager == null) {
                instantiateChildFragmentManager();
            }
    ...
    public void startPostponedEnterTransition() {
        if (this.mFragmentManager == null || this.mFragmentManager.mHost == null) {
            ...
            this.mFragmentManager.mHost.getHandler().postAtFrontOfQueue(new Runnable() { // from class: android.app.-$$Lambda$Fragment$m7ODa2MK0_rf4XCEL5JOn14G0h8
    ...
    public synchronized void callStartTransitionListener() {
    ...
    private synchronized boolean shouldChangeTransition(Transition transition, Transition defaultValue) {
    ...
    synchronized void instantiateChildFragmentManager() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performCreate(Bundle savedInstanceState) {
        if (this.mChildFragmentManager != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized View performCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.noteStateNotSaved();
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performActivityCreated(Bundle savedInstanceState) {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.noteStateNotSaved();
        }
        this.mState = 2;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performResume() {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.noteStateNotSaved();
            this.mChildFragmentManager.execPendingActions();
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void noteStateNotSaved() {
        if (this.mChildFragmentManager != null) {
            this.mChildFragmentManager.noteStateNotSaved();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Deprecated
    public synchronized void performMultiWindowModeChanged(boolean isInMultiWindowMode) {
        onMultiWindowModeChanged(isInMultiWindowMode);
        if (this.mChildFragmentManager != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performMultiWindowModeChanged(boolean isInMultiWindowMode, Configuration newConfig) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Deprecated
    public synchronized void performPictureInPictureModeChanged(boolean isInPictureInPictureMode) {
        onPictureInPictureModeChanged(isInPictureInPictureMode);
        if (this.mChildFragmentManager != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performPictureInPictureModeChanged(boolean isInPictureInPictureMode, Configuration newConfig) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performConfigurationChanged(Configuration newConfig) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performLowMemory() {
        onLowMemory();
        if (this.mChildFragmentManager != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean performCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        boolean show = false;
        if (this.mHidden) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean performPrepareOptionsMenu(Menu menu) {
        boolean show = false;
        if (this.mHidden) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean performOptionsItemSelected(MenuItem item) {
        if (!this.mHidden) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean performContextItemSelected(MenuItem item) {
        if (!this.mHidden) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performOptionsMenuClosed(Menu menu) {
        if (!this.mHidden) {
            if (this.mHasMenu && this.mMenuVisible) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performSaveInstanceState(Bundle outState) {
        Parcelable p;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performPause() {
        if (this.mChildFragmentManager != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performDestroyView() {
        if (this.mChildFragmentManager != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void performDetach() {
        this.mCalled = false;
        onDetach();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setOnStartEnterTransitionListener(OnStartEnterTransitionListener listener) {
        ensureAnimationInfo();
    ...
    private static synchronized Transition loadTransition(Context context, TypedArray typedArray, Transition currentValue, Transition defaultValue, int id) {
    ...
    private synchronized AnimationInfo ensureAnimationInfo() {
        if (this.mAnimationInfo == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized int getNextAnim() {
        if (this.mAnimationInfo == null) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setNextAnim(int animResourceId) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized int getNextTransition() {
        if (this.mAnimationInfo == null) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setNextTransition(int nextTransition, int nextTransitionStyle) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized int getNextTransitionStyle() {
        if (this.mAnimationInfo == null) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized SharedElementCallback getEnterTransitionCallback() {
        if (this.mAnimationInfo == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized SharedElementCallback getExitTransitionCallback() {
        if (this.mAnimationInfo == null) {
            return SharedElementCallback.NULL_CALLBACK;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized Animator getAnimatingAway() {
        if (this.mAnimationInfo == null) {
            return null;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setAnimatingAway(Animator animator) {
        ensureAnimationInfo().mAnimatingAway = animator;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized int getStateAfterAnimating() {
        if (this.mAnimationInfo == null) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setStateAfterAnimating(int state) {
        ensureAnimationInfo().mStateAfterAnimating = state;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean isPostponed() {
        if (this.mAnimationInfo == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean isHideReplaced() {
        if (this.mAnimationInfo == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setHideReplaced(boolean replaced) {

...
public final class SearchableInfo implements Parcelable {
    ...
    public synchronized boolean useBadgeLabel() {
        return (this.mSearchMode & 4) != 0;
    }

    public synchronized boolean useBadgeIcon() {
    ...
    private static synchronized Context createActivityContext(Context context, ComponentName activity) {
        try {
    ...
    public protected SearchableInfo(Context activityContext, AttributeSet attr, ComponentName cName) {
    ...
    public static class ActionKeyInfo implements Parcelable {
        ...
        synchronized ActionKeyInfo(Context activityContext, AttributeSet attr) {
        ...
        private synchronized ActionKeyInfo(Parcel in) {
    ...
    private synchronized void addActionKey(ActionKeyInfo keyInfo) {
        if (this.mActionKeys == null) {
    ...
    public static synchronized SearchableInfo getActivityMetaData(Context context, ActivityInfo activityInfo, int userId) {
        try {
    ...
    private static synchronized SearchableInfo getActivityMetaData(Context context, XmlPullParser xml, ComponentName cName) {
    ...
    public synchronized int getSearchButtonText() {
    ...
    synchronized SearchableInfo(Parcel in) {

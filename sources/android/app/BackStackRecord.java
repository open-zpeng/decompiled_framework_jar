...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
    ...
    public static final class Op {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized Op() {
        }

        synchronized Op(int cmd, Fragment fragment) {
            this.cmd = cmd;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void dump(String prefix, PrintWriter writer, boolean full) {
        String cmdStr;
        if (full) {
            writer.print(prefix);
            writer.print("mName=");
    ...
    public synchronized BackStackRecord(FragmentManagerImpl manager) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void addOp(Op op) {
        this.mOps.add(op);
    ...
    private synchronized void doAddOp(int containerViewId, Fragment fragment, String tag, int opcmd) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void bumpBackStackNesting(int amt) {
        if (!this.mAddToBackStack) {
            return;
        }
    ...
    public synchronized void runOnCommitRunnables() {
        if (this.mCommitRunnables != null) {
    ...
    synchronized int commitInternal(boolean allowStateLoss) {
        if (this.mCommitted) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean interactsWith(int containerId) {
        int numOps = this.mOps.size();
        for (int opNum = 0; opNum < numOps; opNum++) {
            Op op = this.mOps.get(opNum);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean interactsWith(ArrayList<BackStackRecord> records, int startIndex, int endIndex) {
        int thatContainer;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void executeOps() {
        int numOps = this.mOps.size();
        for (int opNum = 0; opNum < numOps; opNum++) {
            Op op = this.mOps.get(opNum);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void executePopOps(boolean moveToState) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized Fragment expandOps(ArrayList<Fragment> added, Fragment oldPrimaryNav) {
        int opNum = 0;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void trackAddedFragmentsInPop(ArrayList<Fragment> added) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setOnStartPostponedListener(Fragment.OnStartEnterTransitionListener listener) {
        for (int opNum = 0; opNum < this.mOps.size(); opNum++) {
            Op op = this.mOps.get(opNum);
            if (isFragmentPostponed(op)) {
    ...
    private static synchronized boolean isFragmentPostponed(Op op) {

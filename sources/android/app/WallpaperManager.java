...
public class WallpaperManager {
    ...
    public protected static Globals sGlobals;
    ...
    static class FastBitmapDrawable extends Drawable {
        ...
        private synchronized FastBitmapDrawable(Bitmap bitmap) {
            this.mBitmap = bitmap;
    ...
    public static class Globals extends IWallpaperManagerCallback.Stub {
        ...
        synchronized Globals(IWallpaperManager service, Looper looper) {
        ...
        public synchronized void addOnColorsChangedListener(OnColorsChangedListener callback, Handler handler, int userId) {
        ...
        public synchronized void removeOnColorsChangedListener(final OnColorsChangedListener callback, int userId) {
        ...
        public synchronized void onWallpaperColorsChanged(final WallpaperColors colors, final int which, final int userId) {
            ...
            while (it.hasNext()) {
                ...
                handler.post(new Runnable() { // from class: android.app.-$$Lambda$WallpaperManager$Globals$1AcnQUORvPlCjJoNqdxfQT4o4Nw
                    ...
                    public final void run() {
                        WallpaperManager.Globals.lambda$onWallpaperColorsChanged$1(WallpaperManager.Globals.this, listener, colors, which, userId);
                    }
                });
            }
        }
        ...
        synchronized WallpaperColors getWallpaperColors(int which, int userId) {
            if (which != 2 && which != 1) {
        ...
        public synchronized Bitmap peekWallpaperBitmap(Context context, boolean returnDefault, int which) {
            return peekWallpaperBitmap(context, returnDefault, which, context.getUserId(), false);
        }

        public synchronized Bitmap peekWallpaperBitmap(Context context, boolean returnDefault, int which, int userId, boolean hardware) {
        ...
        synchronized void forgetLoadedWallpaper() {
            this.mCachedWallpaper = null;
            this.mCachedWallpaperUserId = 0;
            this.mDefaultWallpaper = null;
        }

        private synchronized Bitmap getCurrentWallpaperLocked(Context context, int userId, boolean hardware) {
            if (this.mService == null) {
        ...
        private synchronized Bitmap getDefaultWallpaper(Context context, int which) {
    ...
    static synchronized void initGlobals(IWallpaperManager service, Looper looper) {
        synchronized (sSync) {
            if (sGlobals == null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized WallpaperManager(IWallpaperManager service, Context context, Handler handler) {
    ...
    private protected IWallpaperManager getIWallpaperManager() {
    ...
    public Drawable getBuiltInDrawable(int outWidth, int outHeight, boolean scaleToFit, float horizontalAlignment, float verticalAlignment, int which) {
        ...
        if (sGlobals.mService != null) {
            ...
            if (outWidth <= 0) {
                ...
                BufferedInputStream bufferedInputStream2 = new BufferedInputStream(openDefaultWallpaper(this.mContext, which));
                int outWidth3 = Math.min(inWidth, outWidth);
                int outHeight2 = Math.min(inHeight, outHeight);
                if (scaleToFit) {
                    bufferedInputStream = bufferedInputStream2;
                    bitmapRegionDecoder = null;
                    RectF cropRectF2 = getMaxCropRect(inWidth, inHeight, outWidth3, outHeight2, horizontalAlignment2, verticalAlignment2);
                    cropRectF = cropRectF2;
                    outWidth2 = outWidth3;
                } else {
                    bufferedInputStream = bufferedInputStream2;
                    bitmapRegionDecoder = null;
                ...
                if (roundedTrueCrop.width() > 0 && roundedTrueCrop.height() > 0) {
                    ...
                    if (crop == null) {
                        InputStream is2 = new BufferedInputStream(openDefaultWallpaper(this.mContext, which));
                        BitmapFactory.Options options3 = new BitmapFactory.Options();
                        if (scaleDownSampleSize > 1) {
                            options3.inSampleSize = scaleDownSampleSize;
                        }
                        Bitmap fullSize = BitmapFactory.decodeStream(is2, bitmapRegionDecoder, options3);
                        if (fullSize != null) {
                    ...
                    if (outWidth2 > 0 && outHeight2 > 0) {
                        if (crop.getWidth() != outWidth2 || crop.getHeight() != outHeight2) {
                            ...
                            float verticalAlignment3 = outHeight2;
                            RectF returnRect = new RectF(0.0f, 0.0f, outWidth2, verticalAlignment3);
    ...
    private static synchronized RectF getMaxCropRect(int inWidth, int inHeight, int outWidth, int outHeight, float horizontalAlignment, float verticalAlignment) {
    ...
    private protected Bitmap getBitmap() {
        return getBitmap(false);
    }

    private protected Bitmap getBitmap(boolean hardware) {
        return getBitmapAsUser(this.mContext.getUserId(), hardware);
    }

    public synchronized Bitmap getBitmapAsUser(int userId, boolean hardware) {
    ...
    private protected void addOnColorsChangedListener(OnColorsChangedListener listener, Handler handler, int userId) {
    ...
    public synchronized void removeOnColorsChangedListener(OnColorsChangedListener callback, int userId) {
    ...
    private protected WallpaperColors getWallpaperColors(int which, int userId) {
        return sGlobals.getWallpaperColors(which, userId);
    }

    private protected ParcelFileDescriptor getWallpaperFile(int which, int userId) {
        if (which == 1 || which == 2) {
            if (sGlobals.mService == null) {
                Log.w(TAG, "WallpaperService not running");
                throw new RuntimeException(new DeadSystemException());
    ...
    public synchronized int getWallpaperIdForUser(int which, int userId) {
        try {
            if (sGlobals.mService != null) {
    ...
    private protected int setBitmap(Bitmap fullImage, Rect visibleCropHint, boolean allowBackup, int which, int userId) throws IOException {
    ...
    private final synchronized void validateRect(Rect rect) {
    ...
    private synchronized void copyStreamToWallpaperFile(InputStream data, FileOutputStream fos) throws IOException {
    ...
    private protected boolean setWallpaperComponent(ComponentName name, int userId) {
        if (sGlobals.mService != null) {
            try {
    ...
    private protected static InputStream openDefaultWallpaper(Context context, int which) {
        if (0 != 0 || which == 2) {
            return null;
        }
    ...
    public static synchronized ComponentName getDefaultWallpaperComponent(Context context) {
    ...
    public synchronized boolean setLockWallpaperCallback(IWallpaperManagerCallback callback) {
        if (sGlobals.mService != null) {
            try {
    ...
    public synchronized boolean isWallpaperBackupEligible(int which) {
        if (sGlobals.mService != null) {
            try {
    ...
    public interface OnColorsChangedListener {
        ...
        synchronized default void onColorsChanged(WallpaperColors colors, int which, int userId) {

...
public class FragmentTransition {
    ...
    private static void configureTransitionsReordered(FragmentManagerImpl fragmentManager, int containerId, FragmentContainerTransition fragments, View nonExistentView, ArrayMap<String, String> nameOverrides) {
        ...
        TransitionSet sharedElementTransition = configureSharedElementsReordered(sceneRoot2, nonExistentView, nameOverrides, fragments, sharedElementsOut, sharedElementsIn, enterTransition, exitTransition2);
    ...
    private static void configureTransitionsOrdered(FragmentManagerImpl fragmentManager, int containerId, FragmentContainerTransition fragments, View nonExistentView, ArrayMap<String, String> nameOverrides) {
        ...
        ArrayList<View> sharedElementsOut = new ArrayList<>();
        ArrayList<View> sharedElementsIn = new ArrayList<>();
        TransitionSet sharedElementTransition = configureSharedElementsOrdered(sceneRoot2, nonExistentView, nameOverrides, fragments, sharedElementsOut, sharedElementsIn, enterTransition, exitTransition2);
        if (enterTransition == null && sharedElementTransition == null) {
            exitTransition = exitTransition2;
            if (exitTransition == null) {
                return;
        ...
        if (transition != null) {
            ...
            scheduleRemoveTargets(transition, enterTransition, enteringViews, exitTransition, exitingViews, sharedElementTransition, sharedElementsIn);
            scheduleTargetChange(sceneRoot2, inFragment, nonExistentView, sharedElementsIn, enterTransition, enteringViews, exitTransition, exitingViews);
            TransitionManager.beginDelayedTransition(sceneRoot2, transition);
        }
    }
    ...
    private static void replaceHide(Transition exitTransition, Fragment exitingFragment, final ArrayList<View> exitingViews) {
        if (exitingFragment != null && exitTransition != null && exitingFragment.mAdded && exitingFragment.mHidden && exitingFragment.mHiddenChanged) {
            ...
            OneShotPreDrawListener.add(exitingFragment.mContainer, new Runnable() { // from class: android.app.-$$Lambda$FragmentTransition$PZ32bJ_FSMpbzYzBl8x73NJPidQ
    ...
    private static void scheduleTargetChange(ViewGroup sceneRoot, final Fragment inFragment, final View nonExistentView, final ArrayList<View> sharedElementsIn, final Transition enterTransition, final ArrayList<View> enteringViews, final Transition exitTransition, final ArrayList<View> exitingViews) {
        OneShotPreDrawListener.add(sceneRoot, new Runnable() { // from class: android.app.-$$Lambda$FragmentTransition$8Ei4ls5jlZcfRvuLcweFAxtFBFs
            @Override // java.lang.Runnable
            public final void run() {
    ...
    private static TransitionSet configureSharedElementsReordered(ViewGroup sceneRoot, View nonExistentView, ArrayMap<String, String> nameOverrides, FragmentContainerTransition fragments, ArrayList<View> sharedElementsOut, ArrayList<View> sharedElementsIn, Transition enterTransition, Transition exitTransition) {
        ...
        OneShotPreDrawListener.add(sceneRoot, new Runnable() { // from class: android.app.-$$Lambda$FragmentTransition$jurn0WXuKw3bRQ_2d5zCWdeZWuI
            @Override // java.lang.Runnable
            public final void run() {
                FragmentTransition.lambda$configureSharedElementsReordered$2(Fragment.this, outFragment, inIsPop, inSharedElements, epicenterView, rect);
            }
        });
    ...
    private static TransitionSet configureSharedElementsOrdered(ViewGroup sceneRoot, final View nonExistentView, final ArrayMap<String, String> nameOverrides, final FragmentContainerTransition fragments, final ArrayList<View> sharedElementsOut, final ArrayList<View> sharedElementsIn, final Transition enterTransition, Transition exitTransition) {
        ...
        if (inFragment != null && outFragment != null) {
            ...
            final TransitionSet sharedElementTransition2 = sharedElementTransition;
            if (enterTransition == null && exitTransition == null && sharedElementTransition2 == null) {
                return null;
            }
            callSharedElementStartEnd(inFragment, outFragment, inIsPop, outSharedElements, true);
            ...
            OneShotPreDrawListener.add(sceneRoot, new Runnable() { // from class: android.app.-$$Lambda$FragmentTransition$Ip0LktADPhG_3ouNBXgzufWpFfY
                @Override // java.lang.Runnable
                public final void run() {
                    FragmentTransition.lambda$configureSharedElementsOrdered$3(ArrayMap.this, sharedElementTransition2, fragments, sharedElementsIn, nonExistentView, inFragment, outFragment, inIsPop, sharedElementsOut, enterTransition, inEpicenter2);
                }
            });
            return sharedElementTransition2;
        }
    ...
    /* JADX WARN: Removed duplicated region for block: B:99:0x011f A[ADDED_TO_REGION] */
    /*
        Code decompiled incorrectly, please refer to instructions dump.
        To view partially-correct add '--show-bad-code' argument
    */
    private static void addToFirstInLastOut(android.app.BackStackRecord r23, android.app.BackStackRecord.Op r24, android.util.SparseArray<android.app.FragmentTransition.FragmentContainerTransition> r25, boolean r26, boolean r27) {
        /*

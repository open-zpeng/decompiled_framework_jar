...
public interface IStopUserCallback extends IInterface {
    synchronized void userStopAborted(int i) throws RemoteException;

    private protected void userStopped(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IStopUserCallback {
        ...
        public static synchronized IStopUserCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements IStopUserCallback {
            ...
            public synchronized void userStopped(int userId) throws RemoteException {
            ...
            public synchronized void userStopAborted(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

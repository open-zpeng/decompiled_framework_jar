...
public final class ConfigurationStats implements Parcelable {
    ...
    private protected int mActivationCount;
    private protected long mBeginTimeStamp;
    private protected Configuration mConfiguration;
    private protected long mEndTimeStamp;
    private protected long mLastTimeActive;
    private protected long mTotalTimeActive;

    public synchronized ConfigurationStats() {
    }

...
public class StorageStatsManager {
    ...
    public synchronized StorageStatsManager(Context context, IStorageStatsManager service) {
    ...
    @Deprecated
    private protected boolean isQuotaSupported(String uuid) {
    ...
    @Deprecated
    private protected long getTotalBytes(String uuid) throws IOException {
    ...
    @Deprecated
    private protected long getFreeBytes(String uuid) throws IOException {
        return getFreeBytes(StorageManager.convert(uuid));
    }

    public synchronized long getCacheBytes(UUID storageUuid) throws IOException {
        try {
    ...
    @Deprecated
    public synchronized long getCacheBytes(String uuid) throws IOException {
    ...
    @Deprecated
    private protected StorageStats queryStatsForPackage(String uuid, String packageName, UserHandle user) throws PackageManager.NameNotFoundException, IOException {
    ...
    @Deprecated
    private protected StorageStats queryStatsForUid(String uuid, int uid) throws IOException {
    ...
    @Deprecated
    private protected StorageStats queryStatsForUser(String uuid, UserHandle user) throws IOException {
    ...
    @Deprecated
    private protected ExternalStorageStats queryExternalStatsForUser(String uuid, UserHandle user) throws IOException {
        return queryExternalStatsForUser(StorageManager.convert(uuid), user);
    }

    public synchronized long getCacheQuotaBytes(String volumeUuid, int uid) {
        try {

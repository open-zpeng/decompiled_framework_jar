...
public final class UsageStatsManager {
    ...
    public protected static final UsageEvents sEmptyResults = new UsageEvents();
    public protected final Context mContext;
    public protected final IUsageStatsManager mService;
    ...
    public synchronized UsageStatsManager(Context context, IUsageStatsManager service) {
    ...
    public synchronized void setAppInactive(String packageName, boolean inactive) {
        try {
    ...
    public static synchronized String reasonToString(int standbyReason) {
    ...
    public synchronized void onCarrierPrivilegedAppsChanged() {
        try {
    ...
    public synchronized void reportChooserSelection(String packageName, int userId, String contentType, String[] annotations, String action) {
        try {

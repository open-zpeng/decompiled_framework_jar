...
public class ApplicationErrorReport implements Parcelable {
    ...
    synchronized ApplicationErrorReport(Parcel in) {
        readFromParcel(in);
    }
    ...
    static synchronized ComponentName getErrorReportReceiver(PackageManager pm, String errorPackage, String receiverPackage) {
    ...
    public static class CrashInfo {
        ...
        public synchronized void appendStackTrace(String tr) {
            this.stackTrace = sanitizeString(this.stackTrace + tr);
        }

        private synchronized String sanitizeString(String s) {
    ...
    public static class ParcelableCrashInfo extends CrashInfo implements Parcelable {
        ...
        public synchronized ParcelableCrashInfo() {
        }

        public synchronized ParcelableCrashInfo(Throwable tr) {
            super(tr);
        }

        public synchronized ParcelableCrashInfo(Parcel in) {
            super(in);
        }

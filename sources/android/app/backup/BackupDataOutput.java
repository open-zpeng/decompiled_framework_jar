...
public class BackupDataOutput {
    public private protected long mBackupWriter;
    ...
    public synchronized BackupDataOutput(FileDescriptor fd, long quota, int transportFlags) {
        if (fd == null) {
    ...
    public synchronized void setKeyPrefix(String keyPrefix) {

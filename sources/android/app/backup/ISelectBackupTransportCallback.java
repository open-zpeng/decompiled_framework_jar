...
public interface ISelectBackupTransportCallback extends IInterface {
    synchronized void onFailure(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ISelectBackupTransportCallback {
        ...
        public static synchronized ISelectBackupTransportCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements ISelectBackupTransportCallback {
            ...
            public synchronized void onSuccess(String transportName) throws RemoteException {
            ...
            @Override // android.app.backup.ISelectBackupTransportCallback
            public synchronized void onFailure(int reason) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

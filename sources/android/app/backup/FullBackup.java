...
public class FullBackup {
    ...
    public static synchronized BackupScheme getBackupSchemeForTest(Context context) {
    ...
    public static synchronized void restoreFile(ParcelFileDescriptor data, long size, int type, long mode, long mtime, File outFile) throws IOException {
        long j = 0;
        if (type == 2) {
            if (outFile != null) {
                outFile.mkdirs();
    ...
    public static class BackupScheme {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized String tokenToDirectoryPath(String domainToken) {
            try {
        ...
        private synchronized String sharedDomainToPath(String domain) throws IOException {
        ...
        private synchronized StorageVolume[] getVolumeList() {
        ...
        public static class PathWithRequiredFlags {
            ...
            public synchronized PathWithRequiredFlags(String path, int requiredFlags) {
                this.mPath = path;
            ...
            public synchronized int getRequiredFlags() {
                return this.mRequiredFlags;
            }
        }

        synchronized BackupScheme(Context context) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized boolean isFullBackupContentEnabled() {
        ...
        private synchronized void maybeParseBackupSchemeLocked() throws IOException, XmlPullParserException {
        ...
        @VisibleForTesting
        public synchronized void parseBackupSchemeFromXmlLocked(XmlPullParser parser, Set<PathWithRequiredFlags> excludes, Map<String, Set<PathWithRequiredFlags>> includes) throws IOException, XmlPullParserException {
        ...
        private synchronized int getRequiredFlagsFromString(String requiredFlags) {
        ...
        private synchronized Set<PathWithRequiredFlags> parseCurrentTagForDomain(XmlPullParser parser, Set<PathWithRequiredFlags> excludes, Map<String, Set<PathWithRequiredFlags>> includes, String domain) throws XmlPullParserException {
            if (TAG_INCLUDE.equals(parser.getName())) {
        ...
        private synchronized String getTokenForXmlDomain(String xmlDomain) {
        ...
        private synchronized File extractCanonicalFile(File domain, String filePathFromXml) {
        ...
        private synchronized File getDirectoryForCriteriaDomain(String domain) {
        ...
        private synchronized void validateInnerTagContents(XmlPullParser parser) throws XmlPullParserException {
            if (parser == null) {
                return;
            }

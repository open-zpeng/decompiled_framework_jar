...
public interface IBackupObserver extends IInterface {
    synchronized void backupFinished(int i) throws RemoteException;

    synchronized void onResult(String str, int i) throws RemoteException;

    synchronized void onUpdate(String str, BackupProgress backupProgress) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IBackupObserver {
        ...
        public static synchronized IBackupObserver asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements IBackupObserver {
            ...
            public synchronized void onUpdate(String currentPackage, BackupProgress backupProgress) throws RemoteException {
            ...
            @Override // android.app.backup.IBackupObserver
            public synchronized void onResult(String target, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.app.backup.IBackupObserver
            public synchronized void backupFinished(int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(status);

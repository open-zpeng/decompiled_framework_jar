...
public class BackupHelperDispatcher {
    ...
    public static class Header {
        public private protected int chunkSize;
        public private protected String keyPrefix;

        private synchronized Header() {
        }
    }

    public synchronized void addHelper(String keyPrefix, BackupHelper helper) {
        this.mHelpers.put(keyPrefix, helper);
    }

    public synchronized void performBackup(ParcelFileDescriptor oldState, BackupDataOutput data, ParcelFileDescriptor newState) throws IOException {
    ...
    private synchronized void doOneBackup(ParcelFileDescriptor oldState, BackupDataOutput data, ParcelFileDescriptor newState, Header header, BackupHelper helper) throws IOException {
    ...
    public synchronized void performRestore(BackupDataInput input, int appVersionCode, ParcelFileDescriptor newState) throws IOException {

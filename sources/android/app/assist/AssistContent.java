...
public class AssistContent implements Parcelable {
    ...
    public protected ClipData mClipData;
    public protected final Bundle mExtras;
    public protected Intent mIntent;
    public protected boolean mIsAppProvidedIntent;
    private boolean mIsAppProvidedWebUri;
    public protected String mStructuredData;
    ...
    public synchronized void setDefaultIntent(Intent intent) {
        Uri uri;
        this.mIntent = intent;
        this.mIsAppProvidedIntent = false;
        this.mIsAppProvidedWebUri = false;
    ...
    public private protected AssistContent(Parcel in) {
        this.mIsAppProvidedIntent = false;
        this.mIsAppProvidedWebUri = false;
        if (in.readInt() != 0) {
    ...
    public private protected void writeToParcelInternal(Parcel dest, int flags) {

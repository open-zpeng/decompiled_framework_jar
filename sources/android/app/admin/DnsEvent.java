...
public final class DnsEvent extends NetworkEvent implements Parcelable {
    ...
    public synchronized DnsEvent(String hostname, String[] ipAddresses, int ipAddressesCount, String packageName, long timestamp) {
    ...
    private synchronized DnsEvent(Parcel in) {
    ...
    public String toString() {
        ...
        objArr[2] = this.mIpAddresses == null ? "NONE" : String.join(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER, this.mIpAddresses);

...
public class SecurityLogTags {
    ...
    private synchronized SecurityLogTags() {
    }

    public static synchronized void writeSecurityAdbShellInteractive() {
        EventLog.writeEvent(210001, new Object[0]);
    }

    public static synchronized void writeSecurityAdbShellCommand(String command) {
        EventLog.writeEvent(210002, command);
    }

    public static synchronized void writeSecurityAdbSyncRecv(String path) {
        EventLog.writeEvent(210003, path);
    }

    public static synchronized void writeSecurityAdbSyncSend(String path) {
        EventLog.writeEvent(210004, path);
    }

    public static synchronized void writeSecurityAppProcessStart(String process, long startTime, int uid, int pid, String seinfo, String sha256) {
        EventLog.writeEvent(210005, process, Long.valueOf(startTime), Integer.valueOf(uid), Integer.valueOf(pid), seinfo, sha256);
    }

    public static synchronized void writeSecurityKeyguardDismissed() {
        EventLog.writeEvent(210006, new Object[0]);
    }

    public static synchronized void writeSecurityKeyguardDismissAuthAttempt(int success, int methodStrength) {
        EventLog.writeEvent(210007, Integer.valueOf(success), Integer.valueOf(methodStrength));
    }

    public static synchronized void writeSecurityKeyguardSecured() {
        EventLog.writeEvent(210008, new Object[0]);
    }

    public static synchronized void writeSecurityOsStartup(String bootState, String verityMode) {
        EventLog.writeEvent(210009, bootState, verityMode);
    }

    public static synchronized void writeSecurityOsShutdown() {
        EventLog.writeEvent(210010, new Object[0]);
    }

    public static synchronized void writeSecurityLoggingStarted() {
        EventLog.writeEvent(210011, new Object[0]);
    }

    public static synchronized void writeSecurityLoggingStopped() {
        EventLog.writeEvent(210012, new Object[0]);
    }

    public static synchronized void writeSecurityMediaMounted(String path, String label) {
        EventLog.writeEvent(210013, path, label);
    }

    public static synchronized void writeSecurityMediaUnmounted(String path, String label) {
        EventLog.writeEvent(210014, path, label);
    }

    public static synchronized void writeSecurityLogBufferSizeCritical() {
        EventLog.writeEvent(210015, new Object[0]);
    }

    public static synchronized void writeSecurityPasswordExpirationSet(String package_, int adminUser, int targetUser, long timeout) {
        EventLog.writeEvent(210016, package_, Integer.valueOf(adminUser), Integer.valueOf(targetUser), Long.valueOf(timeout));
    }

    public static synchronized void writeSecurityPasswordComplexitySet(String package_, int adminUser, int targetUser, int length, int quality, int numLetters, int numNonLetters, int numNumeric, int numUppercase, int numLowercase, int numSymbols) {
    ...
    public static synchronized void writeSecurityPasswordHistoryLengthSet(String package_, int adminUser, int targetUser, int length) {
        EventLog.writeEvent(210018, package_, Integer.valueOf(adminUser), Integer.valueOf(targetUser), Integer.valueOf(length));
    }

    public static synchronized void writeSecurityMaxScreenLockTimeoutSet(String package_, int adminUser, int targetUser, long timeout) {
        EventLog.writeEvent(210019, package_, Integer.valueOf(adminUser), Integer.valueOf(targetUser), Long.valueOf(timeout));
    }

    public static synchronized void writeSecurityMaxPasswordAttemptsSet(String package_, int adminUser, int targetUser, int numFailures) {
        EventLog.writeEvent(210020, package_, Integer.valueOf(adminUser), Integer.valueOf(targetUser), Integer.valueOf(numFailures));
    }

    public static synchronized void writeSecurityKeyguardDisabledFeaturesSet(String package_, int adminUser, int targetUser, int features) {
        EventLog.writeEvent(210021, package_, Integer.valueOf(adminUser), Integer.valueOf(targetUser), Integer.valueOf(features));
    }

    public static synchronized void writeSecurityRemoteLock(String package_, int adminUser, int targetUser) {
        EventLog.writeEvent(210022, package_, Integer.valueOf(adminUser), Integer.valueOf(targetUser));
    }

    public static synchronized void writeSecurityWipeFailed(String package_, int adminUser) {
        EventLog.writeEvent(210023, package_, Integer.valueOf(adminUser));
    }

    public static synchronized void writeSecurityKeyGenerated(int success, String keyId, int uid) {
        EventLog.writeEvent(210024, Integer.valueOf(success), keyId, Integer.valueOf(uid));
    }

    public static synchronized void writeSecurityKeyImported(int success, String keyId, int uid) {
        EventLog.writeEvent(210025, Integer.valueOf(success), keyId, Integer.valueOf(uid));
    }

    public static synchronized void writeSecurityKeyDestroyed(int success, String keyId, int uid) {
        EventLog.writeEvent(210026, Integer.valueOf(success), keyId, Integer.valueOf(uid));
    }

    public static synchronized void writeSecurityUserRestrictionAdded(String package_, int adminUser, String restriction) {
        EventLog.writeEvent(210027, package_, Integer.valueOf(adminUser), restriction);
    }

    public static synchronized void writeSecurityUserRestrictionRemoved(String package_, int adminUser, String restriction) {
        EventLog.writeEvent(210028, package_, Integer.valueOf(adminUser), restriction);
    }

    public static synchronized void writeSecurityCertAuthorityInstalled(int success, String subject) {
        EventLog.writeEvent(210029, Integer.valueOf(success), subject);
    }

    public static synchronized void writeSecurityCertAuthorityRemoved(int success, String subject) {
        EventLog.writeEvent(210030, Integer.valueOf(success), subject);
    }

    public static synchronized void writeSecurityCryptoSelfTestCompleted(int success) {
        EventLog.writeEvent(210031, success);
    }

    public static synchronized void writeSecurityKeyIntegrityViolation(String keyId, int uid) {
        EventLog.writeEvent(210032, keyId, Integer.valueOf(uid));
    }

    public static synchronized void writeSecurityCertValidationFailure(String reason) {

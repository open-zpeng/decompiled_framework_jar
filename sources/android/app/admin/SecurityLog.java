...
public class SecurityLog {
    ...
    public static synchronized void setLoggingEnabledProperty(boolean enabled) {
        SystemProperties.set(PROPERTY_LOGGING_ENABLED, enabled ? "true" : "false");
    }

    public static synchronized boolean getLoggingEnabledProperty() {
    ...
    public static final class SecurityEvent implements Parcelable {
        ...
        public private protected SecurityEvent(byte[] data) {
            this(0L, data);
        }

        synchronized SecurityEvent(Parcel source) {

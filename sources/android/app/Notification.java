...
public class Notification implements Parcelable {
    ...
    public static final int PRIORITY_SUGGEST = 3;
    private static final ArraySet<Integer> STANDARD_LAYOUTS = new ArraySet<>();
    @Deprecated
    public static final int STREAM_DEFAULT = -1;
    public static final int STYLE_DIY = 5;
    ...
    public static final String TYPE_ADVERTISMENT = "advertisment";
    ...
    public static class Action implements Parcelable {
        ...
        public Action(Bitmap bitmap, CharSequence title, PendingIntent intent) {
            this(Icon.createWithBitmap(bitmap), title, intent, new Bundle(), null, true, 0, false);
        }
    ...
    public Notification() {
        ...
        this.displayFlag = -1;
        this.clearFlag = -1;
        this.majorType = "default";
        this.msgMajorPriority = 2;
        this.viewStyle = 1;
    ...
    private void readFromParcelImpl(Parcel parcel) {
        ...
        this.msgMajorPriority = parcel.readInt();
    ...
    public void cloneInto(Notification that, boolean heavy) {
        ...
        if (heavy && (remoteViews4 = this.tickerView) != null) {
            that.tickerView = remoteViews4.mo11clone();
        }
        if (heavy && (remoteViews3 = this.contentView) != null) {
            that.contentView = remoteViews3.mo11clone();
        }
        ...
        if (actionArr != null) {
            ...
            while (true) {
                ...
                if (actionArr2[i] != null) {
                    that.actions[i] = actionArr2[i].m9clone();
                }
                i++;
            }
        }
        if (heavy && (remoteViews2 = this.bigContentView) != null) {
            that.bigContentView = remoteViews2.mo11clone();
        }
        if (heavy && (remoteViews = this.headsUpContentView) != null) {
            that.headsUpContentView = remoteViews.mo11clone();
        }
        ...
        that.msgMajorPriority = this.msgMajorPriority;
        that.viewStyle = this.viewStyle;
    }
    ...
    private void writeToParcelImpl(Parcel parcel, int flags) {
        ...
        parcel.writeInt(this.msgMajorPriority);
    ...
    public static class ViewStyle {
        ...
        public ViewStyle setStyle(int style) {
            this.style = style;
            return this;
        }

        public ViewStyle bigPicture(Bitmap bigPicture) {
            this.bigPicture = bigPicture;
            return this;
        }

        public ViewStyle setIcon(Bitmap icon) {
            this.icon = icon;
            return this;
        }

        public ViewStyle setTitleGravity(int gravity) {
    ...
    public static class Builder {
        ...
        public Builder setMajorType(String majorType) {
            this.mN.majorType = majorType;
            return this;
        }

        public Builder setMsgMajorPriority(int msgMajorPriority) {
            this.mN.msgMajorPriority = msgMajorPriority;
            return this;
        }

        public Builder setViewStyle(ViewStyle vs) {
            this.mN.viewStyle = vs.style;
            this.mN.extras.putParcelable("bigPicture", vs.bigPicture);
            this.mN.extras.putParcelable("bigPictureIcon", vs.icon);
            this.mN.extras.putInt("bigPtTtGravity", vs.titleGravity);
            return this;
        }

        public Builder setAppName(String appName) {
            this.mN.extras.putString("appName", appName);
            return this;
        }

        public Builder setShowTime(boolean value) {
            this.mN.extras.putBoolean("setShowTime", value);
            return this;
        }

        public Builder setTtsText(String ttsText) {
            this.mN.extras.putString("setTtsText", ttsText);
            return this;
        }

        public Builder setShowLong(int value) {
            this.mN.extras.putInt("setShowLong", value);
            return this;
        }

        public Builder setShowTimeStyle(int value) {
            this.mN.extras.putInt("setShowTimeStyle", value);
            return this;
        }

        public Builder setSpeechArea(int[] value) {
            this.mN.extras.putIntArray("setSpeechArea", value);
            return this;
        }

        public Builder setSpeechWordListForActionOne(String[] value) {
            this.mN.extras.putStringArray("setSpeechWordListOne", value);
            return this;
        }

        public Builder setSpeechWordListForActionTwo(String[] value) {
            this.mN.extras.putStringArray("setSpeechWordListTwo", value);
            return this;
        }

        public Builder setMsgTmp(int value) {
            this.mN.extras.putInt("setMsgTmp", value);
            return this;
        }

        public Builder setSystemMsg(int value) {
            this.mN.extras.putInt("setSystemMsg", value);
            return this;
        }

        public Builder setEffectiveTime(long value) {
            this.mN.extras.putLong("setEffectiveTime", value);
            return this;
        }

        public Builder setSoundPlayTime(int value) {
            this.mN.extras.putInt("setSoundPlayTime", value);
            return this;
        }

        public Builder setSoundLoop(int value) {
            this.mN.extras.putInt("setSoundLoop", value);
            return this;
        }

        public Builder setLiveStatusbarText(String value) {
            this.mN.extras.putString("setLiveStatusbarText", value);
            return this;
        }

        public Builder setLiveStatusbarStyle(boolean value) {
            this.mN.extras.putBoolean("setLiveStatusbarStyle", value);
            return this;
        }
        ...
        public Builder addAction(Bitmap bitmap, CharSequence title, PendingIntent intent) {
            this.mActions.add(new Action(bitmap, Notification.safeCharSequence(title), intent));
            return this;
        }
        ...
        public RemoteViews applyStandardTemplate(int resId, StandardTemplateParams p, TemplateBindResult result) {
            ...
            if (p.text != null) {
                int textId = showProgress ? R.id.text_line_1 : R.id.text;
        ...
        private void bindLargeIconAndReply(RemoteViews contentView, StandardTemplateParams p, TemplateBindResult result) {
            ...
            contentView.setViewVisibility(R.id.right_icon_container, iconContainerVisible ? 0 : 8);
        ...
        public RemoteViews applyStandardTemplateWithActions(int layoutId, StandardTemplateParams p, TemplateBindResult result) {
            ...
            if (validRemoteInput && replyText != null && replyText.length > 0 && !TextUtils.isEmpty(replyText[0]) && p.maxRemoteInputHistory > 0) {
                ...
                big.setViewVisibility(R.id.notification_material_reply_progress, showSpinner ? 0 : 8);
        ...
        public RemoteViews makePublicContentView(boolean isLowPriority) {
            ...
            StandardTemplateParams params = this.mParams.reset().fillTextsFrom(this);
            if (isLowPriority) {
        ...
        private RemoteViews generateActionButton(Action action, boolean emphazisedMode, StandardTemplateParams p) {
            ...
            if (!emphazisedMode) {
                ...
                button.setColorStateList(R.id.action0, "setRippleColor", ColorStateList.valueOf(rippleColor2));
    ...
    public static class MessagingStyle extends Style {
        ...
        private RemoteViews makeMessagingView(boolean displayImagesAtEnd, boolean hideRightIcons) {
            ...
            contentView.setInt(R.id.status_bar_latest_event_content, "setLayoutColor", this.mBuilder.isColorized(p) ? this.mBuilder.getPrimaryTextColor(p) : this.mBuilder.resolveContrastColor(p));
    ...
    public static class MediaStyle extends Style {
        ...
        private RemoteViews makeMediaBigContentView() {
            ...
            if (this.mBuilder.mN.hasLargeIcon() || actionCount > actionsInCompact) {
                ...
                bindMediaActionButton(big, R.id.media_seamless, new Action((int) R.drawable.ic_media_seamless, this.mBuilder.mContext.getString(R.string.ext_media_seamless_action), (PendingIntent) null), p);

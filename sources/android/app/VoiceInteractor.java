...
public final class VoiceInteractor {
    ...
    public static abstract class Request {
        ...
        abstract synchronized IVoiceInteractorRequest submit(IVoiceInteractor iVoiceInteractor, String str, IVoiceInteractorCallback iVoiceInteractorCallback) throws RemoteException;
        ...
        synchronized String getRequestTypeName() {
            return "Request";
        }
    ...
    public static class ConfirmationRequest extends Request {
        ...
        public synchronized ConfirmationRequest(CharSequence prompt, Bundle extras) {
        ...
        @Override // android.app.VoiceInteractor.Request
        synchronized IVoiceInteractorRequest submit(IVoiceInteractor interactor, String packageName, IVoiceInteractorCallback callback) throws RemoteException {
    ...
    public static class PickOptionRequest extends Request {
        ...
        public static final class Option implements Parcelable {
            ...
            public synchronized Option(CharSequence label) {
                this.mLabel = label;
                this.mIndex = -1;
            }
        ...
        public synchronized PickOptionRequest(CharSequence prompt, Option[] options, Bundle extras) {
            this.mPrompt = prompt != null ? new Prompt(prompt) : null;
            this.mOptions = options;
            this.mExtras = extras;
        }
    ...
    public static class CompleteVoiceRequest extends Request {
        ...
        public synchronized CompleteVoiceRequest(CharSequence message, Bundle extras) {
    ...
    public static class AbortVoiceRequest extends Request {
        ...
        public synchronized AbortVoiceRequest(CharSequence message, Bundle extras) {
            this.mPrompt = message != null ? new Prompt(message) : null;
            this.mExtras = extras;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized VoiceInteractor(IVoiceInteractor interactor, Context context, Activity activity, Looper looper) {
    ...
    synchronized Request pullRequest(IVoiceInteractorRequest request, boolean complete) {
        Request req;
    ...
    private synchronized ArrayList<Request> makeRequestList() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void attachActivity(Activity activity) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void retainInstance() {

...
public class LocalActivityManager {
    ...
    public protected final Activity mParent;
    public protected LocalActivityRecord mResumed;
    public protected boolean mSingleMode;
    public protected final Map<String, LocalActivityRecord> mActivities = new HashMap();
    public protected final ArrayList<LocalActivityRecord> mActivityArray = new ArrayList<>();
    ...
    public static class LocalActivityRecord extends Binder {
        ...
        synchronized LocalActivityRecord(String _id, Intent _intent) {
            this.id = _id;
            this.intent = _intent;
        }
    }
    ...
    public protected void moveToState(LocalActivityRecord r, int desiredState) {
        ...
        if (r.curState == 1) {
            ...
            r.activity = this.mActivityThread.startActivityNow(this.mParent, r.id, r.intent, r.activityInfo, r, r.instanceState, instance2);
            if (r.activity == null) {
                return;
            }
    ...
    private synchronized void performPause(LocalActivityRecord r, boolean finishing) {
    ...
    private synchronized Window performDestroy(LocalActivityRecord r, boolean finish) {
        Window win = r.window;
    ...
    public synchronized HashMap<String, Object> dispatchRetainNonConfigurationInstance() {
        Object instance;
    ...
    public void dispatchDestroy(boolean finishing) {
        ...
        for (int i = 0; i < N; i++) {
            LocalActivityRecord r = this.mActivityArray.get(i);
            this.mActivityThread.performDestroyActivity(r, finishing, 0, false, "LocalActivityManager::dispatchDestroy");
        }

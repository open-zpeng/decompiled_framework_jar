...
public class MediaRouteActionProvider extends ActionProvider {
    ...
    public synchronized void refreshRoute() {
        refreshVisibility();
    }
    ...
    public static class MediaRouterCallback extends MediaRouter.SimpleCallback {
        ...
        public synchronized MediaRouterCallback(MediaRouteActionProvider provider) {
        ...
        private synchronized void refreshRoute(MediaRouter router) {

...
public class DialogFragment extends Fragment implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    Dialog mDialog;
    public private protected boolean mDismissed;
    public private protected boolean mShownByMe;
    public private protected boolean mViewDestroyed;
    int mStyle = 0;
    int mTheme = 0;
    boolean mCancelable = true;
    boolean mShowsDialog = true;
    public private protected int mBackStackId = -1;
    ...
    private protected void showAllowingStateLoss(FragmentManager manager, String tag) {
        this.mDismissed = false;
        this.mShownByMe = true;
        FragmentTransaction ft = manager.beginTransaction();
        ft.add(this, tag);
    ...
    synchronized void dismissInternal(boolean allowStateLoss) {
        if (this.mDismissed) {
            return;
        }

...
public class TaskStackBuilder {
    ...
    private synchronized TaskStackBuilder(Context a) {
    ...
    public synchronized int startActivities(Bundle options, UserHandle userHandle) {
    ...
    public synchronized PendingIntent getPendingIntent(int requestCode, int flags, Bundle options, UserHandle user) {
        if (this.mIntents.isEmpty()) {
            throw new IllegalStateException("No intents added to TaskStackBuilder; cannot getPendingIntent");
        }

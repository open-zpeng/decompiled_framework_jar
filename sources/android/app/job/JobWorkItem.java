...
public final class JobWorkItem implements Parcelable {
    ...
    public private protected int mDeliveryCount;
    public private protected Object mGrants;
    public private protected final Intent mIntent;
    final long mNetworkDownloadBytes;
    final long mNetworkUploadBytes;
    public private protected int mWorkId;
    ...
    @Deprecated
    private protected JobWorkItem(Intent intent, long networkBytes) {
    ...
    public synchronized void bumpDeliveryCount() {
        this.mDeliveryCount++;
    }

    public synchronized void setWorkId(int id) {
        this.mWorkId = id;
    }

    public synchronized int getWorkId() {
        return this.mWorkId;
    }

    public synchronized void setGrants(Object grants) {
        this.mGrants = grants;
    }

    public synchronized Object getGrants() {
        return this.mGrants;
    }
    ...
    public private protected JobWorkItem(Parcel in) {
        if (in.readInt() != 0) {

...
public class JobParameters implements Parcelable {
    ...
    public protected final IBinder callback;
    ...
    public static synchronized String getReasonName(int reason) {
        switch (reason) {
            case 0:
                return "canceled";
            case 1:
    ...
    public synchronized JobParameters(IBinder callback, int jobId, PersistableBundle extras, Bundle transientExtras, ClipData clipData, int clipGrantFlags, boolean overrideDeadlineExpired, Uri[] triggeredContentUris, String[] triggeredContentAuthorities, Network network) {
        this.jobId = jobId;
        this.extras = extras;
    ...
    public synchronized int getStopReason() {
        return this.stopReason;
    }

    public synchronized String getDebugStopReason() {
    ...
    private synchronized JobParameters(Parcel in) {
    ...
    public synchronized void setStopReason(int reason, String debugStopReason) {

...
public abstract class JobServiceEngine {
    ...
    static final class JobInterface extends IJobService.Stub {
        ...
        synchronized JobInterface(JobServiceEngine service) {
    ...
    class JobHandler extends Handler {
        ...
        private synchronized void ackStartMessage(JobParameters params, boolean workOngoing) {
            IJobCallback callback = params.getCallback();
        ...
        private synchronized void ackStopMessage(JobParameters params, boolean reschedule) {
            IJobCallback callback = params.getCallback();
            int jobId = params.getJobId();
            if (callback != null) {
                try {

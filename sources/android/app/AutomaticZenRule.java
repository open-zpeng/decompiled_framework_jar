...
public final class AutomaticZenRule implements Parcelable {
    ...
    public synchronized AutomaticZenRule(String name, ComponentName owner, Uri conditionId, int interruptionFilter, boolean enabled, long creationTime) {
    ...
    public boolean equals(Object o) {
        if (o instanceof AutomaticZenRule) {
            ...
            return other.enabled == this.enabled && Objects.equals(other.name, this.name) && other.interruptionFilter == this.interruptionFilter && Objects.equals(other.conditionId, this.conditionId) && Objects.equals(other.owner, this.owner) && other.creationTime == this.creationTime;
        }
        return false;
    }

...
public class SearchManager implements DialogInterface.OnDismissListener, DialogInterface.OnCancelListener {
    ...
    private protected static final String DISABLE_VOICE_SEARCH = "android.search.DISABLE_VOICE_SEARCH";
    ...
    public protected SearchDialog mSearchDialog;
    ...
    public private protected SearchManager(Context context, Handler handler) throws ServiceManager.ServiceNotFoundException {
    ...
    private protected void startSearch(String initialQuery, boolean selectInitialQuery, ComponentName launchActivity, Bundle appSearchData, boolean globalSearch, Rect sourceBounds) {
        if (globalSearch) {
    ...
    private synchronized void ensureSearchDialog() {
    ...
    synchronized void startGlobalSearch(String initialQuery, boolean selectInitialQuery, Bundle appSearchData, Rect sourceBounds) {
    ...
    public synchronized List<ResolveInfo> getGlobalSearchActivities() {
        try {
    ...
    private protected ComponentName getWebSearchActivity() {
        try {
    ...
    private protected Cursor getSuggestions(SearchableInfo searchable, String query) {
    ...
    public synchronized Intent getAssistIntent(boolean inclContext) {
        try {
    ...
    private protected void launchAssist(Bundle args) {
        try {
    ...
    public synchronized boolean launchLegacyAssist(String hint, int userHandle, Bundle args) {
        try {
            if (this.mService == null) {
                return false;
            }

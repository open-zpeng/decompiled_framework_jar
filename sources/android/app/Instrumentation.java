...
public class Instrumentation {
    ...
    private synchronized void checkInstrumenting(String method) {
    ...
    public static class ActivityMonitor {
        ...
        final synchronized boolean ignoreMatchingSpecificIntents() {
        ...
        final synchronized boolean match(Context who, Activity activity, Intent intent) {
    ...
    public Activity newActivity(Class<?> clazz, Context context, IBinder token, Application application, Intent intent, ActivityInfo info, CharSequence title, Activity parent, String id, Object lastNonConfigurationInstance) throws InstantiationException, IllegalAccessException {
        ...
        activity.attach(context, null, this, token, 0, application == null ? new Application() : application, intent, info, title, parent, id, (Activity.NonConfigurationInstances) lastNonConfigurationInstance, new Configuration(), null, null, null, null);
        return activity;
    }
    ...
    private synchronized AppComponentFactory getFactory(String pkg) {
        if (pkg == null) {
    ...
    private synchronized void prePerformCreate(Activity activity) {
        if (this.mWaitingActivities != null) {
            synchronized (this.mSync) {
    ...
    private synchronized void postPerformCreate(Activity activity) {
        if (this.mActivityMonitors != null) {
            synchronized (this.mSync) {
    ...
    private synchronized void addValue(String key, int value, Bundle results) {
    ...
    public int execStartActivitiesAsUser(Context who, IBinder contextThread, IBinder token, Activity target, Intent[] intents, Bundle options, int userId) {
        ...
        try {
            ...
            int result2 = ActivityManager.getService().startActivities(whoThread, who.getBasePackageName(), intents, resolvedTypes, token, options, userId);
    ...
    public ActivityResult execStartActivity(Context who, IBinder contextThread, IBinder token, String target, Intent intent, int requestCode, Bundle options) {
        ...
        try {
            intent.migrateExtraStreamToClipData();
            intent.prepareToLeaveProcess(who);
            int result2 = ActivityManager.getService().startActivity(whoThread, who.getBasePackageName(), intent, intent.resolveTypeIfNeeded(who.getContentResolver()), token, target, requestCode, 0, null, options);
            checkStartActivityResult(result2, intent);
            return null;
        } catch (RemoteException e) {
            throw new RuntimeException("Failure from system", e);
    ...
    public ActivityResult execStartActivity(Context who, IBinder contextThread, IBinder token, String resultWho, Intent intent, int requestCode, Bundle options, UserHandle user) {
        ...
        try {
            intent.migrateExtraStreamToClipData();
            intent.prepareToLeaveProcess(who);
            int result2 = ActivityManager.getService().startActivityAsUser(whoThread, who.getBasePackageName(), intent, intent.resolveTypeIfNeeded(who.getContentResolver()), token, resultWho, requestCode, 0, null, options, user.getIdentifier());
            checkStartActivityResult(result2, intent);
            return null;
        } catch (RemoteException e) {
            throw new RuntimeException("Failure from system", e);
    ...
    public ActivityResult execStartActivityAsCaller(Context who, IBinder contextThread, IBinder token, Activity target, Intent intent, int requestCode, Bundle options, boolean ignoreTargetSecurity, int userId) {
        ...
        try {
            ...
            intent.prepareToLeaveProcess(who);
            try {
                result = ActivityManager.getService().startActivityAsCaller(whoThread, who.getBasePackageName(), intent, intent.resolveTypeIfNeeded(who.getContentResolver()), token, target != null ? target.mEmbeddedID : null, requestCode, 0, null, options, ignoreTargetSecurity, userId);
            } catch (RemoteException e) {
                e = e;
            }
        } catch (RemoteException e2) {
    ...
    public final synchronized void init(ActivityThread thread, Context instrContext, Context appContext, ComponentName component, IInstrumentationWatcher watcher, IUiAutomationConnection uiAutomationConnection) {
        this.mThread = thread;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void basicInit(ActivityThread thread) {
        this.mThread = thread;
    }
    ...
    private final synchronized void validateNotAppThread() {
    ...
    public static final class EmptyRunnable implements Runnable {
        private synchronized EmptyRunnable() {
        }
    ...
    public static final class SyncRunnable implements Runnable {
        ...
        public synchronized SyncRunnable(Runnable target) {
            this.mTarget = target;
        }
    ...
    public static final class ActivityWaiter {
        ...
        public synchronized ActivityWaiter(Intent _intent) {
            this.intent = _intent;
        }
    }
    ...
    public static final class Idler implements MessageQueue.IdleHandler {
        ...
        public synchronized Idler(Runnable callback) {

...
public final class RemoteInput implements Parcelable {
    ...
    private synchronized RemoteInput(String resultKey, CharSequence label, CharSequence[] choices, int flags, Bundle extras, ArraySet<String> allowedDataTypes) {
    ...
    private synchronized RemoteInput(Parcel in) {
    ...
    private static synchronized String getExtraResultsKeyForData(String mimeType) {
    ...
    private static synchronized Intent getClipDataIntentFromIntent(Intent intent) {

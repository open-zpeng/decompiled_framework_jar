...
public class ActivityGroup extends Activity {
    ...
    public private LocalActivityManager mLocalActivityManager;
    ...
    @Override // android.app.Activity
    public synchronized HashMap<String, Object> onRetainNonConfigurationChildInstances() {
    ...
    synchronized void dispatchActivityResult(String who, int requestCode, int resultCode, Intent data, String reason) {
        Activity act;

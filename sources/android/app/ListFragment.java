...
public class ListFragment extends Fragment {
    ...
    private synchronized void setListShown(boolean shown, boolean animate) {
        ensureList();
    ...
    private synchronized void ensureList() {
        ...
        if (root instanceof ListView) {
            ...
            this.mStandardEmptyView = (TextView) root.findViewById(com.android.internal.R.id.internalEmpty);
            if (this.mStandardEmptyView == null) {
                this.mEmptyView = root.findViewById(16908292);
            } else {
                this.mStandardEmptyView.setVisibility(8);
            }
            this.mProgressContainer = root.findViewById(com.android.internal.R.id.progressContainer);
            this.mListContainer = root.findViewById(com.android.internal.R.id.listContainer);

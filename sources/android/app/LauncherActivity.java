...
public abstract class LauncherActivity extends ListActivity {
    ...
    public static class ListItem {
        ...
        synchronized ListItem(PackageManager pm, ResolveInfo resolveInfo, IconResizer resizer) {
    ...
    public class ActivityAdapter extends BaseAdapter implements Filterable {
        ...
        public synchronized Intent intentForPosition(int position) {
        ...
        public synchronized ListItem itemForPosition(int position) {
            if (this.mActivitiesList == null) {
                return null;
            }
        ...
        private synchronized void bindView(View view, ListItem item) {
    ...
    private synchronized void updateAlertTitle() {
        TextView alertTitle = (TextView) findViewById(16908794);
        if (alertTitle != null) {
    ...
    protected synchronized void onSortResultList(List<ResolveInfo> results) {
    ...
    protected synchronized boolean onEvaluateShowIcons() {
        return true;
    }
}

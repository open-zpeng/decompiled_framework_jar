...
public class DatePickerDialog extends AlertDialog implements DialogInterface.OnClickListener, DatePicker.OnDateChangedListener {
    ...
    public protected final DatePicker mDatePicker;
    ...
    private synchronized DatePickerDialog(Context context, int themeResId, OnDateSetListener listener, Calendar calendar, int year, int monthOfYear, int dayOfMonth) {
        ...
        this.mDatePicker = (DatePicker) view.findViewById(16908917);

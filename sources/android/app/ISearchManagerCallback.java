...
public interface ISearchManagerCallback extends IInterface {
    ...
    synchronized void onDismiss() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ISearchManagerCallback {
        ...
        public static synchronized ISearchManagerCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ISearchManagerCallback {
            ...
            public synchronized void onDismiss() throws RemoteException {

...
public class ProfilerInfo implements Parcelable {
    ...
    public synchronized ProfilerInfo(String filename, ParcelFileDescriptor fd, int interval, boolean autoStop, boolean streaming, String agent, boolean attachAgentDuringBind) {
    ...
    public synchronized ProfilerInfo(ProfilerInfo in) {
    ...
    public synchronized ProfilerInfo setAgent(String agent, boolean attachAgentDuringBind) {
    ...
    public synchronized void closeFd() {
    ...
    private synchronized ProfilerInfo(Parcel in) {
    ...
    public int hashCode() {
        int result = (31 * 17) + Objects.hashCode(this.profileFile);
        return (31 * ((31 * ((31 * ((31 * result) + this.samplingInterval)) + (this.autoStopProfiler ? 1 : 0))) + (this.streamingOutput ? 1 : 0))) + Objects.hashCode(this.agent);
    }
}

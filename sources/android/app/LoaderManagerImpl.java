...
public class LoaderManagerImpl extends LoaderManager {
    ...
    public final class LoaderInfo implements Loader.OnLoadCompleteListener<Object>, Loader.OnLoadCanceledListener<Object> {
        ...
        synchronized void finishRetain() {
            if (this.mRetaining) {
                if (LoaderManagerImpl.DEBUG) {
        ...
        public synchronized void onLoadCanceled(Loader<Object> loader) {
            if (LoaderManagerImpl.DEBUG) {
        ...
        public synchronized void onLoadComplete(Loader<Object> loader, Object data) {
            if (LoaderManagerImpl.DEBUG) {
        ...
        synchronized void callOnLoadFinished(Loader<Object> loader, Object data) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized LoaderManagerImpl(String who, FragmentHostCallback host, boolean started) {
        this.mWho = who;
        this.mHost = host;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void updateHostController(FragmentHostCallback host) {
        this.mHost = host;
    }

    @Override // android.app.LoaderManager
    public synchronized FragmentHostCallback getFragmentHostCallback() {
        return this.mHost;
    }

    private synchronized LoaderInfo createLoader(int id, Bundle args, LoaderManager.LoaderCallbacks<Object> callback) {
    ...
    private synchronized LoaderInfo createAndInstallLoader(int id, Bundle args, LoaderManager.LoaderCallbacks<Object> callback) {
        try {
    ...
    synchronized void installLoader(LoaderInfo info) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void doRetain() {
        if (DEBUG) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void finishRetain() {
        if (this.mRetaining) {
            if (DEBUG) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void doReportNextStart() {
        for (int i = this.mLoaders.size() - 1; i >= 0; i--) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void doReportStart() {
        for (int i = this.mLoaders.size() - 1; i >= 0; i--) {
    ...
    public synchronized boolean hasRunningLoaders() {

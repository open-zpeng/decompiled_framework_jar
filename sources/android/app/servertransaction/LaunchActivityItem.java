...
public class LaunchActivityItem extends ClientTransactionItem {
    ...
    public boolean equals(Object o) {
        ...
        if ((this.mIntent == null && other.mIntent == null) || ((intent = this.mIntent) != null && intent.filterEquals(other.mIntent))) {
            intentsEqual = true;
        } else {
            intentsEqual = false;
        }
    ...
    public int hashCode() {
        ...
        int result2 = ((((((((((((result * 31) + this.mIdent) * 31) + Objects.hashCode(this.mCurConfig)) * 31) + Objects.hashCode(this.mOverrideConfig)) * 31) + Objects.hashCode(this.mCompatInfo)) * 31) + Objects.hashCode(this.mReferrer)) * 31) + Objects.hashCode(Integer.valueOf(this.mProcState))) * 31;
        Bundle bundle = this.mState;
        int result3 = (result2 + (bundle != null ? bundle.size() : 0)) * 31;
        PersistableBundle persistableBundle = this.mPersistentState;
        return ((((((((((result3 + (persistableBundle != null ? persistableBundle.size() : 0)) * 31) + Objects.hashCode(this.mPendingResults)) * 31) + Objects.hashCode(this.mPendingNewIntents)) * 31) + (this.mIsForward ? 1 : 0)) * 31) + Objects.hashCode(this.mProfilerInfo)) * 31) + Objects.hashCode(this.mAssistToken);
    }

...
public class ConfigurationChangeItem extends ClientTransactionItem {
    ...
    private synchronized ConfigurationChangeItem() {
    }

    public static synchronized ConfigurationChangeItem obtain(Configuration config) {
    ...
    private synchronized ConfigurationChangeItem(Parcel in) {

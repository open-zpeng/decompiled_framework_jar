...
public class MoveToDisplayItem extends ClientTransactionItem {
    ...
    private synchronized MoveToDisplayItem() {
    }

    public static synchronized MoveToDisplayItem obtain(int targetDisplayId, Configuration configuration) {
    ...
    private synchronized MoveToDisplayItem(Parcel in) {
    ...
    public int hashCode() {
        int result = (31 * 17) + this.mTargetDisplayId;
        return (31 * result) + this.mConfiguration.hashCode();
    }

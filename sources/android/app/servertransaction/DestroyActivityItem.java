...
public class DestroyActivityItem extends ActivityLifecycleItem {
    ...
    private synchronized DestroyActivityItem() {
    }

    public static synchronized DestroyActivityItem obtain(boolean finished, int configChanges) {
    ...
    private synchronized DestroyActivityItem(Parcel in) {

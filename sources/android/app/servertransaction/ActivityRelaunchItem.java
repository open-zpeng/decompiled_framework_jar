...
public class ActivityRelaunchItem extends ClientTransactionItem {
    ...
    private synchronized ActivityRelaunchItem() {
    }

    public static synchronized ActivityRelaunchItem obtain(List<ResultInfo> pendingResults, List<ReferrerIntent> pendingNewIntents, int configChanges, MergedConfiguration config, boolean preserveWindow) {
    ...
    private synchronized ActivityRelaunchItem(Parcel in) {
    ...
    public int hashCode() {
        int result = (31 * 17) + Objects.hashCode(this.mPendingResults);
        return (31 * ((31 * ((31 * ((31 * result) + Objects.hashCode(this.mPendingNewIntents))) + this.mConfigChanges)) + Objects.hashCode(this.mConfig))) + (this.mPreserveWindow ? 1 : 0);
    }

...
public class StopActivityItem extends ActivityLifecycleItem {
    ...
    private synchronized StopActivityItem() {
    }

    public static synchronized StopActivityItem obtain(boolean showWindow, int configChanges) {
    ...
    private synchronized StopActivityItem(Parcel in) {
    ...
    public int hashCode() {
        int result = (31 * 17) + (this.mShowWindow ? 1 : 0);
        return (31 * result) + this.mConfigChanges;
    }

...
public class NativeActivity extends Activity implements SurfaceHolder.Callback2, InputQueue.Callback, ViewTreeObserver.OnGlobalLayoutListener {
    ...
    public protected long mNativeHandle;

    private native String getDlError();

    public protected native long loadNativeCode(String str, String str2, MessageQueue messageQueue, String str3, String str4, String str5, int i, AssetManager assetManager, byte[] bArr, ClassLoader classLoader, String str6);
    ...
    static class NativeContentView extends View {
        ...
        public synchronized NativeContentView(Context context) {
            super(context);
        }

        public synchronized NativeContentView(Context context, AttributeSet attrs) {
            super(context, attrs);
        }
    }
    ...
    private static synchronized String getAbsolutePath(File file) {
        if (file != null) {
    ...
    public private protected void setWindowFlags(int flags, int mask) {
        getWindow().setFlags(flags, mask);
    }

    public private protected void setWindowFormat(int format) {
        getWindow().setFormat(format);
    }

    public private protected void showIme(int mode) {
        this.mIMM.showSoftInput(this.mNativeContentView, mode);
    }

    public private protected void hideIme(int mode) {

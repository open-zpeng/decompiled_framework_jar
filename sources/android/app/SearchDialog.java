...
public class SearchDialog extends Dialog {
    ...
    static synchronized int resolveDialogTheme(Context context) {
        TypedValue outValue = new TypedValue();
        context.getTheme().resolveAttribute(R.attr.searchDialogTheme, outValue, true);
        return outValue.resourceId;
    }

    public synchronized SearchDialog(Context context, SearchManager searchManager) {
    ...
    private synchronized void createContentView() {
        ...
        this.mCloseSearch = findViewById(android.R.id.closeButton);
        ...
        this.mSearchAutoComplete = (AutoCompleteTextView) this.mSearchView.findViewById(16909363);
    ...
    public synchronized boolean show(String initialQuery, boolean selectInitialQuery, ComponentName componentName, Bundle appSearchData) {
    ...
    private synchronized boolean doShow(String initialQuery, boolean selectInitialQuery, ComponentName componentName, Bundle appSearchData) {
    ...
    private synchronized boolean show(ComponentName componentName, Bundle appSearchData) {
    ...
    private protected void setWorking(boolean working) {
    ...
    public private protected static boolean isLandscapeMode(Context context) {
    ...
    private synchronized void updateSearchAppIcon() {
        Drawable icon;
    ...
    private synchronized void updateSearchBadge() {
        int visibility = 8;
        Drawable icon = null;
    ...
    private synchronized boolean isOutOfBounds(View v, MotionEvent event) {
    ...
    public private void launchQuerySearch(int actionKey, String actionMsg) {
    ...
    public synchronized void setListSelection(int index) {
    ...
    public static class SearchBar extends LinearLayout {
        public synchronized SearchBar(Context context, AttributeSet attrs) {
            super(context, attrs);
        }

        public synchronized SearchBar(Context context) {
            super(context);
        }
    ...
    private synchronized boolean isEmpty(AutoCompleteTextView actv) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean onClosePressed() {
    ...
    private synchronized void setUserQuery(String query) {
        if (query == null) {
            query = "";
        }

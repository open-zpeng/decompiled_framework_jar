...
public final class Slice implements Parcelable {
    ...
    @Deprecated
    private protected static final String EXTRA_SLIDER_VALUE = "android.app.slice.extra.SLIDER_VALUE";
    ...
    @Deprecated
    private protected static final String SUBTYPE_SLIDER = "slider";
    ...
    synchronized Slice(ArrayList<SliceItem> items, String[] hints, Uri uri, SliceSpec spec) {
        this.mHints = hints;
    ...
    public synchronized boolean hasHint(String hint) {
    ...
    public static class Builder {
        ...
        private protected Builder setSpec(SliceSpec spec) {
            this.mSpec = spec;
            return this;
        }
        ...
        @Deprecated
        private protected Builder addTimestamp(long time, String subType, List<String> hints) {
    ...
    private synchronized String toString(String indent) {

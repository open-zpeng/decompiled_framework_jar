...
public class SliceQuery {
    ...
    public static synchronized SliceItem getPrimaryIcon(Slice slice) {
        SliceItem icon;
    ...
    public static synchronized SliceItem findNotContaining(SliceItem container, List<SliceItem> list) {
        SliceItem ret = null;
    ...
    private static synchronized boolean contains(SliceItem container, final SliceItem item) {
    ...
    public static synchronized List<SliceItem> findAll(SliceItem s, String type) {
        return findAll(s, type, (String[]) null, (String[]) null);
    }

    public static synchronized List<SliceItem> findAll(SliceItem s, String type, String hints, String nonHints) {
        return findAll(s, type, new String[]{hints}, new String[]{nonHints});
    }

    public static synchronized List<SliceItem> findAll(SliceItem s, final String type, final String[] hints, final String[] nonHints) {
    ...
    public static synchronized SliceItem find(Slice s, String type, String hints, String nonHints) {
        return find(s, type, new String[]{hints}, new String[]{nonHints});
    }

    public static synchronized SliceItem find(Slice s, String type) {
        return find(s, type, (String[]) null, (String[]) null);
    }

    public static synchronized SliceItem find(SliceItem s, String type) {
        return find(s, type, (String[]) null, (String[]) null);
    }

    public static synchronized SliceItem find(SliceItem s, String type, String hints, String nonHints) {
        return find(s, type, new String[]{hints}, new String[]{nonHints});
    }
    ...
    public static synchronized SliceItem find(SliceItem s, final String type, final String[] hints, final String[] nonHints) {
    ...
    public static synchronized Stream<SliceItem> stream(SliceItem slice) {
    ...
    public static synchronized boolean compareTypes(SliceItem item, String desiredType) {

...
public class SliceManager {
    ...
    public synchronized SliceManager(Context context, Handler handler) throws ServiceManager.ServiceNotFoundException {
    ...
    @Deprecated
    private protected void pinSlice(Uri uri, List<SliceSpec> specs) {
    ...
    public synchronized boolean hasSliceAccess() {
        try {
    ...
    @Deprecated
    private protected Slice bindSlice(Uri uri, List<SliceSpec> supportedSpecs) {
    ...
    private synchronized String getAuthority(Intent intent) {
    ...
    private synchronized Uri resolveStatic(Intent intent, ContentResolver resolver) {
    ...
    @Deprecated
    private protected Slice bindSlice(Intent intent, List<SliceSpec> supportedSpecs) {
    ...
    public synchronized void enforceSlicePermission(Uri uri, String pkg, int pid, int uid, String[] autoGrantPermissions) {
        try {
    ...
    public synchronized void grantPermissionFromUser(Uri uri, String pkg, boolean allSlices) {
        try {

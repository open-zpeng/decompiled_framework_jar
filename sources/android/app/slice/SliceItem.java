...
public final class SliceItem implements Parcelable {
    ...
    @Deprecated
    private protected static final String FORMAT_TIMESTAMP = "long";
    ...
    public synchronized SliceItem(Object obj, String format, String subType, List<String> hints) {
        this(obj, format, subType, (String[]) hints.toArray(new String[hints.size()]));
    }

    public synchronized SliceItem(Object obj, String format, String subType, String[] hints) {
        this.mHints = hints;
        this.mFormat = format;
    ...
    public synchronized SliceItem(PendingIntent intent, Slice slice, String format, String subType, String[] hints) {
    ...
    public synchronized RemoteViews getRemoteView() {
    ...
    @Deprecated
    private protected long getTimestamp() {
        return ((Long) this.mObj).longValue();
    }
    ...
    public synchronized SliceItem(Parcel in) {
    ...
    public synchronized boolean hasHints(String[] hints) {
        if (hints == null) {
            return true;
        }
    ...
    public synchronized boolean hasAnyHints(String[] hints) {
        if (hints == null) {
            return false;
        }
        for (String hint : hints) {
    ...
    private static synchronized String getBaseType(String type) {
    ...
    private static synchronized void writeObj(Parcel dest, int flags, Object obj, String type) {
        char c;
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    private static synchronized Object readObj(String type, Parcel in) {
        char c;
        String baseType = getBaseType(type);
        switch (baseType.hashCode()) {
            case -1422950858:

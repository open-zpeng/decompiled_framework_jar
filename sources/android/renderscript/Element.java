...
public class Element extends BaseObj {
    ...
    private synchronized void updateVisibleSubElements() {
    ...
    synchronized Element(long id, RenderScript rs, Element[] e, String[] n, int[] as) {
        super(id, rs);
        this.mSize = 0;
        this.mVectorSize = 1;
        this.mElements = e;
    ...
    synchronized Element(long id, RenderScript rs, DataType dt, DataKind dk, boolean norm, int size) {
        super(id, rs);
    ...
    public synchronized Element(long id, RenderScript rs) {
        super(id, rs);
    }
    ...
    public private protected static Element createUser(RenderScript rs, DataType dt) {

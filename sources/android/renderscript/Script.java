...
public class Script extends BaseObj {
    ...
    public static final class KernelID extends BaseObj {
        ...
        synchronized KernelID(long id, RenderScript rs, Script s, int slot, int sig) {
            super(id, rs);
            this.mScript = s;
            this.mSlot = slot;
            this.mSig = sig;
    ...
    public static final class InvokeID extends BaseObj {
        ...
        synchronized InvokeID(long id, RenderScript rs, Script s, int slot) {
            super(id, rs);
            this.mScript = s;
            this.mSlot = slot;
        }
    ...
    public static final class FieldID extends BaseObj {
        ...
        synchronized FieldID(long id, RenderScript rs, Script s, int slot) {
            super(id, rs);
            this.mScript = s;
            this.mSlot = slot;
        }
    ...
    public void forEach(int slot, Allocation ain, Allocation aout, FieldPacker v, LaunchOptions sc) {
        ...
        byte[] params2 = params;
        int[] limits = sc != null ? new int[]{sc.xstart, sc.xend, sc.ystart, sc.yend, sc.zstart, sc.zend} : null;
    ...
    protected void forEach(int slot, Allocation[] ains, Allocation aout, FieldPacker v, LaunchOptions sc) {
        ...
        long out_id2 = out_id;
        byte[] params = v != null ? v.getData() : null;
        int[] limits = sc != null ? new int[]{sc.xstart, sc.xend, sc.ystart, sc.yend, sc.zstart, sc.zend} : null;
    ...
    public synchronized Script(long id, RenderScript rs) {
        super(id, rs);
    ...
    public static class Builder {
        ...
        public private protected Builder(RenderScript rs) {
            this.mRS = rs;
        }
    }

...
public class AllocationAdapter extends Allocation {
    ...
    synchronized AllocationAdapter(long id, RenderScript rs, Allocation alloc, Type t) {
        super(id, rs, alloc.mType, alloc.mUsage);
        this.mAdaptedAllocation = alloc;
        this.mWindow = t;
    }

    synchronized void initLOD(int lod) {
        if (lod < 0) {
        ...
        int ty2 = ty;
        int tx2 = tx;
        for (int tx3 = 0; tx3 < lod; tx3++) {
            if (tx2 == 1 && ty2 == 1 && tz2 == 1) {
    ...
    public synchronized void setArray(int arrayNum, int arrayVal) {

...
public final class ScriptIntrinsicBLAS extends ScriptIntrinsic {
    ...
    private synchronized ScriptIntrinsicBLAS(long id, RenderScript rs) {
        super(id, rs);
    }
    ...
    static synchronized void validateSide(int Side2) {
        if (Side2 != 141 && Side2 != 142) {
            throw new RSRuntimeException("Invalid side passed to BLAS");
        }
    }

    static synchronized void validateTranspose(int Trans) {
        if (Trans != 111 && Trans != 112 && Trans != 113) {
            throw new RSRuntimeException("Invalid transpose passed to BLAS");
        }
    }

    static synchronized void validateConjTranspose(int Trans) {
        if (Trans != 111 && Trans != 113) {
            throw new RSRuntimeException("Invalid transpose passed to BLAS");
        }
    }

    static synchronized void validateDiag(int Diag2) {
        if (Diag2 != 131 && Diag2 != 132) {
            throw new RSRuntimeException("Invalid diag passed to BLAS");
        }
    }

    static synchronized void validateUplo(int Uplo2) {
        if (Uplo2 != 121 && Uplo2 != 122) {
            throw new RSRuntimeException("Invalid uplo passed to BLAS");
        }
    }

    static synchronized void validateGEMV(Element e, int TransA, Allocation A, Allocation X, int incX, Allocation Y, int incY) {
        int expectedXDim;
        int expectedYDim;
    ...
    static synchronized void validateTRMV(Element e, int Uplo2, int TransA, int Diag2, Allocation A, Allocation X, int incX) {
        validateTranspose(TransA);
        validateUplo(Uplo2);
        validateDiag(Diag2);
    ...
    static synchronized int validateTPMV(Element e, int Uplo2, int TransA, int Diag2, Allocation Ap, Allocation X, int incX) {
        validateTranspose(TransA);
        validateUplo(Uplo2);
        validateDiag(Diag2);
    ...
    public void DTRMV(int Uplo2, int TransA, int Diag2, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 57, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTRMV(int Uplo2, int TransA, int Diag2, Allocation A, Allocation X, int incX) {
        ...
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 73, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTBMV(int Uplo2, int TransA, int Diag2, int K, Allocation A, Allocation X, int incX) {
        ...
        validateTRMV(Element.F64(this.mRS), Uplo2, TransA, Diag2, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 58, TransA, 0, 0, Uplo2, Diag2, 0, N, K, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTBMV(int Uplo2, int TransA, int Diag2, int K, Allocation A, Allocation X, int incX) {
        ...
        validateTRMV(Element.F64_2(this.mRS), Uplo2, TransA, Diag2, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 74, TransA, 0, 0, Uplo2, Diag2, 0, N, K, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTPMV(int Uplo2, int TransA, int Diag2, Allocation Ap, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 59, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, Ap.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTPMV(int Uplo2, int TransA, int Diag2, Allocation Ap, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 75, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, Ap.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTRSV(int Uplo2, int TransA, int Diag2, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F64(this.mRS), Uplo2, TransA, Diag2, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 60, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTRSV(int Uplo2, int TransA, int Diag2, Allocation A, Allocation X, int incX) {
        validateTRMV(Element.F64_2(this.mRS), Uplo2, TransA, Diag2, A, X, incX);
        int N = A.getType().getY();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 76, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTBSV(int Uplo2, int TransA, int Diag2, int K, Allocation A, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 61, TransA, 0, 0, Uplo2, Diag2, 0, N, K, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTBSV(int Uplo2, int TransA, int Diag2, int K, Allocation A, Allocation X, int incX) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 77, TransA, 0, 0, Uplo2, Diag2, 0, N, K, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void DTPSV(int Uplo2, int TransA, int Diag2, Allocation Ap, Allocation X, int incX) {
        int N = validateTPMV(Element.F64(this.mRS), Uplo2, TransA, Diag2, Ap, X, incX);
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 62, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, Ap.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void ZTPSV(int Uplo2, int TransA, int Diag2, Allocation Ap, Allocation X, int incX) {
        int N = validateTPMV(Element.F64_2(this.mRS), Uplo2, TransA, Diag2, Ap, X, incX);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 78, TransA, 0, 0, Uplo2, Diag2, 0, N, 0, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, Ap.getID(this.mRS), X.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }

    static synchronized int validateSYMV(Element e, int Uplo2, Allocation A, Allocation X, Allocation Y, int incX, int incY) {
        validateUplo(Uplo2);
        int N = A.getType().getY();
        if (A.getType().getX() != N) {
    ...
    static synchronized int validateSPMV(Element e, int Uplo2, Allocation Ap, Allocation X, int incX, Allocation Y, int incY) {
        validateUplo(Uplo2);
    ...
    static synchronized void validateGER(Element e, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        if (!A.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e) || !Y.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
        if (X.getType().getY() > 1 || Y.getType().getY() > 1) {
    ...
    static synchronized int validateSYR(Element e, int Uplo2, Allocation X, int incX, Allocation A) {
        validateUplo(Uplo2);
        if (!A.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
    ...
    static synchronized int validateSPR(Element e, int Uplo2, Allocation X, int incX, Allocation Ap) {
        validateUplo(Uplo2);
        if (!Ap.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
    ...
    static synchronized int validateSYR2(Element e, int Uplo2, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        validateUplo(Uplo2);
        if (!A.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e) || !Y.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
    ...
    static synchronized int validateSPR2(Element e, int Uplo2, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        validateUplo(Uplo2);
        if (!Ap.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e) || !Y.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
    ...
    public void DGER(double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 90, 0, 0, 0, 0, 0, M, N, 0, alpha, X.getID(this.mRS), Y.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSYR(int Uplo2, double alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 91, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha, X.getID(this.mRS), A.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void DSPR(int Uplo2, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 92, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha, X.getID(this.mRS), Ap.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, incX, 0, 0, 0);
    }
    ...
    public void DSYR2(int Uplo2, double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 93, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha, X.getID(this.mRS), Y.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void DSPR2(int Uplo2, double alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 94, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha, X.getID(this.mRS), Y.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, Ap.getID(this.mRS), incX, incY, 0, 0);
    }

    static synchronized void validateGERU(Element e, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        if (!A.getType().getElement().isCompatible(e) || !X.getType().getElement().isCompatible(e) || !Y.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
        if (X.getType().getY() > 1 || Y.getType().getY() > 1) {
    ...
    public void ZGERU(Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 107, 0, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZGERC(Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        ...
        int M = A.getType().getY();
        int N = A.getType().getX();
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 108, 0, 0, 0, 0, 0, M, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), incX, incY, 0, 0);
    }
    ...
    public void ZHER(int Uplo2, double alpha, Allocation X, int incX, Allocation A) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 109, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha, FeatureOption.FO_BOOT_POLICY_CPU, X.getID(this.mRS), 0L, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), incX, 0, 0, 0);
    }
    ...
    public void ZHPR(int Uplo2, double alpha, Allocation X, int incX, Allocation Ap) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 110, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha, FeatureOption.FO_BOOT_POLICY_CPU, X.getID(this.mRS), 0L, FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, Ap.getID(this.mRS), incX, 0, 0, 0);
    }

    public void ZHER2(int Uplo2, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation A) {
        int N = validateSYR2(Element.F64_2(this.mRS), Uplo2, X, incX, Y, incY, A);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 111, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), incX, incY, 0, 0);
    }

    public void ZHPR2(int Uplo2, Double2 alpha, Allocation X, int incX, Allocation Y, int incY, Allocation Ap) {
        int N = validateSPR2(Element.F64_2(this.mRS), Uplo2, X, incX, Y, incY, Ap);
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 112, 0, 0, 0, Uplo2, 0, 0, N, 0, alpha.x, alpha.y, X.getID(this.mRS), Y.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, Ap.getID(this.mRS), incX, incY, 0, 0);
    }

    static synchronized void validateL3(Element e, int TransA, int TransB, int Side2, Allocation A, Allocation B, Allocation C) {
        int aM = -1;
        int aN = -1;
        int bM = -1;
        int bN = -1;
    ...
    static synchronized void validateSYR2K(Element e, int Trans, Allocation A, Allocation B, Allocation C) {
        int Cdim;
        validateTranspose(Trans);
    ...
    static synchronized void validateTRMM(Element e, int Side2, int TransA, Allocation A, Allocation B) {
        validateSide(Side2);
        validateTranspose(TransA);
    ...
    public void DTRMM(int Side2, int Uplo2, int TransA, int Diag2, double alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 123, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, 0, 0, 0, 0);
    }
    ...
    public void ZTRMM(int Side2, int Uplo2, int TransA, int Diag2, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 135, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, 0, 0, 0, 0);
    }

    static synchronized void validateTRSM(Element e, int Side2, int TransA, Allocation A, Allocation B) {
        validateSide(Side2);
        validateTranspose(TransA);
        if (!A.getType().getElement().isCompatible(e) || !B.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
    ...
    public void DTRSM(int Side2, int Uplo2, int TransA, int Diag2, double alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Double(getID(this.mRS), 124, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha, A.getID(this.mRS), B.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, 0L, 0, 0, 0, 0);
    }
    ...
    public void ZTRSM(int Side2, int Uplo2, int TransA, int Diag2, Double2 alpha, Allocation A, Allocation B) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 136, TransA, 0, Side2, Uplo2, Diag2, B.getType().getY(), B.getType().getX(), 0, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), FeatureOption.FO_BOOT_POLICY_CPU, FeatureOption.FO_BOOT_POLICY_CPU, 0L, 0, 0, 0, 0);
    }

    static synchronized void validateHEMM(Element e, int Side2, Allocation A, Allocation B, Allocation C) {
        validateSide(Side2);
        if (!A.getType().getElement().isCompatible(e) || !B.getType().getElement().isCompatible(e) || !C.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
    ...
    static synchronized void validateHERK(Element e, int Trans, Allocation A, Allocation C) {
    ...
    public void ZHERK(int Uplo2, int Trans, double alpha, Allocation A, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 141, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), k, alpha, FeatureOption.FO_BOOT_POLICY_CPU, A.getID(this.mRS), 0L, beta, FeatureOption.FO_BOOT_POLICY_CPU, C.getID(this.mRS), 0, 0, 0, 0);
    }

    static synchronized void validateHER2K(Element e, int Trans, Allocation A, Allocation B, Allocation C) {
        if (!A.getType().getElement().isCompatible(e) || !B.getType().getElement().isCompatible(e) || !C.getType().getElement().isCompatible(e)) {
            throw new RSRuntimeException("Called BLAS with wrong Element type");
        }
        validateConjTranspose(Trans);
    ...
    public void ZHER2K(int Uplo2, int Trans, Double2 alpha, Allocation A, Allocation B, double beta, Allocation C) {
        ...
        this.mRS.nScriptIntrinsicBLAS_Z(getID(this.mRS), 142, Trans, 0, 0, Uplo2, 0, 0, C.getType().getX(), k, alpha.x, alpha.y, A.getID(this.mRS), B.getID(this.mRS), beta, FeatureOption.FO_BOOT_POLICY_CPU, C.getID(this.mRS), 0, 0, 0, 0);
    }

...
public class Byte4 {
    ...
    public synchronized Byte4(Byte4 source) {
        this.x = source.x;
        this.y = source.y;
        this.z = source.z;
        this.w = source.w;
    ...
    public synchronized void add(Byte4 a) {
    ...
    public static synchronized Byte4 add(Byte4 a, Byte4 b) {
    ...
    public static synchronized Byte4 add(Byte4 a, byte b) {
        Byte4 result = new Byte4();
        result.x = (byte) (a.x + b);
        result.y = (byte) (a.y + b);
        result.z = (byte) (a.z + b);
    ...
    public synchronized void sub(Byte4 a) {
        this.x = (byte) (this.x - a.x);
        this.y = (byte) (this.y - a.y);
        this.z = (byte) (this.z - a.z);
        this.w = (byte) (this.w - a.w);
    ...
    public static synchronized Byte4 sub(Byte4 a, Byte4 b) {
        Byte4 result = new Byte4();
        result.x = (byte) (a.x - b.x);
        result.y = (byte) (a.y - b.y);
        result.z = (byte) (a.z - b.z);
    ...
    public static synchronized Byte4 sub(Byte4 a, byte b) {
        Byte4 result = new Byte4();
        result.x = (byte) (a.x - b);
        result.y = (byte) (a.y - b);
        result.z = (byte) (a.z - b);
    ...
    public synchronized void mul(Byte4 a) {
        this.x = (byte) (this.x * a.x);
        this.y = (byte) (this.y * a.y);
        this.z = (byte) (this.z * a.z);
        this.w = (byte) (this.w * a.w);
    ...
    public static synchronized Byte4 mul(Byte4 a, Byte4 b) {
        Byte4 result = new Byte4();
        result.x = (byte) (a.x * b.x);
        result.y = (byte) (a.y * b.y);
        result.z = (byte) (a.z * b.z);
    ...
    public static synchronized Byte4 mul(Byte4 a, byte b) {
        Byte4 result = new Byte4();
        result.x = (byte) (a.x * b);
        result.y = (byte) (a.y * b);
        result.z = (byte) (a.z * b);
    ...
    public synchronized void div(Byte4 a) {
        this.x = (byte) (this.x / a.x);
        this.y = (byte) (this.y / a.y);
        this.z = (byte) (this.z / a.z);
        this.w = (byte) (this.w / a.w);
    ...
    public static synchronized Byte4 div(Byte4 a, Byte4 b) {
        Byte4 result = new Byte4();
        result.x = (byte) (a.x / b.x);
        result.y = (byte) (a.y / b.y);
        result.z = (byte) (a.z / b.z);
    ...
    public static synchronized Byte4 div(Byte4 a, byte b) {
        Byte4 result = new Byte4();
        result.x = (byte) (a.x / b);
        result.y = (byte) (a.y / b);
        result.z = (byte) (a.z / b);
    ...
    public synchronized byte dotProduct(Byte4 a) {
        return (byte) ((this.x * a.x) + (this.y * a.y) + (this.z * a.z) + (this.w * a.w));
    }

    public static synchronized byte dotProduct(Byte4 a, Byte4 b) {
        return (byte) ((b.x * a.x) + (b.y * a.y) + (b.z * a.z) + (b.w * a.w));
    }

    public synchronized void addMultiple(Byte4 a, byte factor) {
    ...
    public synchronized void set(Byte4 a) {
        this.x = a.x;
        this.y = a.y;
        this.z = a.z;
        this.w = a.w;
    ...
    public synchronized void setValues(byte a, byte b, byte c, byte d) {
        this.x = a;
        this.y = b;
        this.z = c;
        this.w = d;

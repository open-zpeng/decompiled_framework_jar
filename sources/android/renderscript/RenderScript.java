...
public class RenderScript {
    ...
    public private protected static int sPointerSize;
    ...
    public private protected RSMessageHandler mMessageCallback = null;
    ...
    private protected static long getMinorID() {
        return 1L;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void nObjDestroy(long id) {
        if (this.mContext != 0) {
    ...
    public private protected synchronized long nScriptCCreate(String resName, String cacheDir, byte[] script, int length) {
        validate();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void validateObject(BaseObj o) {
        if (o != null && o.mRS != this) {
            throw new RSIllegalArgumentException("Attempting to use an object across contexts.");
        }
    }

    public private protected void validate() {
        if (this.mContext == 0) {
    ...
    public static class MessageThread extends Thread {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized MessageThread(RenderScript rs) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized RenderScript(Context ctx) {
        if (ctx != null) {
    ...
    private protected static RenderScript create(Context ctx, int sdkVersion) {
        return create(ctx, sdkVersion, ContextType.NORMAL, 0);
    }

    public protected static RenderScript create(Context ctx, int sdkVersion, ContextType ct, int flags) {
        if (sdkVersion < 23) {
    ...
    private synchronized void helpDestroy() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized long safeID(BaseObj o) {
        if (o != null) {
            return o.getID(this);
        }
        return 0L;

...
public class RenderScript {
    ...
    native void rsnAllocationCopyFromBitmap(long j, long j2, long j3);

    native void rsnAllocationCopyToBitmap(long j, long j2, long j3);

    native long rsnAllocationCreateBitmapBackedAllocation(long j, long j2, int i, long j3, int i2);

    native long rsnAllocationCreateBitmapRef(long j, long j2, long j3);

    native long rsnAllocationCreateFromAssetStream(long j, int i, int i2, int i3);

    native long rsnAllocationCreateFromBitmap(long j, long j2, int i, long j3, int i2);

    native long rsnAllocationCreateTyped(long j, long j2, int i, int i2, long j3);

    native long rsnAllocationCubeCreateFromBitmap(long j, long j2, int i, long j3, int i2);

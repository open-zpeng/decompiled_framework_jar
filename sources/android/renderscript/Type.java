...
public class Type extends BaseObj {
    ...
    public synchronized int getArray(int arrayNum) {
    ...
    synchronized void calcElementCount() {
    ...
    public synchronized Type(long id, RenderScript rs) {
        super(id, rs);
    }
    ...
    public static class Builder {
        ...
        public synchronized Builder setArray(int dim, int value) {
            if (dim < 0 || dim >= 4) {
                throw new RSIllegalArgumentException("Array dimension out of range.");
            }

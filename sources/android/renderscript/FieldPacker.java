...
public class FieldPacker {
    ...
    public static synchronized FieldPacker createFromArray(Object[] args) {
    ...
    private synchronized boolean resize(int newSize) {
    ...
    private synchronized void addSafely(Object obj) {
        boolean retry;

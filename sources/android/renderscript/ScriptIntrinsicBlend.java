...
public class ScriptIntrinsicBlend extends ScriptIntrinsic {
    synchronized ScriptIntrinsicBlend(long id, RenderScript rs) {
        super(id, rs);
    }
    ...
    private synchronized void blend(int id, Allocation ain, Allocation aout, Script.LaunchOptions opt) {

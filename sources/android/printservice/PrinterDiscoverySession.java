...
public abstract class PrinterDiscoverySession {
    ...
    public synchronized void setObserver(IPrintServiceClient observer) {
    ...
    private synchronized void sendOutOfDiscoveryPeriodPrinterChanges() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void startPrinterDiscovery(List<PrinterId> priorityList) {
        if (!this.mIsDestroyed) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void validatePrinters(List<PrinterId> printerIds) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void startPrinterStateTracking(PrinterId printerId) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void requestCustomPrinterIcon(PrinterId printerId) {
        if (!this.mIsDestroyed && this.mObserver != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void stopPrinterStateTracking(PrinterId printerId) {

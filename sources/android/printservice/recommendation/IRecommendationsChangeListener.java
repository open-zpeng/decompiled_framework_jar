...
public interface IRecommendationsChangeListener extends IInterface {
    synchronized void onRecommendationsChanged() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IRecommendationsChangeListener {
        ...
        public static synchronized IRecommendationsChangeListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IRecommendationsChangeListener {
            ...
            public synchronized void onRecommendationsChanged() throws RemoteException {

...
public class ToPackedGrayFilter extends Filter {
    ...
    private protected synchronized ToPackedGrayFilter(String name) {
        super(name);
        this.mOWidth = 0;
        this.mOHeight = 0;
    ...
    public protected synchronized void checkOutputDimensions(int outputWidth, int outputHeight) {
    ...
    public protected synchronized FrameFormat convertInputFormat(FrameFormat inputFormat) {
        int ow = this.mOWidth;

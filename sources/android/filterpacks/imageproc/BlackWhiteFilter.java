...
public class BlackWhiteFilter extends Filter {
    ...
    public protected float mBlack;
    public protected final String mBlackWhiteShader;
    ...
    public protected float mWhite;

    private protected synchronized BlackWhiteFilter(String name) {
        super(name);
        this.mBlack = 0.0f;
        this.mWhite = 1.0f;
        this.mTileSize = 640;

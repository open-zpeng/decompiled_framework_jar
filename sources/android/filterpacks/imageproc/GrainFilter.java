...
public class GrainFilter extends Filter {
    public protected static final int RAND_THRESHOLD = 128;
    public protected Program mGrainProgram;
    public protected final String mGrainShader;
    public protected int mHeight;
    public protected Program mNoiseProgram;
    public protected final String mNoiseShader;
    public protected Random mRandom;
    ...
    private protected synchronized GrainFilter(String name) {
        super(name);
        this.mScale = 0.0f;
        this.mTileSize = 640;
        this.mWidth = 0;

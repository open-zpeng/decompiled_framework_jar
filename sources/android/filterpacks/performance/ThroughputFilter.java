...
public class ThroughputFilter extends Filter {
    public protected long mLastTime;
    public protected FrameFormat mOutputFormat;
    @GenerateFieldPort(hasDefault = true, name = "period")
    public protected int mPeriod;
    public protected int mPeriodFrameCount;
    public protected int mTotalFrameCount;

    private protected synchronized ThroughputFilter(String name) {
        super(name);
        this.mPeriod = 5;
        this.mLastTime = 0L;

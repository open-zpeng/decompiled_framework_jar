...
public class MediaEncoderFilter extends Filter {
    public protected static final int NO_AUDIO_SOURCE = -1;
    public protected static final String TAG = "MediaEncoderFilter";
    @GenerateFieldPort(hasDefault = true, name = "audioSource")
    public protected int mAudioSource;
    public protected boolean mCaptureTimeLapse;
    @GenerateFieldPort(hasDefault = true, name = "errorListener")
    public protected MediaRecorder.OnErrorListener mErrorListener;
    ...
    public protected synchronized void updateSourceRegion() {
    ...
    public protected synchronized void updateMediaRecorderParams() {
    ...
    public protected synchronized void startRecording(FilterContext context) {
        int width;
        int height;
        if (this.mLogVerbose) {
    ...
    private protected synchronized boolean skipFrameAndModifyTimestamp(long timestampNs) {
    ...
    public protected synchronized void stopRecording(FilterContext context) {
        if (this.mLogVerbose) {

...
public class ChangeImageTransform extends Transition {
    ...
    private synchronized ObjectAnimator createNullAnimator(ImageView imageView) {
    ...
    private synchronized ObjectAnimator createMatrixAnimator(ImageView imageView, Matrix startMatrix, Matrix endMatrix) {

...
public class Explode extends Visibility {
    ...
    private synchronized void calculateOut(View sceneRoot, Rect bounds, int[] outVector) {
        int focalX;
        int focalY;
    ...
    private static synchronized double calculateMaxDistance(View sceneRoot, int focalX, int focalY) {

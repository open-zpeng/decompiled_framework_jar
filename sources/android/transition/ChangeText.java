...
public class ChangeText extends Transition {
    ...
    public synchronized ChangeText setChangeBehavior(int changeBehavior) {
    ...
    public synchronized int getChangeBehavior() {
    ...
    */
    ...
    public synchronized void setSelection(EditText editText, int start, int end) {
        if (start >= 0 && end >= 0) {

...
public class TransitionUtils {
    ...
    public static synchronized Animator mergeAnimators(Animator animator1, Animator animator2) {
        if (animator1 == null) {
            return animator2;
        }
        if (animator2 == null) {
    ...
    public static Transition mergeTransitions(Transition... transitions) {
        int nonNullIndex = -1;
        int count = 0;
        for (int count2 = 0; count2 < transitions.length; count2++) {
            if (transitions[count2] != null) {
                count++;
                nonNullIndex = count2;
            }
        }
    ...
    public static synchronized View copyViewImage(ViewGroup sceneRoot, View view, View parent) {
    ...
    public static synchronized Bitmap createDrawableBitmap(Drawable drawable, View hostView) {
    ...
    public static synchronized Bitmap createViewBitmap(View view, Matrix matrix, RectF bounds, ViewGroup sceneRoot) {
    ...
    public static class MatrixEvaluator implements TypeEvaluator<Matrix> {
        ...
        public synchronized Matrix evaluate(float fraction, Matrix startValue, Matrix endValue) {

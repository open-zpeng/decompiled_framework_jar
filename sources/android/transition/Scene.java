...
public final class Scene {
    ...
    public private protected Runnable mEnterAction;
    public private protected Runnable mExitAction;
    ...
    private synchronized Scene(ViewGroup sceneRoot, int layoutId, Context context) {
        this.mLayoutId = -1;
    ...
    public private protected static void setCurrentScene(View view, Scene scene) {
        view.setTagInternal(R.id.current_scene, scene);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized Scene getCurrentScene(View view) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean isCreatedFromLayoutResource() {

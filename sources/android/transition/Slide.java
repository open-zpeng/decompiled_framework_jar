...
public class Slide extends Visibility {
    ...
    public interface CalculateSlide {
        synchronized float getGoneX(ViewGroup viewGroup, View view, float f);

        synchronized float getGoneY(ViewGroup viewGroup, View view, float f);
    }
    ...
    private static abstract class CalculateSlideHorizontal implements CalculateSlide {
        private synchronized CalculateSlideHorizontal() {
        }

        @Override // android.transition.Slide.CalculateSlide
        public synchronized float getGoneY(ViewGroup sceneRoot, View view, float fraction) {
    ...
    private static abstract class CalculateSlideVertical implements CalculateSlide {
        private synchronized CalculateSlideVertical() {
        }

        @Override // android.transition.Slide.CalculateSlide
        public synchronized float getGoneX(ViewGroup sceneRoot, View view, float fraction) {
    ...
    public synchronized void setSlideFraction(float slideFraction) {

...
public class Fade extends Visibility {
    ...
    private synchronized Animator createAnimation(final View view, float startAlpha, float endAlpha) {
    ...
    private static synchronized float getStartAlpha(TransitionValues startValues, float fallbackValue) {
    ...
    public static class FadeAnimatorListener extends AnimatorListenerAdapter {
        ...
        public synchronized FadeAnimatorListener(View view) {
            this.mView = view;
        }

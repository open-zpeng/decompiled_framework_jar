...
public class ChangeBounds extends Transition {
    ...
    public protected static final Property<View, PointF> BOTTOM_RIGHT_ONLY_PROPERTY = new Property<View, PointF>(PointF.class, "bottomRight") { // from class: android.transition.ChangeBounds.4
        @Override // android.util.Property
    ...
    public protected static final Property<View, PointF> POSITION_PROPERTY = new Property<View, PointF>(PointF.class, BrowserContract.Bookmarks.POSITION) { // from class: android.transition.ChangeBounds.6
        @Override // android.util.Property
        public void set(View view, PointF topLeft) {
            int left = Math.round(topLeft.x);
            int top = Math.round(topLeft.y);
    ...
    private synchronized void captureValues(TransitionValues values) {
    ...
    private synchronized boolean parentMatches(View startParent, View endParent) {
        if (!this.mReparent) {
            return true;
        }
        boolean z = true;
    ...
    public Animator createAnimator(final ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (startParent != null && endParent != null) {
            ...
            if (!parentMatches(startParent, endParent)) {
                ...
                PropertyValuesHolder origin = PropertyValuesHolder.ofObject(DRAWABLE_ORIGIN_PROPERTY, (TypeConverter) null, topLeftPath);
                ObjectAnimator anim2 = ObjectAnimator.ofPropertyValuesHolder(drawable, origin);
                anim2.addListener(new AnimatorListenerAdapter() { // from class: android.transition.ChangeBounds.10
            ...
            if (numChanges > 0) {
                ...
                if (changeBounds.mResizeClip) {
                    final int startWidth2 = endBottom;
                    int maxWidth = Math.max(startWidth, endWidth);
                    int maxHeight = Math.max(startHeight, endHeight);
                    view2.setLeftTopRightBottom(startLeft2, startTop2, startLeft2 + maxWidth, startTop2 + maxHeight);
                    ...
                    if (startLeft2 == endLeft2 && startTop2 == endTop) {
                        ...
                        positionAnimator2 = ObjectAnimator.ofObject(view2, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath2);
                    }
                    ...
                    Rect endClip3 = endClip == null ? new Rect(i, i, endWidth, endHeight) : endClip;
                    if (startClip.equals(endClip3)) {
                        positionAnimator = positionAnimator3;
                        clipAnimator = null;
                    } else {
                        view2.setClipBounds(startClip);
                        ObjectAnimator clipAnimator2 = ObjectAnimator.ofObject(view2, "clipBounds", sRectEvaluator, startClip, endClip3);
                        final int endLeft3 = endLeft;
                        positionAnimator = positionAnimator3;
                        clipAnimator = clipAnimator2;
                        clipAnimator.addListener(new AnimatorListenerAdapter() { // from class: android.transition.ChangeBounds.9
                            ...
                            public void onAnimationEnd(Animator animation) {
                                if (!this.mIsCanceled) {
                                    ...
                                    view2.setLeftTopRightBottom(endLeft3, endTop, endRight, startWidth2);
                                }
                            }
                        });
                    }
                    ...
                    if (numChanges != 2) {
                        ...
                        if (startLeft2 != endLeft2) {
                            ...
                            Path bottomRight = getPathMotion().getPath(startRight, startBottom, endRight, startWidth3);
                            anim = ObjectAnimator.ofObject(view2, (Property<View, V>) BOTTOM_RIGHT_ONLY_PROPERTY, (TypeConverter) null, bottomRight);
                        }
                        ...
                        anim = ObjectAnimator.ofObject(view2, (Property<View, V>) POSITION_PROPERTY, (TypeConverter) null, topLeftPath4);
                    } else {
                        ...
                        ObjectAnimator topLeftAnimator = ObjectAnimator.ofObject(viewBounds, (Property<ViewBounds, V>) TOP_LEFT_PROPERTY, (TypeConverter) null, topLeftPath5);
    ...
    public static class ViewBounds {
        ...
        public synchronized ViewBounds(View view) {
            this.mView = view;
        }

        public synchronized void setTopLeft(PointF topLeft) {
        ...
        public synchronized void setBottomRight(PointF bottomRight) {
        ...
        private synchronized void setLeftTopRightBottom() {

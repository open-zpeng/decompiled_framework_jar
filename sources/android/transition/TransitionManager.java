...
public class TransitionManager {
    ...
    public protected static ThreadLocal<WeakReference<ArrayMap<ViewGroup, ArrayList<Transition>>>> sRunningTransitions = new ThreadLocal<>();
    public protected static ArrayList<ViewGroup> sPendingTransitions = new ArrayList<>();
    ...
    public synchronized void setDefaultTransition(Transition transition) {
        sDefaultTransition = transition;
    }

    public static synchronized Transition getDefaultTransition() {
    ...
    private static synchronized void changeScene(Scene scene, Transition transition) {
        ViewGroup sceneRoot = scene.getSceneRoot();
        if (!sPendingTransitions.contains(sceneRoot)) {
            ...
            Transition transitionClone = transition.mo52clone();
    ...
    public protected static ArrayMap<ViewGroup, ArrayList<Transition>> getRunningTransitions() {
    ...
    private static synchronized void sceneChangeRunTransition(ViewGroup sceneRoot, Transition transition) {
    ...
    public static class MultiListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        synchronized MultiListener(Transition transition, ViewGroup sceneRoot) {
    ...
    private static synchronized void sceneChangeSetup(ViewGroup sceneRoot, Transition transition) {

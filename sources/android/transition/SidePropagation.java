...
public class SidePropagation extends VisibilityPropagation {
    ...
    private synchronized int distance(View sceneRoot, int viewX, int viewY, int epicenterX, int epicenterY, int left, int top, int right, int bottom) {
        int side;
    ...
    private synchronized int getMaxDistance(ViewGroup sceneRoot) {
        int i = this.mSide;

...
public class Recolor extends Transition {
    ...
    public synchronized Recolor() {
    }

    public synchronized Recolor(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        ...
        if (view instanceof TextView) {
            ...
            if (start != end) {
                ...
                return ObjectAnimator.ofArgb(textView, Notification.Details.KEY_TEXTCOLOR, start, end);
            }
        }
        return null;
    }

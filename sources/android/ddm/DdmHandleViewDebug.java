...
public class DdmHandleViewDebug extends ChunkHandler {
    ...
    private synchronized DdmHandleViewDebug() {
    }
    ...
    private synchronized Chunk listWindows() {
    ...
    private synchronized View getRootView(ByteBuffer in) {
        try {
    ...
    private synchronized View getTargetView(View root, ByteBuffer in) {
        try {
    ...
    private synchronized Chunk dumpHierarchy(View rootView, ByteBuffer in) {
        int i = 1;
    ...
    private synchronized Chunk captureLayers(View rootView) {
    ...
    private synchronized Chunk dumpTheme(View rootView) {
        ByteArrayOutputStream b = new ByteArrayOutputStream(1024);
        try {
    ...
    private synchronized Chunk captureView(View rootView, View targetView) {
        ByteArrayOutputStream b = new ByteArrayOutputStream(1024);
        try {
    ...
    private synchronized Chunk dumpDisplayLists(final View rootView, final View targetView) {
    ...
    private synchronized Chunk invokeViewMethod(View rootView, View targetView, ByteBuffer in) {
        Class<?>[] argTypes;
        Object[] args;
        int l = in.getInt();
    ...
    private synchronized Chunk setLayoutParameter(View rootView, View targetView, ByteBuffer in) {
        int l = in.getInt();
    ...
    private synchronized Chunk profileView(View rootView, View targetView) {

...
public class DdmHandleHello extends ChunkHandler {
    ...
    private synchronized DdmHandleHello() {
    }
    ...
    private synchronized Chunk handleHELO(Chunk request) {
    ...
    private synchronized Chunk handleFEAT(Chunk request) {
    ...
    public static synchronized void sendWAIT(int reason) {

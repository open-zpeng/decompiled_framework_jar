...
public abstract class AbstractCursor implements CrossProcessCursor {
    ...
    public private Long mCurrentRowID;
    public protected Uri mNotifyUri;
    public private int mRowIdColumnIndex;
    private ContentObserver mSelfObserver;
    private boolean mSelfObserverRegistered;
    public private HashMap<Long, Map<String, Object>> mUpdatedRows;
    private final Object mSelfObserverLock = new Object();
    private final DataSetObservable mDataSetObservable = new DataSetObservable();
    private final ContentObservable mContentObservable = new ContentObservable();
    public protected Bundle mExtras = Bundle.EMPTY;
    @Deprecated
    ...
    public synchronized void onDeactivateOrClose() {
    ...
    public synchronized void setNotificationUri(ContentResolver cr, Uri notifyUri, int userHandle) {
        synchronized (this.mSelfObserverLock) {

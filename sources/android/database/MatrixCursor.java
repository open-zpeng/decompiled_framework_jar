...
public class MatrixCursor extends AbstractCursor {
    ...
    public protected Object[] data;
    public protected int rowCount;
    ...
    public protected Object get(int column) {
    ...
    private synchronized void addRow(ArrayList<?> columnValues, int start) {

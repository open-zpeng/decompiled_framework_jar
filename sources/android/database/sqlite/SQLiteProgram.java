...
public abstract class SQLiteProgram extends SQLiteClosable {
    ...
    public protected final Object[] mBindArgs;
    private final String[] mColumnNames;
    private final SQLiteDatabase mDatabase;
    private final int mNumParameters;
    private final boolean mReadOnly;
    public protected final String mSql;

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized SQLiteProgram(SQLiteDatabase db, String sql, Object[] bindArgs, CancellationSignal cancellationSignalForPrepare) {
        this.mDatabase = db;
        this.mSql = sql.trim();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized String getSql() {
        return this.mSql;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized Object[] getBindArgs() {
        return this.mBindArgs;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized String[] getColumnNames() {
        return this.mColumnNames;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized SQLiteSession getSession() {
        return this.mDatabase.getThreadSession();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized int getConnectionFlags() {
        return this.mDatabase.getThreadDefaultConnectionFlags(this.mReadOnly);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized void onCorruption() {
    ...
    private synchronized void bind(int index, Object value) {

...
public class SQLiteQueryBuilder {
    ...
    public protected String mTables = "";
    public protected StringBuilder mWhereClause = null;
    public protected boolean mDistinct = false;
    ...
    private static synchronized void appendClause(StringBuilder s, String name, String clause) {
    ...
    public protected String[] computeProjection(String[] projectionIn) {
        int i = 0;

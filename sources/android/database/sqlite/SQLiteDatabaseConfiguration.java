...
public final class SQLiteDatabaseConfiguration {
    ...
    private protected int maxSqlCacheSize;
    ...
    public synchronized SQLiteDatabaseConfiguration(String path, int openFlags) {
        if (path == null) {
    ...
    public synchronized SQLiteDatabaseConfiguration(SQLiteDatabaseConfiguration other) {
        if (other == null) {
    ...
    public synchronized void updateParametersFrom(SQLiteDatabaseConfiguration other) {
        if (other == null) {
            throw new IllegalArgumentException("other must not be null.");
        }
    ...
    public synchronized boolean isInMemoryDb() {
        return this.path.equalsIgnoreCase(MEMORY_DB_PATH);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean useCompatibilityWal() {
        return this.journalMode == null && this.syncMode == null && (this.openFlags & 1073741824) == 0;
    }

    private static synchronized String stripPathForLogs(String path) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean isLookasideConfigSet() {

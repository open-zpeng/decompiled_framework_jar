...
public class CursorWindow extends SQLiteClosable implements Parcelable {
    ...
    private protected long mWindowPtr;
    public protected static int sCursorWindowSize = -1;
    ...
    public protected static final LongSparseArray<Integer> sWindowToPidMap = new LongSparseArray<>();
    ...
    private synchronized CursorWindow(Parcel source) {
        this.mCloseGuard = CloseGuard.get();
    ...
    private synchronized void recordNewWindow(int pid, long window) {
    ...
    private synchronized void recordClosingOfWindow(long window) {
        synchronized (sWindowToPidMap) {
    ...
    public protected String printStats() {
    ...
    private static synchronized int getCursorWindowSize() {

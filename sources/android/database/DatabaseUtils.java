...
public class DatabaseUtils {
    ...
    private static final synchronized void readExceptionFromParcel(Parcel reply, String msg, int code) {
        switch (code) {
            case 2:
    ...
    public static synchronized void cursorFillWindow(Cursor cursor, int position, CursorWindow window) {
        boolean success;
    ...
    private static synchronized char[] encodeHex(byte[] input) {
        int l = input.length;
    ...
    private static synchronized int getKeyLen(byte[] arr) {
    ...
    private static synchronized byte[] getCollationKeyInBytes(String name) {
        if (mColl == null) {
    ...
    public static synchronized boolean queryIsEmpty(SQLiteDatabase db, String table) {
    ...
    public static class InsertHelper {
        ...
        private synchronized void buildSQL() throws SQLException {
        ...
        private synchronized SQLiteStatement getStatement(boolean allowReplace) throws SQLException {
            if (allowReplace) {
    ...
    public static synchronized int findRowIdColumnIndex(String[] columnNames) {

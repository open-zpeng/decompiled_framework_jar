...
public final class GestureDescription {
    ...
    private synchronized GestureDescription() {
        this.mStrokes = new ArrayList();
        this.mTempPos = new float[2];
    }

    private synchronized GestureDescription(List<StrokeDescription> strokes) {
        this.mStrokes = new ArrayList();
        this.mTempPos = new float[2];
    ...
    public synchronized long getNextKeyPointAtLeast(long offset) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized int getPointsForTime(long time, TouchPoint[] touchPoints) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized long getTotalDuration(List<StrokeDescription> paths) {
    ...
    public static class StrokeDescription {
        ...
        public synchronized int getContinuedStrokeId() {
            return this.mContinuedStrokeId;
        }

        synchronized float getLength() {
            return this.mPathMeasure.getLength();
        }

        synchronized boolean getPosForTime(long time, float[] pos) {
        ...
        synchronized boolean hasPointForTime(long time) {
    ...
    public static class TouchPoint implements Parcelable {
        ...
        public synchronized TouchPoint() {
        }

        public synchronized TouchPoint(TouchPoint pointToCopy) {
            copyFrom(pointToCopy);
        }

        public synchronized TouchPoint(Parcel parcel) {
        ...
        public synchronized void copyFrom(TouchPoint other) {
    ...
    public static class GestureStep implements Parcelable {
        ...
        public synchronized GestureStep(long timeSinceGestureStart, int numTouchPoints, TouchPoint[] touchPointsToCopy) {
        ...
        public synchronized GestureStep(Parcel parcel) {
    ...
    public static class MotionEventGenerator {
        ...
        public static synchronized List<GestureStep> getGestureStepsFromGestureDescription(GestureDescription description, int sampleTimeMs) {
        ...
        private static synchronized TouchPoint[] getCurrentTouchPoints(int requiredCapacity) {

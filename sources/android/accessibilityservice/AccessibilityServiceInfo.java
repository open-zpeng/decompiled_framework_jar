...
public class AccessibilityServiceInfo implements Parcelable {
    ...
    public synchronized AccessibilityServiceInfo(ResolveInfo resolveInfo, Context context) throws XmlPullParserException, IOException {
    ...
    public synchronized void updateDynamicallyConfigurableProperties(AccessibilityServiceInfo other) {
    ...
    public synchronized void setComponentName(ComponentName component) {
    ...
    private static synchronized void appendFeedbackTypes(StringBuilder stringBuilder, int feedbackTypes) {
    ...
    private static synchronized void appendPackageNames(StringBuilder stringBuilder, String[] packageNames) {
    ...
    private static synchronized void appendEventTypes(StringBuilder stringBuilder, int eventTypes) {
    ...
    private static synchronized void appendFlags(StringBuilder stringBuilder, int flags) {
    ...
    private static synchronized void appendCapabilities(StringBuilder stringBuilder, int capabilities) {
    ...
    public synchronized List<CapabilityInfo> getCapabilityInfos() {
        return getCapabilityInfos(null);
    }

    public synchronized List<CapabilityInfo> getCapabilityInfos(Context context) {
    ...
    private static synchronized SparseArray<CapabilityInfo> getCapabilityInfoSparseArray(Context context) {
    ...
    private static synchronized boolean fingerprintAvailable(Context context) {
    ...
    public static final class CapabilityInfo {
        ...
        public synchronized CapabilityInfo(int capability, int titleResId, int descResId) {

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    IAccessibilityServiceConnection _arg04 = IAccessibilityServiceConnection.Stub.asInterface(data.readStrongBinder());
                    int _arg12 = data.readInt();
                    IBinder _arg2 = data.readStrongBinder();
                    init(_arg04, _arg12, _arg2);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onAccessibilityEvent(_arg0, _arg02);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    onInterrupt();
                ...
                case 7:
                    ...
                    onMagnificationChanged(_arg05, _arg1, _arg22, _arg3, _arg4);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 9:
                    ...
                    _arg02 = data.readInt() != 0;
                    onPerformGestureResult(_arg06, _arg02);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readInt() != 0;
                    onFingerprintCapturingGesturesChanged(_arg02);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    _arg02 = data.readInt() != 0;
                    onAccessibilityButtonAvailabilityChanged(_arg02);
                    return true;
                default:

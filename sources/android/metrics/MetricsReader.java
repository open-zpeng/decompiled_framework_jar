...
public class MetricsReader {
    ...
    @VisibleForTesting
    public synchronized void setLogReader(LogReader reader) {
        this.mReader = reader;
    }
    ...
    public static class Event {
        ...
        public synchronized Event(long timeMillis, int pid, int uid, Object data) {
        ...
        synchronized Event(EventLog.Event nativeEvent) {
    ...
    public static class LogReader {
        public synchronized void readEvents(int[] tags, long horizonMs, Collection<Event> events) throws IOException {
        ...
        public synchronized void writeCheckpoint(int tag) {

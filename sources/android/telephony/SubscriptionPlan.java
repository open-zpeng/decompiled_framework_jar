...
public final class SubscriptionPlan implements Parcelable {
    ...
    private synchronized SubscriptionPlan(RecurrenceRule cycleRule) {
    ...
    private synchronized SubscriptionPlan(Parcel source) {
        this.dataLimitBytes = -1L;
        this.dataLimitBehavior = -1;
        this.dataUsageBytes = -1L;
        this.dataUsageTime = -1L;
    ...
    public synchronized RecurrenceRule getCycleRule() {
    ...
    public static class Builder {
        ...
        public synchronized Builder(ZonedDateTime start, ZonedDateTime end, Period period) {

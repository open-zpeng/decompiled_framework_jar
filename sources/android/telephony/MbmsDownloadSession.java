...
public class MbmsDownloadSession implements AutoCloseable {
    ...
    private synchronized MbmsDownloadSession(Context context, Executor executor, int subscriptionId, MbmsDownloadSessionCallback callback) {
    ...
    private synchronized void validateTempFileRootSanity(File tempFileRootDirectory) throws IOException {
    ...
    private synchronized void writeDownloadRequestToken(DownloadRequest request) {
    ...
    private synchronized void deleteDownloadRequestToken(DownloadRequest request) {
        File token = getDownloadRequestTokenPath(request);
        if (!token.isFile()) {
            String str = LOG_TAG;
    ...
    private synchronized void checkDownloadRequestDestination(DownloadRequest request) {
    ...
    private synchronized File getDownloadRequestTokenPath(DownloadRequest request) {

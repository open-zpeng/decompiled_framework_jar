...
public class PhoneNumberUtils {
    ...
    public private protected static final int MIN_MATCH = 7;
    ...
    private static synchronized boolean isPause(char c) {
        return c == 'p' || c == 'P';
    }

    private static synchronized boolean isToneWait(char c) {
        return c == 'w' || c == 'W';
    }

    private static synchronized boolean isSeparator(char ch) {
    ...
    */
    public static java.lang.String getNumberFromIntent(android.content.Intent r13, android.content.Context r14) {
        ...
        L45:
            r12 = r1
            android.content.ContentResolver r1 = r14.getContentResolver()     // Catch: java.lang.Throwable -> L70 java.lang.RuntimeException -> L72
            r2 = 1
            java.lang.String[] r3 = new java.lang.String[r2]     // Catch: java.lang.Throwable -> L70 java.lang.RuntimeException -> L72
            r2 = 0
            r3[r2] = r11     // Catch: java.lang.Throwable -> L70 java.lang.RuntimeException -> L72
            r4 = 0
            r5 = 0
            r6 = 0
            r2 = r7
            android.database.Cursor r1 = r1.query(r2, r3, r4, r5, r6)     // Catch: java.lang.Throwable -> L70 java.lang.RuntimeException -> L72
            r12 = r1
            if (r12 == 0) goto L6a
            boolean r1 = r12.moveToFirst()     // Catch: java.lang.Throwable -> L70 java.lang.RuntimeException -> L72
            if (r1 == 0) goto L6a
            int r1 = r12.getColumnIndex(r11)     // Catch: java.lang.Throwable -> L70 java.lang.RuntimeException -> L72
            java.lang.String r1 = r12.getString(r1)     // Catch: java.lang.Throwable -> L70 java.lang.RuntimeException -> L72
            r0 = r1
        L6a:
            if (r12 == 0) goto L7d
        L6c:
        ...
        L72:
            ...
            android.telephony.Rlog.e(r2, r3, r1)     // Catch: java.lang.Throwable -> L70
            if (r12 == 0) goto L7d
            goto L6c
        L7d:
            return r0
    ...
    private protected static String extractNetworkPortionAlt(String phoneNumber) {
        if (phoneNumber == null) {
            return null;
        }
        int len = phoneNumber.length();
    ...
    public static synchronized String convertAndStrip(String phoneNumber) {
        return stripSeparators(convertKeypadLettersToDigits(phoneNumber));
    }

    private protected static String convertPreDial(String phoneNumber) {
        if (phoneNumber == null) {
            return null;
        }
        int len = phoneNumber.length();
    ...
    private static synchronized int minPositive(int a, int b) {
        if (a >= 0 && b >= 0) {
            return a < b ? a : b;
        } else if (a >= 0) {
            return a;
    ...
    private static synchronized int indexOfLastNetworkChar(String a) {
    ...
    private protected static boolean compare(String a, String b, boolean useStrictComparation) {
        return useStrictComparation ? compareStrictly(a, b) : compareLoosely(a, b);
    }

    private protected static boolean compareLoosely(String a, String b) {
        if (a == null || b == null) {
            return a == b;
            ...
            while (ia >= 0 && ib >= 0) {
                ...
                if (!skipCmp) {
                    ...
                    ia--;
                    ib--;
                    numNonDialableCharsInA2++;
                }
            }
            if (numNonDialableCharsInA2 < 7) {
                int effectiveALen = a.length() - numNonDialableCharsInA;
                int effectiveBLen = b.length() - numNonDialableCharsInB;
                return effectiveALen == effectiveBLen && effectiveALen == numNonDialableCharsInA2;
            } else if (numNonDialableCharsInA2 < 7 || (ia >= 0 && ib >= 0)) {
    ...
    private protected static boolean compareStrictly(String a, String b) {
        return compareStrictly(a, b, true);
    }

    private protected static boolean compareStrictly(String a, String b, boolean acceptInvalidCCCPrefix) {
        if (a == null || b == null) {
            return a == b;
        } else if (a.length() == 0 && b.length() == 0) {
            return false;
    ...
    private static synchronized String internalGetStrippedReversed(String np, int numDigits) {
        if (np == null) {
            return null;
        }
        ...
        int i = length - 1;
        for (int i2 = i; i2 >= 0 && length - i2 <= numDigits; i2--) {
            char c = np.charAt(i2);
            ret.append(c);
        }
        return ret.toString();
    ...
    private static synchronized void internalCalledPartyBCDFragmentToString(StringBuilder sb, byte[] bytes, int offset, int length, int bcdExtType) {
        char c;
        char c2;
    ...
    private static synchronized char bcdToChar(byte b, int bcdExtType) {
        if (b < 10) {
            return (char) (48 + b);
        }
    ...
    private static synchronized int charToBCD(char c, int bcdExtType) {
        if ('0' <= c && c <= '9') {
            return c - '0';
        }
        String extended = null;
    ...
    private static synchronized boolean isDialable(String address) {
    ...
    private static synchronized boolean isNonSeparator(String address) {
        int count = address.length();
        for (int i = 0; i < count; i++) {
    ...
    private static synchronized byte[] numberToCalledPartyBCDHelper(String number, boolean includeLength, int bcdExtType) {
        ...
        int digitCount = 0;
        int digitCount2 = 0;
        while (digitCount2 < numberLenReal) {
            char c2 = number.charAt(digitCount2);
            if (c2 != c) {
                int shift = (digitCount & 1) == 1 ? 4 : 0;
                int i = (digitCount >> 1) + extraBytes;
                result[i] = (byte) (((byte) ((charToBCD(c2, bcdExtType) & 15) << shift)) | result[i]);
                digitCount++;
            }
            digitCount2++;
            c = PLUS_SIGN_CHAR;
    ...
    @Deprecated
    private protected static String formatNumber(String source, int defaultFormattingType) {
        SpannableStringBuilder text = new SpannableStringBuilder(source);
    ...
    public static void formatNanpNumber(Editable text) {
        ...
        int state = 1;
        int state2 = 0;
        for (int numDashes2 = 0; numDashes2 < length2; numDashes2++) {
            char c = text.charAt(numDashes2);
            if (c != '+') {
                if (c != '-') {
                    switch (c) {
                        case '1':
                        ...
                        case '9':
                            ...
                            if (state == 3) {
                                numDashes = state2 + 1;
                                dashPositions[state2] = numDashes2;
    ...
    private static synchronized void removeDashes(Editable text) {
        int p = 0;
        while (p < text.length()) {
            if (text.charAt(p) == '-') {
                text.delete(p, p + 1);
    ...
    private static synchronized String formatNumberInternal(String rawPhoneNumber, String defaultCountryIso, PhoneNumberUtil.PhoneNumberFormat formatIdentifier) {
    ...
    public static synchronized boolean isInternationalNumber(String phoneNumber, String defaultCountryIso) {
    ...
    private protected static boolean isEmergencyNumber(int subId, String number) {
        return isEmergencyNumberInternal(subId, number, true);
    }

    public static synchronized boolean isPotentialEmergencyNumber(String number) {
        return isPotentialEmergencyNumber(getDefaultVoiceSubId(), number);
    }

    private protected static boolean isPotentialEmergencyNumber(int subId, String number) {
        return isEmergencyNumberInternal(subId, number, false);
    }

    private static synchronized boolean isEmergencyNumberInternal(String number, boolean useExactMatch) {
        return isEmergencyNumberInternal(getDefaultVoiceSubId(), number, useExactMatch);
    }

    private static synchronized boolean isEmergencyNumberInternal(int subId, String number, boolean useExactMatch) {
        return isEmergencyNumberInternal(subId, number, null, useExactMatch);
    }

    private protected static boolean isEmergencyNumber(String number, String defaultCountryIso) {
        return isEmergencyNumber(getDefaultVoiceSubId(), number, defaultCountryIso);
    }

    public static synchronized boolean isEmergencyNumber(int subId, String number, String defaultCountryIso) {
        return isEmergencyNumberInternal(subId, number, defaultCountryIso, true);
    }

    public static synchronized boolean isPotentialEmergencyNumber(String number, String defaultCountryIso) {
        return isPotentialEmergencyNumber(getDefaultVoiceSubId(), number, defaultCountryIso);
    }

    public static synchronized boolean isPotentialEmergencyNumber(int subId, String number, String defaultCountryIso) {
        return isEmergencyNumberInternal(subId, number, defaultCountryIso, false);
    }

    private static synchronized boolean isEmergencyNumberInternal(String number, String defaultCountryIso, boolean useExactMatch) {
        return isEmergencyNumberInternal(getDefaultVoiceSubId(), number, defaultCountryIso, useExactMatch);
    }

    private static synchronized boolean isEmergencyNumberInternal(int subId, String number, String defaultCountryIso, boolean useExactMatch) {
        String[] split;
        String[] split2;
    ...
    private protected static boolean isLocalEmergencyNumber(Context context, int subId, String number) {
        return isLocalEmergencyNumberInternal(subId, number, context, true);
    }

    private protected static boolean isPotentialLocalEmergencyNumber(Context context, String number) {
        return isPotentialLocalEmergencyNumber(context, getDefaultVoiceSubId(), number);
    }

    private protected static boolean isPotentialLocalEmergencyNumber(Context context, int subId, String number) {
        return isLocalEmergencyNumberInternal(subId, number, context, false);
    }

    private static synchronized boolean isLocalEmergencyNumberInternal(String number, Context context, boolean useExactMatch) {
        return isLocalEmergencyNumberInternal(getDefaultVoiceSubId(), number, context, useExactMatch);
    }

    private static synchronized boolean isLocalEmergencyNumberInternal(int subId, String number, Context context, boolean useExactMatch) {
        String countryIso;
    ...
    public static synchronized boolean isVoiceMailNumber(int subId, String number) {
    ...
    private protected static String cdmaCheckAndProcessPlusCode(String dialStr) {
    ...
    public static synchronized String cdmaCheckAndProcessPlusCodeForSms(String dialStr) {
        if (!TextUtils.isEmpty(dialStr) && isReallyDialable(dialStr.charAt(0)) && isNonSeparator(dialStr)) {
            String defaultIso = TelephonyManager.getDefault().getSimCountryIso();
    ...
    public static synchronized String cdmaCheckAndProcessPlusCodeByNumberFormat(String dialStr, int currFormat, int defaultFormat) {
    ...
    @Deprecated
    private protected static CharSequence ttsSpanAsPhoneNumber(CharSequence phoneNumber) {
        return createTtsSpannable(phoneNumber);
    }

    @Deprecated
    public static synchronized void ttsSpanAsPhoneNumber(Spannable s, int start, int end) {
    ...
    private static synchronized String splitAtNonNumerics(CharSequence number) {
        Object obj;
    ...
    private static synchronized String getCurrentIdp(boolean useNanp) {
        if (useNanp) {
    ...
    private static synchronized boolean isTwoToNine(char c) {
        if (c >= '2' && c <= '9') {
            return true;
        }
        return false;
    ...
    private static synchronized int getFormatTypeFromCountryCode(String country) {
    ...
    private protected static boolean isNanp(String dialStr) {
        if (dialStr != null) {
    ...
    private static synchronized boolean isOneNanp(String dialStr) {
        if (dialStr != null) {
    ...
    public static synchronized Uri convertSipUriToTelUri(Uri source) {
    ...
    private static synchronized String processPlusCode(String networkDialStr, boolean useNanp) {
    ...
    private static synchronized int findDialableIndexFromPostDialStr(String postDialStr) {
    ...
    private static synchronized String appendPwCharBackToOrigDialStr(int dialableIndex, String origStr, String dialStr) {
        if (dialableIndex == 1) {
    ...
    private static synchronized boolean matchIntlPrefix(String a, int len) {
        int state = 0;
        for (int state2 = 0; state2 < len; state2++) {
            char c = a.charAt(state2);
            if (state != 0) {
                if (state != 2) {
                    if (state == 4) {
                        if (c == '1') {
    ...
    private static synchronized boolean matchIntlPrefixAndCC(String a, int len) {
        int state = 0;
        for (int state2 = 0; state2 < len; state2++) {
            char c = a.charAt(state2);
            switch (state) {
    ...
    private static synchronized boolean matchTrunkPrefix(String a, int len) {
        boolean found = false;
        for (int i = 0; i < len; i++) {
            char c = a.charAt(i);
            if (c == '0' && !found) {
    ...
    private static synchronized boolean isCountryCallingCode(int countryCallingCodeCandidate) {
    ...
    private static synchronized int tryGetISODigit(char ch) {
        if ('0' <= ch && ch <= '9') {
            return ch - '0';
        }
        return -1;
    ...
    public static class CountryCallingCodeAndNewIndex {
        ...
        public synchronized CountryCallingCodeAndNewIndex(int countryCode, int newIndex) {
            this.countryCallingCode = countryCode;
            this.newIndex = newIndex;
        }
    }

    private static synchronized CountryCallingCodeAndNewIndex tryGetCountryCallingCodeAndNewIndex(String str, boolean acceptThailandCase) {
        int state = 0;
        int ccc = 0;
    ...
    private static synchronized int tryGetTrunkPrefixOmittedIndex(String str, int currentIndex) {
        int length = str.length();
    ...
    private static synchronized boolean checkPrefixIsIgnorable(String str, int forwardIndex, int backwardIndex) {
    ...
    private static synchronized int getDefaultVoiceSubId() {
        return SubscriptionManager.getDefaultVoiceSubscriptionId();
    }

    public static synchronized String convertToEmergencyNumber(Context context, String number) {
        String[] strArr;

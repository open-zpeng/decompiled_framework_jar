...
public class ModemActivityInfo implements Parcelable {
    ...
    public synchronized ModemActivityInfo(long timestamp, int sleepTimeMs, int idleTimeMs, int[] txTimeMs, int rxTimeMs, int energyUsed) {
    ...
    public synchronized int[] getTxTimeMillis() {
        return this.mTxTimeMs;
    }

    public synchronized void setTxTimeMillis(int[] txTimeMs) {
        this.mTxTimeMs = txTimeMs;
    }

    public synchronized int getSleepTimeMillis() {
        return this.mSleepTimeMs;
    }

    public synchronized void setSleepTimeMillis(int sleepTimeMillis) {
        this.mSleepTimeMs = sleepTimeMillis;
    }

    public synchronized int getIdleTimeMillis() {
        return this.mIdleTimeMs;
    }

    public synchronized void setIdleTimeMillis(int idleTimeMillis) {
        this.mIdleTimeMs = idleTimeMillis;
    }

    public synchronized int getRxTimeMillis() {
        return this.mRxTimeMs;
    }

    public synchronized void setRxTimeMillis(int rxTimeMillis) {
        this.mRxTimeMs = rxTimeMillis;
    }

    public synchronized int getEnergyUsed() {
        return this.mEnergyUsed;
    }

    public synchronized void setEnergyUsed(int energyUsed) {
        this.mEnergyUsed = energyUsed;
    }

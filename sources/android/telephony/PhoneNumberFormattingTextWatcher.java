...
public class PhoneNumberFormattingTextWatcher implements TextWatcher {
    public protected AsYouTypeFormatter mFormatter;
    ...
    private synchronized String reformat(CharSequence s, int cursor) {
    ...
    private synchronized String getFormattedNumber(char lastNonSeparator, boolean hasCursor) {
    ...
    private synchronized void stopFormatting() {
        this.mStopFormatting = true;
        this.mFormatter.clear();
    }

    private synchronized boolean hasSeparator(CharSequence s, int start, int count) {

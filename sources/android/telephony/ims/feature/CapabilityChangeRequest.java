...
public final class CapabilityChangeRequest implements Parcelable {
    ...
    public synchronized CapabilityChangeRequest() {
    ...
    private synchronized void addAllCapabilities(Set<CapabilityPair> set, int capabilities, int tech) {
    ...
    protected synchronized CapabilityChangeRequest(Parcel in) {
    ...
    public int hashCode() {
        ...
        return (31 * result) + this.mCapabilitiesToDisable.hashCode();
    }
}

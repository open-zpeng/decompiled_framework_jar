...
public final class ImsReasonInfo implements Parcelable {
    ...
    private protected int mCode;
    private protected int mExtraCode;
    private protected String mExtraMessage;

    public synchronized ImsReasonInfo() {
        this.mCode = 0;
        this.mExtraCode = 0;
        this.mExtraMessage = null;
    }

    private synchronized ImsReasonInfo(Parcel in) {
        this.mCode = in.readInt();
        this.mExtraCode = in.readInt();
        this.mExtraMessage = in.readString();
    }

    private protected ImsReasonInfo(int code, int extraCode) {
        this.mCode = code;

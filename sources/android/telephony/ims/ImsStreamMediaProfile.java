...
public final class ImsStreamMediaProfile implements Parcelable {
    ...
    private protected int mAudioDirection;
    private protected int mAudioQuality;
    public int mRttMode;
    private protected int mVideoDirection;
    public int mVideoQuality;

    public synchronized ImsStreamMediaProfile(Parcel in) {
        readFromParcel(in);
    }
    ...
    public synchronized ImsStreamMediaProfile(int audioQuality, int audioDirection, int videoQuality, int videoDirection) {
        this.mAudioQuality = audioQuality;
        this.mAudioDirection = audioDirection;
        this.mVideoQuality = videoQuality;
        this.mVideoDirection = videoDirection;
    ...
    public synchronized ImsStreamMediaProfile(int rttMode) {
        this.mRttMode = rttMode;
    }

...
public final class ImsSsData implements Parcelable {
    ...
    private synchronized ImsSsData(Parcel in) {
    ...
    public synchronized boolean isTypeCF() {
    ...
    public synchronized boolean isTypeCW() {
    ...
    public synchronized void setSuppServiceInfo(int[] ssInfo) {
        this.mSsInfo = ssInfo;
    }

    public synchronized void setImsSpecificSuppServiceInfo(ImsSsInfo[] imsSsInfo) {
        this.mImsSsInfo = imsSsInfo;
    }

    public synchronized void setCallForwardingInfo(ImsCallForwardInfo[] cfInfo) {
        this.mCfInfo = cfInfo;
    }

    public synchronized int[] getSuppServiceInfo() {
        return this.mSsInfo;
    }

    public synchronized ImsSsInfo[] getImsSpecificSuppServiceInfo() {
        return this.mImsSsInfo;
    }

    public synchronized ImsCallForwardInfo[] getCallForwardInfo() {
        return this.mCfInfo;
    }

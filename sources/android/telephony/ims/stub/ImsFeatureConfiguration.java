...
public final class ImsFeatureConfiguration implements Parcelable {
    ...
    public static final class FeatureSlotPair {
        ...
        public int hashCode() {
            ...
            return (31 * result) + this.featureType;
        }
    ...
    public synchronized ImsFeatureConfiguration() {
        this.mFeatures = new ArraySet();
    }

    public synchronized ImsFeatureConfiguration(Set<FeatureSlotPair> features) {
        this.mFeatures = new ArraySet();
        if (features != null) {
    ...
    synchronized void addFeature(int slotId, int feature) {
        this.mFeatures.add(new FeatureSlotPair(slotId, feature));
    }

    protected synchronized ImsFeatureConfiguration(Parcel in) {

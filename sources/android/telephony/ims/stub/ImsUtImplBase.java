...
public class ImsUtImplBase {
    ...
    public synchronized int queryCLIR() {
        return queryClir();
    }

    public synchronized int queryCLIP() {
        return queryClip();
    }

    public synchronized int queryCOLR() {
        return queryColr();
    }

    public synchronized int queryCOLP() {
        return queryColp();
    }
    ...
    public synchronized int updateCLIR(int clirMode) {
        return updateClir(clirMode);
    }

    public synchronized int updateCLIP(boolean enable) {
        return updateClip(enable);
    }

    public synchronized int updateCOLR(int presentation) {
        return updateColr(presentation);
    }

    public synchronized int updateCOLP(boolean enable) {
    ...
    public synchronized IImsUt getInterface() {

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 12:
                    ...
                    callSessionMergeComplete(_arg024);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 17:
                    ...
                    callSessionConferenceExtended(_arg025, _arg12);
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 19:
                    ...
                    callSessionConferenceExtendReceived(_arg026, _arg13);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 25:
                    ...
                    callSessionUssdMessageReceived(_arg027, _arg14);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionHandover(_arg028, _arg15, _arg2);
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionHandoverFailed(_arg029, _arg16, _arg22);
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg030 = data.readInt();
                    int _arg17 = data.readInt();
                    callSessionMayHandover(_arg030, _arg17);
                    return true;
                case 29:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg031 = data.readInt();
                    callSessionTtyModeReceived(_arg031);
                    return true;
                case 30:
                    data.enforceInterface(DESCRIPTOR);
                    boolean _arg032 = data.readInt() != 0;
                    callSessionMultipartyStateChanged(_arg032);
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {

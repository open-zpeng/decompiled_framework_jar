...
public class CarrierConfigManager {
    ...
    private protected static final String KEY_CARRIER_DEFAULT_ACTIONS_ON_REDIRECTION_STRING_ARRAY = "carrier_default_actions_on_redirection_string_array";
    ...
    private protected static final String KEY_DISABLE_VOICE_BARRING_NOTIFICATION_BOOL = "disable_voice_barring_notification_bool";
    ...
    static {
        ...
        sDefaults.putLong(KEY_CARRIER_DATA_CALL_APN_DELAY_FASTER_LONG, EventManager.TimedEventPair.DEFAULT_TIMEOUT);
    ...
    public synchronized String getDefaultCarrierServicePackageName() {
        try {
    ...
    private synchronized ICarrierConfigLoader getICarrierConfigLoader() {

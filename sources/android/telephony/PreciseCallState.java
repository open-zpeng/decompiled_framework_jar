...
public class PreciseCallState implements Parcelable {
    ...
    private protected PreciseCallState(int ringingCall, int foregroundCall, int backgroundCall, int disconnectCause, int preciseDisconnectCause) {
    ...
    public synchronized PreciseCallState() {
        this.mRingingCallState = -1;
        this.mForegroundCallState = -1;
        this.mBackgroundCallState = -1;
        this.mDisconnectCause = -1;
    ...
    private synchronized PreciseCallState(Parcel in) {
        this.mRingingCallState = -1;
        this.mForegroundCallState = -1;
        this.mBackgroundCallState = -1;
        this.mDisconnectCause = -1;
    ...
    private protected int getRingingCallState() {
        return this.mRingingCallState;
    }

    private protected int getForegroundCallState() {
        return this.mForegroundCallState;
    }

    private protected int getBackgroundCallState() {
        return this.mBackgroundCallState;
    }

    private protected int getDisconnectCause() {
        return this.mDisconnectCause;
    }

    private protected int getPreciseDisconnectCause() {
    ...
    public int hashCode() {
        int result = (31 * 1) + this.mRingingCallState;
        return (31 * ((31 * ((31 * ((31 * result) + this.mForegroundCallState)) + this.mBackgroundCallState)) + this.mDisconnectCause)) + this.mPreciseDisconnectCause;
    }

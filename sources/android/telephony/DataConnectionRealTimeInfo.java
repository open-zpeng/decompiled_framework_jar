...
public class DataConnectionRealTimeInfo implements Parcelable {
    ...
    public synchronized DataConnectionRealTimeInfo(long time, int dcPowerState) {
        this.mTime = time;
        this.mDcPowerState = dcPowerState;
    }

    public synchronized DataConnectionRealTimeInfo() {
        this.mTime = Long.MAX_VALUE;
        this.mDcPowerState = Integer.MAX_VALUE;
    }

    private synchronized DataConnectionRealTimeInfo(Parcel in) {
    ...
    public synchronized int getDcPowerState() {

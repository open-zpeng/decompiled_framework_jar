...
public class MbmsTempFileProvider extends ContentProvider {
    ...
    public static synchronized Uri getUriForFile(Context context, String authority, File file) {
        String pathFragment;
        try {
    ...
    public static synchronized File getFileForUri(Context context, String authority, Uri uri) throws FileNotFoundException {
    ...
    public static synchronized File getEmbmsTempFileDir(Context context) {

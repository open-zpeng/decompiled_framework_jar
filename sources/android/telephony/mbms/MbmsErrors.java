...
public class MbmsErrors {
    ...
    public static class InitializationErrors {
        ...
        private synchronized InitializationErrors() {
        }
    }
    ...
    public static class GeneralErrors {
        ...
        private synchronized GeneralErrors() {
        }
    }
    ...
    public static class StreamingErrors {
        ...
        private synchronized StreamingErrors() {
        }
    }
    ...
    public static class DownloadErrors {
        ...
        private synchronized DownloadErrors() {
        }
    }

    private synchronized MbmsErrors() {
    }
}

...
public class ServiceInfo {
    ...
    public synchronized ServiceInfo(Map<Locale, String> newNames, String newClassName, List<Locale> newLocales, String newServiceId, Date start, Date end) {
    ...
    public synchronized ServiceInfo(Parcel in) {

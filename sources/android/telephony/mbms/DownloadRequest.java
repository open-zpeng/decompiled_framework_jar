...
public final class DownloadRequest implements Parcelable {
    ...
    private static class SerializationDataContainer implements Externalizable {
        ...
        public synchronized SerializationDataContainer() {
        }

        synchronized SerializationDataContainer(DownloadRequest request) {
    ...
    private synchronized DownloadRequest(String fileServiceId, Uri source, Uri destination, int sub, String appIntent, int version) {
    ...
    private synchronized DownloadRequest(Parcel in) {
    ...
    public synchronized Intent getIntentForApp() {
        try {

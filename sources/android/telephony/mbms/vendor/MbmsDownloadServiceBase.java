...
public class MbmsDownloadServiceBase extends IMbmsDownloadService.Stub {
    ...
    private static abstract class VendorDownloadStatusListener extends DownloadStatusListener {
        ...
        protected abstract synchronized void onRemoteException(RemoteException remoteException);

        public synchronized VendorDownloadStatusListener(IDownloadStatusListener listener) {
    ...
    private static abstract class VendorDownloadProgressListener extends DownloadProgressListener {
        ...
        public synchronized VendorDownloadProgressListener(IDownloadProgressListener listener) {
            this.mListener = listener;
        }
    ...
    public final synchronized int initialize(final int subscriptionId, final IMbmsDownloadSessionCallback callback) throws RemoteException {
        if (callback == null) {
    ...
    @Override // android.telephony.mbms.vendor.IMbmsDownloadService
    public final synchronized int addStatusListener(final DownloadRequest downloadRequest, final IDownloadStatusListener listener) throws RemoteException {
        final int uid = Binder.getCallingUid();
    ...
    @Override // android.telephony.mbms.vendor.IMbmsDownloadService
    public final synchronized int removeStatusListener(DownloadRequest downloadRequest, IDownloadStatusListener listener) throws RemoteException {
        if (downloadRequest == null) {
            throw new NullPointerException("Download request must not be null");
        }
        if (listener == null) {
    ...
    @Override // android.telephony.mbms.vendor.IMbmsDownloadService
    public final synchronized int addProgressListener(final DownloadRequest downloadRequest, final IDownloadProgressListener listener) throws RemoteException {
        final int uid = Binder.getCallingUid();
        if (downloadRequest == null) {
            throw new NullPointerException("Download request must not be null");
        }
    ...
    @Override // android.telephony.mbms.vendor.IMbmsDownloadService
    public final synchronized int removeProgressListener(DownloadRequest downloadRequest, IDownloadProgressListener listener) throws RemoteException {
        if (downloadRequest == null) {
            throw new NullPointerException("Download request must not be null");
        }
        if (listener == null) {

...
public class StreamingService implements AutoCloseable {
    ...
    public synchronized StreamingService(int subscriptionId, IMbmsStreamingService service, MbmsStreamingSession session, StreamingServiceInfo streamingServiceInfo, InternalStreamingServiceCallback callback) {
    ...
    public synchronized InternalStreamingServiceCallback getCallback() {
        return this.mCallback;
    }

    private synchronized void sendErrorToApp(int errorCode, String message) {
        try {

...
public class CdmaSmsCbProgramData implements Parcelable {
    ...
    public synchronized CdmaSmsCbProgramData(int operation, int category, int language, int maxMessages, int alertOption, String categoryName) {
    ...
    synchronized CdmaSmsCbProgramData(Parcel in) {
    ...
    public synchronized int getAlertOption() {

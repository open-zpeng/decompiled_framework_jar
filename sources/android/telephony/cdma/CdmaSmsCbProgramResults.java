...
public class CdmaSmsCbProgramResults implements Parcelable {
    ...
    public synchronized CdmaSmsCbProgramResults(int category, int language, int categoryResult) {
        this.mCategory = category;
        this.mLanguage = language;
        this.mCategoryResult = categoryResult;
    }

    synchronized CdmaSmsCbProgramResults(Parcel in) {
    ...
    public synchronized int getCategoryResult() {

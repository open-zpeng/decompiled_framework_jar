...
public final class DownloadableSubscription implements Parcelable {
    ...
    @Deprecated
    private protected final String encodedActivationCode;

    public String getEncodedActivationCode() {
        return this.encodedActivationCode;
    }

    private synchronized DownloadableSubscription(String encodedActivationCode) {
        this.encodedActivationCode = encodedActivationCode;
    }

    private synchronized DownloadableSubscription(Parcel in) {
    ...
    private synchronized DownloadableSubscription(String encodedActivationCode, String confirmationCode, String carrierName, List<UiccAccessRule> accessRules) {
        this.encodedActivationCode = encodedActivationCode;
    ...
    @Deprecated
    public synchronized void setConfirmationCode(String confirmationCode) {
        this.confirmationCode = confirmationCode;
    }
    ...
    @Deprecated
    private protected void setCarrierName(String carrierName) {
        this.carrierName = carrierName;
    }
    ...
    @Deprecated
    public synchronized void setAccessRules(List<UiccAccessRule> accessRules) {
        this.accessRules = accessRules;
    }

    @Deprecated
    private protected void setAccessRules(UiccAccessRule[] accessRules) {

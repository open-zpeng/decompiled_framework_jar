...
public final class EuiccNotification implements Parcelable {
    ...
    public int hashCode() {
        int result = (31 * 1) + this.mSeq;
        return (31 * ((31 * ((31 * result) + Objects.hashCode(this.mTargetAddr))) + this.mEvent)) + Arrays.hashCode(this.mData);
    }
    ...
    private synchronized EuiccNotification(Parcel source) {

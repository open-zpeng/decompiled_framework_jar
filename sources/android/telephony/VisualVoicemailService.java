...
public abstract class VisualVoicemailService extends Service {
    ...
    public static class VisualVoicemailTask {
        ...
        private synchronized VisualVoicemailTask(Messenger replyTo, int taskId) {
            this.mTaskId = taskId;
    ...
    private static synchronized int getSubId(Context context, PhoneAccountHandle phoneAccountHandle) {
        TelephonyManager telephonyManager = (TelephonyManager) context.getSystemService(TelephonyManager.class);

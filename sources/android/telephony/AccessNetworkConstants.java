...
public final class AccessNetworkConstants {
    ...
    public static final class AccessNetworkType {
        ...
        private synchronized AccessNetworkType() {
        }
    }
    ...
    public static final class TransportType {
        ...
        private synchronized TransportType() {
        }
    }
    ...
    public static final class GeranBand {
        ...
        private synchronized GeranBand() {
        }
    }
    ...
    public static final class UtranBand {
        ...
        private synchronized UtranBand() {
        }
    }
    ...
    public static final class EutranBand {
        ...
        private synchronized EutranBand() {
        }
    }
    ...
    public static final class CdmaBands {
        ...
        private synchronized CdmaBands() {
        }
    }

    private synchronized AccessNetworkConstants() {
    }
}

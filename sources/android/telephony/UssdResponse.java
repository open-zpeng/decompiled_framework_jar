...
public final class UssdResponse implements Parcelable {
    ...
    public synchronized String getUssdRequest() {
        return this.mUssdRequest;
    }

    public synchronized CharSequence getReturnMessage() {
    ...
    public synchronized UssdResponse(String ussdRequest, CharSequence returnMessage) {

...
public class RadioAccessFamily implements Parcelable {
    ...
    private protected RadioAccessFamily(int phoneId, int radioAccessFamily) {
        this.mPhoneId = phoneId;
        this.mRadioAccessFamily = radioAccessFamily;
    }

    private protected int getPhoneId() {
        return this.mPhoneId;
    }

    private protected int getRadioAccessFamily() {
    ...
    private protected static int getRafFromNetworkType(int type) {
        switch (type) {
            case 0:
                return 101902;
            case 1:
    ...
    private static synchronized int getAdjustedRaf(int raf) {
        ...
        return (540672 & raf5) > 0 ? 540672 | raf5 : raf5;
    }

    public static synchronized int getHighestRafCapability(int raf) {
        if ((540672 & raf) > 0) {
            return 3;
        }
    ...
    private protected static int getNetworkTypeFromRaf(int raf) {
    ...
    public static synchronized int singleRafTypeFromString(String rafString) {
        char c;
    ...
    public static synchronized int rafTypeFromString(String rafList) {

...
public final class ClientRequestStats implements Parcelable {
    ...
    public synchronized ClientRequestStats(Parcel in) {
    ...
    public synchronized ClientRequestStats() {
        this.mCompletedRequestsWakelockTime = 0L;
        this.mCompletedRequestsCount = 0L;
        this.mPendingRequestsWakelockTime = 0L;
        this.mPendingRequestsCount = 0L;
    ...
    public synchronized ClientRequestStats(ClientRequestStats clientRequestStats) {
        this.mCompletedRequestsWakelockTime = 0L;
        this.mCompletedRequestsCount = 0L;
        this.mPendingRequestsWakelockTime = 0L;
        this.mPendingRequestsCount = 0L;
    ...
    public synchronized void setCallingPackage(String mCallingPackage) {
        this.mCallingPackage = mCallingPackage;
    }

    public synchronized long getCompletedRequestsWakelockTime() {
        return this.mCompletedRequestsWakelockTime;
    }

    public synchronized void addCompletedWakelockTime(long completedRequestsWakelockTime) {
        this.mCompletedRequestsWakelockTime += completedRequestsWakelockTime;
    }

    public synchronized long getPendingRequestsWakelockTime() {
        return this.mPendingRequestsWakelockTime;
    }

    public synchronized void setPendingRequestsWakelockTime(long pendingRequestsWakelockTime) {
        this.mPendingRequestsWakelockTime = pendingRequestsWakelockTime;
    }

    public synchronized long getCompletedRequestsCount() {
        return this.mCompletedRequestsCount;
    }

    public synchronized void incrementCompletedRequestsCount() {
        this.mCompletedRequestsCount++;
    }

    public synchronized long getPendingRequestsCount() {
        return this.mPendingRequestsCount;
    }

    public synchronized void setPendingRequestsCount(long pendingRequestsCount) {
        this.mPendingRequestsCount = pendingRequestsCount;
    }

    public synchronized List<TelephonyHistogram> getRequestHistograms() {
    ...
    public synchronized void updateRequestHistograms(int requestId, int time) {
        synchronized (this.mRequestHistograms) {

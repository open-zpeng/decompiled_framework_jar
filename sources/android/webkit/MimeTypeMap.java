...
public class MimeTypeMap {
    ...
    private synchronized MimeTypeMap() {
    }
    ...
    private static synchronized String mimeTypeFromExtension(String extension) {
        return MimeUtils.guessMimeTypeFromExtension(extension);
    }
    ...
    synchronized String remapGenericMimeType(String mimeType, String url, String contentDisposition) {

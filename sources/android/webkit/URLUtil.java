...
public final class URLUtil {
    ...
    public private protected static boolean verifyURLEncoding(String url) {
    ...
    private static synchronized int parseHex(byte b) {
        if (b < 48 || b > 57) {
            if (b < 65 || b > 70) {
                if (b < 97 || b > 102) {
    ...
    private protected static boolean isResourceUrl(String url) {
    ...
    public private protected static String parseContentDisposition(String contentDisposition) {
        try {

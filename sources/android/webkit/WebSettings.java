...
public abstract class WebSettings {
    ...
    public enum TextSize {
        ...
        public private protected int value;
    ...
    @Deprecated
    private protected void setUseDoubleTree(boolean use) {
    }

    @Deprecated
    private protected boolean getUseDoubleTree() {
        return false;
    }

    @Deprecated
    private protected void setPluginsPath(String pluginsPath) {
    }

    @Deprecated
    private protected String getPluginsPath() {
        return "";
    }

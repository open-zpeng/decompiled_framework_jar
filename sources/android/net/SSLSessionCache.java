...
public final class SSLSessionCache {
    ...
    public private protected final SSLClientSessionCache mSessionCache;

    public static synchronized void install(SSLSessionCache cache, SSLContext context) {
    ...
    public synchronized SSLSessionCache(Object cache) {

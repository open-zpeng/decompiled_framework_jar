        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    IpSecSpiResponse _result = allocateSecurityParameterIndex(_arg04, _arg13, _arg22);
                ...
                case 3:
                    ...
                    IpSecUdpEncapResponse _result2 = openUdpEncapsulationSocket(_arg06, _arg14);
                    reply.writeNoException();
                    if (_result2 != null) {
                        reply.writeInt(1);
                ...
                case 5:
                    ...
                    IpSecTunnelInterfaceResponse _result3 = createTunnelInterface(_arg08, _arg15, _arg2, _arg3, _arg4);
                    reply.writeNoException();
                    if (_result3 != null) {
                        reply.writeInt(1);
                ...
                case 8:
                    ...
                    deleteTunnelInterface(_arg011, _arg16);
                    reply.writeNoException();
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    IpSecTransformResponse _result4 = createTransform(_arg0, _arg17, _arg25);
                    reply.writeNoException();
                    if (_result4 != null) {
                        reply.writeInt(1);
                ...
                case 11:
                    ...
                    applyTransportModeTransform(_arg02, _arg18, _arg26);
                    reply.writeNoException();
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    applyTunnelModeTransform(_arg013, _arg19, _arg27, _arg32);
                    reply.writeNoException();
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);

...
public class LinkQualityInfo implements Parcelable {
    ...
    public synchronized void writeToParcel(Parcel dest, int flags, int objectType) {
    ...
    public synchronized void initializeFromParcel(Parcel in) {
    ...
    public synchronized int getNormalizedSignalStrength() {
        return this.mNormalizedSignalStrength;
    }

    public synchronized void setNormalizedSignalStrength(int normalizedSignalStrength) {
    ...
    private protected void setPacketCount(long packetCount) {
        this.mPacketCount = packetCount;
    }

    public synchronized long getPacketErrorCount() {
        return this.mPacketErrorCount;
    }

    private protected void setPacketErrorCount(long packetErrorCount) {
        this.mPacketErrorCount = packetErrorCount;
    }

    public synchronized int getTheoreticalTxBandwidth() {
        return this.mTheoreticalTxBandwidth;
    }

    public synchronized void setTheoreticalTxBandwidth(int theoreticalTxBandwidth) {
        this.mTheoreticalTxBandwidth = theoreticalTxBandwidth;
    }

    public synchronized int getTheoreticalRxBandwidth() {
        return this.mTheoreticalRxBandwidth;
    }

    public synchronized void setTheoreticalRxBandwidth(int theoreticalRxBandwidth) {
        this.mTheoreticalRxBandwidth = theoreticalRxBandwidth;
    }

    public synchronized int getTheoreticalLatency() {
        return this.mTheoreticalLatency;
    }

    public synchronized void setTheoreticalLatency(int theoreticalLatency) {
        this.mTheoreticalLatency = theoreticalLatency;
    }

    public synchronized long getLastDataSampleTime() {
        return this.mLastDataSampleTime;
    }

    private protected void setLastDataSampleTime(long lastDataSampleTime) {
        this.mLastDataSampleTime = lastDataSampleTime;
    }

    public synchronized int getDataSampleDuration() {
        return this.mDataSampleDuration;
    }

    private protected void setDataSampleDuration(int dataSampleDuration) {

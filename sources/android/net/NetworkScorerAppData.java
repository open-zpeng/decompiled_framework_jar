...
public final class NetworkScorerAppData implements Parcelable {
    ...
    public synchronized NetworkScorerAppData(int packageUid, ComponentName recommendationServiceComp, String recommendationServiceLabel, ComponentName enableUseOpenWifiActivity, String networkAvailableNotificationChannelId) {
    ...
    protected synchronized NetworkScorerAppData(Parcel in) {
    ...
    public synchronized String getRecommendationServicePackageName() {
        return this.mRecommendationService.getPackageName();
    }

    public synchronized ComponentName getRecommendationServiceComponent() {
        return this.mRecommendationService;
    }

    public synchronized ComponentName getEnableUseOpenWifiActivity() {
        return this.mEnableUseOpenWifiActivity;
    }

    public synchronized String getRecommendationServiceLabel() {
        return this.mRecommendationServiceLabel;
    }

    public synchronized String getNetworkAvailableNotificationChannelId() {

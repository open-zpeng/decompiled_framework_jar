...
public final class IpPrefix implements Parcelable {
    ...
    private synchronized void checkAndMaskAddressAndPrefixLength() {
    ...
    public synchronized IpPrefix(byte[] address, int prefixLength) {
        this.address = (byte[]) address.clone();
        this.prefixLength = prefixLength;
        checkAndMaskAddressAndPrefixLength();
    }

    public synchronized IpPrefix(InetAddress address, int prefixLength) {
        this.address = address.getAddress();
        this.prefixLength = prefixLength;
        checkAndMaskAddressAndPrefixLength();
    }

    public synchronized IpPrefix(String prefix) {
    ...
    public synchronized boolean containsPrefix(IpPrefix otherPrefix) {
    ...
    public synchronized boolean isIPv6() {
    ...
    public static synchronized Comparator<IpPrefix> lengthComparator() {

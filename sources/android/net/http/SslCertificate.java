...
public class SslCertificate {
    ...
    public protected final X509Certificate mX509Certificate;
    ...
    private synchronized SslCertificate(String issuedTo, String issuedBy, Date validNotBefore, Date validNotAfter, X509Certificate x509Certificate) {
    ...
    public protected static String getSerialNumber(X509Certificate x509Certificate) {
    ...
    public protected static String getDigest(X509Certificate x509Certificate, String algorithm) {
        if (x509Certificate == null) {
            return "";
        }
        try {
    ...
    private static final synchronized String fingerprint(byte[] bytes) {
        if (bytes == null) {
            return "";
        }
    ...
    private static synchronized Date parseDate(String string) {
        try {
    ...
    private static synchronized Date cloneDate(Date date) {
        if (date == null) {
            return null;
        }
    ...
    private protected View inflateCertificateView(Context context) {
    ...
    private synchronized String formatCertificateDate(Context context, Date certificateDate) {

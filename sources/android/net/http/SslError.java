...
public class SslError {
    ...
    public private protected final SslCertificate mCertificate;
    public private protected int mErrors;
    public private protected final String mUrl;
    ...
    public static synchronized SslError SslErrorFromChromiumErrorCode(int error, SslCertificate cert, String url) {
        if (error == -200) {

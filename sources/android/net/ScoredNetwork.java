...
public class ScoredNetwork implements Parcelable {
    ...
    private synchronized ScoredNetwork(Parcel in) {
    ...
    private synchronized boolean bundleEquals(Bundle bundle1, Bundle bundle2) {
        if (bundle1 == bundle2) {
            return true;
        }
    ...
    public synchronized boolean hasRankingScore() {
        return this.rssiCurve != null || (this.attributes != null && this.attributes.containsKey(ATTRIBUTES_KEY_RANKING_SCORE_OFFSET));
    }

    public synchronized int calculateRankingScore(int rssi) throws UnsupportedOperationException {
        if (!hasRankingScore()) {

...
public class TrafficStats {
    ...
    public static final int TAG_XP_NET_PROBE = -186;
    @Deprecated
    ...
    public protected static synchronized INetworkStatsService getStatsService() {
    ...
    @Deprecated
    private protected static void setThreadStatsUidSelf() {
    ...
    public static synchronized void startDataProfiling(Context context) {
    ...
    public static synchronized NetworkStats stopDataProfiling(Context context) {
    ...
    public static synchronized void closeQuietly(INetworkStatsSession session) {
        if (session != null) {
            try {
                session.close();
    ...
    private static synchronized long addIfSupported(long stat) {
        if (stat == -1) {
            return 0L;
        }
        return stat;
    ...
    private protected static long getMobileTcpRxPackets() {
        String[] mobileIfaces;
        long total = 0;
        for (String iface : getMobileIfaces()) {
            try {
    ...
    private protected static long getMobileTcpTxPackets() {
        String[] mobileIfaces;
        long total = 0;
        for (String iface : getMobileIfaces()) {
            try {
    ...
    public static synchronized long getTxPackets(String iface) {
        try {
    ...
    public static synchronized long getRxPackets(String iface) {
        try {
    ...
    private protected static long getTxBytes(String iface) {
        try {
    ...
    private protected static long getRxBytes(String iface) {
        try {
    ...
    private static synchronized NetworkStats getDataLayerSnapshotForUid(Context context) {
        int uid = Process.myUid();
        try {
    ...
    public protected static String[] getMobileIfaces() {
        try {

...
public final class NsdServiceInfo implements Parcelable {
    ...
    public synchronized NsdServiceInfo(String sn, String rt) {
    ...
    public synchronized void setTxtRecords(String rawRecords) {
        byte[] value;
        String key;
        int pos = 0;
    ...
    private protected void setAttribute(String key, byte[] value) {
        if (TextUtils.isEmpty(key)) {
    ...
    private synchronized int getTxtRecordSize() {
        int txtRecordSize = 0;
    ...
    public synchronized byte[] getTxtRecord() {
        int txtRecordSize = getTxtRecordSize();
        if (txtRecordSize == 0) {
            return new byte[0];
        }

...
public interface IWifiScanner extends IInterface {
    synchronized Bundle getAvailableChannels(int i) throws RemoteException;

    synchronized Messenger getMessenger() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IWifiScanner {
        ...
        private static class Proxy implements IWifiScanner {
            ...
            public synchronized Messenger getMessenger() throws RemoteException {
                Messenger _result;
            ...
            @Override // android.net.wifi.IWifiScanner
            public synchronized Bundle getAvailableChannels(int band) throws RemoteException {
                Bundle _result;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {

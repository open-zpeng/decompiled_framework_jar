...
public class WifiConfiguration implements Parcelable {
    ...
    public static class KeyMgmt {
        ...
        public static final String[] strings = {"NONE", "WPA_PSK", "WPA_EAP", "IEEE8021X", "WPA2_PSK", "OSEN", "FT_PSK", "FT_EAP", "SAE", "OWE", "SUITE_B_192", "WPA_PSK_SHA256", "WPA_EAP_SHA256"};
    ...
    private String trimStringForKeyId(String string) {
        return string == null ? "" : string.replace("\"", "").replace(WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER, "");
    }
    ...
    public String getSsidAndSecurityTypeString() {
        if (this.allowedKeyManagement.get(1)) {
            ...
            String key7 = this.SSID + KeyMgmt.strings[0];
            return key7;
        }
    }

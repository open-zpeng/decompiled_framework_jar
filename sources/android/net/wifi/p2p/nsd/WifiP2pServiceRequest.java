...
public class WifiP2pServiceRequest implements Parcelable {
    private protected static final Parcelable.Creator<WifiP2pServiceRequest> CREATOR = new Parcelable.Creator<WifiP2pServiceRequest>() { // from class: android.net.wifi.p2p.nsd.WifiP2pServiceRequest.1
    ...
    public private WifiP2pServiceRequest(int protocolType, String query) {
        validateQuery(query);
    ...
    private synchronized WifiP2pServiceRequest(int serviceType, int length, int transId, String query) {
    ...
    public synchronized String getSupplicantQuery() {
    ...
    private synchronized void validateQuery(String query) {
        if (query == null) {
            return;
        }
        if (query.length() % 2 != 1) {

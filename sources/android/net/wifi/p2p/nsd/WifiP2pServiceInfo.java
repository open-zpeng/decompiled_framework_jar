...
public class WifiP2pServiceInfo implements Parcelable {
    private protected static final Parcelable.Creator<WifiP2pServiceInfo> CREATOR = new Parcelable.Creator<WifiP2pServiceInfo>() { // from class: android.net.wifi.p2p.nsd.WifiP2pServiceInfo.1
    ...
    public protected List<String> mQueryList;

    public private WifiP2pServiceInfo(List<String> queryList) {
        if (queryList == null) {
    ...
    public synchronized List<String> getSupplicantQueryList() {
        return this.mQueryList;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized String bin2HexStr(byte[] data) {

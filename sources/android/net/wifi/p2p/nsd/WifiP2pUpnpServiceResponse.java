...
public class WifiP2pUpnpServiceResponse extends WifiP2pServiceResponse {
    ...
    public synchronized List<String> getUniqueServiceNames() {
        return this.mUniqueServiceNames;
    }

    protected synchronized WifiP2pUpnpServiceResponse(int status, int transId, WifiP2pDevice dev, byte[] data) {
    ...
    public static synchronized WifiP2pUpnpServiceResponse newInstance(int status, int transId, WifiP2pDevice device, byte[] data) {
        if (status != 0) {

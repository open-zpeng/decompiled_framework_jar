...
public class WifiP2pDnsSdServiceInfo extends WifiP2pServiceInfo {
    ...
    private synchronized WifiP2pDnsSdServiceInfo(List<String> queryList) {
        super(queryList);
    }
    ...
    private static synchronized String createPtrServiceQuery(String instanceName, String serviceType) {
    ...
    private static synchronized String createTxtServiceQuery(String instanceName, String serviceType, DnsSdTxtRecord txtRecord) {
        StringBuffer sb = new StringBuffer();
        sb.append("bonjour ");
    ...
    public private protected static String createRequest(String dnsName, int dnsType, int version) {
        StringBuffer sb = new StringBuffer();
        if (dnsType == 16) {
    ...
    private static synchronized String compressDnsName(String dnsName) {
        StringBuffer sb = new StringBuffer();
        while (true) {

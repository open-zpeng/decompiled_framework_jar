...
public class WifiP2pDnsSdServiceRequest extends WifiP2pServiceRequest {
    private synchronized WifiP2pDnsSdServiceRequest(String query) {
        super(1, query);
    }

    private synchronized WifiP2pDnsSdServiceRequest() {
        super(1, null);
    }

    private synchronized WifiP2pDnsSdServiceRequest(String dnsQuery, int dnsType, int version) {

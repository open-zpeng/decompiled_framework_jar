...
public class WifiP2pManager {
    ...
    public static final int SET_WFDR2_INFO = 139363;
    public static final int SET_WFDR2_INFO_FAILED = 139364;
    public static final int SET_WFDR2_INFO_SUCCEEDED = 139365;
        ...
        public class P2pHandler extends Handler {
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    ...
                    case WifiP2pManager.SET_WFDR2_INFO_FAILED /* 139364 */:
                        if (listener != null) {
                    ...
                    case WifiP2pManager.SET_WFDR2_INFO_SUCCEEDED /* 139365 */:
                        if (listener != null) {
    ...
    public Channel initialize(Context srcContext, Looper srcLooper, ChannelListener listener) {
        if ("com.huawei.nearby".equals(srcContext.getPackageName())) {
            Log.w(TAG, "hicar patch,do fake initialize...");
            return new Channel(srcContext, srcLooper, listener, new Binder(), this);
        }
    ...
    public boolean setP2pTetherConfiguration(WifiP2pConfig config) {
        try {
            return this.mService.setP2pTetherConfiguration(config);
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public WifiP2pConfig getP2pTetherConfiguration() {
        try {
            return this.mService.getP2pTetherConfiguration();
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    }
    ...
    public boolean setP2pTetherEnabled(Channel c, boolean enable) {
        checkChannel(c);
        if (enable) {
            Message resultMsg = c.mAsyncChannel.sendMessageSynchronously(CREATE_GROUP, -3);
            if (resultMsg != null && resultMsg.what == 139279) {
                return true;
            }
        } else {
            Message resultMsg2 = c.mAsyncChannel.sendMessageSynchronously(REMOVE_GROUP, 0);
            if (resultMsg2 != null && resultMsg2.what == 139282) {
                return true;
            }
        }

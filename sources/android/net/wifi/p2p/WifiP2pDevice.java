...
public class WifiP2pDevice implements Parcelable {
    ...
    private protected int deviceCapability;
    public String deviceName;
    private protected int groupCapability;
    public String primaryDeviceType;
    public String secondaryDeviceType;
    public int status;
    private protected WifiP2pWfdInfo wfdInfo;
    private protected int wpsConfigMethodsSupported;
    ...
    public synchronized boolean isInvitationCapable() {
        return (this.deviceCapability & 32) != 0;
    }

    public synchronized boolean isDeviceLimit() {
    ...
    public synchronized boolean isGroupLimit() {
    ...
    private synchronized int parseHex(String hexString) {

...
public final class WifiActivityEnergyInfo implements Parcelable {
    ...
    public synchronized WifiActivityEnergyInfo(long timestamp, int stackState, long txTime, long[] txTimePerLevel, long rxTime, long scanTime, long idleTime, long energyUsed) {
    ...
    public synchronized int getStackState() {
    ...
    public synchronized long getControllerTxTimeMillisAtLevel(int level) {
    ...
    public synchronized long getControllerScanTimeMillis() {

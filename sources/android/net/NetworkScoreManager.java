...
public class NetworkScoreManager {
    ...
    public synchronized NetworkScoreManager(Context context) throws ServiceManager.ServiceNotFoundException {
    ...
    public synchronized NetworkScorerAppData getActiveScorer() {
        try {
    ...
    public synchronized List<NetworkScorerAppData> getAllValidScorers() {
        try {
    ...
    public synchronized boolean requestScores(NetworkKey[] networks) throws SecurityException {
        try {
    ...
    @Deprecated
    public synchronized void registerNetworkScoreCache(int networkType, INetworkScoreCache scoreCache) {
        registerNetworkScoreCache(networkType, scoreCache, 0);
    }

    public synchronized void registerNetworkScoreCache(int networkType, INetworkScoreCache scoreCache, int filterType) {
        try {
    ...
    public synchronized void unregisterNetworkScoreCache(int networkType, INetworkScoreCache scoreCache) {
        try {
    ...
    public synchronized boolean isCallerActiveScorer(int callingUid) {
        try {

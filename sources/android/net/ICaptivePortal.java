...
public interface ICaptivePortal extends IInterface {
    synchronized void appResponse(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ICaptivePortal {
        ...
        public static synchronized ICaptivePortal asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ICaptivePortal {
            ...
            public synchronized void appResponse(int response) throws RemoteException {

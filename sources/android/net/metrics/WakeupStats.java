...
public class WakeupStats {
    ...
    public synchronized WakeupStats(String iface) {
        this.iface = iface;
    }
    ...
    public synchronized void countEvent(WakeupEvent ev) {
        this.totalWakeups++;
        int i = ev.uid;
        if (i == 1000) {
            this.systemWakeups++;
    ...
    private static synchronized void increment(SparseIntArray counters, int key) {

...
public final class NetworkEvent implements Parcelable {
    ...
    public synchronized NetworkEvent(int eventType, long durationMs) {
        this.eventType = eventType;
        this.durationMs = durationMs;
    }

    public synchronized NetworkEvent(int eventType) {
        this(eventType, 0L);
    }

    private synchronized NetworkEvent(Parcel in) {

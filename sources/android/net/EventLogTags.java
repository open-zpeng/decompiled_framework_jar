...
public class EventLogTags {
    ...
    public static synchronized void writeNtpSuccess(String server, long rtt, long offset) {
        EventLog.writeEvent((int) NTP_SUCCESS, server, Long.valueOf(rtt), Long.valueOf(offset));
    }

    public static synchronized void writeNtpFailure(String server, String msg) {

...
public interface INetworkRecommendationProvider extends IInterface {
    synchronized void requestScores(NetworkKey[] networkKeyArr) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements INetworkRecommendationProvider {
        ...
        public static synchronized INetworkRecommendationProvider asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements INetworkRecommendationProvider {
            ...
            public synchronized void requestScores(NetworkKey[] networks) throws RemoteException {

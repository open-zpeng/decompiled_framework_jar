...
public final class IpSecSpiResponse implements Parcelable {
    ...
    public synchronized IpSecSpiResponse(int inStatus, int inResourceId, int inSpi) {
        this.status = inStatus;
        this.resourceId = inResourceId;
        this.spi = inSpi;
    }

    public synchronized IpSecSpiResponse(int inStatus) {
        if (inStatus == 0) {
    ...
    private synchronized IpSecSpiResponse(Parcel in) {

...
public final class Proxy {
    ...
    private protected static final java.net.Proxy getProxy(Context ctx, String url) {
    ...
    private static final synchronized boolean isLocalHost(String host) {
    ...
    public static synchronized int validate(String hostname, String port, String exclList) {
    ...
    public static final synchronized void setHttpProxySystemProperty(String host, String port, String exclList, Uri pacFileUrl) {
        if (exclList != null) {

...
public interface INetworkScoreCache extends IInterface {
    synchronized void clearScores() throws RemoteException;

    synchronized void updateScores(List<ScoredNetwork> list) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements INetworkScoreCache {
        ...
        public static synchronized INetworkScoreCache asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements INetworkScoreCache {
            ...
            public synchronized void updateScores(List<ScoredNetwork> networks) throws RemoteException {
            ...
            @Override // android.net.INetworkScoreCache
            public synchronized void clearScores() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public final class IpSecTunnelInterfaceResponse implements Parcelable {
    ...
    public synchronized IpSecTunnelInterfaceResponse(int inStatus) {
        if (inStatus == 0) {
    ...
    public synchronized IpSecTunnelInterfaceResponse(int inStatus, int inResourceId, String inInterfaceName) {
        this.status = inStatus;
        this.resourceId = inResourceId;
        this.interfaceName = inInterfaceName;
    }

    private synchronized IpSecTunnelInterfaceResponse(Parcel in) {

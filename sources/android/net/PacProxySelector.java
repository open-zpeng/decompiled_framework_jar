...
public class PacProxySelector extends ProxySelector {
    ...
    public synchronized PacProxySelector() {
    ...
    private static synchronized List<java.net.Proxy> parseResponse(String response) {
    ...
    private static synchronized java.net.Proxy proxyFromHostPort(Proxy.Type type, String hostPortString) {
        try {

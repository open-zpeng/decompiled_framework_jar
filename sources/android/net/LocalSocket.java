...
public class LocalSocket implements Closeable {
    ...
    public protected final LocalSocketImpl impl;
    ...
    private synchronized LocalSocket(LocalSocketImpl impl, int sockType) {
        this.impl = impl;
    ...
    public static synchronized LocalSocket createConnectedLocalSocket(FileDescriptor fd) {
        return createConnectedLocalSocket(new LocalSocketImpl(fd), 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized LocalSocket createLocalSocketForAccept(LocalSocketImpl impl) {
        return createConnectedLocalSocket(impl, 0);
    }

    private static synchronized LocalSocket createConnectedLocalSocket(LocalSocketImpl impl, int sockType) {
    ...
    private synchronized void implCreateIfNeeded() throws IOException {
        if (!this.implCreated) {
            synchronized (this) {
                if (!this.implCreated) {

...
public final class IpSecUdpEncapResponse implements Parcelable {
    ...
    public synchronized IpSecUdpEncapResponse(int inStatus) {
        if (inStatus == 0) {
    ...
    public synchronized IpSecUdpEncapResponse(int inStatus, int inResourceId, int inPort, FileDescriptor inFd) throws IOException {
    ...
    private synchronized IpSecUdpEncapResponse(Parcel in) {

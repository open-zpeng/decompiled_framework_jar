...
public class NetworkWatchlistManager {
    ...
    public synchronized NetworkWatchlistManager(Context context, INetworkWatchlistManager manager) {
        this.mContext = context;
        this.mNetworkWatchlistManager = manager;
    }

    public synchronized NetworkWatchlistManager(Context context) {
    ...
    public synchronized void reportWatchlistIfNecessary() {
        try {
    ...
    public synchronized void reloadWatchlist() {
        try {
    ...
    public synchronized byte[] getWatchlistConfigHash() {
        try {

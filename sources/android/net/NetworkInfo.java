...
public class NetworkInfo implements Parcelable {
    ...
    private protected NetworkInfo(int type, int subtype, String typeName, String subtypeName) {
    ...
    private protected void setSubtype(int subtype, String subtypeName) {
        synchronized (this) {
            this.mSubtype = subtype;
            this.mSubtypeName = subtypeName;
        }
    ...
    @Deprecated
    private protected void setIsAvailable(boolean isAvailable) {
        synchronized (this) {
    ...
    @Deprecated
    private protected void setFailover(boolean isFailover) {
        synchronized (this) {
    ...
    @VisibleForTesting
    @Deprecated
    private protected void setRoaming(boolean isRoaming) {
        synchronized (this) {
    ...
    @Deprecated
    private protected void setDetailedState(DetailedState detailedState, String reason, String extraInfo) {
        synchronized (this) {
    ...
    public synchronized void setExtraInfo(String extraInfo) {
        this.mExtraInfo = extraInfo;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        synchronized (this) {
            ...
            dest.writeInt(this.mIsPersist ? 1 : 0);

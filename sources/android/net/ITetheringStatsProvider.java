...
public interface ITetheringStatsProvider extends IInterface {
    ...
    synchronized NetworkStats getTetherStats(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ITetheringStatsProvider {
        ...
        public static synchronized ITetheringStatsProvider asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ITetheringStatsProvider {
            ...
            public synchronized NetworkStats getTetherStats(int how) throws RemoteException {

...
public class PreferenceFrameLayout extends FrameLayout {
    ...
    public synchronized PreferenceFrameLayout(Context context) {
        this(context, null);
    }

    public synchronized PreferenceFrameLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.preferenceFrameLayoutStyle);
    }

    public synchronized PreferenceFrameLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    public synchronized PreferenceFrameLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        public synchronized LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
        ...
        public synchronized LayoutParams(int width, int height) {
            super(width, height);
            this.removeBorders = false;
        }
    }

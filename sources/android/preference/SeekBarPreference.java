...
public class SeekBarPreference extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public synchronized SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private protected SeekBarPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, 0);
    }

    private protected SeekBarPreference(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.seekBarPreferenceStyle);
    }

    private protected SeekBarPreference(Context context) {
        this(context, null);
    }
    ...
    private synchronized void setProgress(int progress, boolean notifyChanged) {
    ...
    synchronized void syncProgress(SeekBar seekBar) {

...
public class PreferenceManager {
    ...
    public protected List<OnActivityDestroyListener> mActivityDestroyListeners;
    private List<OnActivityResultListener> mActivityResultListeners;
    private List<OnActivityStopListener> mActivityStopListeners;
    private Context mContext;
    private SharedPreferences.Editor mEditor;
    public protected PreferenceFragment mFragment;
    private int mNextRequestCode;
    private boolean mNoCommit;
    public protected OnPreferenceTreeClickListener mOnPreferenceTreeClickListener;
    private PreferenceDataStore mPreferenceDataStore;
    private PreferenceScreen mPreferenceScreen;
    private List<DialogInterface> mPreferencesScreens;
    public protected SharedPreferences mSharedPreferences;
    ...
    public interface OnPreferenceTreeClickListener {
        synchronized boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference);
    }
    ...
    public private protected PreferenceManager(Context context) {
        init(context);
    }
    ...
    public private protected void setFragment(PreferenceFragment fragment) {
        this.mFragment = fragment;
    }

    public private protected PreferenceFragment getFragment() {
    ...
    private synchronized List<ResolveInfo> queryIntentActivities(Intent queryIntent) {
        return this.mContext.getPackageManager().queryIntentActivities(queryIntent, 128);
    }

    public private protected PreferenceScreen inflateFromIntent(Intent queryIntent, PreferenceScreen rootPreferences) {
    ...
    private static synchronized int getDefaultSharedPreferencesMode() {
        return 0;
    }

    public private protected PreferenceScreen getPreferenceScreen() {
        return this.mPreferenceScreen;
    }

    public private protected boolean setPreferences(PreferenceScreen preferenceScreen) {
    ...
    public private protected SharedPreferences.Editor getEditor() {
        if (this.mPreferenceDataStore != null) {
            return null;
        }
        if (this.mNoCommit) {
    ...
    public private protected boolean shouldCommit() {
        return !this.mNoCommit;
    }

    public protected void setNoCommit(boolean noCommit) {
    ...
    public private protected Activity getActivity() {
    ...
    public private protected void registerOnActivityResultListener(OnActivityResultListener listener) {
        synchronized (this) {
    ...
    public private protected void unregisterOnActivityResultListener(OnActivityResultListener listener) {
        synchronized (this) {
            if (this.mActivityResultListeners != null) {
    ...
    public private protected void dispatchActivityResult(int requestCode, int resultCode, Intent data) {
        synchronized (this) {
            if (this.mActivityResultListeners == null) {
                return;
            }
    ...
    public private protected void dispatchActivityStop() {
        synchronized (this) {
            if (this.mActivityStopListeners == null) {
                return;
            }
    ...
    public private protected void registerOnActivityDestroyListener(OnActivityDestroyListener listener) {
        synchronized (this) {
    ...
    public private protected void unregisterOnActivityDestroyListener(OnActivityDestroyListener listener) {
        synchronized (this) {
            if (this.mActivityDestroyListeners != null) {
    ...
    public private protected void dispatchActivityDestroy() {
    ...
    public private protected int getNextRequestCode() {
        int i;
        synchronized (this) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void addPreferencesScreen(DialogInterface screen) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void removePreferencesScreen(DialogInterface screen) {
        if (this.mPreferencesScreens == null) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void dispatchNewIntent(Intent intent) {
        dismissAllScreens();
    }

    private synchronized void dismissAllScreens() {
        if (this.mPreferencesScreens == null) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setOnPreferenceTreeClickListener(OnPreferenceTreeClickListener listener) {
        this.mOnPreferenceTreeClickListener = listener;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized OnPreferenceTreeClickListener getOnPreferenceTreeClickListener() {

...
public abstract class PreferenceFragment extends Fragment implements PreferenceManager.OnPreferenceTreeClickListener {
    ...
    private synchronized void requirePreferenceManager() {
        if (this.mPreferenceManager == null) {
            throw new RuntimeException("This should be called after super.onCreate.");
        }
    }

    private synchronized void postBindPreferences() {
    ...
    protected synchronized void onBindPreferences() {
    }

    protected synchronized void onUnbindPreferences() {
    }

    private protected ListView getListView() {
        ensureList();
        return this.mList;
    }

    public synchronized boolean hasListView() {
        if (this.mList != null) {
            return true;
        }
        View root = getView();

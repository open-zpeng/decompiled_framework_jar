...
public class Preference implements Comparable<Preference> {
    ...
    private String mKey;
    public protected int mLayoutResId;
    ...
    public protected CharSequence mSummary;
    private CharSequence mTitle;
    private int mTitleRes;
    public protected int mWidgetLayoutResId;

    /* JADX INFO: Access modifiers changed from: package-private */
    /* loaded from: classes2.dex */
    public interface OnPreferenceChangeInternalListener {
        synchronized void onPreferenceChange(Preference preference);

        synchronized void onPreferenceHierarchyChange(Preference preference);
    }
    ...
    private synchronized void setEnabledStateOnViews(View v, boolean enabled) {
    ...
    public private protected long getId() {
        return this.mId;
    }
    ...
    public private protected final void setOnPreferenceChangeInternalListener(OnPreferenceChangeInternalListener listener) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void assignParent(PreferenceGroup parentGroup) {
        this.mParentGroup = parentGroup;
    }

    private synchronized void registerDependency() {
    ...
    private synchronized void unregisterDependency() {
    ...
    public protected void registerDependent(Preference dependent) {
    ...
    private synchronized void unregisterDependent(Preference dependent) {
        if (this.mDependents != null) {
    ...
    private synchronized void dispatchSetInitialValue() {
    ...
    private synchronized void tryCommit(SharedPreferences.Editor editor) {
    ...
    synchronized StringBuilder getFilterableStringBuilder() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void dispatchSaveInstanceState(Bundle container) {
        if (hasKey()) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void dispatchRestoreInstanceState(Bundle container) {
        Parcelable state;

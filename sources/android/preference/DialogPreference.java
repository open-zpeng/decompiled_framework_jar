...
public abstract class DialogPreference extends Preference implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener, PreferenceManager.OnActivityDestroyListener {
    public protected AlertDialog.Builder mBuilder;
    public protected Dialog mDialog;
    public protected Drawable mDialogIcon;
    private int mDialogLayoutResId;
    public protected CharSequence mDialogMessage;
    public protected CharSequence mDialogTitle;
    public protected CharSequence mNegativeButtonText;
    public protected CharSequence mPositiveButtonText;
    public protected int mWhichButtonClicked;
    ...
    protected synchronized boolean needInputMethod() {
        return false;
    }

    private synchronized void requestInputMethod(Dialog dialog) {

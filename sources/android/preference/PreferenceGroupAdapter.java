...
public class PreferenceGroupAdapter extends BaseAdapter implements Preference.OnPreferenceChangeInternalListener {
    ...
    public static class PreferenceLayout implements Comparable<PreferenceLayout> {
        ...
        private synchronized PreferenceLayout() {
        }

        @Override // java.lang.Comparable
        public synchronized int compareTo(PreferenceLayout other) {
    ...
    public synchronized PreferenceGroupAdapter(PreferenceGroup preferenceGroup) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void syncMyPreferences() {
        if (this.mIsSyncing) {
            return;
        }
    ...
    private synchronized void flattenPreferenceGroup(List<Preference> preferences, PreferenceGroup group) {
    ...
    private synchronized PreferenceLayout createPreferenceLayout(Preference preference, PreferenceLayout in) {
    ...
    private synchronized void addPreferenceClassName(Preference preference) {
    ...
    public synchronized void setHighlighted(int position) {
        this.mHighlightedPosition = position;
    }

    public synchronized void setHighlightedDrawable(Drawable drawable) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        convertView = (Collections.binarySearch(this.mPreferenceLayouts, this.mTempPreferenceLayout) < 0 || getItemViewType(position) == getHighlightItemViewType()) ? null : null;
    ...
    public synchronized void onPreferenceChange(Preference preference) {
        notifyDataSetChanged();
    }

    @Override // android.preference.Preference.OnPreferenceChangeInternalListener
    public synchronized void onPreferenceHierarchyChange(Preference preference) {
    ...
    private synchronized int getHighlightItemViewType() {

...
public class TabWidget extends LinearLayout implements View.OnFocusChangeListener {
    ...
    public protected boolean mDrawBottomStrips;
    private int[] mImposedTabWidths;
    private int mImposedTabsHeight;
    private Drawable mLeftStrip;
    private Drawable mRightStrip;
    public protected int mSelectedTab;
    private OnTabSelectionChanged mSelectionChangedListener;
    private boolean mStripMoved;

    /* loaded from: classes3.dex */
    interface OnTabSelectionChanged {
        synchronized void onTabSelectionChanged(int i, boolean z);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // android.widget.LinearLayout
    public synchronized void measureHorizontal(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    public private protected void setTabSelectionListener(OnTabSelectionChanged listener) {

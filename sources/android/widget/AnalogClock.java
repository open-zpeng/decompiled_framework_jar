...
public class AnalogClock extends View {
    ...
    public protected Drawable mDial;
    private int mDialHeight;
    private int mDialWidth;
    private float mHour;
    public protected Drawable mHourHand;
    private final BroadcastReceiver mIntentReceiver;
    public protected Drawable mMinuteHand;
    ...
    private synchronized void updateContentDescription(Time time) {

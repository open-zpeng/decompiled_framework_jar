...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
    ...
    public private protected boolean mDataChanged;
    private boolean mDesiredFocusableInTouchModeState;
    private int mDesiredFocusableState;
    private View mEmptyView;
    @ViewDebug.ExportedProperty(category = "scrolling")
    public private protected int mFirstPosition;
    boolean mInLayout;
    @ViewDebug.ExportedProperty(category = Slice.HINT_LIST)
    int mItemCount;
    private int mLayoutHeight;
    public private protected boolean mNeedSync;
    @ViewDebug.ExportedProperty(category = Slice.HINT_LIST)
    public private protected int mNextSelectedPosition;
    public private protected long mNextSelectedRowId;
    int mOldItemCount;
    public private protected int mOldSelectedPosition;
    long mOldSelectedRowId;
    public private protected OnItemClickListener mOnItemClickListener;
    OnItemLongClickListener mOnItemLongClickListener;
    public private protected OnItemSelectedListener mOnItemSelectedListener;
    private AdapterView<T>.SelectionNotifier mPendingSelectionNotifier;
    @ViewDebug.ExportedProperty(category = Slice.HINT_LIST)
    public private protected int mSelectedPosition;
    long mSelectedRowId;
    private AdapterView<T>.SelectionNotifier mSelectionNotifier;
    int mSpecificTop;
    long mSyncHeight;
    int mSyncMode;
    public private protected int mSyncPosition;
    long mSyncRowId;
    ...
    synchronized boolean isInFilterMode() {
        return false;
    }
    ...
    public synchronized void checkFocus() {
        T adapter = getAdapter();
        boolean z = true;
        boolean empty = adapter == null || adapter.getCount() == 0;
    ...
    private synchronized void updateEmptyStatus(boolean empty) {
        if (isInFilterMode()) {
            empty = false;
        }
        if (empty) {
    ...
    public private protected void selectionChanged() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void dispatchOnItemSelected() {
        fireOnSelected();
        performAccessibilityActionsOnSelected();
    }

    private synchronized void fireOnSelected() {
    ...
    private synchronized void performAccessibilityActionsOnSelected() {
    ...
    private synchronized boolean isScrollableForAccessibility() {
        int itemCount;
        T adapter = getAdapter();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void handleDataChanged() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void checkSelectionChanged() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized int findSyncPosition() {
        int count = this.mItemCount;
        if (count == 0) {
            return -1;
        }
    ...
    public private protected void setSelectedPositionInt(int position) {
        this.mSelectedPosition = position;
        this.mSelectedRowId = getItemIdAtPosition(position);
    }

    public private protected void setNextSelectedPositionInt(int position) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void rememberSyncState() {
        if (getChildCount() > 0) {
            this.mNeedSync = true;
    ...
    public void onProvideAutofillStructure(ViewStructure structure, int flags) {
        ...
        if (adapter != null && (options = adapter.getAutofillOptions()) != null) {

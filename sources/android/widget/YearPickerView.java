...
public class YearPickerView extends ListView {
    ...
    private static class YearAdapter extends BaseAdapter {
        private static final int ITEM_LAYOUT = 17367334;
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (hasNewView) {
                v = (TextView) this.mInflater.inflate(17367334, parent, false);
            } else {
            ...
            if (hasNewView || v.isActivated() != activated) {
                if (activated) {
                    textAppearanceResId = 16974741;
                } else {
                    textAppearanceResId = 16974740;
                }

...
public class RemoteViewsListAdapter extends BaseAdapter {
    ...
    public synchronized RemoteViewsListAdapter(Context context, ArrayList<RemoteViews> remoteViews, int viewTypeCount) {
    ...
    public synchronized void setViewsList(ArrayList<RemoteViews> remoteViews) {
        this.mRemoteViewsList = remoteViews;
        init();

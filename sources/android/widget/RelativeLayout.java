    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveRules(int layoutDirection) {
            ...
            if (this.mIsRtlCompatibilityMode) {
                ...
                if (iArr10[18] != 0) {
                    char c = isLayoutRtl ? (char) 7 : (char) 5;
                ...
                if (iArr12[19] != 0) {
                    char c2 = isLayoutRtl ? (char) 5 : (char) 7;
                ...
                if (iArr17[16] != 0) {
                    char c3 = isLayoutRtl ? (char) 1 : (char) 0;
                ...
                if (iArr19[17] != 0) {
                    char c4 = isLayoutRtl ? (char) 0 : (char) 1;

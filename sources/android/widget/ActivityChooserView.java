...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (itemViewType != 0) {
                if (itemViewType == 1) {
                    if (convertView == null || convertView.getId() != 1) {
                        ...
                        TextView titleView = (TextView) convertView2.findViewById(16908310);
                        titleView.setText(ActivityChooserView.this.mContext.getString(R.string.activity_chooser_view_see_all));
                        return convertView2;
                    }
                    return convertView;
                }
            ...
            if (convertView == null || convertView.getId() != 16909174) {

...
public class DropDownListView extends ListView {
    ...
    public synchronized DropDownListView(Context context, boolean hijackFocus) {
        this(context, hijackFocus, 16842861);
    }

    public synchronized DropDownListView(Context context, boolean hijackFocus, int defStyleAttr) {
    ...
    public synchronized boolean onForwardedEvent(MotionEvent event, int activePointerId) {
    ...
    public synchronized void setListSelectionHidden(boolean hideListSelection) {
        this.mListSelectionHidden = hideListSelection;
    }

    private synchronized void clearPressedItem() {
    ...
    private synchronized void setPressedItem(View child, int position, float x, float y) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    @Override // android.widget.AbsListView
    public synchronized View obtainView(int position, boolean[] isScrap) {

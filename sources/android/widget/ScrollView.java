...
public class ScrollView extends FrameLayout {
                ...
                if (actionMasked == 2) {
                    ...
                    if (activePointerIndex == -1) {
                        ...
                        if (this.mIsBeingDragged) {
                            ...
                            int unconsumedY = deltaY3 - scrolledDeltaY;
                            if (dispatchNestedScroll(0, scrolledDeltaY, 0, unconsumedY, this.mScrollOffset)) {
                                ...
                                if (pulledToY < 0) {
                                    this.mEdgeGlowTop.onPull(deltaY3 / getHeight(), ev.getX(activePointerIndex) / getWidth());
                                    if (!this.mEdgeGlowBottom.isFinished()) {
                                        this.mEdgeGlowBottom.onRelease();
                                    }
                                } else if (pulledToY > range) {
                                    this.mEdgeGlowBottom.onPull(deltaY3 / getHeight(), 1.0f - (ev.getX(activePointerIndex) / getWidth()));
    ...
    private void flingWithNestedDispatch(int velocityY) {
        boolean canFling = ((this.mScrollY > 0 && this.mScrollY < getScrollRange()) || velocityY > 0) && ((this.mScrollY > 0 && this.mScrollY < getScrollRange()) || velocityY < 0);

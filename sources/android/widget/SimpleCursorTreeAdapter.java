...
public abstract class SimpleCursorTreeAdapter extends ResourceCursorTreeAdapter {
    ...
    private synchronized void init(String[] groupFromNames, int[] groupTo, String[] childFromNames, int[] childTo) {
    ...
    private synchronized void bindView(View view, Context context, Cursor cursor, int[] from, int[] to) {
    ...
    private synchronized void initFromColumns(Cursor cursor, String[] fromColumnNames, int[] fromColumns) {

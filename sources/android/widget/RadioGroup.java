...
public class RadioGroup extends LinearLayout {
    ...
    public protected CompoundButton.OnCheckedChangeListener mChildOnCheckedChangeListener;
    ...
    public synchronized void setCheckedId(int id) {
        AutofillManager afm;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void setCheckedStateForView(int viewId, boolean checked) {

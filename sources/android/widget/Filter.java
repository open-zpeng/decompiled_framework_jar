...
public abstract class Filter {
    ...
    public interface Delayer {
        synchronized long getPostingDelay(CharSequence charSequence);
    }
            ...
            try {
                ...
                synchronized (Filter.this.mLock) {
                    if (Filter.this.mThreadHandler != null) {
                        ...
                        Filter.this.mThreadHandler.sendMessageDelayed(finishMessage, EventManager.TimedEventPair.DEFAULT_TIMEOUT);
                    }
                }
            } finally {
    ...
    public static class RequestArguments {
        ...
        private synchronized RequestArguments() {
        }
    }
}

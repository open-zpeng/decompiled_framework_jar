...
class ExpandableListConnector extends BaseAdapter implements Filterable {
    ...
    public PositionMetadata getUnflattenedPos(int flPos) {
        ...
        if (leftExpGroupIndex > midExpGroupIndex) {
            ...
            int groupPos = (flPos - leftExpGm.lastChildFlPos) + leftExpGm.gPos;
            insertPosition = insertPosition2;
            rightExpGroupIndex = groupPos;
            ...
            int groupPos2 = rightExpGm.gPos - (rightExpGm.flPos - flPos);
            insertPosition = rightExpGroupIndex3;
            rightExpGroupIndex = groupPos2;
        } else {
    ...
    public int getItemViewType(int flatListPos) {
        ...
        if (expandableListAdapter instanceof HeterogeneousExpandableList) {
            ...
            if (pos.type == 2) {
                ...
                retValue = childType + adapter.getGroupTypeCount();
            }
        } else if (pos.type == 2) {
            retValue = 0;
        } else {

...
public class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public synchronized ActionMenuPresenter(Context context) {
    ...
    public synchronized void setWidthLimit(int width, boolean strict) {
        this.mWidthLimit = width;
        this.mStrictWidthLimit = strict;
        this.mWidthLimitSet = true;
    }

    public synchronized void setReserveOverflow(boolean reserveOverflow) {
        this.mReserveOverflow = reserveOverflow;
        this.mReserveOverflowSet = true;
    }

    public synchronized void setItemLimit(int itemCount) {
        this.mMaxItems = itemCount;
        this.mMaxItemsSet = true;
    }

    public synchronized void setExpandedActionViewsExclusive(boolean isExclusive) {
        this.mExpandedActionViewsExclusive = isExclusive;
    }

    public synchronized void setOverflowIcon(Drawable icon) {
        if (this.mOverflowButton != null) {
    ...
    public synchronized Drawable getOverflowIcon() {
        if (this.mOverflowButton != null) {
    ...
    @Override // com.android.internal.view.menu.BaseMenuPresenter
    public synchronized void bindItemView(MenuItemImpl item, MenuView.ItemView itemView) {
    ...
    public synchronized void computeMenuItemAnimationInfo(boolean preLayout) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void runItemAnimations() {
        ObjectAnimator anim;
    ...
    private synchronized void setupItemAnimations() {
    ...
    private synchronized View findViewForItem(MenuItem item) {
    ...
    public synchronized boolean hideSubMenus() {
    ...
    public synchronized boolean isOverflowReserved() {
        ...
        while (i < itemsSize) {
            ...
            if (item2.requiresActionButton()) {
                ...
                if (item2.requestsActionButton()) {
                    ...
                    boolean isAction2 = (maxActions4 > 0 || inGroup) && widthLimit2 > 0 && (!actionMenuPresenter.mStrictWidthLimit || cellsRemaining > 0);
                    if (isAction2) {
    ...
    private protected Parcelable onSaveInstanceState() {
        SavedState state = new SavedState();
        state.openSubMenuId = this.mOpenSubMenuId;
        return state;
    }

    private protected void onRestoreInstanceState(Parcelable state) {
        MenuItem item;
    ...
    public synchronized void onSubUiVisibilityChanged(boolean isVisible) {
        if (isVisible) {
            super.onSubMenuSelected(null);
    ...
    public synchronized void setMenuView(ActionMenuView menuView) {
    ...
    public static class SavedState implements Parcelable {
        ...
        synchronized SavedState(Parcel in) {
    ...
    public static class MenuItemLayoutInfo {
        ...
        synchronized MenuItemLayoutInfo(View view, boolean preLayout) {
    ...
    public static class ItemAnimationInfo {
        ...
        synchronized ItemAnimationInfo(int id, MenuItemLayoutInfo info, Animator anim, int animType) {
            this.id = id;

...
public class Spinner extends AbsSpinner implements DialogInterface.OnClickListener {
    ...
    int mDropDownWidth;
    public protected ForwardingListener mForwardingListener;
    private int mGravity;
    public protected SpinnerPopup mPopup;
    ...
    public interface SpinnerPopup {
        ...
        synchronized Drawable getBackground();

        synchronized CharSequence getHintText();

        synchronized int getHorizontalOffset();

        synchronized int getVerticalOffset();

        private protected boolean isShowing();

        synchronized void setAdapter(ListAdapter listAdapter);

        synchronized void setBackgroundDrawable(Drawable drawable);

        synchronized void setHorizontalOffset(int i);

        synchronized void setPromptText(CharSequence charSequence);

        synchronized void setVerticalOffset(int i);

        synchronized void show(int i, int i2);
    }
    ...
    private synchronized View makeView(int position, boolean addChild) {
        View child;
    ...
    private synchronized void setUpChild(View child, boolean addChild) {
    ...
    synchronized int measureContentWidth(SpinnerAdapter adapter, Drawable background) {
        if (adapter == null) {
            return 0;
        }
        View itemView = null;
    ...
    public static class DropDownAdapter implements ListAdapter, SpinnerAdapter {
        ...
        public synchronized DropDownAdapter(SpinnerAdapter adapter, Resources.Theme dropDownTheme) {
    ...
    private class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        @Override // android.widget.Spinner.SpinnerPopup
        public synchronized void setAdapter(ListAdapter adapter) {
            this.mListAdapter = adapter;
        }

        @Override // android.widget.Spinner.SpinnerPopup
        public synchronized void setPromptText(CharSequence hintText) {
            this.mPrompt = hintText;
        }

        @Override // android.widget.Spinner.SpinnerPopup
        public synchronized CharSequence getHintText() {
            return this.mPrompt;
        }

        @Override // android.widget.Spinner.SpinnerPopup
        public synchronized void show(int textDirection, int textAlignment) {
        ...
        @Override // android.widget.Spinner.SpinnerPopup
        public synchronized void setBackgroundDrawable(Drawable bg) {
            Log.e(Spinner.TAG, "Cannot set popup background for MODE_DIALOG, ignoring");
        }

        @Override // android.widget.Spinner.SpinnerPopup
        public synchronized void setVerticalOffset(int px) {
            Log.e(Spinner.TAG, "Cannot set vertical offset for MODE_DIALOG, ignoring");
        }

        @Override // android.widget.Spinner.SpinnerPopup
        public synchronized void setHorizontalOffset(int px) {
    ...
    public class DropdownPopup extends ListPopupWindow implements SpinnerPopup {
        ...
        synchronized void computeContentWidth() {
            int hOffset;

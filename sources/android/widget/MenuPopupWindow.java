...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public synchronized MenuPopupWindow(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
    }

    @Override // android.widget.ListPopupWindow
    synchronized DropDownListView createDropDownListView(Context context, boolean hijackFocus) {
        MenuDropDownListView view = new MenuDropDownListView(context, hijackFocus);
        view.setHoverListener(this);
        return view;
    }

    public synchronized void setEnterTransition(Transition enterTransition) {
        this.mPopup.setEnterTransition(enterTransition);
    }

    public synchronized void setExitTransition(Transition exitTransition) {
        this.mPopup.setExitTransition(exitTransition);
    }

    public synchronized void setHoverListener(MenuItemHoverListener hoverListener) {
        this.mHoverListener = hoverListener;
    }

    public synchronized void setTouchModal(boolean touchModal) {
        this.mPopup.setTouchModal(touchModal);
    }

    @Override // android.widget.MenuItemHoverListener
    public synchronized void onItemHoverEnter(MenuBuilder menu, MenuItem item) {
    ...
    @Override // android.widget.MenuItemHoverListener
    public synchronized void onItemHoverExit(MenuBuilder menu, MenuItem item) {
        if (this.mHoverListener != null) {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public synchronized MenuDropDownListView(Context context, boolean hijackFocus) {

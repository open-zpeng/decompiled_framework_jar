    ...
    public void layoutChildren(int left, int top, int right, int bottom, boolean forceLeftGravity) {
        ...
        while (i < count2) {
            ...
            if (child.getVisibility() == 8) {
                ...
                count = count2;
                if (i2 == 1) {
                    int childLeft2 = parentRight2 - parentLeft2;
                    childLeft = ((((childLeft2 - width) / 2) + parentLeft2) + lp.leftMargin) - lp.rightMargin;
                } else if (i2 == 5 && !forceLeftGravity) {
                    childLeft = (parentRight2 - width) - lp.rightMargin;
                } else {
                    int childLeft3 = lp.leftMargin;
                    childLeft = childLeft3 + parentLeft2;
                }
                if (verticalGravity == 16) {
                    parentLeft = parentLeft2;
                    int parentLeft3 = parentBottom - parentTop;
                    childTop = ((((parentLeft3 - height) / 2) + parentTop) + lp.topMargin) - lp.bottomMargin;
                } else if (verticalGravity == 48) {
                    parentLeft = parentLeft2;
                    int parentLeft4 = lp.topMargin;
                    childTop = parentTop + parentLeft4;
                } else if (verticalGravity == 80) {
                    int childTop2 = parentBottom - height;
                    parentLeft = parentLeft2;
                    int parentLeft5 = lp.bottomMargin;
                    childTop = childTop2 - parentLeft5;
                } else {

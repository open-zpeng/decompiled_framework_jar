...
public class Toolbar extends ViewGroup {
    ...
    public protected ImageButton mNavButtonView;
    ...
    public protected int mTitleMarginBottom;
    public protected int mTitleMarginEnd;
    public protected int mTitleMarginStart;
    public protected int mTitleMarginTop;
    private CharSequence mTitleText;
    private int mTitleTextAppearance;
    private int mTitleTextColor;
    public protected TextView mTitleTextView;
    ...
    public Toolbar(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        Drawable navIcon2 = a.getDrawable(2);
        if (navIcon2 != null) {
            setLogo(navIcon2);
        }
    ...
    public synchronized void setMenu(MenuBuilder menu, ActionMenuPresenter outerPresenter) {
    ...
    private synchronized void ensureLogoView() {
        if (this.mLogoView == null) {
    ...
    private synchronized void ensureMenu() {
        ensureMenuView();
    ...
    private synchronized void ensureMenuView() {
        if (this.mMenuView == null) {
    ...
    private synchronized MenuInflater getMenuInflater() {
    ...
    private synchronized void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
    ...
    public synchronized void ensureCollapseButtonView() {
    ...
    private synchronized void addSystemView(View v, boolean allowHide) {
        LayoutParams lp;
    ...
    private synchronized void postShowOverflowMenu() {
    ...
    public synchronized void onSetLayoutParams(View child, ViewGroup.LayoutParams lp) {
        if (!checkLayoutParams(lp)) {
            child.setLayoutParams(generateLayoutParams(lp));
        }
    }

    private synchronized void measureChildConstrained(View child, int parentWidthSpec, int widthUsed, int parentHeightSpec, int heightUsed, int heightConstraint) {
        int size;
    ...
    private synchronized int measureChildCollapseMargins(View child, int parentWidthMeasureSpec, int widthUsed, int parentHeightMeasureSpec, int heightUsed, int[] collapsingMargins) {
        ViewGroup.MarginLayoutParams lp = (ViewGroup.MarginLayoutParams) child.getLayoutParams();
    ...
    private synchronized boolean shouldCollapse() {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int measuredWidth = resolveSizeAndState(Math.max(width3, getSuggestedMinimumWidth()), widthMeasureSpec, (-16777216) & childState3);
        int measuredHeight = resolveSizeAndState(Math.max(height6, getSuggestedMinimumHeight()), heightMeasureSpec, childState3 << 16);
    ...
    */
    ...
    private synchronized int getViewListMeasuredWidth(List<View> views, int[] collapsingMargins) {
    ...
    private synchronized int layoutChildLeft(View child, int left, int[] collapsingMargins, int alignmentHeight) {
        LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    private synchronized int layoutChildRight(View child, int right, int[] collapsingMargins, int alignmentHeight) {
        LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    private synchronized int getChildTop(View child, int alignmentHeight) {
        LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    private synchronized int getChildVerticalGravity(int gravity) {
    ...
    private synchronized void addCustomViewsWithGravity(List<View> views, int gravity) {
    ...
    private synchronized int getChildHorizontalGravity(int gravity) {
    ...
    private synchronized boolean shouldLayout(View view) {
        return (view == null || view.getParent() != this || view.getVisibility() == 8) ? false : true;
    }

    private synchronized int getHorizontalMargins(View v) {
        ViewGroup.MarginLayoutParams mlp = (ViewGroup.MarginLayoutParams) v.getLayoutParams();
        return mlp.getMarginStart() + mlp.getMarginEnd();
    }

    private synchronized int getVerticalMargins(View v) {
        ViewGroup.MarginLayoutParams mlp = (ViewGroup.MarginLayoutParams) v.getLayoutParams();
    ...
    private static synchronized boolean isCustomView(View child) {
        return ((LayoutParams) child.getLayoutParams()).mViewType == 0;
    }

    public synchronized DecorToolbar getWrapper() {
    ...
    synchronized void removeChildrenForExpandedActionView() {
        int childCount = getChildCount();
        for (int i = childCount - 1; i >= 0; i--) {
            View child = getChildAt(i);
            LayoutParams lp = (LayoutParams) child.getLayoutParams();
    ...
    synchronized void addChildrenForExpandedActionView() {
    ...
    private synchronized boolean isChildOrHidden(View child) {
    ...
    public synchronized void setMenuCallbacks(MenuPresenter.Callback pcb, MenuBuilder.Callback mcb) {
    ...
    private synchronized void ensureContentInsets() {
        if (this.mContentInsets == null) {
            this.mContentInsets = new RtlSpacingHelper();
        }
    }

    synchronized ActionMenuPresenter getOuterActionMenuPresenter() {
        return this.mOuterActionMenuPresenter;
    }

    synchronized Context getPopupContext() {
    ...
    public class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        @Override // com.android.internal.view.menu.MenuPresenter
        public synchronized boolean onSubMenuSelected(SubMenuBuilder subMenu) {
            return false;
        }

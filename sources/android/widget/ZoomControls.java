...
public class ZoomControls extends LinearLayout {
    public protected final ZoomButton mZoomIn;
    public protected final ZoomButton mZoomOut;
    ...
    private synchronized void fade(int visibility, float startAlpha, float endAlpha) {

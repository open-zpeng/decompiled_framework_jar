...
public abstract class AbsListView extends AdapterView<ListAdapter> implements TextWatcher, ViewTreeObserver.OnGlobalLayoutListener, Filter.FilterListener, ViewTreeObserver.OnTouchModeChangeListener, RemoteViewsAdapter.RemoteAdapterConnectionCallback {
    ...
    public Parcelable onSaveInstanceState() {
        ...
        SparseBooleanArray sparseBooleanArray = this.mCheckStates;
        if (sparseBooleanArray != null) {
            ss.checkState = sparseBooleanArray.m39clone();
        }
    ...
    private void scrollIfNeeded(int x, int y, MotionEvent vtev) {
        ...
        if (!dispatchNestedPreScroll(0, i != Integer.MIN_VALUE ? i - y : -rawDeltaY2, this.mScrollConsumed, this.mScrollOffset)) {
            ...
            int scrollConsumedCorrection2 = iArr3[1];
            if (vtev != null) {
        ...
        int i2 = this.mLastY;
        int incrementalDeltaY3 = i2 != Integer.MIN_VALUE ? (y - i2) + scrollConsumedCorrection : deltaY;
        ...
        if (i3 == 3) {
            ...
            if (y != this.mLastY) {
                ...
                if (incrementalDeltaY3 == 0) {
                    ...
                    boolean atEdge2 = trackMotionScroll(deltaY, incrementalDeltaY3);
                    atEdge = atEdge2;
                }
            ...
            if (overScrollDistance == 0) {
                ...
                if (overscrollMode2 == 0 || (overscrollMode2 == 1 && !contentFits())) {
                    if (rawDeltaY > 0) {
                        this.mEdgeGlowTop.onPull(overScrollDistance4 / getHeight(), x / getWidth());
                        if (!this.mEdgeGlowBottom.isFinished()) {
                            this.mEdgeGlowBottom.onRelease();
                        }
                        invalidateTopGlow();
                    } else if (rawDeltaY < 0) {
                        this.mEdgeGlowBottom.onPull(overScrollDistance4 / getHeight(), 1.0f - (x / getWidth()));
                        if (!this.mEdgeGlowTop.isFinished()) {
                            this.mEdgeGlowTop.onRelease();
                        }
                        invalidateBottomGlow();
    ...
    private void onTouchMove(MotionEvent ev, MotionEvent vtev) {
        ...
        } else if (!startScrollIfNeeded((int) ev.getX(pointerIndex), y, vtev)) {
            View motionView = getChildAt(this.mMotionPosition - this.mFirstPosition);

...
public abstract class AbsSpinner extends AdapterView<SpinnerAdapter> {
    ...
    abstract synchronized void layout(int i, boolean z);
    ...
    private synchronized void initAbsSpinner() {
        setFocusable(true);
    ...
    synchronized int getChildWidth(View child) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void recycleAllViews() {
    ...
    synchronized void setSelectionInt(int position, boolean animate) {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized SavedState(Parcel in) {
            super(in);

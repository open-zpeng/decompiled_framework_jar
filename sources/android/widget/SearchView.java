...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    public protected boolean mClearingFocus;
    public protected final ImageView mCloseButton;
    private final ImageView mCollapsedIcon;
    public protected int mCollapsedImeOptions;
    private final CharSequence mDefaultQueryHint;
    private final View mDropDownAnchor;
    public protected boolean mExpandedInActionView;
    private final ImageView mGoButton;
    public protected boolean mIconified;
    public protected boolean mIconifiedByDefault;
    private int mMaxWidth;
    private CharSequence mOldQueryText;
    public protected final View.OnClickListener mOnClickListener;
    private OnCloseListener mOnCloseListener;
    private final TextView.OnEditorActionListener mOnEditorActionListener;
    public protected final AdapterView.OnItemClickListener mOnItemClickListener;
    private final AdapterView.OnItemSelectedListener mOnItemSelectedListener;
    public protected OnQueryTextListener mOnQueryChangeListener;
    ...
    public protected final ImageView mSearchButton;
    public protected final View mSearchEditFrame;
    public protected final Drawable mSearchHintIcon;
    public protected final View mSearchPlate;
    public protected final SearchAutoComplete mSearchSrcTextView;
    private Rect mSearchSrcTextViewBounds;
    private Rect mSearchSrtTextViewBoundsExpanded;
    private SearchableInfo mSearchable;
    public protected final View mSubmitArea;
    private boolean mSubmitButtonEnabled;
    private final int mSuggestionCommitIconResId;
    private final int mSuggestionRowLayout;
    public protected CursorAdapter mSuggestionsAdapter;
    private int[] mTemp;
    private int[] mTemp2;
    ...
    public protected CharSequence mUserQuery;
    private final Intent mVoiceAppSearchIntent;
    public protected final ImageView mVoiceButton;
    public protected boolean mVoiceButtonEnabled;
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(16909363);
    ...
    public synchronized int getSuggestionRowLayout() {
        return this.mSuggestionRowLayout;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized int getSuggestionCommitIconResId() {
    ...
    public synchronized void setAppSearchData(Bundle appSearchData) {
    ...
    private synchronized void getChildBoundsWithinSearchView(View view, Rect rect) {
    ...
    public protected void updateViewsVisibility(boolean collapsed) {
        int iconVisibility;
    ...
    private synchronized boolean hasVoiceSearch() {
    ...
    private synchronized boolean isSubmitAreaEnabled() {
        return (this.mSubmitButtonEnabled || this.mVoiceButtonEnabled) && !isIconified();
    }

    public protected void updateSubmitButton(boolean hasText) {
        int visibility = 8;
    ...
    public protected void updateSubmitArea() {
        int visibility = 8;
    ...
    private synchronized void updateCloseButton() {
    ...
    private synchronized void postUpdateFocusedState() {
        post(this.mUpdateDrawableStateRunnable);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void updateFocusedState() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onQueryRefine(CharSequence queryText) {
        setQuery(queryText);
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean onSuggestionsKey(View v, int keyCode, KeyEvent event) {
        SearchableInfo.ActionKeyInfo actionKey;
        int position;
        String actionMsg;
    ...
    private static synchronized String getActionKeyMessage(Cursor c, SearchableInfo.ActionKeyInfo actionKey) {
        String result = null;
    ...
    private synchronized CharSequence getDecoratedHint(CharSequence hintText) {
    ...
    private synchronized void updateSearchAutoComplete() {
    ...
    private synchronized void updateVoiceButton(boolean empty) {
        int visibility = 8;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onTextChanged(CharSequence newText) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onSubmitQuery() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onSearchClicked() {
        updateViewsVisibility(false);
        this.mSearchSrcTextView.requestFocus();
        this.mSearchSrcTextView.setImeVisibility(true);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onVoiceClicked() {
        if (this.mSearchable == null) {
            return;
        }
    ...
    synchronized void onTextFocusChanged() {
        updateViewsVisibility(isIconified());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void adjustDropDownSizeAndPosition() {
        int iconOffset;
        int offset;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean onItemClicked(int position, int actionKey, String actionMsg) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean onItemSelected(int position) {
    ...
    private synchronized void rewriteQueryFromSuggestion(int position) {
    ...
    private synchronized boolean launchSuggestion(int position, int actionKey, String actionMsg) {
        Cursor c = this.mSuggestionsAdapter.getCursor();
    ...
    private synchronized void launchIntent(Intent intent) {
        if (intent == null) {
            return;
        }
        try {
    ...
    public protected void setQuery(CharSequence query) {
        this.mSearchSrcTextView.setText(query, true);
        this.mSearchSrcTextView.setSelection(TextUtils.isEmpty(query) ? 0 : query.length());
    }

    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void launchQuerySearch(int actionKey, String actionMsg, String query) {
        Intent intent = createIntent(Intent.ACTION_SEARCH, null, null, query, actionKey, actionMsg);
        getContext().startActivity(intent);
    }

    private synchronized Intent createIntent(String action, Uri data, String extraData, String query, int actionKey, String actionMsg) {
    ...
    private synchronized Intent createVoiceWebSearchIntent(Intent baseIntent, SearchableInfo searchable) {
    ...
    private synchronized Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ComponentName searchActivity = searchable.getSearchActivity();
    ...
    private synchronized Intent createIntentFromSuggestion(Cursor c, int actionKey, String actionMsg) {
        int rowNum;
        String id;
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void forceSuggestionQuery() {
        this.mSearchSrcTextView.doBeforeTextChanged();
        this.mSearchSrcTextView.doAfterTextChanged();
    }

    static synchronized boolean isLandscapeMode(Context context) {
    ...
    private static class UpdatableTouchDelegate extends TouchDelegate {
        ...
        public synchronized UpdatableTouchDelegate(Rect targetBounds, Rect actualBounds, View delegateView) {
        ...
        public synchronized void setBounds(Rect desiredBounds, Rect actualBounds) {
    ...
    public static class SearchAutoComplete extends AutoCompleteTextView {
        ...
        public synchronized SearchAutoComplete(Context context) {
            super(context);
        ...
        private protected SearchAutoComplete(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.mRunShowSoftInputIfNecessary = new Runnable() { // from class: android.widget.-$$Lambda$SearchView$SearchAutoComplete$qdPU54FiW6QTzCbsg7P4cSs3cJ8
                @Override // java.lang.Runnable
                public final void run() {
        ...
        public synchronized SearchAutoComplete(Context context, AttributeSet attrs, int defStyleAttrs) {
        ...
        public synchronized SearchAutoComplete(Context context, AttributeSet attrs, int defStyleAttrs, int defStyleRes) {
        ...
        synchronized void setSearchView(SearchView searchView) {
        ...
        private synchronized int getSearchViewTextMinWidthDp() {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public synchronized void showSoftInputIfNecessary() {
            if (this.mHasPendingShowSoftInputRequest) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public synchronized void setImeVisibility(boolean visible) {
            InputMethodManager imm = (InputMethodManager) getContext().getSystemService(InputMethodManager.class);
            if (!visible) {
                this.mHasPendingShowSoftInputRequest = false;
                removeCallbacks(this.mRunShowSoftInputIfNecessary);

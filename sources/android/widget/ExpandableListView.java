...
public class ExpandableListView extends ListView {
    ...
    public protected Drawable mChildDivider;
    private Drawable mChildIndicator;
    private int mChildIndicatorEnd;
    private int mChildIndicatorLeft;
    private int mChildIndicatorRight;
    private int mChildIndicatorStart;
    public protected ExpandableListConnector mConnector;
    public protected Drawable mGroupIndicator;
    private int mIndicatorEnd;
    public protected int mIndicatorLeft;
    private final Rect mIndicatorRect;
    public protected int mIndicatorRight;
    private int mIndicatorStart;
    public protected OnChildClickListener mOnChildClickListener;
    public protected OnGroupClickListener mOnGroupClickListener;
    public protected OnGroupCollapseListener mOnGroupCollapseListener;
    public protected OnGroupExpandListener mOnGroupExpandListener;
    ...
    public protected static final int[][] GROUP_STATE_SETS = {EMPTY_STATE_SET, GROUP_EXPANDED_STATE_SET, GROUP_EMPTY_STATE_SET, GROUP_EXPANDED_EMPTY_STATE_SET};
    ...
    private synchronized boolean hasRtlSupport() {
    ...
    private synchronized void resolveIndicator() {
    ...
    private synchronized void resolveChildIndicator() {
        boolean isLayoutRtl = isLayoutRtl();
        if (isLayoutRtl) {
                ...
                if (b < 0) {
                    ...
                    if (pos.position.type != lastItemType) {
                        ...
                        if (isLayoutRtl) {
                            ...
                            int i2 = indicatorRect.left;
                            int temp2 = this.mPaddingRight;
                            indicatorRect.left = i2 - temp2;
    ...
    private synchronized Drawable getIndicator(ExpandableListConnector.PositionMetadata pos) {
        Drawable indicator;
        int[] stateSet;
    ...
    private synchronized boolean isHeaderOrFooterPosition(int position) {
        int footerViewsStart = this.mItemCount - getFooterViewsCount();
        return position < getHeaderViewsCount() || position >= footerViewsStart;
    }

    private synchronized int getFlatPositionForConnector(int flatListPosition) {
        return flatListPosition - getHeaderViewsCount();
    }

    private synchronized int getAbsoluteFlatPosition(int flatListPosition) {
    ...
    synchronized boolean handleItemClick(View v, int position, long id) {
    ...
    synchronized ContextMenu.ContextMenuInfo createContextMenuInfo(View view, int flatListPosition, long id) {
        if (isHeaderOrFooterPosition(flatListPosition)) {
    ...
    private synchronized long getChildOrGroupId(ExpandableListPosition position) {
        if (position.type == 1) {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        synchronized SavedState(Parcelable superState, ArrayList<ExpandableListConnector.GroupMetadata> expandedGroupMetadataList) {
            super(superState);

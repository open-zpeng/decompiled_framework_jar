...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl, SubtitleController.Anchor {
    ...
    public protected static final int STATE_IDLE = 0;
    ...
    public protected int mCurrentBufferPercentage;
    public protected int mCurrentState;
    public protected MediaPlayer.OnErrorListener mErrorListener;
    public protected Map<String, String> mHeaders;
    private MediaPlayer.OnInfoListener mInfoListener;
    public protected MediaController mMediaController;
    ...
    public private protected MediaPlayer.OnPreparedListener mPreparedListener;
    public private protected SurfaceHolder.Callback mSHCallback;
    ...
    public protected SurfaceHolder mSurfaceHolder;
    private int mSurfaceWidth;
    public protected int mTargetState;
    public protected Uri mUri;
    public protected int mVideoHeight;
    public protected int mVideoWidth;
    ...
    private synchronized void toggleMediaControlsVisiblity() {
    ...
    private synchronized void measureAndLayoutSubtitleWidget() {
    ...
    public synchronized void setSubtitleWidget(SubtitleTrack.RenderingWidget subtitleWidget) {
    ...
    @Override // android.media.SubtitleController.Anchor
    public synchronized Looper getSubtitleLooper() {

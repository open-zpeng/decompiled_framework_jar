...
public abstract class CursorTreeAdapter extends BaseExpandableListAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    private synchronized void init(Cursor cursor, Context context, boolean autoRequery) {
    ...
    public class MyCursorHelper {
        ...
        synchronized long getId(int position) {
        ...
        synchronized Cursor moveTo(int position) {
            if (this.mDataValid && this.mCursor != null && this.mCursor.moveToPosition(position)) {
                return this.mCursor;
            }
            return null;
        ...
        synchronized void changeCursor(Cursor cursor, boolean releaseCursors) {

...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient, ThemedSpinnerAdapter {
    ...
    public private ChangeObserver mChangeObserver;
    public private Context mContext;
    public private Cursor mCursor;
    protected CursorFilter mCursorFilter;
    public private DataSetObserver mDataSetObserver;
    public private boolean mDataValid;
    protected Context mDropDownContext;
    protected FilterQueryProvider mFilterQueryProvider;
    public private int mRowIDColumn;
    ...
    synchronized void init(Context context, Cursor c, int flags) {
        if ((flags & 1) == 1) {
            flags |= 2;

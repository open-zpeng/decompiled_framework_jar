...
public class ViewAnimator extends FrameLayout {
    ...
    public private protected boolean mFirstTime;
    Animation mInAnimation;
    Animation mOutAnimation;
    public private protected int mWhichChild;
    ...
    private synchronized void initViewAnimator(Context context, AttributeSet attrs) {
        if (attrs == null) {
    ...
    public private protected void showOnly(int childIndex, boolean animate) {
    ...
    synchronized void showOnly(int childIndex) {

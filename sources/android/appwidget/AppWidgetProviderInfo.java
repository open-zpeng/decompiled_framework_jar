...
public class AppWidgetProviderInfo implements Parcelable {
    ...
    /* renamed from: clone */
    public AppWidgetProviderInfo m16clone() {
        AppWidgetProviderInfo that = new AppWidgetProviderInfo();
        ComponentName componentName = this.provider;
        that.provider = componentName == null ? null : componentName.m18clone();
        ...
        that.configure = componentName2 != null ? componentName2.m18clone() : null;

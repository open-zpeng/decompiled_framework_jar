...
public class AppWidgetProviderInfo implements Parcelable {
    ...
    private protected ActivityInfo providerInfo;
    ...
    public AppWidgetProviderInfo m15clone() {
        ...
        that.provider = this.provider == null ? null : this.provider.m17clone();
        ...
        that.configure = this.configure == null ? null : this.configure.m17clone();
    ...
    private synchronized Drawable loadDrawable(Context context, int density, int resourceId, boolean loadDefaultIcon) {
        try {
    ...
    public synchronized void updateDimensions(DisplayMetrics displayMetrics) {

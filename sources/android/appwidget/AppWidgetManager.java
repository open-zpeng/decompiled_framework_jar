...
public class AppWidgetManager {
    ...
    public protected final IAppWidgetService mService;

    public static AppWidgetManager getInstance(Context context) {
        return (AppWidgetManager) context.getSystemService(Context.APPWIDGET_SERVICE);
    }

    public synchronized AppWidgetManager(Context context, IAppWidgetService service) {
    ...
    private protected List<AppWidgetProviderInfo> getInstalledProviders(int categoryFilter) {
        if (this.mService == null) {
            return Collections.emptyList();
        }
    ...
    private protected List<AppWidgetProviderInfo> getInstalledProvidersForProfile(int categoryFilter, UserHandle profile, String packageName) {
        if (this.mService == null) {
            return Collections.emptyList();
        }
        if (profile == null) {
    ...
    private protected void bindAppWidgetId(int appWidgetId, ComponentName provider) {
        if (this.mService == null) {
            return;
        }
    ...
    private protected void bindAppWidgetId(int appWidgetId, ComponentName provider, Bundle options) {
        if (this.mService == null) {
            return;
        }
    ...
    public synchronized boolean hasBindAppWidgetPermission(String packageName, int userId) {
        if (this.mService == null) {
            return false;
        }
        try {
    ...
    public synchronized boolean hasBindAppWidgetPermission(String packageName) {
        if (this.mService == null) {
            return false;
        }
        try {
    ...
    public synchronized void setBindAppWidgetPermission(String packageName, boolean permission) {
        if (this.mService == null) {
            return;
        }
    ...
    public synchronized void setBindAppWidgetPermission(String packageName, int userId, boolean permission) {
        if (this.mService == null) {
            return;
        }
        try {
    ...
    public synchronized boolean isBoundWidgetPackage(String packageName, int userId) {
        if (this.mService == null) {
            return false;
        }
        try {
    ...
    public protected boolean bindAppWidgetIdIfAllowed(int appWidgetId, int profileId, ComponentName provider, Bundle options) {
        if (this.mService == null) {
            return false;
        }
        try {
    ...
    public synchronized boolean requestPinAppWidget(ComponentName provider, PendingIntent successCallback) {

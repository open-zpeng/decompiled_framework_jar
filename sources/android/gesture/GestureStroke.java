...
public class GestureStroke {
    ...
    private synchronized GestureStroke(RectF bbx, float len, float[] pts, long[] times) {
    ...
    synchronized void draw(Canvas canvas, Paint paint) {
    ...
    private synchronized void makePath() {
    ...
    public synchronized void serialize(DataOutputStream out) throws IOException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized GestureStroke deserialize(DataInputStream in) throws IOException {

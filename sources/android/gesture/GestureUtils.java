...
public final class GestureUtils {
    ...
    private synchronized GestureUtils() {
    }
    ...
    private static synchronized void plot(float x, float y, float[] sample, int sampleSize) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized float[] computeCentroid(float[] points) {
        ...
        float[] center = {(2.0f * centerY2) / count, (2.0f * centerY) / count};
        return center;
    }

    private static synchronized float[][] computeCoVariance(float[] points) {
    ...
    static synchronized float computeTotalLength(float[] points) {
        float sum = 0.0f;
    ...
    static synchronized float computeStraightness(float[] points) {
    ...
    static synchronized float computeStraightness(float[] points, float totalLen) {
        float dx = points[2] - points[0];
        float dy = points[3] - points[1];
        return ((float) Math.hypot(dx, dy)) / totalLen;
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized float squaredEuclideanDistance(float[] vector1, float[] vector2) {
    ...
    static synchronized float cosineDistance(float[] vector1, float[] vector2) {
        float sum = 0.0f;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized float minimumCosineDistance(float[] vector1, float[] vector2, int numOrientations) {
        int len = vector1.length;
        float a = 0.0f;
        float b = 0.0f;
    ...
    private static synchronized OrientedBoundingBox computeOrientedBoundingBox(float[] points, float[] centroid) {
        float angle;
    ...
    private static synchronized float[] computeOrientation(float[][] covarianceMatrix) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized float[] rotate(float[] points, float angle) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized float[] translate(float[] points, float dx, float dy) {
        int size = points.length;
        for (int i = 0; i < size; i += 2) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized float[] scale(float[] points, float sx, float sy) {
        int size = points.length;
        for (int i = 0; i < size; i += 2) {

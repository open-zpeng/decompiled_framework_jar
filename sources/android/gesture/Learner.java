...
abstract class Learner {
    ...
    public abstract synchronized ArrayList<Prediction> classify(int i, int i2, float[] fArr);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized ArrayList<Instance> getInstances() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void removeInstances(String name) {

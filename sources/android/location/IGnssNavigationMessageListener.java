...
public interface IGnssNavigationMessageListener extends IInterface {
    synchronized void onGnssNavigationMessageReceived(GnssNavigationMessage gnssNavigationMessage) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IGnssNavigationMessageListener {
        ...
        public static synchronized IGnssNavigationMessageListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IGnssNavigationMessageListener {
            ...
            public synchronized void onGnssNavigationMessageReceived(GnssNavigationMessage event) throws RemoteException {

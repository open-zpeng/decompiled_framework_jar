...
public class CountryDetector {
    ...
    private static final class ListenerTransport extends ICountryListener.Stub {
        ...
        public synchronized ListenerTransport(CountryListener listener, Looper looper) {
        ...
        public synchronized void onCountryDetected(final Country country) {
    ...
    private protected void addCountryListener(CountryListener listener, Looper looper) {
    ...
    private protected void removeCountryListener(CountryListener listener) {
        synchronized (this.mListeners) {

...
public class GpsMeasurement implements Parcelable {
    ...
    private synchronized String getAccumulatedDeltaRangeStateString() {
    ...
    private synchronized String getLossOfLockString() {
    ...
    private synchronized String getMultipathIndicatorString() {
    ...
    private synchronized void resetFlag(int flag) {
        this.mFlags &= ~flag;
    }

    private synchronized boolean isFlagSet(int flag) {

...
public final class GpsStatus {
    ...
    private synchronized void setStatus(int svCount, int[] svidWithFlags, float[] cn0s, float[] elevations, float[] azimuths) {
        clearSatellites();
    ...
    public synchronized void setStatus(GnssStatus status, int timeToFirstFix) {
    ...
    public private protected void setTimeToFirstFix(int ttff) {
    ...
    private synchronized void clearSatellites() {

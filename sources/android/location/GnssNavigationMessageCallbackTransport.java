...
public class GnssNavigationMessageCallbackTransport extends LocalListenerHelper<GnssNavigationMessage.Callback> {
    ...
    public synchronized GnssNavigationMessageCallbackTransport(Context context, ILocationManager locationManager) {
    ...
    private class ListenerTransport extends IGnssNavigationMessageListener.Stub {
        ...
        public synchronized void onGnssNavigationMessageReceived(final GnssNavigationMessage event) {

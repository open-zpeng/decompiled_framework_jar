...
public class GeocoderParams implements Parcelable {
    ...
    private synchronized GeocoderParams() {
    }

    public synchronized GeocoderParams(Context context, Locale locale) {
        this.mLocale = locale;
        this.mPackageName = context.getPackageName();
    }

    private protected Locale getLocale() {
        return this.mLocale;
    }

    private protected String getClientPackage() {

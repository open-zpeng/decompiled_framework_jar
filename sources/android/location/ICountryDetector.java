...
public interface ICountryDetector extends IInterface {
    synchronized void addCountryListener(ICountryListener iCountryListener) throws RemoteException;

    synchronized Country detectCountry() throws RemoteException;

    synchronized void removeCountryListener(ICountryListener iCountryListener) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ICountryDetector {
        ...
        private static class Proxy implements ICountryDetector {
            ...
            public synchronized Country detectCountry() throws RemoteException {
                Country _result;
            ...
            @Override // android.location.ICountryDetector
            public synchronized void addCountryListener(ICountryListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.location.ICountryDetector
            public synchronized void removeCountryListener(ICountryListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

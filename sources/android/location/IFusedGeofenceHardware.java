...
public interface IFusedGeofenceHardware extends IInterface {
    synchronized void addGeofences(GeofenceHardwareRequestParcelable[] geofenceHardwareRequestParcelableArr) throws RemoteException;

    synchronized boolean isSupported() throws RemoteException;

    synchronized void modifyGeofenceOptions(int i, int i2, int i3, int i4, int i5, int i6) throws RemoteException;

    synchronized void pauseMonitoringGeofence(int i) throws RemoteException;

    synchronized void removeGeofences(int[] iArr) throws RemoteException;

    synchronized void resumeMonitoringGeofence(int i, int i2) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IFusedGeofenceHardware {
        ...
        public static synchronized IFusedGeofenceHardware asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IFusedGeofenceHardware {
            ...
            public synchronized boolean isSupported() throws RemoteException {
            ...
            @Override // android.location.IFusedGeofenceHardware
            public synchronized void addGeofences(GeofenceHardwareRequestParcelable[] geofenceRequestsArray) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.location.IFusedGeofenceHardware
            public synchronized void removeGeofences(int[] geofenceIds) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.location.IFusedGeofenceHardware
            public synchronized void pauseMonitoringGeofence(int geofenceId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.location.IFusedGeofenceHardware
            public synchronized void resumeMonitoringGeofence(int geofenceId, int monitorTransitions) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.location.IFusedGeofenceHardware
            public synchronized void modifyGeofenceOptions(int geofenceId, int lastTransition, int monitorTransitions, int notificationResponsiveness, int unknownTimer, int sourcesToUse) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public class LocationProvider {
    ...
    public synchronized LocationProvider(String name, ProviderProperties properties) {
    ...
    public static synchronized boolean propertiesMeetCriteria(String name, ProviderProperties properties, Criteria criteria) {

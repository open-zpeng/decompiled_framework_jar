...
public class FusedBatchOptions implements Parcelable {
    ...
    public synchronized void setMaxPowerAllocationInMW(double value) {
        this.mMaxPowerAllocationInMW = value;
    }

    public synchronized double getMaxPowerAllocationInMW() {
        return this.mMaxPowerAllocationInMW;
    }

    public synchronized void setPeriodInNS(long value) {
        this.mPeriodInNS = value;
    }

    public synchronized long getPeriodInNS() {
        return this.mPeriodInNS;
    }

    public synchronized void setSmallestDisplacementMeters(float value) {
        this.mSmallestDisplacementMeters = value;
    }

    public synchronized float getSmallestDisplacementMeters() {
        return this.mSmallestDisplacementMeters;
    }

    public synchronized void setSourceToUse(int source) {
        this.mSourcesToUse |= source;
    }

    public synchronized void resetSourceToUse(int source) {
        this.mSourcesToUse &= ~source;
    }

    public synchronized boolean isSourceToUseSet(int source) {
        return (this.mSourcesToUse & source) != 0;
    }

    public synchronized int getSourcesToUse() {

...
public class Country implements Parcelable {
    ...
    private protected Country(String countryIso, int source) {
    ...
    private synchronized Country(String countryIso, int source, long timestamp) {
        if (countryIso == null || source < 0 || source > 3) {
            throw new IllegalArgumentException();
        }
        this.mCountryIso = countryIso.toUpperCase(Locale.US);
    ...
    public synchronized Country(Country country) {
    ...
    private protected final int getSource() {
        return this.mSource;
    }
    ...
    public synchronized boolean equalsIgnoreSource(Country country) {

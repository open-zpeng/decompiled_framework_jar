        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    restoreDelayedRuntimePermissionBackup(_arg05, _arg13, _arg2);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    getAppPermissions(_arg06, _arg14);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg07 = data.readString();
                    String _arg16 = data.readString();
                    revokeRuntimePermission(_arg07, _arg16);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    countPermissionApps(_arg08, _arg17, _arg22);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    getPermissionUsages(_arg09, _arg18, _arg23);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setRuntimePermissionGrantStateByDeviceAdmin(_arg010, _arg19, _arg25, _arg32, _arg42);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {

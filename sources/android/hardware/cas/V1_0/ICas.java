...
public interface ICas extends IBase {
    ...
    public static final class Proxy implements ICas {
        ...
        @Override // android.hardware.cas.V1_0.ICas, android.hidl.base.V1_0.IBase, android.os.IHwInterface
        ...
        @Override // android.hardware.cas.V1_0.ICas, android.hidl.base.V1_0.IBase
        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, final HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            ...
            switch (_hidl_code) {
                ...
                case 4:
                    ...
                    int _hidl_out_status4 = setSessionPrivateData(sessionId2, pvtData2);
                    _hidl_reply.writeStatus(0);
                    _hidl_reply.writeInt32(_hidl_out_status4);
                    _hidl_reply.send();
                    return;
                case 5:
                    int _hidl_out_status5 = _hidl_flags & 1;
                    _hidl_is_oneway = _hidl_out_status5 != 0;
                    if (_hidl_is_oneway) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                    ...
                    return;
                case 6:
                    int arg = _hidl_flags & 1;
                    _hidl_is_oneway = arg != 0;
                    if (_hidl_is_oneway) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                ...
                case 7:
                    ...
                    _hidl_is_oneway = _hidl_out_status8 != 0;
                    if (_hidl_is_oneway) {
                        _hidl_reply.writeStatus(Integer.MIN_VALUE);
                        _hidl_reply.send();
                        return;
                    ...
                    int _hidl_out_status9 = sendEvent(event, arg2, eventData);
                    _hidl_reply.writeStatus(0);

...
public interface ISerialManager extends IInterface {
    synchronized String[] getSerialPorts() throws RemoteException;

    synchronized ParcelFileDescriptor openSerialPort(String str) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ISerialManager {
        ...
        public static synchronized ISerialManager asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ISerialManager {
            ...
            public synchronized String[] getSerialPorts() throws RemoteException {
            ...
            @Override // android.hardware.ISerialManager
            public synchronized ParcelFileDescriptor openSerialPort(String name) throws RemoteException {

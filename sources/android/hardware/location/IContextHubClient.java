...
public interface IContextHubClient extends IInterface {
    ...
    synchronized int sendMessageToNanoApp(NanoAppMessage nanoAppMessage) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IContextHubClient {
        ...
        public static synchronized IContextHubClient asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IContextHubClient {
            ...
            public synchronized int sendMessageToNanoApp(NanoAppMessage message) throws RemoteException {

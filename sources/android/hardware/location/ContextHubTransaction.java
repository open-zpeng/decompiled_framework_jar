...
public class ContextHubTransaction<T> {
    ...
    public static class Response<R> {
        ...
        public synchronized Response(int result, R contents) {
            this.mResult = result;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized ContextHubTransaction(int type) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setResponse(Response<T> response) {

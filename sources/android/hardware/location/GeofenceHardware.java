...
public final class GeofenceHardware {
    ...
    private protected GeofenceHardware(IGeofenceHardware service) {
    ...
    public synchronized void removeCallback(GeofenceHardwareCallback callback) {
        synchronized (this.mCallbacks) {
            this.mCallbacks.remove(callback);
        }
    }

    private synchronized GeofenceHardwareCallbackWrapper getCallbackWrapper(GeofenceHardwareCallback callback) {
    ...
    private synchronized void removeMonitorCallback(GeofenceHardwareMonitorCallback callback) {
        synchronized (this.mMonitorCallbacks) {
            this.mMonitorCallbacks.remove(callback);
        }
    }

    private synchronized GeofenceHardwareMonitorCallbackWrapper getMonitorCallbackWrapper(GeofenceHardwareMonitorCallback callback) {
    ...
    public class GeofenceHardwareMonitorCallbackWrapper extends IGeofenceHardwareMonitorCallback.Stub {
        ...
        public synchronized void onMonitoringSystemChange(GeofenceHardwareMonitorEvent event) {
    ...
    public class GeofenceHardwareCallbackWrapper extends IGeofenceHardwareCallback.Stub {
        ...
        public synchronized void onGeofenceTransition(int geofenceId, int transition, Location location, long timestamp, int monitoringType) {
        ...
        @Override // android.hardware.location.IGeofenceHardwareCallback
        public synchronized void onGeofenceAdd(int geofenceId, int status) {
            GeofenceHardwareCallback c = this.mCallback.get();
            if (c != null) {
        ...
        @Override // android.hardware.location.IGeofenceHardwareCallback
        public synchronized void onGeofenceRemove(int geofenceId, int status) {
            GeofenceHardwareCallback c = this.mCallback.get();
            if (c != null) {
        ...
        @Override // android.hardware.location.IGeofenceHardwareCallback
        public synchronized void onGeofencePause(int geofenceId, int status) {
            GeofenceHardwareCallback c = this.mCallback.get();
            if (c != null) {
        ...
        @Override // android.hardware.location.IGeofenceHardwareCallback
        public synchronized void onGeofenceResume(int geofenceId, int status) {
            GeofenceHardwareCallback c = this.mCallback.get();
            if (c != null) {

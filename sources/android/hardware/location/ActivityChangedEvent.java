...
public class ActivityChangedEvent implements Parcelable {
    ...
    public synchronized ActivityChangedEvent(ActivityRecognitionEvent[] activityRecognitionEvents) {
    ...
    public synchronized Iterable<ActivityRecognitionEvent> getActivityRecognitionEvents() {

...
public interface IActivityRecognitionHardwareWatcher extends IInterface {
    synchronized void onInstanceChanged(IActivityRecognitionHardware iActivityRecognitionHardware) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IActivityRecognitionHardwareWatcher {
        ...
        public static synchronized IActivityRecognitionHardwareWatcher asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IActivityRecognitionHardwareWatcher {
            ...
            public synchronized void onInstanceChanged(IActivityRecognitionHardware instance) throws RemoteException {

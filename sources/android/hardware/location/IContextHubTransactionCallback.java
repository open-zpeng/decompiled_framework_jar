...
public interface IContextHubTransactionCallback extends IInterface {
    synchronized void onQueryResponse(int i, List<NanoAppState> list) throws RemoteException;

    synchronized void onTransactionComplete(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IContextHubTransactionCallback {
        ...
        public static synchronized IContextHubTransactionCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IContextHubTransactionCallback {
            ...
            public synchronized void onQueryResponse(int result, List<NanoAppState> nanoappList) throws RemoteException {
            ...
            @Override // android.hardware.location.IContextHubTransactionCallback
            public synchronized void onTransactionComplete(int result) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(result);

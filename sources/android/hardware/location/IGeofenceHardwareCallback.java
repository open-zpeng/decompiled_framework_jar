...
public interface IGeofenceHardwareCallback extends IInterface {
    synchronized void onGeofenceAdd(int i, int i2) throws RemoteException;

    synchronized void onGeofencePause(int i, int i2) throws RemoteException;

    synchronized void onGeofenceRemove(int i, int i2) throws RemoteException;

    synchronized void onGeofenceResume(int i, int i2) throws RemoteException;

    synchronized void onGeofenceTransition(int i, int i2, Location location, long j, int i3) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IGeofenceHardwareCallback {
        ...
        public static synchronized IGeofenceHardwareCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IGeofenceHardwareCallback {
            ...
            public synchronized void onGeofenceTransition(int geofenceId, int transition, Location location, long timestamp, int monitoringType) throws RemoteException {
            ...
            @Override // android.hardware.location.IGeofenceHardwareCallback
            public synchronized void onGeofenceAdd(int geofenceId, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(geofenceId);
            ...
            @Override // android.hardware.location.IGeofenceHardwareCallback
            public synchronized void onGeofenceRemove(int geofenceId, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(geofenceId);
            ...
            @Override // android.hardware.location.IGeofenceHardwareCallback
            public synchronized void onGeofencePause(int geofenceId, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(geofenceId);
            ...
            @Override // android.hardware.location.IGeofenceHardwareCallback
            public synchronized void onGeofenceResume(int geofenceId, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(geofenceId);

...
public final class SensorDirectChannel implements Channel {
    ...
    @Deprecated
    private protected boolean isValid() {
        return isOpen();
    }
    ...
    public synchronized SensorDirectChannel(SensorManager manager, int id, int type, long size) {
    ...
    static synchronized long[] encodeData(MemoryFile ashmem) {
        int fd;
        try {

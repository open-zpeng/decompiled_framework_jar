...
public final class KeyboardLayout implements Parcelable, Comparable<KeyboardLayout> {
    ...
    public synchronized KeyboardLayout(String descriptor, String label, String collection, int priority, LocaleList locales, int vid, int pid) {
    ...
    private synchronized KeyboardLayout(Parcel source) {
    ...
    public synchronized LocaleList getLocales() {
    ...
    public synchronized int compareTo(KeyboardLayout another) {

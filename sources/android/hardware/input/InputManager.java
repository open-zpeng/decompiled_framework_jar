...
public final class InputManager {
    ...
    private protected static final int INJECT_INPUT_EVENT_MODE_WAIT_FOR_FINISH = 2;
    ...
    public protected final IInputManager mIm;
    ...
    public interface OnTabletModeChangedListener {
        synchronized void onTabletModeChanged(long j, boolean z);
    }
    ...
    private synchronized InputManager(IInputManager im) {
        this.mIm = im;
    }
    ...
    public synchronized InputDevice getInputDeviceByDescriptor(String descriptor) {
        if (descriptor == null) {
    ...
    public synchronized boolean isInputDeviceEnabled(int id) {
        try {
    ...
    public synchronized void enableInputDevice(int id) {
        try {
    ...
    public synchronized void disableInputDevice(int id) {
        try {
    ...
    private synchronized int findInputDeviceListenerLocked(InputDeviceListener listener) {
    ...
    public synchronized int isInTabletMode() {
        try {
    ...
    public synchronized void registerOnTabletModeChangedListener(OnTabletModeChangedListener listener, Handler handler) {
        if (listener == null) {
            throw new IllegalArgumentException("listener must not be null");
        }
    ...
    public synchronized void unregisterOnTabletModeChangedListener(OnTabletModeChangedListener listener) {
        if (listener == null) {
            throw new IllegalArgumentException("listener must not be null");
        }
        synchronized (this.mTabletModeLock) {
    ...
    private synchronized void initializeTabletModeListenerLocked() {
    ...
    private synchronized int findOnTabletModeChangedListenerLocked(OnTabletModeChangedListener listener) {
    ...
    public synchronized KeyboardLayout[] getKeyboardLayoutsForInputDevice(InputDeviceIdentifier identifier) {
        try {
    ...
    public synchronized KeyboardLayout getKeyboardLayout(String keyboardLayoutDescriptor) {
    ...
    public synchronized String getCurrentKeyboardLayoutForInputDevice(InputDeviceIdentifier identifier) {
        try {
    ...
    public synchronized void setCurrentKeyboardLayoutForInputDevice(InputDeviceIdentifier identifier, String keyboardLayoutDescriptor) {
        if (identifier == null) {
    ...
    public synchronized String[] getEnabledKeyboardLayoutsForInputDevice(InputDeviceIdentifier identifier) {
        if (identifier == null) {
    ...
    public synchronized void addKeyboardLayoutForInputDevice(InputDeviceIdentifier identifier, String keyboardLayoutDescriptor) {
        if (identifier == null) {
            throw new IllegalArgumentException("inputDeviceDescriptor must not be null");
        }
        if (keyboardLayoutDescriptor == null) {
    ...
    public synchronized void removeKeyboardLayoutForInputDevice(InputDeviceIdentifier identifier, String keyboardLayoutDescriptor) {
        if (identifier == null) {
            throw new IllegalArgumentException("inputDeviceDescriptor must not be null");
        }
        if (keyboardLayoutDescriptor == null) {
    ...
    public synchronized TouchCalibration getTouchCalibration(String inputDeviceDescriptor, int surfaceRotation) {
        try {
    ...
    public synchronized void setTouchCalibration(String inputDeviceDescriptor, int surfaceRotation, TouchCalibration calibration) {
        try {
    ...
    public synchronized int getPointerSpeed(Context context) {
        try {
            int speed = Settings.System.getInt(context.getContentResolver(), "pointer_speed");
            return speed;
    ...
    public synchronized void setPointerSpeed(Context context, int speed) {
        if (speed < -7 || speed > 7) {
    ...
    public synchronized void tryPointerSpeed(int speed) {
        if (speed < -7 || speed > 7) {
            throw new IllegalArgumentException("speed out of range");
        }
        try {
    ...
    public synchronized boolean[] deviceHasKeys(int[] keyCodes) {
        return deviceHasKeys(-1, keyCodes);
    }

    public synchronized boolean[] deviceHasKeys(int id, int[] keyCodes) {
    ...
    public synchronized void setCustomPointerIcon(PointerIcon icon) {
        try {
    ...
    public synchronized void requestPointerCapture(IBinder windowToken, boolean enable) {
        try {
    ...
    private synchronized void populateInputDevicesLocked() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onInputDevicesChanged(int[] deviceIdAndGeneration) {
        synchronized (this.mInputDevicesLock) {
    ...
    private synchronized void sendMessageToInputDeviceListenersLocked(int what, int deviceId) {
        int numListeners = this.mInputDeviceListeners.size();
        for (int i = 0; i < numListeners; i++) {
    ...
    private static synchronized boolean containsDeviceId(int[] deviceIdAndGeneration, int deviceId) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onTabletModeChanged(long whenNanos, boolean inTabletMode) {
        synchronized (this.mTabletModeLock) {
            int N = this.mOnTabletModeChangedListeners.size();
            for (int i = 0; i < N; i++) {
    ...
    public synchronized Vibrator getInputDeviceVibrator(int deviceId) {
    ...
    public static final class InputDeviceListenerDelegate extends Handler {
        ...
        public synchronized InputDeviceListenerDelegate(InputDeviceListener listener, Handler handler) {
    ...
    public static final class OnTabletModeChangedListenerDelegate extends Handler {
        ...
        public synchronized OnTabletModeChangedListenerDelegate(OnTabletModeChangedListener listener, Handler handler) {
            super(handler != null ? handler.getLooper() : Looper.myLooper());
            this.mListener = listener;
        }

        public synchronized void sendTabletModeChanged(long whenNanos, boolean inTabletMode) {

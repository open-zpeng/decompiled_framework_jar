...
public class RadioManager {
    ...
    public static class ModuleProperties implements Parcelable {
        ...
        private static synchronized Set<Integer> arrayToSet(int[] arr) {
            return (Set) Arrays.stream(arr).boxed().collect(Collectors.toSet());
        }

        private static synchronized int[] setToArray(Set<Integer> set) {
            return set.stream().mapToInt(new ToIntFunction() { // from class: android.hardware.radio.-$$Lambda$RadioManager$ModuleProperties$UV1wDVoVlbcxpr8zevj_aMFtUGw
        ...
        private synchronized ModuleProperties(Parcel in) {
            this.mId = in.readInt();
    ...
    public static class BandDescriptor implements Parcelable {
        ...
        synchronized BandDescriptor(int region, int type, int lowerLimit, int upperLimit, int spacing) {
        ...
        private synchronized BandDescriptor(Parcel in) {
        ...
        public static synchronized int lookupTypeFromParcel(Parcel in) {
        ...
        public int hashCode() {
            int result = (31 * 1) + this.mRegion;
            return (31 * ((31 * ((31 * ((31 * result) + this.mType)) + this.mLowerLimit)) + this.mUpperLimit)) + this.mSpacing;
        }
    ...
    public static class FmBandDescriptor extends BandDescriptor {
        ...
        public synchronized FmBandDescriptor(int region, int type, int lowerLimit, int upperLimit, int spacing, boolean stereo, boolean rds, boolean ta, boolean af, boolean ea) {
        ...
        private synchronized FmBandDescriptor(Parcel in) {
            super(in, null);
        ...
        public int hashCode() {
            ...
            return (31 * ((31 * ((31 * ((31 * ((31 * result) + (this.mStereo ? 1 : 0))) + (this.mRds ? 1 : 0))) + (this.mTa ? 1 : 0))) + (this.mAf ? 1 : 0))) + (this.mEa ? 1 : 0);
        }
    ...
    public static class AmBandDescriptor extends BandDescriptor {
        ...
        public synchronized AmBandDescriptor(int region, int type, int lowerLimit, int upperLimit, int spacing, boolean stereo) {
            super(region, type, lowerLimit, upperLimit, spacing);
            this.mStereo = stereo;
        }
        ...
        private synchronized AmBandDescriptor(Parcel in) {
            super(in, null);
            this.mStereo = in.readByte() == 1;
        }
        ...
        public int hashCode() {
            int result = super.hashCode();
            return (31 * result) + (this.mStereo ? 1 : 0);
        }
    ...
    public static class BandConfig implements Parcelable {
        ...
        synchronized BandConfig(BandDescriptor descriptor) {
            this.mDescriptor = (BandDescriptor) Objects.requireNonNull(descriptor);
        }

        synchronized BandConfig(int region, int type, int lowerLimit, int upperLimit, int spacing) {
            this.mDescriptor = new BandDescriptor(region, type, lowerLimit, upperLimit, spacing);
        }

        private synchronized BandConfig(Parcel in) {
            this.mDescriptor = new BandDescriptor(in, null);
        }

        synchronized BandDescriptor getDescriptor() {
        ...
        public int hashCode() {
            int result = (31 * 1) + this.mDescriptor.hashCode();
            return result;
        }
    ...
    public static class FmBandConfig extends BandConfig {
        ...
        public synchronized FmBandConfig(FmBandDescriptor descriptor) {
            super(descriptor);
        ...
        synchronized FmBandConfig(int region, int type, int lowerLimit, int upperLimit, int spacing, boolean stereo, boolean rds, boolean ta, boolean af, boolean ea) {
            super(region, type, lowerLimit, upperLimit, spacing);
            this.mStereo = stereo;
            this.mRds = rds;
            this.mTa = ta;
        ...
        private synchronized FmBandConfig(Parcel in) {
            super(in, null);
            this.mStereo = in.readByte() == 1;
            this.mRds = in.readByte() == 1;
            this.mTa = in.readByte() == 1;
    ...
    public static class AmBandConfig extends BandConfig {
        ...
        public synchronized AmBandConfig(AmBandDescriptor descriptor) {
            super(descriptor);
            this.mStereo = descriptor.isStereoSupported();
        }

        synchronized AmBandConfig(int region, int type, int lowerLimit, int upperLimit, int spacing, boolean stereo) {
            super(region, type, lowerLimit, upperLimit, spacing);
            this.mStereo = stereo;
        }
        ...
        private synchronized AmBandConfig(Parcel in) {
            super(in, null);
            this.mStereo = in.readByte() == 1;
        }
    ...
    public static class ProgramInfo implements Parcelable {
        ...
        public synchronized ProgramInfo(ProgramSelector selector, ProgramSelector.Identifier logicallyTunedTo, ProgramSelector.Identifier physicallyTunedTo, Collection<ProgramSelector.Identifier> relatedContent, int infoFlags, int signalQuality, RadioMetadata metadata, Map<String, String> vendorInfo) {
        ...
        private synchronized ProgramInfo(Parcel in) {
    ...
    public void addAnnouncementListener(Set<Integer> enabledAnnouncementTypes, Announcement.OnListUpdatedListener listener) {
        addAnnouncementListener(new Executor() { // from class: android.hardware.radio.-$$Lambda$RadioManager$cfMLnpQqL72UMrjmCGbrhAOHHgg
    ...
    public void addAnnouncementListener(Executor executor, Set<Integer> enabledAnnouncementTypes, Announcement.OnListUpdatedListener listener) {
        ...
        int[] types = enabledAnnouncementTypes.stream().mapToInt(new ToIntFunction() { // from class: android.hardware.radio.-$$Lambda$RadioManager$UV1wDVoVlbcxpr8zevj_aMFtUGw
            @Override // java.util.function.ToIntFunction
            public final int applyAsInt(Object obj) {
                int intValue;
                intValue = ((Integer) obj).intValue();
    ...
    public class AnonymousClass1 extends IAnnouncementListener.Stub {
        ...
        public void onListUpdated(final List<Announcement> activeAnnouncements) {
            ...
            executor.execute(new Runnable() { // from class: android.hardware.radio.-$$Lambda$RadioManager$1$yOwq8CG0kiZcgKFclFSIrjag008
    ...
    public synchronized RadioManager(Context context) throws ServiceManager.ServiceNotFoundException {

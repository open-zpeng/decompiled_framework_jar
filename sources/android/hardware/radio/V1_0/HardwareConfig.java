...
public final class HardwareConfig {
    ...
    public final void readEmbeddedFromParcel(HwParcel parcel, HwBlob _hidl_blob, long _hidl_offset) {
        ...
        for (int _hidl_index_02 = 0; _hidl_index_02 < _hidl_vec_size; _hidl_index_02++) {
            ...
            _hidl_vec_element.readEmbeddedFromParcel(parcel, childBlob, _hidl_index_02 * 20);
            this.modem.add(_hidl_vec_element);
        }
        int _hidl_vec_size2 = _hidl_blob.getInt32(_hidl_offset + 48 + 8);
        HwBlob childBlob2 = parcel.readEmbeddedBuffer(_hidl_vec_size2 * 16, _hidl_blob.handle(), 0 + _hidl_offset + 48, true);
        this.sim.clear();
        while (true) {
    ...
    public final void writeEmbeddedToBlob(HwBlob _hidl_blob, long _hidl_offset) {
        ...
        while (true) {
            ...
            if (_hidl_index_03 >= _hidl_vec_size2) {
                ...
                this.sim.get(_hidl_index_03).writeEmbeddedToBlob(childBlob2, _hidl_index_03 * 16);

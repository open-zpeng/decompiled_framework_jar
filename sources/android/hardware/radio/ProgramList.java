...
public final class ProgramList implements AutoCloseable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void apply(Chunk chunk) {
        synchronized (this.mLock) {
            if (this.mIsClosed) {
                return;
            }
    ...
    public synchronized void putLocked(RadioManager.ProgramInfo value) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void removeLocked(ProgramSelector.Identifier key) {
    ...
    public static final class Filter implements Parcelable {
        ...
        public synchronized Filter(Map<String, String> vendorFilter) {
            this.mIdentifierTypes = Collections.emptySet();
            this.mIdentifiers = Collections.emptySet();
            this.mIncludeCategories = false;
            this.mExcludeModifications = false;
        ...
        private synchronized Filter(Parcel in) {
        ...
        public synchronized Map<String, String> getVendorFilter() {
    ...
    public static final class Chunk implements Parcelable {
        ...
        public synchronized Chunk(boolean purge, boolean complete, Set<RadioManager.ProgramInfo> modified, Set<ProgramSelector.Identifier> removed) {
            this.mPurge = purge;
        ...
        private synchronized Chunk(Parcel in) {
        ...
        public synchronized boolean isPurge() {
            return this.mPurge;
        }
        ...
        public synchronized Set<RadioManager.ProgramInfo> getModified() {
            return this.mModified;
        }

        public synchronized Set<ProgramSelector.Identifier> getRemoved() {

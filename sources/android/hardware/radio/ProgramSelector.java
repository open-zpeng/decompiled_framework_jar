...
public final class ProgramSelector implements Parcelable {
    ...
    private static synchronized boolean isValidAmFmFrequency(boolean isAm, int frequencyKhz) {
    ...
    private synchronized ProgramSelector(Parcel in) {
    ...
    public static final class Identifier implements Parcelable {
        ...
        private synchronized Identifier(Parcel in) {

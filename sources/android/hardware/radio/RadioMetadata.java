...
public final class RadioMetadata implements Parcelable {
    ...
    public static final class Clock implements Parcelable {
        ...
        private synchronized Clock(Parcel in) {
    ...
    synchronized RadioMetadata() {
        this.mBundle = new Bundle();
    }

    private synchronized RadioMetadata(Bundle bundle) {
        this.mBundle = new Bundle(bundle);
    }

    private synchronized RadioMetadata(Parcel in) {
    ...
    public static synchronized void putInt(Bundle bundle, String key, int value) {
    ...
    public synchronized int getBitmapId(String key) {
    ...
    public static synchronized String getKeyFromNativeKey(int nativeKey) {
    ...
    public static final class Builder {
        ...
        public synchronized Builder(RadioMetadata source, int maxBitmapSize) {
            this(source);
            for (String key : this.mBundle.keySet()) {
        ...
        private synchronized Bitmap scaleBitmap(Bitmap bmp, int maxSize) {
    ...
    synchronized int putIntFromNative(int nativeKey, int value) {
    ...
    synchronized int putStringFromNative(int nativeKey, String value) {
        String key = getKeyFromNativeKey(nativeKey);
    ...
    synchronized int putBitmapFromNative(int nativeKey, byte[] value) {
        String key = getKeyFromNativeKey(nativeKey);
    ...
    synchronized int putClockFromNative(int nativeKey, long utcEpochSeconds, int timezoneOffsetInMinutes) {
        String key = getKeyFromNativeKey(nativeKey);

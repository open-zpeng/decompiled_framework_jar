        ...
        public void onTransact(int _hidl_code, HwParcel _hidl_request, HwParcel _hidl_reply, int _hidl_flags) throws RemoteException {
            switch (_hidl_code) {
                ...
                case 135:
                    ...
                    return;
                case 136:
                    int serial134 = _hidl_flags & 1;
                    boolean _hidl_is_oneway136 = serial134 != 0;
                    ...
                    stopKeepalive(serial135, sessionHandle);
                    return;
                case 137:
                    ...
                    startNetworkScan_1_2(serial136, request2);
                    return;
                case 138:
                    ...
                    setIndicationFilter_1_2(serial137, indicationFilter2);
                    return;
                case 139:
                    ...
                    setSignalStrengthReportingCriteria(serial138, hysteresisMs, hysteresisDb, thresholdsDbm, accessNetwork);
                    return;
                case 140:
                    ...
                    setLinkCapacityReportingCriteria(serial139, hysteresisMs2, hysteresisDlKbps, hysteresisUlKbps, thresholdsDownlinkKbps, thresholdsUplinkKbps, accessNetwork2);
                    return;
                case 141:
                    ...
                    setupDataCall_1_2(serial140, accessNetwork3, dataProfileInfo3, modemCognitive3, roamingAllowed2, isRoaming4, reason, addresses, dnses);
                    return;
                case 142:
                ...
                default:
                    switch (_hidl_code) {
                        ...
                        case 256136003:
                            ...
                            return;
                        case 256398152:
                            boolean _hidl_is_oneway146 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway146) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 256462420:
                            boolean _hidl_is_oneway147 = (_hidl_flags & 1) != 0;
                            if (!_hidl_is_oneway147) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 256660548:
                            boolean _hidl_is_oneway148 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway148) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            return;
                        case 256921159:
                            boolean _hidl_is_oneway149 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway149) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 257049926:
                            boolean _hidl_is_oneway150 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway150) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 257120595:
                            boolean _hidl_is_oneway151 = (_hidl_flags & 1) != 0;
                            if (!_hidl_is_oneway151) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 257250372:
                            boolean _hidl_is_oneway152 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway152) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }

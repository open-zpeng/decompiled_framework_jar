        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    onTrafficAnnouncement(_arg03);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    _arg03 = data.readInt() != 0;
                    onEmergencyAnnouncement(_arg03);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    _arg03 = data.readInt() != 0;
                    onAntennaState(_arg03);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    _arg03 = data.readInt() != 0;
                    onBackgroundScanAvailabilityChange(_arg03);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg04 = ProgramList.Chunk.CREATOR.createFromParcel(data);
                    } else {
                        _arg04 = null;
                    }
                    onProgramListUpdated(_arg04);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);

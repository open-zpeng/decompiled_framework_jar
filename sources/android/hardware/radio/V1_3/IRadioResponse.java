                ...
                default:
                    switch (_hidl_code) {
                        ...
                        case 256660548:
                            ...
                            return;
                        case 256921159:
                            boolean _hidl_is_oneway153 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway153) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 257049926:
                            boolean _hidl_is_oneway154 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway154) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 257120595:
                            boolean _hidl_is_oneway155 = (_hidl_flags & 1) != 0;
                            if (!_hidl_is_oneway155) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }
                            ...
                            return;
                        case 257250372:
                            boolean _hidl_is_oneway156 = (_hidl_flags & 1) != 0;
                            if (_hidl_is_oneway156) {
                                _hidl_reply.writeStatus(Integer.MIN_VALUE);
                                _hidl_reply.send();
                                return;
                            }

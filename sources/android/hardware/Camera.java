...
public class Camera {
    ...
    public class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (i == 1) {
                ...
                Log.i(Camera.TAG, "handle CAMERA_MSG_COMPRESSED_IMAGE, callback:" + Camera.this.mJpegCallback);
    ...
    public class Parameters {
        ...
        private static final String AVM_3603DANGLE = "3603d_angle";
        ...
        private static final String AVM_TRANSBODY = "transbody";
        ...
        public ArrayList<String> getRegisterPropertyIds() {
            ...
            propertyIds.add(AVM_3603DANGLE);
            propertyIds.add(AVM_TRANSBODY);
        ...
        public void setAvm3603DAngel(int value) {
            set(AVM_3603DANGLE, value);
        }

        public void setAvmTransBody(int value) {
            set(AVM_TRANSBODY, value);
        }
        ...
        public int get3603dAngle() {
            return getInt(AVM_3603DANGLE);
        }

        public int getTransBodySwitchStatus() {
            return getInt(AVM_TRANSBODY);
        }

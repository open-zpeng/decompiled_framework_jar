...
public final class HdmiPlaybackClient extends HdmiClient {
    ...
    public synchronized HdmiPlaybackClient(IHdmiControlService service) {
        super(service);
    }
    ...
    private synchronized IHdmiControlCallback getCallbackWrapper(final OneTouchPlayCallback callback) {
    ...
    private synchronized IHdmiControlCallback getCallbackWrapper(final DisplayStatusCallback callback) {

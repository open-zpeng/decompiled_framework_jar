...
public interface IHdmiInputChangeListener extends IInterface {
    synchronized void onChanged(HdmiDeviceInfo hdmiDeviceInfo) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IHdmiInputChangeListener {
        ...
        public static synchronized IHdmiInputChangeListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements IHdmiInputChangeListener {
            ...
            public synchronized void onChanged(HdmiDeviceInfo device) throws RemoteException {

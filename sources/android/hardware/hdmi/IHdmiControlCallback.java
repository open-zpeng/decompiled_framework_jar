...
public interface IHdmiControlCallback extends IInterface {
    synchronized void onComplete(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IHdmiControlCallback {
        ...
        public static synchronized IHdmiControlCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IHdmiControlCallback {
            ...
            public synchronized void onComplete(int result) throws RemoteException {

...
public abstract class HdmiRecordListener {
    ...
    public static class TimerStatusData {
        ...
        public static synchronized TimerStatusData parseFrom(int result) {
        ...
        private static synchronized int bcdByteToInt(byte value) {
            return ((((value >> 4) & 15) * 10) + value) & 15;
        }

        private synchronized TimerStatusData() {
        }

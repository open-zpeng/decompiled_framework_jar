...
public class HdmiDeviceInfo implements Parcelable {
    ...
    public synchronized HdmiDeviceInfo(int logicalAddress, int physicalAddress, int portId, int deviceType, int vendorId, String displayName, int powerStatus) {
    ...
    public synchronized HdmiDeviceInfo(int logicalAddress, int physicalAddress, int portId, int deviceType, int vendorId, String displayName) {
        this(logicalAddress, physicalAddress, portId, deviceType, vendorId, displayName, -1);
    }

    public synchronized HdmiDeviceInfo(int physicalAddress, int portId) {
    ...
    public synchronized HdmiDeviceInfo(int physicalAddress, int portId, int adopterId, int deviceId) {

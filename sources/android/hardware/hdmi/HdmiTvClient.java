...
public final class HdmiTvClient extends HdmiClient {
    ...
    public synchronized HdmiTvClient(IHdmiControlService service) {
        super(service);
    }

    static synchronized HdmiTvClient create(IHdmiControlService service) {
    ...
    private static synchronized IHdmiControlCallback getCallbackWrapper(final SelectCallback callback) {
    ...
    private static synchronized IHdmiInputChangeListener getListenerWrapper(final InputChangeListener listener) {
    ...
    private static synchronized IHdmiRecordListener getListenerWrapper(final HdmiRecordListener callback) {
    ...
    private synchronized void checkTimerRecordingSourceType(int sourceType) {
        switch (sourceType) {
            case 1:
            case 2:
            case 3:
    ...
    private synchronized IHdmiMhlVendorCommandListener getListenerWrapper(final HdmiMhlVendorCommandListener listener) {

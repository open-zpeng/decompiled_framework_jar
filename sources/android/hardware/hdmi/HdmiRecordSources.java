...
public final class HdmiRecordSources {
    ...
    public static boolean checkRecordSource(byte[] recordSource) {
        ...
        return recordSourceType != 1 ? recordSourceType != 2 ? recordSourceType != 3 ? recordSourceType != 4 ? recordSourceType == 5 && extraDataSize == 2 : extraDataSize == 1 : extraDataSize == 4 : extraDataSize == 7 : extraDataSize == 0;
    }
}

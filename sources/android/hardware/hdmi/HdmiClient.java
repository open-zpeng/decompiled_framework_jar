...
public abstract class HdmiClient {
    ...
    abstract synchronized int getDeviceType();

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized HdmiClient(IHdmiControlService service) {
    ...
    private static synchronized IHdmiVendorCommandListener getListenerWrapper(final HdmiControlManager.VendorCommandListener listener) {

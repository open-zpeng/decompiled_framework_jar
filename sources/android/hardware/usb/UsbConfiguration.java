...
public class UsbConfiguration implements Parcelable {
    ...
    public synchronized UsbConfiguration(int id, String name, int attributes, int maxPower) {
        this.mId = id;
        this.mName = name;
    ...
    public synchronized int getAttributes() {
    ...
    public synchronized void setInterfaces(Parcelable[] interfaces) {

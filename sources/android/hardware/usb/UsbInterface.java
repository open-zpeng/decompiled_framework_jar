...
public class UsbInterface implements Parcelable {
    ...
    public synchronized UsbInterface(int id, int alternateSetting, String name, int Class, int subClass, int protocol) {
        this.mId = id;
    ...
    public synchronized void setEndpoints(Parcelable[] endpoints) {

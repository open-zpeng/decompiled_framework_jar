...
public class UsbDeviceConnection {
    ...
    public synchronized UsbDeviceConnection(UsbDevice device) {
        this.mDevice = device;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean open(String name, ParcelFileDescriptor pfd, Context context) {
    ...
    private static synchronized void checkBounds(byte[] buffer, int start, int length) {

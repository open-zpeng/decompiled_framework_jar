...
public final class Sensor {
    ...
    private protected static final int TYPE_DEVICE_ORIENTATION = 27;
    ...
    private protected static final int TYPE_PICK_UP_GESTURE = 25;
    ...
    public static synchronized int getMaxLengthValuesArray(Sensor sensor, int sdkLevel) {
    ...
    public synchronized String getRequiredPermission() {
    ...
    synchronized void setRange(float max, float res) {
        this.mMaxRange = max;
    ...
    private synchronized boolean setType(int value) {
        this.mType = value;
        int i = this.mType;
        if (i == 27) {
    ...
    private synchronized void setUuid(long msb, long lsb) {
        this.mId = (int) msb;
    }
}

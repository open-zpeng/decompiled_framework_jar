...
public final class HardwareBuffer implements Parcelable, AutoCloseable {
    ...
    public protected HardwareBuffer(long nativeObject) {
    ...
    @Deprecated
    private protected boolean isDestroyed() {
        return isClosed();
    }
    ...
    private static synchronized boolean isSupportedFormat(int format) {

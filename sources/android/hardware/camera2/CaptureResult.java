...
public class CaptureResult extends CameraMetadata<Key<?>> {
    ...
    public protected final CameraMetadataNative mResults;
    ...
    @Deprecated
    private protected static final Key<Boolean> QUIRKS_PARTIAL_RESULT = new Key<>("android.quirks.partialResult", Boolean.TYPE);
    @Deprecated
    private protected static final Key<Integer> REQUEST_FRAME_COUNT = new Key<>("android.request.frameCount", Integer.TYPE);
    ...
    private protected static final Key<int[]> STATISTICS_FACE_IDS = new Key<>("android.statistics.faceIds", int[].class);
    private protected static final Key<int[]> STATISTICS_FACE_LANDMARKS = new Key<>("android.statistics.faceLandmarks", int[].class);
    private protected static final Key<Rect[]> STATISTICS_FACE_RECTANGLES = new Key<>("android.statistics.faceRectangles", Rect[].class);
    private protected static final Key<byte[]> STATISTICS_FACE_SCORES = new Key<>("android.statistics.faceScores", byte[].class);
    @SyntheticKey
    @PublicKey
    ...
    private protected static final Key<float[]> STATISTICS_LENS_SHADING_MAP = new Key<>("android.statistics.lensShadingMap", float[].class);
    @Deprecated
    private protected static final Key<float[]> STATISTICS_PREDICTED_COLOR_GAINS = new Key<>("android.statistics.predictedColorGains", float[].class);
    @Deprecated
    private protected static final Key<Rational[]> STATISTICS_PREDICTED_COLOR_TRANSFORM = new Key<>("android.statistics.predictedColorTransform", Rational[].class);
    @PublicKey
    ...
    private protected static final Key<long[]> STATISTICS_OIS_TIMESTAMPS = new Key<>("android.statistics.oisTimestamps", long[].class);
    private protected static final Key<float[]> STATISTICS_OIS_X_SHIFTS = new Key<>("android.statistics.oisXShifts", float[].class);
    private protected static final Key<float[]> STATISTICS_OIS_Y_SHIFTS = new Key<>("android.statistics.oisYShifts", float[].class);
    @SyntheticKey
    @PublicKey
    ...
    private protected static final Key<Long> SYNC_FRAME_NUMBER = new Key<>("android.sync.frameNumber", Long.TYPE);
    @PublicKey
    ...
    public synchronized CaptureResult(CameraMetadataNative results, CaptureRequest parent, CaptureResultExtras extras) {
        if (results == null) {
    ...
    public synchronized CaptureResult(CameraMetadataNative results, int sequenceId) {
        if (results == null) {
            throw new IllegalArgumentException("results was null");
        }
        this.mResults = CameraMetadataNative.move(results);

...
public class LegacyMetadataMapper {
    ...
    private static void mapSensor(CameraMetadataNative m, Camera.Parameters p) {
        ...
        float height = (float) Math.abs(focalLength * 2.0f * Math.tan(angleVer / 2.0d));
    ...
    public static int convertSceneModeFromLegacy(String mode) {
        if (mode == null) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String convertSceneModeToLegacy(int mode) {
        if (mode == 1) {
            return "auto";
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int convertEffectModeFromLegacy(String mode) {
        if (mode == null) {
            return 0;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String convertEffectModeToLegacy(int mode) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static int convertAntiBandingModeOrDefault(String mode) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static String convertAfModeToLegacy(int mode, List<String> supportedFocusModes) {

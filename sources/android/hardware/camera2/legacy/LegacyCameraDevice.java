...
public class LegacyCameraDevice implements AutoCloseable {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean needsConversion(Surface s) throws LegacyExceptionUtils.BufferQueueAbandonedException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void connectSurface(Surface surface) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        Preconditions.checkNotNull(surface);
        LegacyExceptionUtils.throwOnError(nativeConnectSurface(surface));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void disconnectSurface(Surface surface) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        if (surface == null) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void produceFrame(Surface surface, byte[] pixelBuffer, int width, int height, int pixelFormat) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        Preconditions.checkNotNull(surface);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setSurfaceFormat(Surface surface, int pixelFormat) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        Preconditions.checkNotNull(surface);
        LegacyExceptionUtils.throwOnError(nativeSetSurfaceFormat(surface, pixelFormat));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setSurfaceDimens(Surface surface, int width, int height) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        Preconditions.checkNotNull(surface);
        Preconditions.checkArgumentPositive(width, "width must be positive.");
        Preconditions.checkArgumentPositive(height, "height must be positive.");
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static List<Long> getSurfaceIds(Collection<Surface> surfaces) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        if (surfaces == null) {
            throw new NullPointerException("Null argument surfaces");
        }
        List<Long> surfaceIds = new ArrayList<>();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static boolean containsSurfaceId(Surface s, Collection<Long> ids) {
        try {
            long id = getSurfaceId(s);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setSurfaceOrientation(Surface surface, int facing, int sensorOrientation) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        Preconditions.checkNotNull(surface);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setNextTimestamp(Surface surface, long timestamp) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        Preconditions.checkNotNull(surface);
        LegacyExceptionUtils.throwOnError(nativeSetNextTimestamp(surface, timestamp));
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static void setScalingMode(Surface surface, int mode) throws LegacyExceptionUtils.BufferQueueAbandonedException {
        Preconditions.checkNotNull(surface);

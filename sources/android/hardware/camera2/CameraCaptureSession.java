...
public abstract class CameraCaptureSession implements AutoCloseable {
    ...
    public abstract synchronized void prepare(int i, Surface surface) throws CameraAccessException;
    ...
    public abstract synchronized void tearDown(Surface surface) throws CameraAccessException;
    ...
    public static abstract class CaptureCallback {
        ...
        public synchronized void onCapturePartial(CameraCaptureSession session, CaptureRequest request, CaptureResult result) {
        }

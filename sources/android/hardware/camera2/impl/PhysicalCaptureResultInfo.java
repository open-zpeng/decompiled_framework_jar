...
public class PhysicalCaptureResultInfo implements Parcelable {
    ...
    private synchronized PhysicalCaptureResultInfo(Parcel in) {
        readFromParcel(in);
    }

    public synchronized PhysicalCaptureResultInfo(String cameraId, CameraMetadataNative cameraMetadata) {
    ...
    public synchronized CameraMetadataNative getCameraMetadata() {

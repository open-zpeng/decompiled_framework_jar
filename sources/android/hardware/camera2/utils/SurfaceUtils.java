...
public class SurfaceUtils {
    public static synchronized boolean isSurfaceForPreview(Surface surface) {
        return LegacyCameraDevice.isPreviewConsumer(surface);
    }

    public static synchronized boolean isSurfaceForHwVideoEncoder(Surface surface) {
        return LegacyCameraDevice.isVideoEncoderConsumer(surface);
    }

    public static synchronized long getSurfaceId(Surface surface) {
        try {
    ...
    public static synchronized int getSurfaceFormat(Surface surface) {
        try {
    ...
    public static synchronized int getSurfaceDataspace(Surface surface) {
        try {
    ...
    private static synchronized void checkHighSpeedSurfaceFormat(Surface surface) {
    ...
    public static synchronized void checkConstrainedHighSpeedSurfaces(Collection<Surface> surfaces, Range<Integer> fpsRange, StreamConfigurationMap config) {

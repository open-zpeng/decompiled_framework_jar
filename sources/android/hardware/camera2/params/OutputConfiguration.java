...
public final class OutputConfiguration implements Parcelable {
    ...
    public synchronized boolean isForPhysicalCamera() {
        return this.mPhysicalCameraId != null;
    }

    public synchronized boolean isDeferredConfiguration() {
    ...
    public synchronized OutputConfiguration(OutputConfiguration other) {
        this.SURFACE_TYPE_UNKNOWN = -1;
        this.SURFACE_TYPE_SURFACE_VIEW = 0;
        this.SURFACE_TYPE_SURFACE_TEXTURE = 1;
        if (other == null) {
    ...
    private synchronized OutputConfiguration(Parcel source) {
        boolean isDeferred;
        this.SURFACE_TYPE_UNKNOWN = -1;
        this.SURFACE_TYPE_SURFACE_VIEW = 0;
        this.SURFACE_TYPE_SURFACE_TEXTURE = 1;

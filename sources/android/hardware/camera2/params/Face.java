...
public final class Face {
    ...
    public synchronized Face(Rect bounds, int score, int id, Point leftEyePosition, Point rightEyePosition, Point mouthPosition) {
    ...
    public synchronized Face(Rect bounds, int score) {
    ...
    private static synchronized void checkNotNull(String name, Object obj) {
        if (obj == null) {
            throw new IllegalArgumentException(name + " was required, but it was null");
        }
    }

    private static synchronized void checkNull(String name, Object obj) {
        if (obj != null) {

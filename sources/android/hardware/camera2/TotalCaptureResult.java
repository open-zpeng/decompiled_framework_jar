...
public final class TotalCaptureResult extends CaptureResult {
    ...
    public synchronized TotalCaptureResult(CameraMetadataNative results, CaptureRequest parent, CaptureResultExtras extras, List<CaptureResult> partials, int sessionId, PhysicalCaptureResultInfo[] physicalResults) {
    ...
    public synchronized TotalCaptureResult(CameraMetadataNative results, int sequenceId) {

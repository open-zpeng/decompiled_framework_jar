...
public final class MarshalHelpers {
    private protected static final int SIZEOF_BYTE = 1;
    private protected static final int SIZEOF_DOUBLE = 8;
    private protected static final int SIZEOF_FLOAT = 4;
    private protected static final int SIZEOF_INT32 = 4;
    private protected static final int SIZEOF_INT64 = 8;
    private protected static final int SIZEOF_RATIONAL = 8;

    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized int getPrimitiveTypeSize(int nativeType) {
        switch (nativeType) {
            case 0:
                return 1;
            case 1:
    ...
    private protected static synchronized <T> Class<T> checkPrimitiveClass(Class<T> klass) {
    ...
    private protected static synchronized <T> boolean isPrimitiveClass(Class<T> klass) {
        if (klass == null) {
            return false;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized <T> Class<T> wrapClassIfPrimitive(Class<T> klass) {
        if (klass == Byte.TYPE) {
            return Byte.class;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized String toStringNativeType(int nativeType) {
        switch (nativeType) {
            case 0:
                return "TYPE_BYTE";
            case 1:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized int checkNativeType(int nativeType) {
        switch (nativeType) {
            case 0:
            case 1:
            case 2:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized int checkNativeTypeEquals(int expectedNativeType, int actualNativeType) {
    ...
    public protected synchronized MarshalHelpers() {

...
public class MarshalQueryableEnum<T extends Enum<T>> implements MarshalQueryable<T> {
    ...
    public protected static final int UINT8_MAX = 255;
    public protected static final int UINT8_MIN = 0;
    public protected static final String TAG = MarshalQueryableEnum.class.getSimpleName();
    public protected static final HashMap<Class<? extends Enum>, int[]> sEnumValues = new HashMap<>();
    ...
    private class MarshalerEnum extends Marshaler<T> {
        ...
        public synchronized T m27unmarshal(ByteBuffer buffer) {
            int enumValue;
    ...
    private protected static synchronized <T extends Enum<T>> void registerEnumValues(Class<T> enumType, int[] values) {
    ...
    public static synchronized <T extends Enum<T>> int getEnumValue(T enumValue) {
    ...
    /* JADX INFO: Access modifiers changed from: public */
    public static synchronized <T extends Enum<T>> T getEnumFromValue(Class<T> enumType, int value) {
        int ordinal;

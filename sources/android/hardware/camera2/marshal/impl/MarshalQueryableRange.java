...
public class MarshalQueryableRange<T extends Comparable<? super T>> implements MarshalQueryable<Range<T>> {
    public protected static final int RANGE_COUNT = 2;

    /* loaded from: classes.dex */
    private class MarshalerRange extends Marshaler<Range<T>> {
        public protected final Class<? super Range<T>> mClass;
        public protected final Constructor<Range<T>> mConstructor;
        public protected final Marshaler<T> mNestedTypeMarshaler;
        ...
        private protected synchronized void marshal(Range<T> value, ByteBuffer buffer) {
        ...
        public synchronized Range<T> m33unmarshal(ByteBuffer buffer) {
        ...
        private protected synchronized int calculateMarshalSize(Range<T> value) {
    ...
    private protected synchronized Marshaler<Range<T>> createMarshaler(TypeReference<Range<T>> managedType, int nativeType) {
        return new MarshalerRange(managedType, nativeType);
    }

    private protected synchronized boolean isTypeMappingSupported(TypeReference<Range<T>> managedType, int nativeType) {

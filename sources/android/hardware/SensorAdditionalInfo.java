...
public class SensorAdditionalInfo {
    ...
    public synchronized SensorAdditionalInfo(Sensor aSensor, int aType, int aSerial, int[] aIntValues, float[] aFloatValues) {
        this.sensor = aSensor;
        this.type = aType;
        this.serial = aSerial;
    ...
    public static synchronized SensorAdditionalInfo createLocalGeomagneticField(float strength, float declination, float inclination) {
    ...
    public static synchronized SensorAdditionalInfo createCustomInfo(Sensor aSensor, int type, float[] data) {

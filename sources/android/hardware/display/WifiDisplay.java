...
public final class WifiDisplay implements Parcelable {
    ...
    public synchronized WifiDisplay(String deviceAddress, String deviceName, String deviceAlias, boolean available, boolean canConnect, boolean remembered) {
    ...
    private protected String getDeviceName() {
        return this.mDeviceName;
    }

    private protected String getDeviceAlias() {
    ...
    public synchronized String getFriendlyDisplayName() {
    ...
    public synchronized boolean hasSameAddress(WifiDisplay other) {

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 7:
                    ...
                    boolean nightDisplayActivated = setNightDisplayActivated(_arg0);
                    reply.writeNoException();
                ...
                case 14:
                    ...
                    boolean nightDisplayCustomStartTime = setNightDisplayCustomStartTime(_arg02);
                    reply.writeNoException();
                ...
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = Time.CREATOR.createFromParcel(data);
                    } else {
                        _arg03 = null;
                    }
                    boolean nightDisplayCustomEndTime = setNightDisplayCustomEndTime(_arg03);
                    reply.writeNoException();
                ...
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                    boolean displayWhiteBalanceEnabled = setDisplayWhiteBalanceEnabled(_arg0);
                    reply.writeNoException();

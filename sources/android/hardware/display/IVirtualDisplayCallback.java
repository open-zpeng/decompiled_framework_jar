...
public interface IVirtualDisplayCallback extends IInterface {
    synchronized void onPaused() throws RemoteException;

    synchronized void onResumed() throws RemoteException;

    synchronized void onStopped() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IVirtualDisplayCallback {
        ...
        public static synchronized IVirtualDisplayCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IVirtualDisplayCallback {
            ...
            public synchronized void onPaused() throws RemoteException {
            ...
            @Override // android.hardware.display.IVirtualDisplayCallback
            public synchronized void onResumed() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.hardware.display.IVirtualDisplayCallback
            public synchronized void onStopped() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

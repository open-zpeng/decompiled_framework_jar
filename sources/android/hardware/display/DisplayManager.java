...
public final class DisplayManager {
    private protected static final String ACTION_WIFI_DISPLAY_STATUS_CHANGED = "android.hardware.display.action.WIFI_DISPLAY_STATUS_CHANGED";
    private static final boolean DEBUG = false;
    public static final String DISPLAY_CATEGORY_PRESENTATION = "android.hardware.display.category.PRESENTATION";
    private protected static final String EXTRA_WIFI_DISPLAY_STATUS = "android.hardware.display.extra.WIFI_DISPLAY_STATUS";
    ...
    public synchronized DisplayManager(Context context) {
    ...
    private synchronized void addAllDisplaysLocked(ArrayList<Display> displays, int[] displayIds) {
    ...
    private synchronized void addPresentationDisplaysLocked(ArrayList<Display> displays, int[] displayIds, int matchType) {
        for (int i : displayIds) {
            Display display = getOrCreateDisplayLocked(i, true);
    ...
    private synchronized Display getOrCreateDisplayLocked(int displayId, boolean assumeValid) {
    ...
    private protected void pauseWifiDisplay() {
        this.mGlobal.pauseWifiDisplay();
    }

    private protected void resumeWifiDisplay() {
    ...
    private protected void renameWifiDisplay(String deviceAddress, String alias) {
        this.mGlobal.renameWifiDisplay(deviceAddress, alias);
    }

    private protected void forgetWifiDisplay(String deviceAddress) {
    ...
    public synchronized VirtualDisplay createVirtualDisplay(MediaProjection projection, String name, int width, int height, int densityDpi, Surface surface, int flags, VirtualDisplay.Callback callback, Handler handler, String uniqueId) {
    ...
    public static int getOverrideBrightness(int brightness) {
        return Math.round((brightness * 245.0f) / 255.0f) + 10;
    }
}

...
public interface IConsumerIrService extends IInterface {
    synchronized int[] getCarrierFrequencies() throws RemoteException;

    synchronized boolean hasIrEmitter() throws RemoteException;

    synchronized void transmit(String str, int i, int[] iArr) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IConsumerIrService {
        ...
        public static synchronized IConsumerIrService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IConsumerIrService {
            ...
            public synchronized boolean hasIrEmitter() throws RemoteException {
            ...
            @Override // android.hardware.IConsumerIrService
            public synchronized void transmit(String packageName, int carrierFrequency, int[] pattern) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.hardware.IConsumerIrService
            public synchronized int[] getCarrierFrequencies() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public interface IHardwarePropertiesManager extends IInterface {
    synchronized CpuUsageInfo[] getCpuUsages(String str) throws RemoteException;

    synchronized float[] getDeviceTemperatures(String str, int i, int i2) throws RemoteException;

    synchronized float[] getFanSpeeds(String str) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IHardwarePropertiesManager {
        ...
        public static synchronized IHardwarePropertiesManager asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IHardwarePropertiesManager {
            ...
            public synchronized float[] getDeviceTemperatures(String callingPackage, int type, int source) throws RemoteException {
            ...
            @Override // android.os.IHardwarePropertiesManager
            public synchronized CpuUsageInfo[] getCpuUsages(String callingPackage) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IHardwarePropertiesManager
            public synchronized float[] getFanSpeeds(String callingPackage) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public final class Bundle extends BaseBundle implements Cloneable, Parcelable {
    ...
    @VisibleForTesting
    public synchronized Bundle(Parcel parcelledData) {
        super(parcelledData);
        this.mFlags = 1024;
        maybePrefillHasFds();
    }
    ...
    @VisibleForTesting
    public synchronized Bundle(Parcel parcelledData, int length) {
        super(parcelledData, length);
        this.mFlags = 1024;
        maybePrefillHasFds();
    }

    private synchronized void maybePrefillHasFds() {
    ...
    synchronized Bundle(boolean doInit) {
        super(doInit);
    }

    private protected static Bundle forPair(String key, String value) {
    ...
    public synchronized boolean setAllowFds(boolean allowFds) {

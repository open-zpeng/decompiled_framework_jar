...
public interface ISystemUpdateManager extends IInterface {
    synchronized Bundle retrieveSystemUpdateInfo() throws RemoteException;

    synchronized void updateSystemUpdateInfo(PersistableBundle persistableBundle) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ISystemUpdateManager {
        ...
        public static synchronized ISystemUpdateManager asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ISystemUpdateManager {
            ...
            public synchronized Bundle retrieveSystemUpdateInfo() throws RemoteException {
                Bundle _result;
            ...
            @Override // android.os.ISystemUpdateManager
            public synchronized void updateSystemUpdateInfo(PersistableBundle data) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

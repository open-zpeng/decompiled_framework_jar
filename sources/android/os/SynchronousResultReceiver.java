...
public class SynchronousResultReceiver extends ResultReceiver {
    ...
    public static class Result {
        ...
        public synchronized Result(int resultCode, Bundle bundle) {
    ...
    public synchronized SynchronousResultReceiver(String name) {
        super((Handler) null);
        this.mFuture = new CompletableFuture<>();
        this.mName = name;
    }
    ...
    public synchronized Result awaitResult(long timeoutMillis) throws TimeoutException {

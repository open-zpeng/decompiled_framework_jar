...
public class UserManager {
    ...
    public UserInfo preCreateUser(int flags) {
        try {
            return this.mService.preCreateUser(flags);
        } catch (RemoteException re) {
            throw re.rethrowFromSystemServer();
        }
    }
    ...
    public boolean isUserSwitcherEnabled() {
        ...
        boolean userSwitcherEnabled = Settings.Global.getInt(this.mContext.getContentResolver(), Settings.Global.USER_SWITCHER_ENABLED, 1) != 0;
        if (userSwitcherEnabled && (users = getUsers(true)) != null) {

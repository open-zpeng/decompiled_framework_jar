...
public final class ServiceManager {
    ...
    public protected static IServiceManager sServiceManager;
    private static final Object sLock = new Object();
    public protected static HashMap<String, IBinder> sCache = new HashMap<>();
    ...
    private protected ServiceManager() {
    }

    public protected static IServiceManager getIServiceManager() {
    ...
    public static synchronized IBinder getServiceOrThrow(String name) throws ServiceNotFoundException {
    ...
    private protected static void addService(String name, IBinder service) {
        addService(name, service, false, 8);
    }

    private protected static void addService(String name, IBinder service, boolean allowIsolated) {
        addService(name, service, allowIsolated, 8);
    }

    private protected static void addService(String name, IBinder service, boolean allowIsolated, int dumpPriority) {
        try {
    ...
    private protected static String[] listServices() {
        try {
    ...
    public static synchronized void initServiceCache(Map<String, IBinder> cache) {
        if (sCache.size() != 0) {
    ...
    public static class ServiceNotFoundException extends Exception {
        public synchronized ServiceNotFoundException(String name) {
            super("No service published for: " + name);
        }
    }

    private static synchronized IBinder rawGetService(String name) throws RemoteException {
        long slowThreshold;
        int logInterval;

...
public class PerformanceCollector {
    ...
    public interface PerformanceResultsWriter {
        synchronized void writeBeginSnapshot(String str);

        synchronized void writeEndSnapshot(Bundle bundle);

        synchronized void writeMeasurement(String str, float f);

        synchronized void writeMeasurement(String str, long j);

        synchronized void writeMeasurement(String str, String str2);

        synchronized void writeStartTiming(String str);

        synchronized void writeStopTiming(Bundle bundle);
    }
    ...
    public synchronized PerformanceCollector(PerformanceResultsWriter writer) {
        setPerformanceResultsWriter(writer);
    }

    public synchronized void setPerformanceResultsWriter(PerformanceResultsWriter writer) {
    ...
    private protected void startTiming(String label) {
        if (this.mPerfWriter != null) {
    ...
    public synchronized Bundle addIteration(String label) {
    ...
    private protected Bundle stopTiming(String label) {
        addIteration(label);
        if (this.mPerfWriter != null) {
    ...
    public synchronized void addMeasurement(String label, long value) {
        if (this.mPerfWriter != null) {
            this.mPerfWriter.writeMeasurement(label, value);
        }
    }

    public synchronized void addMeasurement(String label, float value) {
        if (this.mPerfWriter != null) {
            this.mPerfWriter.writeMeasurement(label, value);
        }
    }

    public synchronized void addMeasurement(String label, String value) {
        if (this.mPerfWriter != null) {
            this.mPerfWriter.writeMeasurement(label, value);
        }
    }

    private synchronized void startPerformanceSnapshot() {
    ...
    private synchronized void endPerformanceSnapshot() {
    ...
    private static synchronized void startAllocCounting() {
    ...
    private static synchronized void stopAllocCounting() {
        Runtime.getRuntime().gc();
        Runtime.getRuntime().runFinalization();
        Runtime.getRuntime().gc();
    ...
    private static synchronized Bundle getAllocCounts() {
    ...
    private static synchronized Bundle getBinderCounts() {
        Bundle results = new Bundle();

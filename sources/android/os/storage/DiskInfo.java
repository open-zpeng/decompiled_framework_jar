...
public class DiskInfo implements Parcelable {
    ...
    private protected static final Parcelable.Creator<DiskInfo> CREATOR = new Parcelable.Creator<DiskInfo>() { // from class: android.os.storage.DiskInfo.1
    ...
    private protected final int flags;
    public final String id;
    private protected String label;
    private protected long size;
    public String sysPath;
    public int volumeCount;

    public synchronized DiskInfo(String id, int flags) {
        this.id = (String) Preconditions.checkNotNull(id);
        this.flags = flags;
    }

    private protected DiskInfo(Parcel parcel) {
    ...
    private synchronized boolean isInteresting(String label) {
    ...
    private protected boolean isDefaultPrimary() {
        return (this.flags & 2) != 0;
    }

    private protected boolean isSd() {
        return (this.flags & 4) != 0;
    }

    private protected boolean isUsb() {

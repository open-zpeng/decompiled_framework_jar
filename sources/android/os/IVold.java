...
public interface IVold extends IInterface {
    ...
    synchronized void abortIdleMaint(IVoldTaskListener iVoldTaskListener) throws RemoteException;

    synchronized void addUserKeyAuth(int i, int i2, String str, String str2) throws RemoteException;

    synchronized void benchmark(String str, IVoldTaskListener iVoldTaskListener) throws RemoteException;

    synchronized void checkEncryption(String str) throws RemoteException;

    synchronized String createObb(String str, String str2, int i) throws RemoteException;

    synchronized void createUserKey(int i, int i2, boolean z) throws RemoteException;

    synchronized void destroyObb(String str) throws RemoteException;
    ...
    synchronized void encryptFstab(String str) throws RemoteException;

    synchronized void fbeEnable() throws RemoteException;

    synchronized void fdeChangePassword(int i, String str) throws RemoteException;

    synchronized void fdeCheckPassword(String str) throws RemoteException;

    synchronized void fdeClearPassword() throws RemoteException;

    synchronized int fdeComplete() throws RemoteException;

    synchronized void fdeEnable(int i, String str, int i2) throws RemoteException;

    synchronized String fdeGetField(String str) throws RemoteException;

    synchronized String fdeGetPassword() throws RemoteException;

    synchronized int fdeGetPasswordType() throws RemoteException;

    synchronized void fdeRestart() throws RemoteException;

    synchronized void fdeSetField(String str, String str2) throws RemoteException;

    synchronized void fdeVerifyPassword(String str) throws RemoteException;

    synchronized void fixateNewestUserKeyAuth(int i) throws RemoteException;

    synchronized void forgetPartition(String str, String str2) throws RemoteException;

    synchronized void format(String str, String str2) throws RemoteException;

    synchronized void fstrim(int i, IVoldTaskListener iVoldTaskListener) throws RemoteException;

    synchronized void initUser0() throws RemoteException;

    synchronized boolean isConvertibleToFbe() throws RemoteException;

    synchronized void lockUserKey(int i) throws RemoteException;

    synchronized void mkdirs(String str) throws RemoteException;

    synchronized void monitor() throws RemoteException;

    synchronized void mount(String str, int i, int i2) throws RemoteException;

    synchronized FileDescriptor mountAppFuse(int i, int i2, int i3) throws RemoteException;

    synchronized void mountDefaultEncrypted() throws RemoteException;

    synchronized void mountFstab(String str) throws RemoteException;

    synchronized void moveStorage(String str, String str2, IVoldTaskListener iVoldTaskListener) throws RemoteException;

    synchronized void onSecureKeyguardStateChanged(boolean z) throws RemoteException;

    synchronized void onUserAdded(int i, int i2) throws RemoteException;

    synchronized void onUserRemoved(int i) throws RemoteException;

    synchronized void onUserStarted(int i) throws RemoteException;

    synchronized void onUserStopped(int i) throws RemoteException;

    synchronized void partition(String str, int i, int i2) throws RemoteException;

    synchronized void prepareUserStorage(String str, int i, int i2, int i3) throws RemoteException;

    synchronized void remountUid(int i, int i2) throws RemoteException;

    synchronized void reset() throws RemoteException;

    synchronized void runIdleMaint(IVoldTaskListener iVoldTaskListener) throws RemoteException;

    synchronized void setListener(IVoldListener iVoldListener) throws RemoteException;

    synchronized void shutdown() throws RemoteException;

    synchronized void unlockUserKey(int i, int i2, String str, String str2) throws RemoteException;

    synchronized void unmount(String str) throws RemoteException;

    synchronized void unmountAppFuse(int i, int i2, int i3) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IVold {
        ...
        public static synchronized IVold asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IVold {
            ...
            public synchronized void setListener(IVoldListener listener) throws RemoteException {
            ...
            @Override // android.os.IVold
            public synchronized void monitor() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void onUserAdded(int userId, int userSerial) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void onUserRemoved(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void onUserStarted(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void onUserStopped(int userId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void onSecureKeyguardStateChanged(boolean isShowing) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void partition(String diskId, int partitionType, int ratio) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void forgetPartition(String partGuid, String fsUuid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void mount(String volId, int mountFlags, int mountUserId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void format(String volId, String fsType) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void checkEncryption(String volId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void moveStorage(String fromVolId, String toVolId, IVoldTaskListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void remountUid(int uid, int remountMode) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void mkdirs(String path) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized String createObb(String sourcePath, String sourceKey, int ownerGid) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void destroyObb(String volId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fstrim(int fstrimFlags, IVoldTaskListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void runIdleMaint(IVoldTaskListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void abortIdleMaint(IVoldTaskListener listener) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized FileDescriptor mountAppFuse(int uid, int pid, int mountId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void unmountAppFuse(int uid, int pid, int mountId) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fdeCheckPassword(String password) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fdeRestart() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized int fdeComplete() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fdeEnable(int passwordType, String password, int encryptionFlags) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fdeChangePassword(int passwordType, String password) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fdeVerifyPassword(String password) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized String fdeGetField(String key) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fdeSetField(String key, String value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized int fdeGetPasswordType() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized String fdeGetPassword() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fdeClearPassword() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void fbeEnable() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void mountDefaultEncrypted() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void initUser0() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void mountFstab(String mountPoint) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void encryptFstab(String mountPoint) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void createUserKey(int userId, int userSerial, boolean ephemeral) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void addUserKeyAuth(int userId, int userSerial, String token, String secret) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void unlockUserKey(int userId, int userSerial, String token, String secret) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void prepareUserStorage(String uuid, int userId, int userSerial, int storageFlags) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVold
            public synchronized void destroyUserStorage(String uuid, int userId, int storageFlags) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public class Broadcaster {
    ...
    private protected Broadcaster() {
    }

    private protected void request(int senderWhat, Handler target, int targetWhat) {
        int n;
        synchronized (this) {
            if (this.mReg == null) {
    ...
    private protected void cancelRequest(int senderWhat, Handler target, int targetWhat) {
        synchronized (this) {
            Registration start = this.mReg;
    ...
    public synchronized void dumpRegistrations() {
        Registration start = this.mReg;
    ...
    private protected void broadcast(Message msg) {
        synchronized (this) {
            if (this.mReg == null) {
                return;
            }

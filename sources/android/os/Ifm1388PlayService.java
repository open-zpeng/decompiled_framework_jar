...
public interface Ifm1388PlayService extends IInterface {
    ...
    int is_playing() throws RemoteException;

    int set_mode(int i) throws RemoteException;

    int start_play(byte[] bArr, byte[] bArr2) throws RemoteException;

    int stop_play() throws RemoteException;

    /* loaded from: classes2.dex */
    public static class Default implements Ifm1388PlayService {
        @Override // android.os.Ifm1388PlayService
        public int start_play(byte[] channel_mapping, byte[] filepath) throws RemoteException {
            return 0;
        }

        @Override // android.os.Ifm1388PlayService
        public int stop_play() throws RemoteException {
            return 0;
        }
        ...
        @Override // android.os.Ifm1388PlayService
        public int is_playing() throws RemoteException {
            return 0;
        }
    ...
    /* loaded from: classes2.dex */
    public static abstract class Stub extends Binder implements Ifm1388PlayService {
        private static final String DESCRIPTOR = "android.os.Ifm1388PlayService";
        ...
        static final int TRANSACTION_get_sdcard_path = 10;
        static final int TRANSACTION_is_playing = 9;
        static final int TRANSACTION_set_mode = 6;
        static final int TRANSACTION_start_play = 1;
        static final int TRANSACTION_stop_play = 2;

        public Stub() {
            attachInterface(this, DESCRIPTOR);
        }

        public static Ifm1388PlayService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
            IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
            if (iin != null && (iin instanceof Ifm1388PlayService)) {
                return (Ifm1388PlayService) iin;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    int _result = start_play(_arg03, _arg12);
                    reply.writeNoException();
                    reply.writeInt(_result);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    int _result2 = stop_play();
                    reply.writeNoException();
                ...
                case 10:
                    ...
                    int _result10 = get_sdcard_path(_arg02);
                    reply.writeNoException();
        ...
        /* loaded from: classes2.dex */
        public static class Proxy implements Ifm1388PlayService {
            public static Ifm1388PlayService sDefaultImpl;
            ...
            public int start_play(byte[] channel_mapping, byte[] filepath) throws RemoteException {
                ...
                try {
                    ...
                    _data.writeByteArray(channel_mapping);
                    _data.writeByteArray(filepath);
                    boolean _status = this.mRemote.transact(1, _data, _reply, 0);
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().start_play(channel_mapping, filepath);
                    }
            ...
            public int stop_play() throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().stop_play();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
            ...
            public int is_playing() throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().is_playing();
                    }
                    _reply.readException();
                    int _result = _reply.readInt();
                    return _result;
        ...
        public static boolean setDefaultImpl(Ifm1388PlayService impl) {
        ...
        public static Ifm1388PlayService getDefaultImpl() {

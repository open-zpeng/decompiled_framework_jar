...
public interface IStoraged extends IInterface {
    synchronized int getRecentPerf() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IStoraged {
        ...
        public static synchronized IStoraged asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IStoraged {
            ...
            @Override // android.os.IStoraged
            public synchronized int getRecentPerf() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

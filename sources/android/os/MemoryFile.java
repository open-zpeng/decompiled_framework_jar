...
public class MemoryFile {
    ...
    public protected static native int native_get_size(FileDescriptor fileDescriptor) throws IOException;

    public protected static native boolean native_pin(FileDescriptor fileDescriptor, boolean z) throws IOException;
    ...
    public private protected void deactivate() {
    ...
    private synchronized void checkActive() throws IOException {
        if (this.mMapping == null) {
            throw new IOException("MemoryFile has been deactivated");
        }
    }

    private synchronized void beginAccess() throws IOException {
        checkActive();
    ...
    private synchronized void endAccess() throws IOException {

...
public class TransactionTracker {
    ...
    private synchronized void resetTraces() {
        this.mTraces = new HashMap();
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized TransactionTracker() {
        resetTraces();
    }

    public synchronized void addTrace(Throwable tr) {
    ...
    public synchronized void writeTracesToFile(ParcelFileDescriptor fd) {
    ...
    public synchronized void clearTraces() {
        resetTraces();
    }
}

...
public class HealthStats {
    ...
    private synchronized HealthStats() {
    ...
    private static synchronized int getIndex(int[] keys, int key) {
        return Arrays.binarySearch(keys, key);
    }

    private static synchronized ArrayMap<String, HealthStats> createHealthStatsMap(Parcel in) {
        int count = in.readInt();
    ...
    private static synchronized <T extends Parcelable> ArrayMap<String, T> createParcelableMap(Parcel in, Parcelable.Creator<T> creator) {
        int count = in.readInt();
    ...
    private static synchronized ArrayMap<String, Long> createLongsMap(Parcel in) {
        int count = in.readInt();

...
public class SystemService {
    ...
    private protected static void start(String name) {
        SystemProperties.set("ctl.start", name);
    }

    private protected static void stop(String name) {
        SystemProperties.set("ctl.stop", name);
    }

    public static synchronized void restart(String name) {
        SystemProperties.set("ctl.restart", name);
    }

    public static synchronized State getState(String service) {
    ...
    public static synchronized boolean isStopped(String service) {
        return State.STOPPED.equals(getState(service));
    }

    public static synchronized boolean isRunning(String service) {
        return State.RUNNING.equals(getState(service));
    }

    public static synchronized void waitForState(String service, State state, long timeoutMillis) throws TimeoutException {

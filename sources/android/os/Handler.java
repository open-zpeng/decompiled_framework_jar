...
public class Handler {
    ...
    public private protected final Looper mLooper;
    public private protected IMessenger mMessenger;
    ...
    public synchronized Handler(Callback callback, boolean async) {
    ...
    public static synchronized Handler mainIfNull(Handler handler) {
        return handler == null ? getMain() : handler;
    }

    public synchronized String getTraceName(Message message) {
    ...
    public final synchronized boolean runWithScissors(Runnable r, long timeout) {
        if (r == null) {
    ...
    public final synchronized boolean executeOrSendMessage(Message msg) {
    ...
    private synchronized boolean enqueueMessage(MessageQueue queue, Message msg, long uptimeMillis) {
        msg.target = this;
    ...
    public final synchronized boolean hasMessagesOrCallbacks() {
    ...
    public final synchronized void dumpMine(Printer pw, String prefix) {
        pw.println(prefix + this + " @ " + SystemClock.uptimeMillis());
        if (this.mLooper == null) {
            pw.println(prefix + "looper uninitialized");
            return;
    ...
    public private protected final IMessenger getIMessenger() {
    ...
    private static synchronized Message getPostMessage(Runnable r) {
        Message m = Message.obtain();
        m.callback = r;
        return m;
    }

    public protected static Message getPostMessage(Runnable r, Object token) {
        Message m = Message.obtain();
        m.obj = token;
        m.callback = r;
        return m;
    ...
    private static synchronized void handleCallback(Message message) {
    ...
    private static final class BlockingRunnable implements Runnable {
        ...
        public synchronized BlockingRunnable(Runnable task) {
            this.mTask = task;
        }
        ...
        public synchronized boolean postAndWait(Handler handler, long timeout) {

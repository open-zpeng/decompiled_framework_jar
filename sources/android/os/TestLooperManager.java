...
public class TestLooperManager {
    ...
    public synchronized TestLooperManager(Looper looper) {
    ...
    @Deprecated
    private protected MessageQueue getQueue() {
    ...
    private class LooperHolder implements Runnable {
        ...
        private synchronized void processMessage(MessageExecution mex) {
            synchronized (mex) {
                try {
    ...
    public static class MessageExecution {
        ...
        private synchronized MessageExecution() {
        }
    }
}

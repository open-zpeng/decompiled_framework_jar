...
public class PowerSaveState implements Parcelable {
    ...
    public synchronized PowerSaveState(Builder builder) {
    ...
    public synchronized PowerSaveState(Parcel in) {
    ...
    public static final class Builder {
        ...
        public synchronized Builder setBatterySaverEnabled(boolean enabled) {
            this.mBatterySaverEnabled = enabled;
            return this;
        }

        public synchronized Builder setGlobalBatterySaverEnabled(boolean enabled) {
            this.mGlobalBatterySaverEnabled = enabled;
            return this;
        }

        public synchronized Builder setGpsMode(int mode) {
            this.mGpsMode = mode;
            return this;
        }

        public synchronized Builder setBrightnessFactor(float factor) {
            this.mBrightnessFactor = factor;
            return this;
        }

        public synchronized PowerSaveState build() {

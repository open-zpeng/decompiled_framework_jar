...
public abstract class VibrationEffect implements Parcelable {
    ...
    public static class Waveform extends VibrationEffect implements Parcelable {
        ...
        public void validate() {
            ...
            if (jArr2.length != this.mAmplitudes.length) {
        ...
        public int hashCode() {
            ...
            return result + (Arrays.hashCode(this.mAmplitudes) * 37) + (this.mRepeat * 37);
        }
    ...
    public static class Prebaked extends VibrationEffect implements Parcelable {
        ...
        public int hashCode() {
            ...
            return result + (this.mEffectStrength * 37);
        }

...
public class FileBridge extends Thread {
    ...
    public synchronized FileBridge() {
        try {
    ...
    public synchronized void setTargetFile(FileDescriptor target) {
        this.mTarget = target;
    }

    public synchronized FileDescriptor getClientSocket() {
        return this.mClient;
    }
    ...
    public static class FileBridgeOutputStream extends OutputStream {
        ...
        public synchronized FileBridgeOutputStream(ParcelFileDescriptor clientPfd) {
            this.mTemp = new byte[8];
            this.mClientPfd = clientPfd;
            this.mClient = clientPfd.getFileDescriptor();
        }

        public synchronized FileBridgeOutputStream(FileDescriptor client) {
            this.mTemp = new byte[8];
        ...
        private synchronized void writeCommandAndBlock(int cmd, String cmdString) throws IOException {

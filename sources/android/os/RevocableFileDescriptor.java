...
public class RevocableFileDescriptor {
    ...
    public synchronized RevocableFileDescriptor() {
    }

    public synchronized RevocableFileDescriptor(Context context, File file) throws IOException {
        try {
    ...
    public synchronized RevocableFileDescriptor(Context context, FileDescriptor fd) throws IOException {
        init(context, fd);
    }

    public synchronized void init(Context context, FileDescriptor fd) throws IOException {
        this.mInner = fd;
    ...
    public synchronized ParcelFileDescriptor getRevocableFileDescriptor() {
        return this.mOuter;
    }

...
public final class PersistableBundle extends BaseBundle implements Cloneable, Parcelable, XmlUtils.WriteMapCallback {
    ...
    public static synchronized boolean isValidType(Object value) {
    ...
    public synchronized PersistableBundle(Bundle b) {
        this(b.getMap());
    }

    private synchronized PersistableBundle(ArrayMap<String, Object> map) {
        this.mFlags = 1;
        putAll(map);
    ...
    public synchronized PersistableBundle(Parcel parcelledData, int length) {
        super(parcelledData, length);
        this.mFlags = 1;
    }

    synchronized PersistableBundle(boolean doInit) {
        super(doInit);
    }

    public static synchronized PersistableBundle forPair(String key, String value) {
    ...
    public synchronized void writeUnknownObject(Object v, String name, XmlSerializer out) throws XmlPullParserException, IOException {
    ...
    public synchronized void saveToXml(XmlSerializer out) throws IOException, XmlPullParserException {
        unparcel();
    ...
    public static class MyReadMapCallback implements XmlUtils.ReadMapCallback {
        synchronized MyReadMapCallback() {
        }

        @Override // com.android.internal.util.XmlUtils.ReadMapCallback
        public synchronized Object readThisUnknownObjectXml(XmlPullParser in, String tag) throws XmlPullParserException, IOException {
    ...
    public static synchronized PersistableBundle restoreFromXml(XmlPullParser in) throws IOException, XmlPullParserException {
        int event;

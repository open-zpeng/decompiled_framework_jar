...
public final class ParcelableException extends RuntimeException implements Parcelable {
    ...
    public synchronized ParcelableException(Throwable t) {
        super(t);
    }

    public synchronized <T extends Throwable> void maybeRethrow(Class<T> clazz) throws Throwable {
        if (clazz.isAssignableFrom(getCause().getClass())) {
            throw getCause();
        }
    }

    public static synchronized Throwable readFromParcel(Parcel in) {
    ...
    public static synchronized void writeToParcel(Parcel out, Throwable t) {

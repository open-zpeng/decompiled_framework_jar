...
public class BaseBundle {
    ...
    @VisibleForTesting
    public int mFlags;
    public private protected ArrayMap<String, Object> mMap;
    private boolean mParcelledByNative;
    public private protected Parcel mParcelledData;

    public static synchronized void setShouldDefuse(boolean shouldDefuse) {
    ...
    public static final class NoImagePreloadHolder {
        ...
        synchronized NoImagePreloadHolder() {
        }
    }

    synchronized BaseBundle(ClassLoader loader, int capacity) {
        this.mMap = null;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BaseBundle() {
        this((ClassLoader) null, 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BaseBundle(Parcel parcelledData) {
        this.mMap = null;
        this.mParcelledData = null;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BaseBundle(Parcel parcelledData, int length) {
        this.mMap = null;
        this.mParcelledData = null;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BaseBundle(ClassLoader loader) {
        this(loader, 0);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BaseBundle(int capacity) {
        this((ClassLoader) null, capacity);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BaseBundle(BaseBundle b) {
        this.mMap = null;
        this.mParcelledData = null;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized BaseBundle(boolean doInit) {
        this.mMap = null;
        this.mParcelledData = null;
    }

    public synchronized String getPairValue() {
        unparcel();
    ...
    public private protected void unparcel() {
        synchronized (this) {
    ...
    */
    private synchronized void initializeFromParcelLocked(android.os.Parcel r8, boolean r9, boolean r10) {
        /*
            r7 = this;
        ...
        L37:
            if (r10 == 0) goto L43
            java.lang.ClassLoader r4 = r7.mClassLoader     // Catch: java.lang.Throwable -> L3f android.os.BadParcelableException -> L41
            r8.readArrayMapSafelyInternal(r3, r0, r4)     // Catch: java.lang.Throwable -> L3f android.os.BadParcelableException -> L41
            goto L48
        L3f:
            r4 = move-exception
            goto L6a
        ...
        L43:
            java.lang.ClassLoader r4 = r7.mClassLoader     // Catch: java.lang.Throwable -> L3f android.os.BadParcelableException -> L41
            r8.readArrayMapInternal(r3, r0, r4)     // Catch: java.lang.Throwable -> L3f android.os.BadParcelableException -> L41
        L48:
            r7.mMap = r3
            if (r9 == 0) goto L4f
        L4c:
        ...
        L4f:
            ...
            goto L68
        L54:
            boolean r5 = android.os.BaseBundle.sShouldDefuse     // Catch: java.lang.Throwable -> L3f
            if (r5 == 0) goto L69
            java.lang.String r5 = "Bundle"
            java.lang.String r6 = "Failed to parse Bundle, but defusing quietly"
            android.util.Log.w(r5, r6, r4)     // Catch: java.lang.Throwable -> L3f
            r3.erase()     // Catch: java.lang.Throwable -> L3f
            r7.mMap = r3
            if (r9 == 0) goto L4f
            goto L4c
        L68:
    ...
    public synchronized boolean isEmptyParcel() {
        return isEmptyParcel(this.mParcelledData);
    }

    private static synchronized boolean isEmptyParcel(Parcel p) {
        return p == NoImagePreloadHolder.EMPTY_PARCEL;
    }

    private static synchronized void recycleParcel(Parcel p) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized ArrayMap<String, Object> getMap() {
        unparcel();
        return this.mMap;
    }
    ...
    public synchronized boolean maybeIsEmpty() {
        if (isParcelled()) {
    ...
    public static synchronized boolean kindofEquals(BaseBundle a, BaseBundle b) {
        return a == b || (a != null && a.kindofEquals(b));
    }

    public synchronized boolean kindofEquals(BaseBundle other) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void copyInternal(BaseBundle from, boolean deep) {
        synchronized (from) {
    ...
    synchronized Object deepCopyValue(Object value) {
        if (value == null) {
            return null;
        }
    ...
    synchronized ArrayList deepcopyArrayList(ArrayList from) {
        int N = from.size();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void putAll(ArrayMap map) {
        unparcel();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void putIntegerArrayList(String key, ArrayList<Integer> value) {
        unparcel();
        this.mMap.put(key, value);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void putStringArrayList(String key, ArrayList<String> value) {
        unparcel();
        this.mMap.put(key, value);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void putCharSequenceArrayList(String key, ArrayList<CharSequence> value) {
        unparcel();
        this.mMap.put(key, value);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void putCharArray(String key, char[] value) {
        unparcel();
        this.mMap.put(key, value);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void putCharSequenceArray(String key, CharSequence[] value) {
        unparcel();
        this.mMap.put(key, value);
    }
    ...
    synchronized void typeWarning(String key, Object value, String className, Object defaultValue, ClassCastException e) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void typeWarning(String key, Object value, String className, ClassCastException e) {
    ...
    public double getDouble(String key) {
        unparcel();
        return getDouble(key, FeatureOption.FO_BOOT_POLICY_CPU);
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void writeToParcelInner(Parcel parcel, int flags) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void readFromParcelInner(Parcel parcel) {
        int length = parcel.readInt();
        readFromParcelInner(parcel, length);
    }

    private synchronized void readFromParcelInner(Parcel parcel, int length) {
        if (length < 0) {
    ...
    public static synchronized void dumpStats(IndentingPrintWriter pw, String key, Object value) {
    ...
    public static synchronized void dumpStats(IndentingPrintWriter pw, SparseArray array) {
        pw.increaseIndent();
        if (array == null) {
            pw.println("[null]");
            return;
    ...
    public static synchronized void dumpStats(IndentingPrintWriter pw, BaseBundle bundle) {
        pw.increaseIndent();
        if (bundle == null) {
            pw.println("[null]");
            return;

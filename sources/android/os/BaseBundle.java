...
public class BaseBundle {
    ...
    */
    private void initializeFromParcelLocked(android.os.Parcel r8, boolean r9, boolean r10) {
        ...
        L35:
            if (r10 == 0) goto L3d
            java.lang.ClassLoader r4 = r7.mClassLoader     // Catch: java.lang.Throwable -> L4e android.os.BadParcelableException -> L50
            r8.readArrayMapSafelyInternal(r3, r0, r4)     // Catch: java.lang.Throwable -> L4e android.os.BadParcelableException -> L50
            goto L42
        L3d:
            java.lang.ClassLoader r4 = r7.mClassLoader     // Catch: java.lang.Throwable -> L4e android.os.BadParcelableException -> L50
            r8.readArrayMapInternal(r3, r0, r4)     // Catch: java.lang.Throwable -> L4e android.os.BadParcelableException -> L50
        L42:
            r7.mMap = r3
            if (r9 == 0) goto L49
        L46:
        ...
        L50:
            r4 = move-exception
            boolean r5 = android.os.BaseBundle.sShouldDefuse     // Catch: java.lang.Throwable -> L4e
            if (r5 == 0) goto L65
            java.lang.String r5 = "Bundle"
            java.lang.String r6 = "Failed to parse Bundle, but defusing quietly"
            android.util.Log.w(r5, r6, r4)     // Catch: java.lang.Throwable -> L4e
            r3.erase()     // Catch: java.lang.Throwable -> L4e
            r7.mMap = r3
            if (r9 == 0) goto L49
            goto L46
        L64:

...
public class EventLogTags {
    ...
    public static synchronized void writeServiceManagerStats(int callCount, int totalTime, int duration) {
    ...
    public static synchronized void writeServiceManagerSlow(int time, String service) {

...
public final class StatsDimensionsValue implements Parcelable {
    ...
    public synchronized StatsDimensionsValue(Parcel in) {
    ...
    private static synchronized boolean writeValueToParcel(int valueType, Object value, Parcel out, int flags) {
        try {
            switch (valueType) {
                case 2:
    ...
    private static synchronized Object readValueFromParcel(int valueType, Parcel parcel) {
        switch (valueType) {
            case 2:

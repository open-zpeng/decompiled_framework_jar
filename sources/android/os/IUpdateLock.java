...
public interface IUpdateLock extends IInterface {
    synchronized void acquireUpdateLock(IBinder iBinder, String str) throws RemoteException;

    synchronized void releaseUpdateLock(IBinder iBinder) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IUpdateLock {
        ...
        public static synchronized IUpdateLock asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IUpdateLock {
            ...
            public synchronized void acquireUpdateLock(IBinder token, String tag) throws RemoteException {
            ...
            @Override // android.os.IUpdateLock
            public synchronized void releaseUpdateLock(IBinder token) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public final class Message implements Parcelable {
    ...
    public int arg1;
    public int arg2;
    public private protected Runnable callback;
    Bundle data;
    public private protected int flags;
    public private protected Message next;
    public Object obj;
    public Messenger replyTo;
    public int sendingUid = -1;
    public private protected Handler target;
    public int what;
    public private protected long when;
    ...
    public static synchronized void updateCheckRecycle(int targetSdkVersion) {
    ...
    public private protected void recycleUnchecked() {
        this.flags = 1;
        this.what = 0;
        this.arg1 = 0;
        this.arg2 = 0;
    ...
    public synchronized Message setWhat(int what) {
        this.what = what;
        return this;
    }
    ...
    public private protected void markInUse() {
        this.flags |= 1;
    }
    ...
    public private protected String toString(long now) {

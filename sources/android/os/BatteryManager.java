...
public class BatteryManager {
    ...
    private protected static final String EXTRA_CHARGE_COUNTER = "charge_counter";
    @SystemApi
    ...
    private protected static final String EXTRA_INVALID_CHARGER = "invalid_charger";
    public static final String EXTRA_LEVEL = "level";
    private protected static final String EXTRA_MAX_CHARGING_CURRENT = "max_charging_current";
    private protected static final String EXTRA_MAX_CHARGING_VOLTAGE = "max_charging_voltage";
    ...
    private protected BatteryManager() {
        this.mContext = null;
    ...
    public synchronized BatteryManager(Context context, IBatteryStats batteryStats, IBatteryPropertiesRegistrar batteryPropertiesRegistrar) {
    ...
    private synchronized long queryProperty(int id) {
        if (this.mBatteryPropertiesRegistrar == null) {
            return Long.MIN_VALUE;
        }
        try {
            BatteryProperty prop = new BatteryProperty();
            long ret = this.mBatteryPropertiesRegistrar.getProperty(id, prop) == 0 ? prop.getLong() : Long.MIN_VALUE;
            return ret;
        } catch (RemoteException e) {
            throw e.rethrowFromSystemServer();
        }
    ...
    public static synchronized boolean isPlugWired(int plugType) {

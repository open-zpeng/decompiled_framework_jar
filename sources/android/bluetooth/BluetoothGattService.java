...
public class BluetoothGattService implements Parcelable {
    ...
    public private BluetoothDevice mDevice;
    ...
    synchronized BluetoothGattService(BluetoothDevice device, UUID uuid, int instanceId, int serviceType) {
        this.mHandles = 0;
        this.mDevice = device;
        this.mUuid = uuid;
    ...
    public synchronized BluetoothGattService(UUID uuid, int instanceId, int serviceType) {
        this.mHandles = 0;
        this.mDevice = null;
        this.mUuid = uuid;
        this.mInstanceId = instanceId;
    ...
    private synchronized BluetoothGattService(Parcel in) {
        this.mHandles = 0;
    ...
    synchronized BluetoothGattCharacteristic getCharacteristic(UUID uuid, int instanceId) {
    ...
    synchronized int getHandles() {
        return this.mHandles;
    }

    public synchronized void setHandles(int handles) {
        this.mHandles = handles;
    }

    public synchronized void addIncludedService(BluetoothGattService includedService) {
    ...
    public synchronized boolean isAdvertisePreferred() {
        return this.mAdvertisePreferred;
    }

    private protected void setAdvertisePreferred(boolean advertisePreferred) {

...
public class SdpMasRecord implements Parcelable {
    ...
    public synchronized SdpMasRecord(int masInstanceId, int l2capPsm, int rfcommChannelNumber, int profileVersion, int supportedFeatures, int supportedMessageTypes, String serviceName) {
    ...
    public synchronized SdpMasRecord(Parcel in) {
    ...
    public synchronized int getMasInstanceId() {
    ...
    public synchronized int getRfcommCannelNumber() {
    ...
    public synchronized int getSupportedMessageTypes() {
        return this.mSupportedMessageTypes;
    }

    public synchronized boolean msgSupported(int msg) {

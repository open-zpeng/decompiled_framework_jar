...
public final class BluetoothHeadset implements BluetoothProfile {
    private protected static final String ACTION_ACTIVE_DEVICE_CHANGED = "android.bluetooth.headset.profile.action.ACTIVE_DEVICE_CHANGED";
    ...
    public synchronized BluetoothHeadset(Context context, BluetoothProfile.ServiceListener l) {
    ...
    public static synchronized boolean isBluetoothVoiceDialingEnabled(Context context) {
    ...
    public synchronized void setAudioRouteAllowed(boolean allowed) {
        IBluetoothHeadset service = this.mService;
        if (service != null && isEnabled()) {
            try {
    ...
    public synchronized boolean getAudioRouteAllowed() {
        IBluetoothHeadset service = this.mService;
        if (service != null && isEnabled()) {
            try {
    ...
    public synchronized void setForceScoAudio(boolean forced) {
        IBluetoothHeadset service = this.mService;
        if (service != null && isEnabled()) {
            try {
    ...
    private protected boolean connectAudio() {
        IBluetoothHeadset service = this.mService;
        if (service != null && isEnabled()) {
            try {
    ...
    private protected boolean disconnectAudio() {
        IBluetoothHeadset service = this.mService;
        if (service != null && isEnabled()) {
            try {
    ...
    private protected boolean startScoUsingVirtualVoiceCall() {
    ...
    private protected boolean stopScoUsingVirtualVoiceCall() {
    ...
    private protected void phoneStateChanged(int numActive, int numHeld, int callState, String number, int type) {
        IBluetoothHeadset service = this.mService;
        if (service != null && isEnabled()) {
            try {
    ...
    public synchronized void clccResponse(int index, int direction, int status, int mode, boolean mpty, String number, int type) {
        IBluetoothHeadset service = this.mService;
        if (service != null && isEnabled()) {
            try {
    ...
    public static synchronized boolean isInbandRingingSupported(Context context) {

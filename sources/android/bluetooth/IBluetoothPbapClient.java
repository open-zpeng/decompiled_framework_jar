        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    List<BluetoothDevice> _result2 = getDevicesMatchingConnectionStates(_arg07);
                    reply.writeNoException();
                ...
                case 8:
                    ...
                    boolean pullPhonebook = pullPhonebook(_arg06, _arg12, _arg2, _arg3, _arg4);
                    reply.writeNoException();
        ...
        public static class Proxy implements IBluetoothPbapClient {
            ...
            public boolean pullPhonebook(BluetoothDevice device, String pbName, long filter, int listStartOffset, int maxListCount) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        boolean pullPhonebook = Stub.getDefaultImpl().pullPhonebook(device, pbName, filter, listStartOffset, maxListCount);
                        _reply.recycle();
                        _data.recycle();
                        return pullPhonebook;
                    }

...
public final class BluetoothHealthAppConfiguration implements Parcelable {
    ...
    synchronized BluetoothHealthAppConfiguration(String name, int dataType) {
        this.mName = name;
    ...
    public synchronized BluetoothHealthAppConfiguration(String name, int dataType, int role, int channelType) {
        this.mName = name;
        this.mDataType = dataType;
        this.mRole = role;
    ...
    public boolean equals(Object o) {
        if (o instanceof BluetoothHealthAppConfiguration) {
            ...
            return this.mName != null && this.mName.equals(config.getName()) && this.mDataType == config.getDataType() && this.mRole == config.getRole() && this.mChannelType == config.getChannelType();
        }
        return false;
    }
    ...
    public synchronized int getChannelType() {

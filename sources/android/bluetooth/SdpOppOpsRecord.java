...
public class SdpOppOpsRecord implements Parcelable {
    ...
    public synchronized SdpOppOpsRecord(String serviceName, int rfcommChannel, int l2capPsm, int version, byte[] formatsList) {
    ...
    public synchronized int getRfcommChannel() {
    ...
    public synchronized byte[] getFormatsList() {
    ...
    public synchronized SdpOppOpsRecord(Parcel in) {

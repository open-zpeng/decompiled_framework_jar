...
public class SdpMnsRecord implements Parcelable {
    ...
    public synchronized SdpMnsRecord(int l2capPsm, int rfcommChannelNumber, int profileVersion, int supportedFeatures, String serviceName) {
    ...
    public synchronized SdpMnsRecord(Parcel in) {

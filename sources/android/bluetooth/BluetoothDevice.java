...
public final class BluetoothDevice implements Parcelable {
    ...
    private protected static final String ACTION_ALIAS_CHANGED = "android.bluetooth.device.action.ALIAS_CHANGED";
    ...
    private protected static final String ACTION_DISAPPEARED = "android.bluetooth.device.action.DISAPPEARED";
    ...
    private protected static final String ACTION_PAIRING_CANCEL = "android.bluetooth.device.action.PAIRING_CANCEL";
    public static final String ACTION_PAIRING_REQUEST = "android.bluetooth.device.action.PAIRING_REQUEST";
    private protected static final String ACTION_SDP_RECORD = "android.bluetooth.device.action.SDP_RECORD";
    ...
    private protected static final String EXTRA_REASON = "android.bluetooth.device.extra.REASON";
    public static final String EXTRA_RSSI = "android.bluetooth.device.extra.RSSI";
    public static final String EXTRA_SDP_RECORD = "android.bluetooth.device.extra.SDP_RECORD";
    private protected static final String EXTRA_SDP_SEARCH_STATUS = "android.bluetooth.device.extra.SDP_SEARCH_STATUS";
    ...
    private protected static final int UNBOND_REASON_AUTH_FAILED = 1;
    private protected static final int UNBOND_REASON_AUTH_REJECTED = 2;
    private protected static final int UNBOND_REASON_AUTH_TIMEOUT = 6;
    private protected static final int UNBOND_REASON_DISCOVERY_IN_PROGRESS = 5;
    private protected static final int UNBOND_REASON_REMOTE_AUTH_CANCELED = 8;
    private protected static final int UNBOND_REASON_REMOTE_DEVICE_DOWN = 4;
    public static final int UNBOND_REASON_REMOVED = 9;
    private protected static final int UNBOND_REASON_REPEATED_ATTEMPTS = 7;
    ...
    public private protected static IBluetooth getService() {
        synchronized (BluetoothDevice.class) {
            if (sService == null) {
    ...
    public private protected BluetoothDevice(String address) {
        getService();
    ...
    private protected String getAlias() {
        IBluetooth service = sService;
        if (service == null) {
    ...
    private protected boolean setAlias(String alias) {
        IBluetooth service = sService;
        if (service == null) {
    ...
    private protected int getBatteryLevel() {
        IBluetooth service = sService;
        if (service == null) {
    ...
    private protected boolean createBond(int transport) {
        IBluetooth service = sService;
        if (service == null) {
            Log.e(TAG, "BT not enabled. Cannot create bond to Remote Device");
            return false;
    ...
    public synchronized boolean createBondOutOfBand(int transport, OobData oobData) {
        IBluetooth service = sService;
        if (service == null) {
    ...
    private protected boolean isBondingInitiatedLocally() {
        IBluetooth service = sService;
        if (service == null) {
    ...
    public synchronized boolean setDeviceOutOfBandData(byte[] hash, byte[] randomizer) {
        return false;
    }
    ...
    public synchronized boolean sdpSearch(ParcelUuid uuid) {
        IBluetooth service = sService;
        if (service == null) {
    ...
    private protected boolean setPasskey(int passkey) {
        return false;
    }
    ...
    public synchronized boolean setRemoteOutOfBandData() {
        return false;
    }

    private protected boolean cancelPairingUserInput() {
        IBluetooth service = sService;
        if (service == null) {
    ...
    private protected boolean isBluetoothDock() {
        return false;
    }
    ...
    private protected int getPhonebookAccessPermission() {
        IBluetooth service = sService;
        if (service == null) {
            return 0;
        }
    ...
    private protected int getMessageAccessPermission() {
        IBluetooth service = sService;
        if (service == null) {
            return 0;
        }
    ...
    private protected boolean setMessageAccessPermission(int value) {
        IBluetooth service = sService;
        if (service == null) {
            return false;
        }
    ...
    public synchronized int getSimAccessPermission() {
        IBluetooth service = sService;
        if (service == null) {
            return 0;
        }
    ...
    private protected boolean setSimAccessPermission(int value) {
        IBluetooth service = sService;
        if (service == null) {
            return false;
        }
    ...
    private protected BluetoothSocket createRfcommSocket(int channel) throws IOException {
    ...
    public synchronized BluetoothSocket createL2capSocket(int channel) throws IOException {
        return new BluetoothSocket(3, -1, true, true, this, channel, null);
    }

    public synchronized BluetoothSocket createInsecureL2capSocket(int channel) throws IOException {
    ...
    private protected BluetoothSocket createInsecureRfcommSocket(int port) throws IOException {
        if (!isBluetoothEnabled()) {
            Log.e(TAG, "Bluetooth is not enabled");
            throw new IOException();
        }
    ...
    private protected BluetoothSocket createScoSocket() throws IOException {
        if (!isBluetoothEnabled()) {
            Log.e(TAG, "Bluetooth is not enabled");
            throw new IOException();
        }
    ...
    private protected static byte[] convertPinToBytes(String pin) {
        if (pin == null) {
            return null;
        }
        try {
    ...
    private protected BluetoothGatt connectGatt(Context context, boolean autoConnect, BluetoothGattCallback callback, int transport, boolean opportunistic, int phy, Handler handler) {
        if (callback == null) {
    ...
    public synchronized BluetoothSocket createL2capCocSocket(int transport, int psm) throws IOException {
        if (!isBluetoothEnabled()) {
    ...
    public synchronized BluetoothSocket createInsecureL2capCocSocket(int transport, int psm) throws IOException {
        if (!isBluetoothEnabled()) {

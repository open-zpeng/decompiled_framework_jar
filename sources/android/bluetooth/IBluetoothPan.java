...
public interface IBluetoothPan extends IInterface {
    ...
    void setBluetoothTethering(boolean z, String str) throws RemoteException;
    ...
    public static class Default implements IBluetoothPan {
        ...
        @Override // android.bluetooth.IBluetoothPan
        public void setBluetoothTethering(boolean value, String pkgName) throws RemoteException {
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    setBluetoothTethering(_arg04, _arg1);
                    reply.writeNoException();
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
        ...
        public static class Proxy implements IBluetoothPan {
            ...
            public void setBluetoothTethering(boolean value, String pkgName) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        Stub.getDefaultImpl().setBluetoothTethering(value, pkgName);
                    } else {
                        _reply.readException();
                    }
                } finally {

...
public interface IBluetoothPan extends IInterface {
    ...
    synchronized boolean isTetheringOn() throws RemoteException;

    synchronized void setBluetoothTethering(boolean z) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IBluetoothPan {
        ...
        public static synchronized IBluetoothPan asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IBluetoothPan {
            ...
            public synchronized boolean isTetheringOn() throws RemoteException {
            ...
            @Override // android.bluetooth.IBluetoothPan
            public synchronized void setBluetoothTethering(boolean value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

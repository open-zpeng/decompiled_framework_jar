...
public interface IBluetoothGattServerCallback extends IInterface {
    synchronized void onCharacteristicReadRequest(String str, int i, int i2, boolean z, int i3) throws RemoteException;

    synchronized void onCharacteristicWriteRequest(String str, int i, int i2, int i3, boolean z, boolean z2, int i4, byte[] bArr) throws RemoteException;

    synchronized void onConnectionUpdated(String str, int i, int i2, int i3, int i4) throws RemoteException;

    synchronized void onDescriptorReadRequest(String str, int i, int i2, boolean z, int i3) throws RemoteException;

    synchronized void onDescriptorWriteRequest(String str, int i, int i2, int i3, boolean z, boolean z2, int i4, byte[] bArr) throws RemoteException;

    synchronized void onExecuteWrite(String str, int i, boolean z) throws RemoteException;

    synchronized void onMtuChanged(String str, int i) throws RemoteException;

    synchronized void onNotificationSent(String str, int i) throws RemoteException;
    ...
    synchronized void onServerConnectionState(int i, int i2, boolean z, String str) throws RemoteException;

    synchronized void onServerRegistered(int i, int i2) throws RemoteException;

    synchronized void onServiceAdded(int i, BluetoothGattService bluetoothGattService) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IBluetoothGattServerCallback {
        ...
        public static synchronized IBluetoothGattServerCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements IBluetoothGattServerCallback {
            ...
            public synchronized void onServerRegistered(int status, int serverIf) throws RemoteException {
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onServerConnectionState(int status, int serverIf, boolean connected, String address) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(status);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onServiceAdded(int status, BluetoothGattService service) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(status);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onCharacteristicReadRequest(String address, int transId, int offset, boolean isLong, int handle) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onDescriptorReadRequest(String address, int transId, int offset, boolean isLong, int handle) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onCharacteristicWriteRequest(String address, int transId, int offset, int length, boolean isPrep, boolean needRsp, int handle, byte[] value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onDescriptorWriteRequest(String address, int transId, int offset, int length, boolean isPrep, boolean needRsp, int handle, byte[] value) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onExecuteWrite(String address, int transId, boolean execWrite) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onNotificationSent(String address, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);
            ...
            @Override // android.bluetooth.IBluetoothGattServerCallback
            public synchronized void onMtuChanged(String address, int mtu) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeString(address);

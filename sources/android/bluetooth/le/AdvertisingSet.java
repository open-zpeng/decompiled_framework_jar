...
public final class AdvertisingSet {
    ...
    public synchronized AdvertisingSet(int advertiserId, IBluetoothManager bluetoothManager) {
    ...
    synchronized void setAdvertiserId(int advertiserId) {
        this.mAdvertiserId = advertiserId;
    }
    ...
    public synchronized void getOwnAddress() {
        try {
    ...
    public synchronized int getAdvertiserId() {
        return this.mAdvertiserId;
    }

    public void updateAdvertisingWhiteList(BluetoothDevice btDevice, boolean toAdd) {
        try {
            this.mGatt.updateAdvertisingWhiteList(this.mAdvertiserId, btDevice, toAdd);
        } catch (RemoteException e) {
            Log.e(TAG, "remote exception - ", e);
        }
    }

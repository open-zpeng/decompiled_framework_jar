...
public final class PeriodicAdvertisingReport implements Parcelable {
    ...
    public synchronized PeriodicAdvertisingReport(int syncHandle, int txPower, int rssi, int dataStatus, ScanRecord data) {
    ...
    private synchronized PeriodicAdvertisingReport(Parcel in) {
        readFromParcel(in);
    }
    ...
    public synchronized int getSyncHandle() {
    ...
    public synchronized int getDataStatus() {
        return this.mDataStatus;
    }

    public synchronized ScanRecord getData() {
        return this.mData;
    }

    public synchronized long getTimestampNanos() {

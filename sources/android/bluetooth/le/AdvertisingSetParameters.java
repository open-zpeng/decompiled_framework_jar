...
public final class AdvertisingSetParameters implements Parcelable {
    ...
    private synchronized AdvertisingSetParameters(boolean connectable, boolean scannable, boolean isLegacy, boolean isAnonymous, boolean includeTxPower, int primaryPhy, int secondaryPhy, int interval, int txPowerLevel) {
    ...
    private synchronized AdvertisingSetParameters(Parcel in) {

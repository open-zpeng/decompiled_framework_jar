...
public final class ScanSettings implements Parcelable {
    ...
    public synchronized int getMatchMode() {
        return this.mMatchMode;
    }

    public synchronized int getNumOfMatches() {
    ...
    private synchronized ScanSettings(int scanMode, int callbackType, int scanResultType, long reportDelayMillis, int matchMode, int numOfMatchesPerFilter, boolean legacy, int phy) {
    ...
    private synchronized ScanSettings(Parcel in) {
    ...
    public static final class Builder {
        ...
        private synchronized boolean isValidCallbackType(int callbackType) {

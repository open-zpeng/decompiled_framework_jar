...
public interface IBluetoothHeadsetClient extends IInterface {
    ...
    boolean sendVendorAtCommand(BluetoothDevice bluetoothDevice, String str) throws RemoteException;
    ...
    public static class Default implements IBluetoothHeadsetClient {
        ...
        @Override // android.bluetooth.IBluetoothHeadsetClient
        public boolean sendVendorAtCommand(BluetoothDevice device, String atCommand) throws RemoteException {
            return false;
        }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 4:
                    ...
                    List<BluetoothDevice> _result2 = getDevicesMatchingConnectionStates(_arg026);
                    reply.writeNoException();
                ...
                case 6:
                    ...
                    boolean priority = setPriority(_arg04, _arg12);
                    reply.writeNoException();
                ...
                case 12:
                    ...
                    boolean acceptCall = acceptCall(_arg010, _arg13);
                    reply.writeNoException();
                ...
                case 16:
                    ...
                    boolean enterPrivateMode = enterPrivateMode(_arg014, _arg14);
                    reply.writeNoException();
                ...
                case 18:
                    ...
                    BluetoothHeadsetClientCall _result7 = dial(_arg016, _arg15);
                    reply.writeNoException();
                    if (_result7 != null) {
                        reply.writeInt(1);
                ...
                case 19:
                    ...
                    boolean sendDTMF = sendDTMF(_arg017, _arg16);
                    reply.writeNoException();
                ...
                case 24:
                    ...
                    setAudioRouteAllowed(_arg022, _arg17);
                    reply.writeNoException();
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 26:
                    ...
                    boolean sendVendorAtCommand = sendVendorAtCommand(_arg024, _arg18);
                    reply.writeNoException();
                ...
                case 27:
                    ...
                    Bundle _result9 = getCurrentAgFeatures(_arg025);
                    reply.writeNoException();
                    if (_result9 != null) {
                        reply.writeInt(1);
        ...
        public static class Proxy implements IBluetoothHeadsetClient {
            ...
            public boolean sendVendorAtCommand(BluetoothDevice device, String atCommand) throws RemoteException {
                ...
                try {
                    ...
                    if (!_status && Stub.getDefaultImpl() != null) {
                        return Stub.getDefaultImpl().sendVendorAtCommand(device, atCommand);
                    }
                    _reply.readException();
                    boolean _result = _reply.readInt() != 0;
                    return _result;

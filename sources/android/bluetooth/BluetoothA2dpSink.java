...
public final class BluetoothA2dpSink implements BluetoothProfile {
    ...
    public synchronized BluetoothA2dpSink(Context context, BluetoothProfile.ServiceListener l) {
    ...
    public synchronized BluetoothAudioConfig getAudioConfig(BluetoothDevice device) {
        IBluetoothA2dpSink service = this.mService;
        if (service != null && isEnabled() && isValidDevice(device)) {
            try {

...
public class BluetoothGattDescriptor implements Parcelable {
    ...
    public private BluetoothGattCharacteristic mCharacteristic;
    ...
    synchronized BluetoothGattDescriptor(BluetoothGattCharacteristic characteristic, UUID uuid, int instance, int permissions) {
        initDescriptor(characteristic, uuid, instance, permissions);
    }

    public synchronized BluetoothGattDescriptor(UUID uuid, int instance, int permissions) {
        initDescriptor(null, uuid, instance, permissions);
    }

    private synchronized void initDescriptor(BluetoothGattCharacteristic characteristic, UUID uuid, int instance, int permissions) {
    ...
    private synchronized BluetoothGattDescriptor(Parcel in) {
    ...
    public private protected void setCharacteristic(BluetoothGattCharacteristic characteristic) {
        this.mCharacteristic = characteristic;
    }

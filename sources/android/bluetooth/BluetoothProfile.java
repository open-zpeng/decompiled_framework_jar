...
public interface BluetoothProfile {
    ...
    private protected static final int A2DP_SINK = 11;
    public static final int AVRCP = 13;
    private protected static final int AVRCP_CONTROLLER = 12;
    ...
    private protected static final int PAN = 5;
    public static final int PBAP = 6;
    public static final int PBAP_CLIENT = 17;
    private protected static final int PRIORITY_AUTO_CONNECT = 1000;
    @SystemApi
    public static final int PRIORITY_OFF = 0;
    @SystemApi
    public static final int PRIORITY_ON = 100;
    private protected static final int PRIORITY_UNDEFINED = -1;
    ...
    static synchronized String getConnectionStateName(int connectionState) {

...
public final class BluetoothAudioConfig implements Parcelable {
    ...
    public synchronized BluetoothAudioConfig(int sampleRate, int channelConfig, int audioFormat) {
    ...
    public synchronized int getChannelConfig() {
        return this.mChannelConfig;
    }

    public synchronized int getAudioFormat() {

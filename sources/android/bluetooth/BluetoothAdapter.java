...
public final class BluetoothAdapter {
    ...
    public protected IBluetooth mService;
    ...
    public interface BluetoothStateChangeCallback {
        synchronized void onBluetoothStateChange(boolean z);
    }
    ...
    public static synchronized String nameForState(int state) {
        switch (state) {
            case 10:
                return "OFF";
            case 11:
    ...
    synchronized BluetoothAdapter(IBluetoothManager managerService) {
        try {
    ...
    public synchronized PeriodicAdvertisingManager getPeriodicAdvertisingManager() {
    ...
    private protected int getLeState() {
        int state = 10;
        try {
            try {
                this.mServiceLock.readLock().lock();
    ...
    synchronized boolean getLeAccess() {
    ...
    private protected boolean disable(boolean persist) {
        try {
    ...
    private protected boolean factoryReset() {
        try {
            try {
                this.mServiceLock.readLock().lock();
            } catch (RemoteException e) {
    ...
    private protected ParcelUuid[] getUuids() {
        try {
            if (getState() != 12) {
                return null;
            }
    ...
    public synchronized BluetoothClass getBluetoothClass() {
        try {
            if (getState() != 12) {
                return null;
            }
    ...
    public synchronized boolean setBluetoothClass(BluetoothClass bluetoothClass) {
        try {
            if (getState() != 12) {
                return false;
            }
    ...
    private protected boolean setScanMode(int mode, int duration) {
        try {
            if (getState() != 12) {
                return false;
            }
    ...
    private protected boolean setScanMode(int mode) {
        if (getState() != 12) {
            return false;
        }
    ...
    public boolean dut_mode_configure(boolean isOn) {
        if (getState() != 12) {
            return false;
        }
        try {
            if (this.mService != null) {
                return this.mService.dut_mode_configure(isOn);
            }
        } catch (RemoteException e) {
            Log.e(TAG, "dut_mode_configure error:" + e);
        }
        return false;
    }

    private protected int getDiscoverableTimeout() {
        try {
            if (getState() != 12) {
                return -1;
            }
    ...
    private protected void setDiscoverableTimeout(int timeout) {
        if (getState() != 12) {
            return;
        }
        try {
    ...
    public synchronized long getDiscoveryEndMillis() {
        try {
            try {
                this.mServiceLock.readLock().lock();
                if (this.mService != null) {
    ...
    public synchronized int getMaxConnectedAudioDevices() {
        try {
            try {
                this.mServiceLock.readLock().lock();
                if (this.mService != null) {
    ...
    public synchronized boolean isHardwareTrackingFiltersAvailable() {
        if (getLeAccess()) {
            try {
    ...
    @Deprecated
    public synchronized BluetoothActivityEnergyInfo getControllerActivityEnergyInfo(int updateType) {
    ...
    public synchronized void requestControllerActivityEnergyInfo(ResultReceiver result) {
        try {
            try {
                this.mServiceLock.readLock().lock();
                if (this.mService != null) {
    ...
    public synchronized List<Integer> getSupportedProfiles() {
    ...
    private protected int getConnectionState() {
        try {
            if (getState() != 12) {
                return 0;
            }
    ...
    public synchronized BluetoothServerSocket listenUsingRfcommOn(int channel) throws IOException {
        return listenUsingRfcommOn(channel, false, false);
    }

    private protected BluetoothServerSocket listenUsingRfcommOn(int channel, boolean mitm, boolean min16DigitPin) throws IOException {
    ...
    private protected BluetoothServerSocket listenUsingEncryptedRfcommWithServiceRecord(String name, UUID uuid) throws IOException {
        return createNewRfcommSocketAndRecord(name, uuid, false, true);
    }

    private synchronized BluetoothServerSocket createNewRfcommSocketAndRecord(String name, UUID uuid, boolean auth, boolean encrypt) throws IOException {
    ...
    public synchronized BluetoothServerSocket listenUsingInsecureRfcommOn(int port) throws IOException {
    ...
    public synchronized BluetoothServerSocket listenUsingEncryptedRfcommOn(int port) throws IOException {
    ...
    public static synchronized BluetoothServerSocket listenUsingScoOn() throws IOException {
        BluetoothServerSocket socket = new BluetoothServerSocket(2, false, false, -1);
        socket.mSocket.bindListen();
        return socket;
    }

    public synchronized BluetoothServerSocket listenUsingL2capOn(int port, boolean mitm, boolean min16DigitPin) throws IOException {
    ...
    public synchronized BluetoothServerSocket listenUsingL2capOn(int port) throws IOException {
        return listenUsingL2capOn(port, false, false);
    }

    public synchronized BluetoothServerSocket listenUsingInsecureL2capOn(int port) throws IOException {
    ...
    public synchronized Pair<byte[], byte[]> readOutOfBandData() {
        return null;
    }
    ...
    public synchronized boolean changeApplicationBluetoothState(boolean on, BluetoothStateChangeCallback callback) {
        return false;
    }
    ...
    public class StateChangeCallbackWrapper extends IBluetoothStateChangeCallback.Stub {
        ...
        public synchronized void onBluetoothStateChange(boolean on) {
            this.mCallback.onBluetoothStateChange(on);
        }
    }

    private synchronized Set<BluetoothDevice> toDeviceSet(BluetoothDevice[] devices) {
    ...
    public private protected IBluetoothManager getBluetoothManager() {
        return this.mManagerService;
    }

    public private protected IBluetooth getBluetoothService(IBluetoothManagerCallback cb) {
    ...
    synchronized void removeServiceStateCallback(IBluetoothManagerCallback cb) {
        synchronized (this.mProxyServiceStateCallbacks) {
    ...
    public synchronized BluetoothServerSocket listenUsingL2capCoc(int transport) throws IOException {
        if (transport != 2) {
    ...
    public synchronized BluetoothServerSocket listenUsingInsecureL2capCoc(int transport) throws IOException {
        if (transport != 2) {
            throw new IllegalArgumentException("Unsupported transport: " + transport);
        }

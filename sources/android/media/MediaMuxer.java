...
public final class MediaMuxer {
    ...
    public protected static final int MUXER_STATE_STARTED = 1;
    public protected static final int MUXER_STATE_STOPPED = 2;
    public protected static final int MUXER_STATE_UNINITIALIZED = -1;
    public protected long mNativeObject;
    public protected int mState = -1;
    public protected final CloseGuard mCloseGuard = CloseGuard.get();
    ...
    public protected static native long nativeSetup(FileDescriptor fileDescriptor, int i) throws IllegalArgumentException, IOException;
    ...
    public static final class OutputFormat {
        ...
        private synchronized OutputFormat() {
        }
    }
    ...
    private synchronized void setUpMediaMuxer(FileDescriptor fd, int format) throws IOException {

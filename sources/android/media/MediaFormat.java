...
public final class MediaFormat {
    ...
    public protected Map<String, Object> mMap;
    ...
    public synchronized MediaFormat(Map<String, Object> map) {
        this.mMap = map;
    }
    ...
    public private protected Map<String, Object> getMap() {
        return this.mMap;
    }
    ...
    public final synchronized int getInteger(String name, int defaultValue) {
        try {

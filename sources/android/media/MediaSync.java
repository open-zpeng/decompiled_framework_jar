...
public final class MediaSync {
    ...
    public static class AudioBuffer {
        ...
        public synchronized AudioBuffer(ByteBuffer byteBuffer, int bufferId, long presentationTimeUs) {
    ...
    public void setPlaybackParams(PlaybackParams params) {
        ...
        if (this.mPlaybackRate != FeatureOption.FO_BOOT_POLICY_CPU && this.mAudioThread != null) {
            postRenderAudio(0L);
        }
    }
    ...
    public void queueAudio(ByteBuffer audioData, int bufferId, long presentationTimeUs) {
        ...
        if (this.mPlaybackRate != FeatureOption.FO_BOOT_POLICY_CPU) {
            postRenderAudio(0L);
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void postRenderAudio(long delayMillis) {
        this.mAudioHandler.postDelayed(new Runnable() { // from class: android.media.MediaSync.1
            ...
            public void run() {
                synchronized (MediaSync.this.mAudioLock) {
                    if (MediaSync.this.mPlaybackRate == FeatureOption.FO_BOOT_POLICY_CPU) {
                        return;
                    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final synchronized void postReturnByteBuffer(final AudioBuffer audioBuffer) {
        synchronized (this.mCallbackLock) {
    ...
    private final synchronized void returnAudioBuffers() {
        synchronized (this.mAudioLock) {
    ...
    private synchronized void createAudioThread() {

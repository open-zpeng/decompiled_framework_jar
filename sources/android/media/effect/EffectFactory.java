...
public class EffectFactory {
    ...
    public synchronized EffectFactory(EffectContext effectContext) {
    ...
    private static synchronized Class getEffectClassByName(String className) {
        String[] strArr;
    ...
    private synchronized Effect instantiateEffect(Class effectClass, String name) {
        try {

...
public class FilterGraphEffect extends FilterEffect {
    ...
    public synchronized FilterGraphEffect(EffectContext context, String name, String graphString, String inputName, String outputName, Class scheduler) {
        super(context, name);
    ...
    private synchronized void createGraph(String graphString) {

...
public abstract class FilterEffect extends Effect {
    ...
    public synchronized FilterEffect(EffectContext context, String name) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized void beginGLEffect() {
        this.mEffectContext.assertValidGLState();
        this.mEffectContext.saveGLState();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized void endGLEffect() {
        this.mEffectContext.restoreGLState();
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized FilterContext getFilterContext() {
        return this.mEffectContext.mFilterContext;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized Frame frameFromTexture(int texId, int width, int height) {

...
public class MediaDescription implements Parcelable {
    ...
    private synchronized MediaDescription(String mediaId, CharSequence title, CharSequence subtitle, CharSequence description, Bitmap icon, Uri iconUri, Bundle extras, Uri mediaUri) {
    ...
    private synchronized MediaDescription(Parcel in) {

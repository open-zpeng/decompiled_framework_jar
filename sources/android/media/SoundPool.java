...
public class SoundPool extends PlayerBase {
    ...
    private synchronized SoundPool(int maxStreams, AudioAttributes attributes) {
        super(attributes, 3);
        Log.d(TAG, "SoundPool attributes:" + attributes);
    ...
    public final int play(int soundID, float leftVolume, float rightVolume, int priority, int loop, float rate) {
        ...
        if (5 == this.mAttributes.getUsage() && !mSystemSoundOn) {
            ...
            return 0;
        } else if (mPolicyNotPlay && (5 == this.mAttributes.getUsage() || 13 == this.mAttributes.getUsage())) {
            ...
            if (testvol != 0) {
                ...
                float rightVolume3 = testvol / 100.0f;
                leftVolume2 = leftVolume3;
                rightVolume2 = rightVolume3;
            } else {
    ...
    public final int play(int soundID, float leftVolume, float rightVolume, int priority, int loop, float rate, int location, int fadeTime) {
        ...
        if (service != null && ret != 0) {
            try {
                service.selectAlarmChannels(location, fadeTime, ret);
                service.applyAlarmId(this.mAttributes.getUsage(), ret);
    ...
    public synchronized void setVolume(int streamID, float volume) {
    ...
    private static synchronized void postEventFromNative(Object ref, int msg, int arg1, int arg2, Object obj) {
        ...
        } else if (soundPool.mEventHandler != null) {

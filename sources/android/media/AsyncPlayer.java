...
public class AsyncPlayer {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void startSound(Command cmd) {
        try {
    ...
    private synchronized void enqueueLocked(Command cmd) {
    ...
    private protected void setUsesWakeLock(Context context) {

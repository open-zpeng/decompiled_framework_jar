...
public class EncoderCapabilities {
    ...
    public static class VideoEncoderCap {
        private protected final int mCodec;
        public final int mMaxBitRate;
        private protected final int mMaxFrameHeight;
        public final int mMaxFrameRate;
        private protected final int mMaxFrameWidth;
        public final int mMinBitRate;
        private protected final int mMinFrameHeight;
        public final int mMinFrameRate;
        private protected final int mMinFrameWidth;

        private synchronized VideoEncoderCap(int codec, int minBitRate, int maxBitRate, int minFrameRate, int maxFrameRate, int minFrameWidth, int maxFrameWidth, int minFrameHeight, int maxFrameHeight) {
            this.mCodec = codec;
    ...
    public static class AudioEncoderCap {
        ...
        private synchronized AudioEncoderCap(int codec, int minBitRate, int maxBitRate, int minSampleRate, int maxSampleRate, int minChannels, int maxChannels) {
            this.mCodec = codec;
            this.mMinBitRate = minBitRate;
            this.mMaxBitRate = maxBitRate;
    ...
    public static synchronized int[] getOutputFileFormats() {
    ...
    private protected static List<VideoEncoderCap> getVideoEncoders() {
    ...
    public static synchronized List<AudioEncoderCap> getAudioEncoders() {

...
public interface IMediaRouterClient extends IInterface {
    synchronized void onRestoreRoute() throws RemoteException;

    synchronized void onStateChanged() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IMediaRouterClient {
        ...
        public static synchronized IMediaRouterClient asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IMediaRouterClient {
            ...
            public synchronized void onStateChanged() throws RemoteException {
            ...
            @Override // android.media.IMediaRouterClient
            public synchronized void onRestoreRoute() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public final class MediaProjection {
    ...
    public synchronized MediaProjection(Context context, IMediaProjection impl) {
    ...
    public synchronized VirtualDisplay createVirtualDisplay(String name, int width, int height, int dpi, boolean isSecure, Surface surface, VirtualDisplay.Callback callback, Handler handler) {
    ...
    public synchronized AudioRecord createAudioRecord(int sampleRateInHz, int channelConfig, int audioFormat, int bufferSizeInBytes) {
        return null;
    }
    ...
    public synchronized IMediaProjection getProjection() {
        return this.mImpl;
    }

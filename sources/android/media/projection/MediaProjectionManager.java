...
public final class MediaProjectionManager {
    ...
    public static abstract class Callback {
        public abstract synchronized void onStart(MediaProjectionInfo mediaProjectionInfo);

        public abstract synchronized void onStop(MediaProjectionInfo mediaProjectionInfo);
    }

    public synchronized MediaProjectionManager(Context context) {
    ...
    public synchronized MediaProjectionInfo getActiveProjectionInfo() {
        try {
    ...
    public synchronized void stopActiveProjection() {
        try {
    ...
    public synchronized void addCallback(Callback callback, Handler handler) {
        if (callback == null) {
    ...
    private static final class CallbackDelegate extends IMediaProjectionWatcherCallback.Stub {
        ...
        public synchronized CallbackDelegate(Callback callback, Handler handler) {
            this.mCallback = callback;
            this.mHandler = handler == null ? new Handler() : handler;
        }

        @Override // android.media.projection.IMediaProjectionWatcherCallback
        public synchronized void onStart(final MediaProjectionInfo info) {
        ...
        @Override // android.media.projection.IMediaProjectionWatcherCallback
        public synchronized void onStop(final MediaProjectionInfo info) {

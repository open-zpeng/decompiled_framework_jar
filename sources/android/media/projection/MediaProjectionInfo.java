...
public final class MediaProjectionInfo implements Parcelable {
    ...
    public synchronized MediaProjectionInfo(String packageName, UserHandle handle) {
        this.mPackageName = packageName;
        this.mUserHandle = handle;
    }

    public synchronized MediaProjectionInfo(Parcel in) {
    ...
    public synchronized UserHandle getUserHandle() {

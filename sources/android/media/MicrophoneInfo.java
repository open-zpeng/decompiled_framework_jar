...
public final class MicrophoneInfo {
    ...
    public synchronized void setId(int portId) {
        this.mPortId = portId;
    }

    public synchronized void setChannelMapping(List<Pair<Integer, Integer>> channelMapping) {
        this.mChannelMapping = channelMapping;
    }
    ...
    public static final class Coordinate3F {
        ...
        synchronized Coordinate3F(float x, float y, float z) {
            this.x = x;
            this.y = y;
            this.z = z;
        }

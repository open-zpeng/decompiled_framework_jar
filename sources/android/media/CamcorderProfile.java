...
public class CamcorderProfile {
    ...
    public protected static final native CamcorderProfile native_get_camcorder_profile(int i, int i2);
    ...
    private synchronized CamcorderProfile(int duration, int quality, int fileFormat, int videoCodec, int videoBitRate, int videoFrameRate, int videoWidth, int videoHeight, int audioCodec, int audioBitRate, int audioSampleRate, int audioChannels) {

    ...
    private int parseC1(byte[] data, int pos) {
        ...
        switch (i) {
            ...
            case 145:
                ...
                return pos11;
            case 146:
                int row = data[pos] & MidiConstants.STATUS_CHANNEL_MASK;

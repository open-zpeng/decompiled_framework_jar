...
public class ImageWriter implements AutoCloseable {
    ...
    public static synchronized ImageWriter newInstance(Surface surface, int maxImages, int format) {
    ...
    protected synchronized ImageWriter(Surface surface, int maxImages, int format) {
    ...
    private synchronized void attachAndQueueInputImage(Image image) {
        if (image == null) {
            throw new IllegalArgumentException("image shouldn't be null");
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void abortImage(Image image) {
        if (image == null) {
            throw new IllegalArgumentException("image shouldn't be null");
        }
    ...
    public static class WriterSurfaceImage extends Image {
        ...
        public synchronized WriterSurfaceImage(ImageWriter writer) {
            this.mOwner = writer;
        }
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        @Override // android.media.Image
        public synchronized ImageWriter getOwner() {
            throwISEIfImageIsInvalid();
            return this.mOwner;
        }

...
public final class AudioFocusRequest {
    ...
    private synchronized AudioFocusRequest(AudioManager.OnAudioFocusChangeListener listener, Handler handler, AudioAttributes attr, int focusGain, int flags) {
    ...
    public static final synchronized boolean isValidFocusGain(int focusGain) {
        switch (focusGain) {
            case 1:
            case 2:
            case 3:
    ...
    public synchronized Handler getOnAudioFocusChangeListenerHandler() {
    ...
    public static final class Builder {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized Builder setOnAudioFocusChangeListenerInt(AudioManager.OnAudioFocusChangeListener listener, Handler handler) {
            this.mFocusListener = listener;
            this.mListenerHandler = handler;
            return this;
        }

...
public final class TimedText {
    ...
    public static final class CharPos {
        ...
        public synchronized CharPos(int startChar, int endChar) {
    ...
    public static final class Justification {
        ...
        public synchronized Justification(int horizontal, int vertical) {
    ...
    public static final class Style {
        ...
        public synchronized Style(int startChar, int endChar, int fontId, boolean isBold, boolean isItalic, boolean isUnderlined, int fontSize, int colorRGBA) {
            this.startChar = startChar;
            this.endChar = endChar;
            this.fontID = fontId;
            this.isBold = isBold;
    ...
    public static final class Font {
        ...
        public synchronized Font(int id, String name) {
            this.ID = id;
            this.name = name;
        }
    }
    ...
    public static final class Karaoke {
        ...
        public synchronized Karaoke(int startTimeMs, int endTimeMs, int startChar, int endChar) {
    ...
    public static final class HyperText {
        ...
        public synchronized HyperText(int startChar, int endChar, String url, String alt) {
            this.startChar = startChar;
            this.endChar = endChar;
            this.URL = url;
            this.altString = alt;
    ...
    public synchronized TimedText(Parcel parcel) {
    ...
    private synchronized void readStyle(Parcel parcel) {
    ...
    private synchronized void readFont(Parcel parcel) {
    ...
    private synchronized void readHighlight(Parcel parcel) {
    ...
    private synchronized void readKaraoke(Parcel parcel) {
        int entryCount = parcel.readInt();
        for (int i = 0; i < entryCount; i++) {
    ...
    private synchronized void readHyperText(Parcel parcel) {
        int startChar = parcel.readInt();
        int endChar = parcel.readInt();
    ...
    private synchronized void readBlinkingText(Parcel parcel) {
        int startChar = parcel.readInt();
        int endChar = parcel.readInt();
    ...
    private synchronized boolean isValidKey(int key) {
    ...
    private synchronized boolean containsKey(int key) {
    ...
    private synchronized Set keySet() {
        return this.mKeyObjectMap.keySet();
    }

    public protected Object getObject(int key) {
        if (containsKey(key)) {

...
public abstract class SoundTriggerDetectionService extends Service {
    ...
    public synchronized void setClient(UUID uuid, Bundle params, ISoundTriggerDetectionServiceClient client) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void removeClient(UUID uuid, Bundle params) {
        synchronized (this.mLock) {

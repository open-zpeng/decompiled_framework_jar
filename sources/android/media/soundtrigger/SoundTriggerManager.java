...
public final class SoundTriggerManager {
    ...
    public synchronized SoundTriggerManager(Context context, ISoundTriggerService soundTriggerService) {
    ...
    public static class Model {
        ...
        synchronized Model(SoundTrigger.GenericSoundModel soundTriggerModel) {
        ...
        synchronized SoundTrigger.GenericSoundModel getGenericSoundModel() {
            return this.mGenericSoundModel;
        }
    }

    private protected int loadSoundModel(SoundTrigger.SoundModel soundModel) {
        if (soundModel == null) {
    ...
    private protected int startRecognition(UUID soundModelId, PendingIntent callbackIntent, SoundTrigger.RecognitionConfig config) {
    ...
    private protected int startRecognition(UUID soundModelId, Bundle params, ComponentName detectionService, SoundTrigger.RecognitionConfig config) {
    ...
    private protected int stopRecognition(UUID soundModelId) {
        if (soundModelId == null) {
            return Integer.MIN_VALUE;
        }
        try {
    ...
    private protected int unloadSoundModel(UUID soundModelId) {
        if (soundModelId == null) {
            return Integer.MIN_VALUE;
        }
        try {
    ...
    private protected boolean isRecognitionActive(UUID soundModelId) {
        if (soundModelId == null) {
            return false;
        }
        try {

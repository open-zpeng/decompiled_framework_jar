...
public final class MediaDrm implements AutoCloseable {
    ...
    public static final class MediaDrmStateException extends IllegalStateException {
        ...
        public synchronized MediaDrmStateException(int errorCode, String detailMessage) {
            super(detailMessage);
    ...
    public static final class KeyStatus {
        ...
        synchronized KeyStatus(byte[] keyId, int statusCode) {
            this.mKeyId = keyId;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized List<KeyStatus> keyStatusListFromParcel(Parcel parcel) {
    ...
    private static synchronized void postEventFromNative(Object mediadrm_ref, int what, int eventType, int extra, Object obj) {
    ...
    public static final class CertificateRequest {
        ...
        synchronized CertificateRequest(byte[] data, String defaultUrl) {
            this.mData = data;
        ...
        private protected String getDefaultUrl() {
            return this.mDefaultUrl;
        }
    }

    private protected CertificateRequest getCertificateRequest(int certType, String certAuthority) {
    ...
    public static final class Certificate {
        ...
        private protected byte[] getWrappedPrivateKey() {
        ...
        private protected byte[] getContent() {
    ...
    private protected Certificate provideCertificateResponse(byte[] response) throws DeniedByServerException {
        return provideProvisionResponseNative(response);
    }

    private protected byte[] signRSA(byte[] sessionId, String algorithm, byte[] wrappedKey, byte[] message) {

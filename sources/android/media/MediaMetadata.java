...
public final class MediaMetadata implements Parcelable {
    ...
    private synchronized MediaMetadata(Bundle bundle) {
        this.mBundle = new Bundle(bundle);
    }

    private synchronized MediaMetadata(Parcel in) {
    ...
    public int hashCode() {
        int hashCode;
        int hashCode2 = 17;
        for (int hashCode3 = 0; hashCode3 < METADATA_KEYS_TYPE.size(); hashCode3++) {
            String key = METADATA_KEYS_TYPE.keyAt(hashCode3);
            switch (METADATA_KEYS_TYPE.valueAt(hashCode3).intValue()) {
                case 0:
                    hashCode = (31 * hashCode2) + Long.hashCode(getLong(key));
                    break;
                case 1:
                    hashCode = (31 * hashCode2) + Objects.hash(getString(key));
                    break;
                default:
            }
            hashCode2 = hashCode;
    ...
    public static final class Builder {
        ...
        public synchronized Builder(MediaMetadata source, int maxBitmapSize) {
            this(source);

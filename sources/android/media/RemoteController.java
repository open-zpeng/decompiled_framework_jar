...
public final class RemoteController {
    ...
    public protected MediaController mCurrentSession;
    ...
    private protected boolean setArtworkConfiguration(boolean wantBitmap, int width, int height) throws IllegalArgumentException {
        synchronized (mInfoLock) {
            if (wantBitmap) {
                if (width > 0 && height > 0) {
    ...
    public class MetadataEditor extends MediaMetadataEditor {
        ...
        private synchronized void cleanupBitmapFromBundle(int key) {
    ...
    public synchronized void startListeningToSessions() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void stopListeningToSessions() {
        this.mSessionManager.removeOnActiveSessionsChangedListener(this.mSessionListener);
    }

    private static synchronized void sendMsg(Handler handler, int msg, int existingMsgPolicy, int arg1, int arg2, Object obj, int delayMs) {
        if (handler == null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onClientChange(boolean clearing) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void updateController(MediaController controller) {
        synchronized (mInfoLock) {
            try {
                if (controller == null) {
                    if (this.mCurrentSession != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onNewPlaybackState(PlaybackState state) {
        OnClientUpdateListener l;
        synchronized (mInfoLock) {
            l = this.mOnClientUpdateListener;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onNewMediaMetadata(MediaMetadata metadata) {
        OnClientUpdateListener l;
    ...
    private static class PlaybackInfo {
        ...
        synchronized PlaybackInfo(int state, long stateChangeTimeMs, long currentPosMs, float speed) {
            this.mState = state;
    ...
    public private protected OnClientUpdateListener getUpdateListener() {

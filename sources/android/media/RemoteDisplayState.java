...
public final class RemoteDisplayState implements Parcelable {
    ...
    private protected final ArrayList<RemoteDisplayInfo> displays;

    private protected RemoteDisplayState() {
        this.displays = new ArrayList<>();
    }

    synchronized RemoteDisplayState(Parcel src) {
    ...
    public static final class RemoteDisplayInfo implements Parcelable {
        ...
        public synchronized RemoteDisplayInfo(String id) {
            this.id = id;
            this.status = 0;
        ...
        public synchronized RemoteDisplayInfo(RemoteDisplayInfo other) {
            this.id = other.id;
        ...
        synchronized RemoteDisplayInfo(Parcel in) {

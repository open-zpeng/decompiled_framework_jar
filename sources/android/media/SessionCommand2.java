...
public final class SessionCommand2 {
    ...
    public synchronized SessionCommand2(int commandCode) {
        this.mProvider = ApiLoader.getProvider().createMediaSession2Command(this, commandCode, null, null);
    }

    public synchronized SessionCommand2(String action, Bundle extras) {
        if (action == null) {
    ...
    public synchronized MediaSession2Provider.CommandProvider getProvider() {
        return this.mProvider;
    }

    public synchronized int getCommandCode() {
        return this.mProvider.getCommandCode_impl();
    }

    public synchronized String getCustomCommand() {
    ...
    public static synchronized SessionCommand2 fromBundle(Bundle command) {

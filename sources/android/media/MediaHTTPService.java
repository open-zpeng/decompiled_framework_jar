...
public class MediaHTTPService extends IMediaHTTPService.Stub {
    ...
    public synchronized MediaHTTPService(List<HttpCookie> cookies) {
        this.mCookies = cookies;
        Log.v(TAG, "MediaHTTPService(" + this + "): Cookies: " + cookies);
    }

    @Override // android.media.IMediaHTTPService
    public synchronized IMediaHTTPConnection makeHTTPConnection() {
    ...
    public private protected static IBinder createHttpServiceBinderIfNecessary(String path) {
        return createHttpServiceBinderIfNecessary(path, null);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized IBinder createHttpServiceBinderIfNecessary(String path, List<HttpCookie> cookies) {

...
class Cea608CCWidget extends ClosedCaptionWidget implements Cea608CCParser.DisplayListener {
    ...
    public synchronized Cea608CCWidget(Context context) {
        this(context, null);
    }

    public synchronized Cea608CCWidget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public synchronized Cea608CCWidget(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, 0);
    }

    public synchronized Cea608CCWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public synchronized void onDisplayChanged(SpannableStringBuilder[] styledTexts) {
    ...
    @Override // android.media.Cea608CCParser.DisplayListener
    public synchronized CaptioningManager.CaptionStyle getCaptionStyle() {
    ...
    public static class CCLineBox extends TextView {
        ...
        synchronized CCLineBox(Context context) {
            super(context);
            this.mTextColor = -1;
        ...
        synchronized void setCaptionStyle(CaptioningManager.CaptionStyle captionStyle) {
        ...
        private synchronized void drawEdgeOutline(Canvas c) {
        ...
        private synchronized void drawEdgeRaisedOrDepressed(Canvas c) {
            TextPaint textPaint = getPaint();
            Paint.Style previousStyle = textPaint.getStyle();
        ...
        private synchronized void setBackgroundSpans(int color) {
    ...
    private static class CCLayout extends LinearLayout implements ClosedCaptionWidget.ClosedCaptionLayout {
        ...
        synchronized CCLayout(Context context) {
            super(context);
        ...
        public synchronized void setCaptionStyle(CaptioningManager.CaptionStyle captionStyle) {
            for (int i = 0; i < 15; i++) {
        ...
        synchronized void update(SpannableStringBuilder[] textBuffer) {
            for (int i = 0; i < 15; i++) {

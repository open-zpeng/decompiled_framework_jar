...
public final class MediaBrowser {
    ...
    private synchronized void subscribeInternal(String parentId, Bundle options, SubscriptionCallback callback) {
    ...
    private synchronized void unsubscribeInternal(String parentId, SubscriptionCallback callback) {
        if (TextUtils.isEmpty(parentId)) {
            throw new IllegalArgumentException("parentId cannot be empty.");
        }
        Subscription sub = this.mSubscriptions.get(parentId);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized String getStateLabel(int state) {
        switch (state) {
            case 0:
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final synchronized void onServiceConnected(final IMediaBrowserServiceCallbacks callback, final String root, final MediaSession.Token session, final Bundle extra) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final synchronized void onConnectionFailed(final IMediaBrowserServiceCallbacks callback) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public final synchronized void onLoadChildren(final IMediaBrowserServiceCallbacks callback, final String parentId, final ParceledListSlice list, final Bundle options) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized boolean isCurrent(IMediaBrowserServiceCallbacks callback, String funcName) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized ServiceCallbacks getNewServiceCallbacks() {
    ...
    public static class MediaItem implements Parcelable {
        ...
        private synchronized MediaItem(Parcel in) {
    ...
    public class MediaServiceConnection implements ServiceConnection {
        ...
        private synchronized void postOrRun(Runnable r) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public synchronized boolean isCurrent(String funcName) {
    ...
    public static class ServiceCallbacks extends IMediaBrowserServiceCallbacks.Stub {
        ...
        public synchronized ServiceCallbacks(MediaBrowser mediaBrowser) {
            this.mMediaBrowser = new WeakReference<>(mediaBrowser);
        }

        public synchronized void onConnect(String root, MediaSession.Token session, Bundle extras) {
        ...
        public synchronized void onLoadChildren(String parentId, ParceledListSlice list) {
            onLoadChildrenWithOptions(parentId, list, null);
        }

        public synchronized void onLoadChildrenWithOptions(String parentId, ParceledListSlice list, Bundle options) {
            MediaBrowser mediaBrowser = this.mMediaBrowser.get();
            if (mediaBrowser != null) {
    ...
    public static class Subscription {
        ...
        public synchronized List<Bundle> getOptionsList() {
            return this.mOptionsList;
        }

        public synchronized List<SubscriptionCallback> getCallbacks() {
            return this.mCallbacks;
        }

        public synchronized SubscriptionCallback getCallback(Context context, Bundle options) {
            if (options != null) {
        ...
        public synchronized void putCallback(Context context, Bundle options, SubscriptionCallback callback) {
            if (options != null) {
                options.setClassLoader(context.getClassLoader());
            }
            for (int i = 0; i < this.mOptionsList.size(); i++) {

...
public class MediaBrowserUtils {
    public static synchronized boolean areSameOptions(Bundle options1, Bundle options2) {
    ...
    public static synchronized boolean hasDuplicatedItems(Bundle options1, Bundle options2) {
        int startIndex1;
        int endIndex1;
        int startIndex2;
        int endIndex2;

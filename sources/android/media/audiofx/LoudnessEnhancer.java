...
public class LoudnessEnhancer extends AudioEffect {
    ...
    public interface OnParameterChangeListener {
        synchronized void onParameterChange(LoudnessEnhancer loudnessEnhancer, int i, int i2);
    }
    ...
    public synchronized LoudnessEnhancer(int priority, int audioSession) throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException, RuntimeException {
    ...
    public synchronized Settings getProperties() throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
    ...
    public synchronized void setProperties(Settings settings) throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {

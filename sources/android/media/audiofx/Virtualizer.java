...
public class Virtualizer extends AudioEffect {
    ...
    private synchronized boolean getAnglesInt(int inputChannelMask, int deviceType, int[] angles) throws IllegalStateException, IllegalArgumentException, UnsupportedOperationException {
    ...
    private static synchronized int getDeviceForModeQuery(int virtualizationMode) throws IllegalArgumentException {
    ...
    private static synchronized int getDeviceForModeForce(int virtualizationMode) throws IllegalArgumentException {
    ...
    private static synchronized int deviceToMode(int deviceType) {
        if (deviceType != 19) {
            if (deviceType != 22) {
                switch (deviceType) {
                    case 1:

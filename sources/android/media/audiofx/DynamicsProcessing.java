...
public final class DynamicsProcessing extends AudioEffect {
    ...
    public interface OnParameterChangeListener {
        synchronized void onParameterChange(DynamicsProcessing dynamicsProcessing, int i, int i2);
    }
    ...
    public synchronized DynamicsProcessing(int priority, int audioSession) {
    ...
    public static final class Eq extends BandStage {
        ...
        private synchronized void checkBand(int band) {
    ...
    public static final class Config {
        ...
        public synchronized Config(int variant, float frameDurationMs, int channelCount, boolean preEqInUse, int preEqBandCount, boolean mbcInUse, int mbcBandCount, boolean postEqInUse, int postEqBandCount, boolean limiterInUse, Channel[] channel) {
        ...
        public synchronized Config(int channelCount, Config cfg) {
        ...
        public synchronized Config(Config cfg) {
        ...
        private synchronized void checkChannel(int channelIndex) {
    ...
    private synchronized void setEngineArchitecture(int variant, float preferredFrameDuration, boolean preEqInUse, int preEqBandCount, boolean mbcInUse, int mbcBandCount, boolean postEqInUse, int postEqBandCount, boolean limiterInUse) {
        Number[] params = {48};
    ...
    private synchronized void updateEngineEqBandByChannelIndex(int param, int channelIndex, int bandIndex, EqBand eqBand) {
    ...
    private synchronized Eq queryEngineEqByChannelIndex(int param, int channelIndex) {
    ...
    private synchronized EqBand queryEngineEqBandByChannelIndex(int param, int channelIndex, int bandIndex) {
        Number[] params = {Integer.valueOf(param), Integer.valueOf(channelIndex), Integer.valueOf(bandIndex)};
    ...
    private synchronized void updateEngineEqByChannelIndex(int param, int channelIndex, Eq eq) {
    ...
    private synchronized Mbc queryEngineMbcByChannelIndex(int channelIndex) {
    ...
    private synchronized MbcBand queryEngineMbcBandByChannelIndex(int channelIndex, int bandIndex) {
    ...
    private synchronized void updateEngineMbcBandByChannelIndex(int channelIndex, int bandIndex, MbcBand mbcBand) {
        Number[] params = {85, Integer.valueOf(channelIndex), Integer.valueOf(bandIndex)};
    ...
    private synchronized void updateEngineMbcByChannelIndex(int channelIndex, Mbc mbc) {
    ...
    private synchronized void updateEngineLimiterByChannelIndex(int channelIndex, Limiter limiter) {
    ...
    private synchronized Limiter queryEngineLimiterByChannelIndex(int channelIndex) {
        Number[] params = {112, Integer.valueOf(channelIndex)};
    ...
    private synchronized Channel queryEngineByChannelIndex(int channelIndex) {
    ...
    private synchronized void updateEngineChannelByChannelIndex(int channelIndex, Channel channel) {
    ...
    private synchronized int getOneInt(int param) {
        int[] params = {param};
    ...
    private synchronized void setTwoFloat(int param, int paramA, float valueSet) {
        int[] params = {param, paramA};
        byte[] value = floatToByteArray(valueSet);
        checkStatus(setParameter(params, value));
    }

    private synchronized byte[] numberArrayToByteArray(Number[] values) {
        int expectedBytes = 0;
    ...
    private synchronized void byteArrayToNumberArray(byte[] valuesIn, Number[] valuesOut) {
        int outIndex;
        int inIndex = 0;
        int outIndex2 = 0;
    ...
    private synchronized void setNumberArray(Number[] params, Number[] values) {
        byte[] paramBytes = numberArrayToByteArray(params);
        byte[] valueBytes = numberArrayToByteArray(values);
        checkStatus(setParameter(paramBytes, valueBytes));
    }

    private synchronized float getTwoFloat(int param, int paramA) {
        int[] params = {param, paramA};
    ...
    private synchronized void updateEffectArchitecture() {
        this.mChannelCount = getChannelCount();
    }
    ...
    public synchronized void setParameterListener(OnParameterChangeListener listener) {
    ...
    public static class Settings {
        ...
        public synchronized Settings() {
        }

        public synchronized Settings(String settings) {
    ...
    public synchronized Settings getProperties() {
    ...
    public synchronized void setProperties(Settings settings) {

...
public class Visualizer {
    ...
    public synchronized int setServerDiedListener(OnServerDiedListener listener) {
        synchronized (this.mListenerLock) {
    ...
    private class NativeEventHandler extends Handler {
        ...
        private synchronized void handleCaptureMessage(Message msg) {
        ...
        private synchronized void handleServerDiedMessage(Message msg) {

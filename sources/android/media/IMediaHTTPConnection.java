...
public interface IMediaHTTPConnection extends IInterface {
    synchronized IBinder connect(String str, String str2) throws RemoteException;

    synchronized void disconnect() throws RemoteException;

    synchronized String getMIMEType() throws RemoteException;

    synchronized long getSize() throws RemoteException;

    synchronized String getUri() throws RemoteException;

    synchronized int readAt(long j, int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IMediaHTTPConnection {
        ...
        public static synchronized IMediaHTTPConnection asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IMediaHTTPConnection {
            ...
            public synchronized IBinder connect(String uri, String headers) throws RemoteException {
            ...
            @Override // android.media.IMediaHTTPConnection
            public synchronized int readAt(long offset, int size) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.media.IMediaHTTPConnection
            public synchronized long getSize() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.media.IMediaHTTPConnection
            public synchronized String getMIMEType() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.media.IMediaHTTPConnection
            public synchronized String getUri() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public final class AudioFocusInfo implements Parcelable {
    ...
    public synchronized AudioFocusInfo(AudioAttributes aa, int clientUid, String clientId, String packageName, int gainRequest, int lossReceived, int flags, int sdk) {
    ...
    public synchronized void setGen(long g) {
        this.mGenCount = g;
    }

    public synchronized long getGen() {
    ...
    public synchronized int getSdkTarget() {
        return this.mSdkTarget;
    }

    public synchronized void clearLossReceived() {

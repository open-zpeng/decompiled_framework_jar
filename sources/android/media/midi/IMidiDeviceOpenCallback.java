...
public interface IMidiDeviceOpenCallback extends IInterface {
    synchronized void onDeviceOpened(IMidiDeviceServer iMidiDeviceServer, IBinder iBinder) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IMidiDeviceOpenCallback {
        ...
        public static synchronized IMidiDeviceOpenCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IMidiDeviceOpenCallback {
            ...
            public synchronized void onDeviceOpened(IMidiDeviceServer server, IBinder token) throws RemoteException {

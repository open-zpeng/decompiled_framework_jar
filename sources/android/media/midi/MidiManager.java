...
public final class MidiManager {
    ...
    private class DeviceListener extends IMidiDeviceListener.Stub {
        ...
        public synchronized void onDeviceAdded(final MidiDeviceInfo device) {
            if (this.mHandler != null) {
                this.mHandler.post(new Runnable() { // from class: android.media.midi.MidiManager.DeviceListener.1
        ...
        @Override // android.media.midi.IMidiDeviceListener
        public synchronized void onDeviceRemoved(final MidiDeviceInfo device) {
            if (this.mHandler != null) {
                this.mHandler.post(new Runnable() { // from class: android.media.midi.MidiManager.DeviceListener.2
                    @Override // java.lang.Runnable
                    public void run() {
        ...
        @Override // android.media.midi.IMidiDeviceListener
        public synchronized void onDeviceStatusChanged(final MidiDeviceStatus status) {
            if (this.mHandler != null) {
                this.mHandler.post(new Runnable() { // from class: android.media.midi.MidiManager.DeviceListener.3
                    @Override // java.lang.Runnable
                    public void run() {
    ...
    public synchronized MidiManager(IMidiManager service) {
    ...
    public synchronized void sendOpenDeviceResponse(final MidiDevice device, final OnDeviceOpenedListener listener, Handler handler) {
        if (handler != null) {
    ...
    public synchronized MidiDeviceServer createDeviceServer(MidiReceiver[] inputPortReceivers, int numOutputPorts, String[] inputPortNames, String[] outputPortNames, Bundle properties, int type, MidiDeviceServer.Callback callback) {
        try {
        } catch (RemoteException e) {
            e = e;
        }

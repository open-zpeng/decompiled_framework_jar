...
public interface IMidiDeviceListener extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IMidiDeviceListener {
        ...
        public static synchronized IMidiDeviceListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IMidiDeviceListener {
            ...
            public synchronized void onDeviceAdded(MidiDeviceInfo device) throws RemoteException {
            ...
            @Override // android.media.midi.IMidiDeviceListener
            public synchronized void onDeviceRemoved(MidiDeviceInfo device) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (device != null) {
            ...
            @Override // android.media.midi.IMidiDeviceListener
            public synchronized void onDeviceStatusChanged(MidiDeviceStatus status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (status != null) {

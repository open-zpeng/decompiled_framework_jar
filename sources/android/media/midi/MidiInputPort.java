...
public final class MidiInputPort extends MidiReceiver implements Closeable {
    ...
    public synchronized MidiInputPort(IMidiDeviceServer server, IBinder token, FileDescriptor fd, int portNumber) {
        super(1015);
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized MidiInputPort(FileDescriptor fd, int portNumber) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized FileDescriptor claimFileDescriptor() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized IMidiDeviceServer getDeviceServer() {

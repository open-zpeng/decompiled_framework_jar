...
public interface IBluetoothMidiService extends IInterface {
    synchronized IBinder addBluetoothDevice(BluetoothDevice bluetoothDevice) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IBluetoothMidiService {
        ...
        public static synchronized IBluetoothMidiService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IBluetoothMidiService {
            ...
            public synchronized IBinder addBluetoothDevice(BluetoothDevice bluetoothDevice) throws RemoteException {

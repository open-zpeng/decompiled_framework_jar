...
public final class MidiOutputPort extends MidiSender implements Closeable {
    ...
    public synchronized MidiOutputPort(IMidiDeviceServer server, IBinder token, FileDescriptor fd, int portNumber) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized MidiOutputPort(FileDescriptor fd, int portNumber) {

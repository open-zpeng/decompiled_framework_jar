...
public final class MidiDeviceServer implements Closeable {
    ...
    public interface Callback {
        ...
        synchronized void onDeviceStatusChanged(MidiDeviceServer midiDeviceServer, MidiDeviceStatus midiDeviceStatus);
    }
    ...
    private abstract class PortClient implements IBinder.DeathRecipient {
        ...
        abstract synchronized void close();
        ...
        synchronized MidiInputPort getInputPort() {
            return null;
        }
    ...
    private static synchronized FileDescriptor[] createSeqPacketSocketPair() throws IOException {
        try {
    ...
    public synchronized MidiDeviceServer(IMidiManager midiManager, MidiReceiver[] inputPortReceivers, int numOutputPorts, Callback callback) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized MidiDeviceServer(IMidiManager midiManager, MidiReceiver[] inputPortReceivers, MidiDeviceInfo deviceInfo, Callback callback) {
        this(midiManager, inputPortReceivers, deviceInfo.getOutputPortCount(), callback);
        this.mDeviceInfo = deviceInfo;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized IMidiDeviceServer getBinderInterface() {
        return this.mServer;
    }

    public synchronized IBinder asBinder() {
        return this.mServer.asBinder();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void updateDeviceStatus() {
    ...
    public synchronized MidiReceiver[] getOutputPortReceivers() {

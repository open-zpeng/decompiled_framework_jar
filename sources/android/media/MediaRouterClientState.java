...
public final class MediaRouterClientState implements Parcelable {
    ...
    public synchronized MediaRouterClientState() {
        this.routes = new ArrayList<>();
    }

    synchronized MediaRouterClientState(Parcel src) {
    ...
    public static final class RouteInfo implements Parcelable {
        ...
        public synchronized RouteInfo(String id) {
            this.id = id;
            this.enabled = true;
            this.statusCode = 0;
            this.playbackType = 1;
        ...
        public synchronized RouteInfo(RouteInfo other) {
            this.id = other.id;
        ...
        synchronized RouteInfo(Parcel in) {

...
public final class PlaybackParams implements Parcelable {
    ...
    public protected static final int SET_AUDIO_FALLBACK_MODE = 4;
    public protected static final int SET_AUDIO_STRETCH_MODE = 8;
    public protected static final int SET_PITCH = 2;
    public protected static final int SET_SPEED = 1;
    public protected int mAudioFallbackMode;
    public protected int mAudioStretchMode;
    public protected float mPitch;
    public protected int mSet;
    public protected float mSpeed;
    ...
    private synchronized PlaybackParams(Parcel in) {
        this.mSet = 0;
        this.mAudioFallbackMode = 0;
        this.mAudioStretchMode = 0;
        this.mPitch = 1.0f;

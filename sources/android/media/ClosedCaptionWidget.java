...
abstract class ClosedCaptionWidget extends ViewGroup implements SubtitleTrack.RenderingWidget {
    ...
    interface ClosedCaptionLayout {
        ...
        synchronized void setFontScale(float f);
    }

    public abstract synchronized ClosedCaptionLayout createCaptionLayout(Context context);

    public synchronized ClosedCaptionWidget(Context context) {
        this(context, null);
    }

    public synchronized ClosedCaptionWidget(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public synchronized ClosedCaptionWidget(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, 0);
    }

    public synchronized ClosedCaptionWidget(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {

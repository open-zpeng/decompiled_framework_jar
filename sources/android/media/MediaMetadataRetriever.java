...
public class MediaMetadataRetriever {
    ...
    public protected native byte[] getEmbeddedPicture(int i);

    public protected final native void native_finalize();

    public protected static native void native_init();

    public protected native void native_setup();
    ...
    private synchronized List<Bitmap> getFramesAtIndexInternal(int frameIndex, int numFrames, BitmapParams params) {
    ...
    private synchronized Bitmap getImageAtIndexInternal(int imageIndex, BitmapParams params) {

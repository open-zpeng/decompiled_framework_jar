...
public class Metadata {
    ...
    private protected static final int PAUSE_AVAILABLE = 1;
    public static final int RATING = 17;
    private protected static final int SEEK_AVAILABLE = 4;
    private protected static final int SEEK_BACKWARD_AVAILABLE = 2;
    private protected static final int SEEK_FORWARD_AVAILABLE = 3;
    ...
    private synchronized boolean scanAllRecords(Parcel parcel, int bytesLeft) {
        int metadataType;
        int recCount = 0;
        boolean error = false;
    ...
    private protected Set<Integer> keySet() {
    ...
    private protected String getString(int key) {
        checkType(key, 1);
        return this.mParcel.readString();
    }

    private protected int getInt(int key) {
        checkType(key, 2);
    ...
    private protected long getLong(int key) {
        checkType(key, 4);
        return this.mParcel.readLong();
    }

    private protected double getDouble(int key) {
        checkType(key, 5);
        return this.mParcel.readDouble();
    }

    private protected byte[] getByteArray(int key) {
        checkType(key, 7);
        return this.mParcel.createByteArray();
    }

    private protected Date getDate(int key) {
        checkType(key, 6);
    ...
    public static synchronized int lastSytemId() {
        return 31;
    }

    public static synchronized int firstCustomId() {
        return 8192;
    }

    public static synchronized int lastType() {
        return 7;
    }

    private synchronized boolean checkMetadataId(int val) {
    ...
    private synchronized void checkType(int key, int expectedType) {

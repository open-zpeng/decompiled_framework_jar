        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    createSession(_arg0, _arg1, _arg2);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ITvInputSessionCallback _arg08 = ITvInputSessionCallback.Stub.asInterface(data.readStrongBinder());
                    String _arg12 = data.readString();
                    createRecordingSession(_arg08, _arg12);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {

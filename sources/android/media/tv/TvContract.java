...
public final class TvContract {
    ...
    interface PreviewProgramColumns {
        private protected static final int ASPECT_RATIO_16_9 = 0;
        private protected static final int ASPECT_RATIO_1_1 = 3;
        private protected static final int ASPECT_RATIO_2_3 = 4;
        private protected static final int ASPECT_RATIO_3_2 = 1;
        private protected static final int ASPECT_RATIO_4_3 = 2;
        private protected static final int AVAILABILITY_AVAILABLE = 0;
        private protected static final int AVAILABILITY_FREE_WITH_SUBSCRIPTION = 1;
        private protected static final int AVAILABILITY_PAID_CONTENT = 2;
        private protected static final String COLUMN_AUTHOR = "author";
        private protected static final String COLUMN_AVAILABILITY = "availability";
        private protected static final String COLUMN_BROWSABLE = "browsable";
        private protected static final String COLUMN_CONTENT_ID = "content_id";
        private protected static final String COLUMN_DURATION_MILLIS = "duration_millis";
        private protected static final String COLUMN_INTENT_URI = "intent_uri";
        private protected static final String COLUMN_INTERACTION_COUNT = "interaction_count";
        private protected static final String COLUMN_INTERACTION_TYPE = "interaction_type";
        private protected static final String COLUMN_INTERNAL_PROVIDER_ID = "internal_provider_id";
        private protected static final String COLUMN_ITEM_COUNT = "item_count";
        private protected static final String COLUMN_LAST_PLAYBACK_POSITION_MILLIS = "last_playback_position_millis";
        private protected static final String COLUMN_LIVE = "live";
        private protected static final String COLUMN_LOGO_URI = "logo_uri";
        private protected static final String COLUMN_OFFER_PRICE = "offer_price";
        private protected static final String COLUMN_POSTER_ART_ASPECT_RATIO = "poster_art_aspect_ratio";
        private protected static final String COLUMN_PREVIEW_VIDEO_URI = "preview_video_uri";
        private protected static final String COLUMN_RELEASE_DATE = "release_date";
        private protected static final String COLUMN_STARTING_PRICE = "starting_price";
        private protected static final String COLUMN_THUMBNAIL_ASPECT_RATIO = "poster_thumbnail_aspect_ratio";
        private protected static final String COLUMN_TRANSIENT = "transient";
        private protected static final String COLUMN_TYPE = "type";
        private protected static final int INTERACTION_TYPE_FANS = 3;
        private protected static final int INTERACTION_TYPE_FOLLOWERS = 2;
        private protected static final int INTERACTION_TYPE_LIKES = 4;
        private protected static final int INTERACTION_TYPE_LISTENS = 1;
        private protected static final int INTERACTION_TYPE_THUMBS = 5;
        private protected static final int INTERACTION_TYPE_VIEWERS = 6;
        private protected static final int INTERACTION_TYPE_VIEWS = 0;
        private protected static final int TYPE_ALBUM = 8;
        private protected static final int TYPE_ARTIST = 9;
        private protected static final int TYPE_CHANNEL = 6;
        private protected static final int TYPE_CLIP = 4;
        private protected static final int TYPE_EVENT = 5;
        private protected static final int TYPE_MOVIE = 0;
        private protected static final int TYPE_PLAYLIST = 10;
        private protected static final int TYPE_STATION = 11;
        private protected static final int TYPE_TRACK = 7;
        private protected static final int TYPE_TV_EPISODE = 3;
        private protected static final int TYPE_TV_SEASON = 2;
        private protected static final int TYPE_TV_SERIES = 1;
    ...
    interface ProgramColumns {
        private protected static final String COLUMN_AUDIO_LANGUAGE = "audio_language";
        private protected static final String COLUMN_CANONICAL_GENRE = "canonical_genre";
        private protected static final String COLUMN_CONTENT_RATING = "content_rating";
        private protected static final String COLUMN_EPISODE_DISPLAY_NUMBER = "episode_display_number";
        private protected static final String COLUMN_EPISODE_TITLE = "episode_title";
        private protected static final String COLUMN_INTERNAL_PROVIDER_DATA = "internal_provider_data";
        private protected static final String COLUMN_INTERNAL_PROVIDER_FLAG1 = "internal_provider_flag1";
        private protected static final String COLUMN_INTERNAL_PROVIDER_FLAG2 = "internal_provider_flag2";
        private protected static final String COLUMN_INTERNAL_PROVIDER_FLAG3 = "internal_provider_flag3";
        private protected static final String COLUMN_INTERNAL_PROVIDER_FLAG4 = "internal_provider_flag4";
        private protected static final String COLUMN_LONG_DESCRIPTION = "long_description";
        private protected static final String COLUMN_POSTER_ART_URI = "poster_art_uri";
        private protected static final String COLUMN_REVIEW_RATING = "review_rating";
        private protected static final String COLUMN_REVIEW_RATING_STYLE = "review_rating_style";
        private protected static final String COLUMN_SEARCHABLE = "searchable";
        private protected static final String COLUMN_SEASON_DISPLAY_NUMBER = "season_display_number";
        private protected static final String COLUMN_SEASON_TITLE = "season_title";
        private protected static final String COLUMN_SHORT_DESCRIPTION = "short_description";
        private protected static final String COLUMN_THUMBNAIL_URI = "thumbnail_uri";
        private protected static final String COLUMN_TITLE = "title";
        private protected static final String COLUMN_VERSION_NUMBER = "version_number";
        private protected static final String COLUMN_VIDEO_HEIGHT = "video_height";
        private protected static final String COLUMN_VIDEO_WIDTH = "video_width";
        private protected static final int REVIEW_RATING_STYLE_PERCENTAGE = 2;
        private protected static final int REVIEW_RATING_STYLE_STARS = 0;
        private protected static final int REVIEW_RATING_STYLE_THUMBS_UP_DOWN = 1;
    ...
    public static synchronized Uri buildWatchedProgramUri(long watchedProgramId) {
        return ContentUris.withAppendedId(WatchedPrograms.CONTENT_URI, watchedProgramId);
    }

    private static synchronized boolean isTvUri(Uri uri) {
        return uri != null && "content".equals(uri.getScheme()) && AUTHORITY.equals(uri.getAuthority());
    }

    private static synchronized boolean isTwoSegmentUriStartingWith(Uri uri, String pathSegment) {
    ...
    private synchronized TvContract() {
    }
    ...
    public static final class Programs implements BaseTvColumns, ProgramColumns {
        ...
        public static final class Genres {
            ...
            private static synchronized String encodeToCsv(String genre) {
                StringBuilder sb = new StringBuilder();
    ...
    public static final class RecordedPrograms implements BaseTvColumns, ProgramColumns {
        ...
        private synchronized RecordedPrograms() {
        }
    }
    ...
    public static final class PreviewPrograms implements BaseTvColumns, ProgramColumns, PreviewProgramColumns {
        ...
        private synchronized PreviewPrograms() {
        }
    }
    ...
    public static final class WatchNextPrograms implements BaseTvColumns, ProgramColumns, PreviewProgramColumns {
        ...
        private synchronized WatchNextPrograms() {
        }
    }
    ...
    public static final class WatchedPrograms implements BaseTvColumns {
        ...
        private synchronized WatchedPrograms() {
        }
    }
}

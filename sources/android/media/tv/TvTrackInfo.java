...
public final class TvTrackInfo implements Parcelable {
    ...
    private synchronized TvTrackInfo(int type, String id, String language, CharSequence description, int audioChannelCount, int audioSampleRate, int videoWidth, int videoHeight, float videoFrameRate, float videoPixelAspectRatio, byte videoActiveFormatDescription, Bundle extra) {
        this.mType = type;
        this.mId = id;
    ...
    private synchronized TvTrackInfo(Parcel in) {

...
public interface ITvInputHardwareCallback extends IInterface {
    synchronized void onReleased() throws RemoteException;

    synchronized void onStreamConfigChanged(TvStreamConfig[] tvStreamConfigArr) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ITvInputHardwareCallback {
        ...
        public static synchronized ITvInputHardwareCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ITvInputHardwareCallback {
            ...
            public synchronized void onReleased() throws RemoteException {
            ...
            @Override // android.media.tv.ITvInputHardwareCallback
            public synchronized void onStreamConfigChanged(TvStreamConfig[] configs) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

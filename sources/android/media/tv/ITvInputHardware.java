...
public interface ITvInputHardware extends IInterface {
    synchronized void overrideAudioSink(int i, String str, int i2, int i3, int i4) throws RemoteException;

    synchronized void setStreamVolume(float f) throws RemoteException;

    synchronized boolean setSurface(Surface surface, TvStreamConfig tvStreamConfig) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ITvInputHardware {
        ...
        public static synchronized ITvInputHardware asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ITvInputHardware {
            ...
            public synchronized boolean setSurface(Surface surface, TvStreamConfig config) throws RemoteException {
            ...
            @Override // android.media.tv.ITvInputHardware
            public synchronized void setStreamVolume(float volume) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.media.tv.ITvInputHardware
            public synchronized void overrideAudioSink(int audioType, String audioAddress, int samplingRate, int channelMask, int format) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

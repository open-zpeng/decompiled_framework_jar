...
public final class TvInputInfo implements Parcelable {
    ...
    public static final class Builder {
        ...
        public TvInputInfo build() {
            ...
            return new TvInputInfo(resolveInfo, id, type, isHardwareInput, charSequence, i, icon, icon2, icon3, str, booleanValue, num != null ? num.intValue() : 0, this.mHdmiDeviceInfo, isConnectedToHdmiSwitch, hdmiConnectionRelativePosition, this.mParentId, this.mExtras);
        }

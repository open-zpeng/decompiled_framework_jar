...
public abstract class TvInputService extends Service {
    ...
    public synchronized boolean isPassthroughInput(String inputId) {
    ...
    public static abstract class Session implements KeyEvent.Callback {
        ...
        public protected Rect mOverlayFrame;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public synchronized void notifyTimeShiftStartPositionChanged(final long timeMs) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public synchronized void notifyTimeShiftCurrentPositionChanged(final long timeMs) {
        ...
        public synchronized void createOverlayView(IBinder windowToken, Rect frame) {
            ...
            int flags = MetricsProto.MetricsEvent.DIALOG_RUNNIGN_SERVICE;
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized void removeOverlayView(boolean clearWindowToken) {
            if (clearWindowToken) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized void scheduleOverlayViewCleanup() {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public synchronized int dispatchInputEvent(InputEvent event, InputEventReceiver receiver) {
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public synchronized void initialize(ITvInputSessionCallback callback) {
            synchronized (this.mLock) {
        ...
        private synchronized void executeOrPostRunnableOnMainThread(Runnable action) {
            synchronized (this.mLock) {
    ...
    public static final class OverlayViewCleanUpTask extends AsyncTask<View, Void, Void> {
        private synchronized OverlayViewCleanUpTask() {
        }
    ...
    public static synchronized boolean isNavigationKey(int keyCode) {
        switch (keyCode) {
            case 19:
            case 20:
            case 21:
    ...
    private final class ServiceHandler extends Handler {
        ...
        private synchronized void broadcastAddHardwareInput(int deviceId, TvInputInfo inputInfo) {
        ...
        private synchronized void broadcastAddHdmiInput(int id, TvInputInfo inputInfo) {
            int n = TvInputService.this.mCallbacks.beginBroadcast();
            for (int i = 0; i < n; i++) {
                try {
        ...
        private synchronized void broadcastRemoveHardwareInput(String inputId) {
            int n = TvInputService.this.mCallbacks.beginBroadcast();
            for (int i = 0; i < n; i++) {
                try {

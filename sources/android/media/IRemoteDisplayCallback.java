...
public interface IRemoteDisplayCallback extends IInterface {
    private protected void onStateChanged(RemoteDisplayState remoteDisplayState) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IRemoteDisplayCallback {
        ...
        public static synchronized IRemoteDisplayCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IRemoteDisplayCallback {
            ...
            public synchronized void onStateChanged(RemoteDisplayState state) throws RemoteException {

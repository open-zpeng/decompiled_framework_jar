...
public class RemoteConnectionManager {
    ...
    public synchronized RemoteConnectionManager(ConnectionService ourConnectionServiceImpl) {
        this.mOurConnectionServiceImpl = ourConnectionServiceImpl;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void addConnectionService(ComponentName componentName, IConnectionService outgoingConnectionServiceRpc) {
    ...
    public synchronized RemoteConnection createRemoteConnection(PhoneAccountHandle connectionManagerPhoneAccount, ConnectionRequest request, boolean isIncoming) {
    ...
    public synchronized void conferenceRemoteConnections(RemoteConnection a, RemoteConnection b) {

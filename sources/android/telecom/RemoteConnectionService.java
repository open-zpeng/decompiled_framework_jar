...
public final class RemoteConnectionService {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized RemoteConnectionService(IConnectionService outgoingConnectionServiceRpc, ConnectionService ourConnectionServiceImpl) throws RemoteException {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized RemoteConnection createRemoteConnection(PhoneAccountHandle connectionManagerPhoneAccount, ConnectionRequest request, boolean isIncoming) {
    ...
    public synchronized boolean hasConnection(String callId) {
        return this.mConnectionById.containsKey(callId);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public synchronized RemoteConnection findConnectionForAction(String callId, String action) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized RemoteConference findConferenceForAction(String callId, String action) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void maybeDisconnectAdapter() {

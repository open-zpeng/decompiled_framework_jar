...
public abstract class InCallService extends Service {
    ...
    public static abstract class VideoCall {
        ...
        public abstract synchronized void destroy();
    ...
    private final class InCallServiceBinder extends IInCallService.Stub {
        ...
        public synchronized void setInCallAdapter(IInCallAdapter inCallAdapter) {
            InCallService.this.mHandler.obtainMessage(1, inCallAdapter).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void addCall(ParcelableCall call) {
            InCallService.this.mHandler.obtainMessage(2, call).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void updateCall(ParcelableCall call) {
            InCallService.this.mHandler.obtainMessage(3, call).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void setPostDial(String callId, String remaining) {
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void setPostDialWait(String callId, String remaining) {
        ...
        @Override // com.android.internal.telecom.IInCallService
        public synchronized void onCallAudioStateChanged(CallAudioState callAudioState) {
            InCallService.this.mHandler.obtainMessage(5, callAudioState).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void bringToForeground(boolean showDialpad) {
            InCallService.this.mHandler.obtainMessage(6, showDialpad ? 1 : 0, 0).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void onCanAddCallChanged(boolean canAddCall) {
        ...
        @Override // com.android.internal.telecom.IInCallService
        public synchronized void onConnectionEvent(String callId, String event, Bundle extras) {
            SomeArgs args = SomeArgs.obtain();
            args.arg1 = callId;
            args.arg2 = event;
            args.arg3 = extras;
        ...
        @Override // com.android.internal.telecom.IInCallService
        public synchronized void onRttUpgradeRequest(String callId, int id) {
            InCallService.this.mHandler.obtainMessage(10, id, 0, callId).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void onRttInitiationFailure(String callId, int reason) {
            InCallService.this.mHandler.obtainMessage(11, reason, 0, callId).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void onHandoverFailed(String callId, int error) {
            InCallService.this.mHandler.obtainMessage(12, error, 0, callId).sendToTarget();
        }

        @Override // com.android.internal.telecom.IInCallService
        public synchronized void onHandoverComplete(String callId) {
    ...
    @Deprecated
    public final synchronized AudioState getAudioState() {
        if (this.mPhone == null) {
            return null;
        }
    ...
    @Deprecated
    public synchronized void onAudioStateChanged(AudioState audioState) {
    }

...
public abstract class TimedEvent<T> {
    private protected abstract synchronized T getKey();

    private protected abstract synchronized long getTime();

    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized <T> Map<T, Double> averageTimings(Collection<? extends TimedEvent<T>> events) {

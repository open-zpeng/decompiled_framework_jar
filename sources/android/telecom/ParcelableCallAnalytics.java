...
public class ParcelableCallAnalytics implements Parcelable {
    ...
    public static final class VideoEvent implements Parcelable {
        ...
        public synchronized VideoEvent(int eventName, long timeSinceLastEvent, int videoState) {
            this.mEventName = eventName;
            this.mTimeSinceLastEvent = timeSinceLastEvent;
            this.mVideoState = videoState;
        }

        synchronized VideoEvent(Parcel in) {
            this.mEventName = in.readInt();
            this.mTimeSinceLastEvent = in.readLong();
            this.mVideoState = in.readInt();
        }

        public synchronized int getEventName() {
            return this.mEventName;
        }

        public synchronized long getTimeSinceLastEvent() {
    ...
    public static final class AnalyticsEvent implements Parcelable {
        ...
        synchronized AnalyticsEvent(Parcel in) {
            this.mEventName = in.readInt();
            this.mTimeSinceLastEvent = in.readLong();
        }
    ...
    public static final class EventTiming implements Parcelable {
        ...
        private synchronized EventTiming(Parcel in) {
    ...
    public synchronized void setIsVideoCall(boolean isVideoCall) {
        this.isVideoCall = isVideoCall;
    }

    public synchronized void setVideoEvents(List<VideoEvent> videoEvents) {
    ...
    public synchronized List<VideoEvent> getVideoEvents() {
    ...
    private static synchronized void writeBooleanAsByte(Parcel out, boolean b) {
        out.writeByte(b ? (byte) 1 : (byte) 0);
    }

    private static synchronized boolean readByteAsBoolean(Parcel in) {

...
public class VideoProfile implements Parcelable {
    ...
    private static synchronized boolean hasState(int videoState, int state) {
    ...
    public static final class CameraCapabilities implements Parcelable {
        ...
        private protected CameraCapabilities(int width, int height, boolean zoomSupported, float maxZoom) {
            this.mWidth = width;
            this.mHeight = height;

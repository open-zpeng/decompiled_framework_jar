...
public class DefaultDialerManager {
    ...
    public static boolean setDefaultDialerApplication(Context context, String packageName, int user) {
        ...
        try {
            ...
            ((RoleManager) context.getSystemService(RoleManager.class)).addRoleHolderAsUser(RoleManager.ROLE_DIALER, packageName, 0, UserHandle.of(user), AsyncTask.THREAD_POOL_EXECUTOR, callback);

...
public final class PhoneAccount implements Parcelable {
    ...
    public static class Builder {
        ...
        public synchronized Builder setLabel(CharSequence label) {
            this.mLabel = label;
            return this;
        }
        ...
        public synchronized Builder setIsEnabled(boolean isEnabled) {
            this.mIsEnabled = isEnabled;
            return this;
        }

        public synchronized Builder setGroupId(String groupId) {
            if (groupId != null) {
        ...
        public synchronized Builder setSupportedAudioRoutes(int routes) {
    ...
    private synchronized PhoneAccount(PhoneAccountHandle account, Uri address, Uri subscriptionAddress, int capabilities, Icon icon, int highlightColor, CharSequence label, CharSequence shortDescription, List<String> supportedUriSchemes, Bundle extras, int supportedAudioRoutes, boolean isEnabled, String groupId) {
    ...
    public synchronized boolean hasAudioRoutes(int routes) {
    ...
    private synchronized PhoneAccount(Parcel in) {
        if (in.readInt() > 0) {
    ...
    private synchronized String capabilitiesToString() {
        StringBuilder sb = new StringBuilder();
    ...
    private synchronized String audioRoutesToString() {
        StringBuilder sb = new StringBuilder();
        if (hasAudioRoutes(2)) {
            sb.append("B");
        }

...
public abstract class Connection extends Conferenceable {
    ...
    public static synchronized String capabilitiesToStringShort(int capabilities) {
        return capabilitiesToStringInternal(capabilities, false);
    }

    private static synchronized String capabilitiesToStringInternal(int capabilities, boolean isLong) {
    ...
    public static synchronized String propertiesToStringShort(int properties) {
        return propertiesToStringInternal(properties, false);
    }

    private static synchronized String propertiesToStringInternal(int properties, boolean isLong) {
        StringBuilder builder = new StringBuilder();
        builder.append("[");
        if (isLong) {
    ...
    public static abstract class Listener {
        public synchronized void onStateChanged(Connection c, int state) {
        }

        public synchronized void onAddressChanged(Connection c, Uri newAddress, int presentation) {
        }

        public synchronized void onCallerDisplayNameChanged(Connection c, String callerDisplayName, int presentation) {
        }

        public synchronized void onVideoStateChanged(Connection c, int videoState) {
        }

        public synchronized void onDisconnected(Connection c, DisconnectCause disconnectCause) {
        }

        public synchronized void onPostDialWait(Connection c, String remaining) {
        }

        public synchronized void onPostDialChar(Connection c, char nextChar) {
        }

        public synchronized void onRingbackRequested(Connection c, boolean ringback) {
        }

        public synchronized void onDestroyed(Connection c) {
        }

        public synchronized void onConnectionCapabilitiesChanged(Connection c, int capabilities) {
        }

        public synchronized void onConnectionPropertiesChanged(Connection c, int properties) {
        }

        public synchronized void onSupportedAudioRoutesChanged(Connection c, int supportedAudioRoutes) {
        }

        public synchronized void onVideoProviderChanged(Connection c, VideoProvider videoProvider) {
        }

        public synchronized void onAudioModeIsVoipChanged(Connection c, boolean isVoip) {
        }

        public synchronized void onStatusHintsChanged(Connection c, StatusHints statusHints) {
        }

        public synchronized void onConferenceablesChanged(Connection c, List<Conferenceable> conferenceables) {
        }

        public synchronized void onConferenceChanged(Connection c, Conference conference) {
        }

        public synchronized void onConferenceParticipantsChanged(Connection c, List<ConferenceParticipant> participants) {
        }

        public synchronized void onConferenceStarted() {
        }

        public synchronized void onConferenceMergeFailed(Connection c) {
        }

        public synchronized void onExtrasChanged(Connection c, Bundle extras) {
        }

        public synchronized void onExtrasRemoved(Connection c, List<String> keys) {
        }

        public synchronized void onConnectionEvent(Connection c, String event, Bundle extras) {
        }

        public synchronized void onConferenceSupportedChanged(Connection c, boolean isConferenceSupported) {
        }

        public synchronized void onAudioRouteChanged(Connection c, int audioRoute, String bluetoothAddress) {
        }

        public synchronized void onRttInitiationSuccess(Connection c) {
        }

        public synchronized void onRttInitiationFailure(Connection c, int reason) {
        }

        public synchronized void onRttSessionRemotelyTerminated(Connection c) {
        }

        public synchronized void onRemoteRttRequest(Connection c) {
        }

        public synchronized void onPhoneAccountChanged(Connection c, PhoneAccountHandle pHandle) {
        }
    }
    ...
    public static final class RttTextStream {
        ...
        public synchronized RttTextStream(ParcelFileDescriptor toInCall, ParcelFileDescriptor fromInCall) {
        ...
        public synchronized ParcelFileDescriptor getFdFromInCall() {
            return this.mFdFromInCall;
        }

        public synchronized ParcelFileDescriptor getFdToInCall() {
    ...
    public static final class RttModifyStatus {
        ...
        private synchronized RttModifyStatus() {
        }
    }
    ...
    public static abstract class VideoProvider {
        ...
        private final class VideoProviderBinder extends IVideoProvider.Stub {
            ...
            public synchronized void addVideoCallback(IBinder videoCallbackBinder) {
                VideoProvider.this.mMessageHandler.obtainMessage(1, videoCallbackBinder).sendToTarget();
            }

            @Override // com.android.internal.telecom.IVideoProvider
            public synchronized void removeVideoCallback(IBinder videoCallbackBinder) {
                VideoProvider.this.mMessageHandler.obtainMessage(12, videoCallbackBinder).sendToTarget();
            }

            @Override // com.android.internal.telecom.IVideoProvider
            public synchronized void setCamera(String cameraId, String callingPackageName, int targetSdkVersion) {
        ...
        private protected VideoProvider(Looper looper) {
            this.mVideoCallbacks = new ConcurrentHashMap<>(8, 0.9f, 1);
            this.mBinder = new VideoProviderBinder();
            this.mMessageHandler = new VideoProviderHandler(looper);
        }

        public final synchronized IVideoProvider getInterface() {
            return this.mBinder;
        }

        public synchronized void onSetCamera(String cameraId, String callingPackageName, int callingUid, int callingPid, int targetSdkVersion) {
        }
        ...
        public synchronized void changeCallDataUsage(long dataUsage) {
        ...
        public static synchronized String sessionEventToString(int event) {
            switch (event) {
                case 1:
    ...
    public final synchronized int getVideoState() {
    ...
    public final synchronized long getConnectTimeMillis() {
        return this.mConnectTimeMillis;
    }

    public final synchronized long getConnectElapsedTimeMillis() {
    ...
    public final synchronized Connection addConnectionListener(Listener l) {
        this.mListeners.add(l);
        return this;
    }

    public final synchronized Connection removeConnectionListener(Listener l) {
        if (l != null) {
    ...
    public synchronized void setTelecomCallId(String callId) {
    ...
    public final synchronized int getSupportedAudioRoutes() {
    ...
    public final synchronized void setSupportedAudioRoutes(int supportedAudioRoutes) {
    ...
    public final synchronized void setConnectTimeMillis(long connectTimeMillis) {
        this.mConnectTimeMillis = connectTimeMillis;
    }

    public final synchronized void setConnectionStartElapsedRealTime(long connectElapsedTimeMillis) {
    ...
    public final synchronized void setConnectionService(ConnectionService connectionService) {
        checkImmutable();
    ...
    public final synchronized void unsetConnectionService(ConnectionService connectionService) {
    ...
    public final synchronized ConnectionService getConnectionService() {
        return this.mConnectionService;
    }

    public final synchronized boolean setConference(Conference conference) {
        checkImmutable();
    ...
    public final synchronized void resetConference() {
        if (this.mConference != null) {
    ...
    public final void sendRttInitiationFailure(final int reason) {
        this.mListeners.forEach(new Consumer() { // from class: android.telecom.-$$Lambda$Connection$noXZvls4rxmO_SOjgkFMZLLrfSg
            @Override // java.util.function.Consumer
            public final void accept(Object obj) {
                ((Connection.Listener) obj).onRttInitiationFailure(Connection.this, reason);
            }
        });
    }
    ...
    public synchronized void onDisconnectConferenceParticipant(Uri endpoint) {
    }
    ...
    public synchronized void onSilence() {
    }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized String toLogSafePhoneNumber(String number) {
        if (number == null) {
            return "";
        }
        if (PII_DEBUG) {
    ...
    private static class FailureSignalingConnection extends Connection {
        ...
        public synchronized FailureSignalingConnection(DisconnectCause disconnectCause) {
        ...
        public synchronized void checkImmutable() {
            if (this.mImmutable) {
    ...
    private final synchronized void fireConferenceChanged() {
        for (Listener l : this.mListeners) {
    ...
    protected final synchronized void notifyConferenceMergeFailed() {
        for (Listener l : this.mListeners) {
            l.onConferenceMergeFailed(this);
        }
    }

    protected final synchronized void updateConferenceParticipants(List<ConferenceParticipant> conferenceParticipants) {
        for (Listener l : this.mListeners) {
            l.onConferenceParticipantsChanged(this, conferenceParticipants);
        }
    }

    protected synchronized void notifyConferenceStarted() {
        for (Listener l : this.mListeners) {
            l.onConferenceStarted();
        }
    }

    protected synchronized void notifyConferenceSupportedChanged(boolean isConferenceSupported) {
        for (Listener l : this.mListeners) {
            l.onConferenceSupportedChanged(this, isConferenceSupported);
        }
    }

    public synchronized void notifyPhoneAccountChanged(PhoneAccountHandle pHandle) {
        for (Listener l : this.mListeners) {
            l.onPhoneAccountChanged(this, pHandle);
        }
    }

    public synchronized void setPhoneAccountHandle(PhoneAccountHandle phoneAccountHandle) {
    ...
    public synchronized PhoneAccountHandle getPhoneAccountHandle() {

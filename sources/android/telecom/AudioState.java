...
public class AudioState implements Parcelable {
    ...
    public protected final boolean isMuted;
    public protected final int route;
    public protected final int supportedRouteMask;
    ...
    private static synchronized void listAppend(StringBuffer buffer, String str) {
        if (buffer.length() > 0) {
            buffer.append(", ");
        }
        buffer.append(str);

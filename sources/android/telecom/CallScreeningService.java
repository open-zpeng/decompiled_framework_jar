...
public abstract class CallScreeningService extends Service {
    ...
    private final class CallScreeningBinder extends ICallScreeningService.Stub {
        ...
        public synchronized void screenCall(ICallScreeningAdapter adapter, ParcelableCall call) {
    ...
    public static class CallResponse {
        ...
        private synchronized CallResponse(boolean shouldDisallowCall, boolean shouldRejectCall, boolean shouldSkipCallLog, boolean shouldSkipNotification) {

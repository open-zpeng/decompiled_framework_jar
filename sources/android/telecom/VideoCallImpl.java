...
public class VideoCallImpl extends InCallService.VideoCall {
    ...
    public final class VideoCallListenerBinder extends IVideoCallback.Stub {
        ...
        public synchronized void receiveSessionModifyRequest(VideoProfile videoProfile) {
        ...
        @Override // com.android.internal.telecom.IVideoCallback
        public synchronized void receiveSessionModifyResponse(int status, VideoProfile requestProfile, VideoProfile responseProfile) {
            if (VideoCallImpl.this.mHandler == null) {
                return;
            }
        ...
        @Override // com.android.internal.telecom.IVideoCallback
        public synchronized void handleCallSessionEvent(int event) {
            if (VideoCallImpl.this.mHandler == null) {
                return;
            }
        ...
        @Override // com.android.internal.telecom.IVideoCallback
        public synchronized void changePeerDimensions(int width, int height) {
            if (VideoCallImpl.this.mHandler == null) {
                return;
            }
            SomeArgs args = SomeArgs.obtain();
        ...
        @Override // com.android.internal.telecom.IVideoCallback
        public synchronized void changeVideoQuality(int videoQuality) {
            if (VideoCallImpl.this.mHandler == null) {
                return;
            }
        ...
        @Override // com.android.internal.telecom.IVideoCallback
        public synchronized void changeCameraCapabilities(VideoProfile.CameraCapabilities cameraCapabilities) {
            if (VideoCallImpl.this.mHandler == null) {
                return;
            }
    ...
    public synchronized VideoCallImpl(IVideoProvider videoProvider, String callingPackageName, int targetSdkVersion) throws RemoteException {
    ...
    @VisibleForTesting
    public synchronized void setTargetSdkVersion(int sdkVersion) {
    ...
    public synchronized void setVideoState(int videoState) {

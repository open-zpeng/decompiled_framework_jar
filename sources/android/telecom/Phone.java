...
public final class Phone {
    ...
    public synchronized Phone(InCallAdapter adapter, String callingPackage, int targetSdkVersion) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalSetPostDialWait(String telecomId, String remaining) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized Call internalGetCallByTelecomId(String telecomId) {
        return this.mCallByTelecomCallId.get(telecomId);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalBringToForeground(boolean showDialpad) {
        fireBringToForeground(showDialpad);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalSetCanAddCall(boolean canAddCall) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalOnConnectionEvent(String telecomId, String event, Bundle extras) {
        Call call = this.mCallByTelecomCallId.get(telecomId);
        if (call != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalOnRttUpgradeRequest(String callId, int requestId) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalOnRttInitiationFailure(String callId, int reason) {
        Call call = this.mCallByTelecomCallId.get(callId);
        if (call != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalOnHandoverFailed(String callId, int error) {
        Call call = this.mCallByTelecomCallId.get(callId);
        if (call != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized void internalOnHandoverComplete(String callId) {
        Call call = this.mCallByTelecomCallId.get(callId);
        if (call != null) {
    ...
    private protected final void setProximitySensorOff(boolean screenOnImmediately) {
    ...
    private synchronized void fireCallAudioStateChanged(CallAudioState audioState) {
        for (Listener listener : this.mListeners) {
    ...
    private synchronized void fireBringToForeground(boolean showDialpad) {
        for (Listener listener : this.mListeners) {
            listener.onBringToForeground(this, showDialpad);
        }
    }

    private synchronized void fireCanAddCallChanged(boolean canAddCall) {
        for (Listener listener : this.mListeners) {

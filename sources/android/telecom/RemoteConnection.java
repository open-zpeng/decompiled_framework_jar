...
public final class RemoteConnection {
    ...
    public static abstract class Callback {
        ...
        public synchronized void onRttInitiationSuccess(RemoteConnection connection) {
        }

        public synchronized void onRttInitiationFailure(RemoteConnection connection, int reason) {
        }

        public synchronized void onRttSessionRemotelyTerminated(RemoteConnection connection) {
        }

        public synchronized void onRemoteRttRequest(RemoteConnection connection) {
        }
    }
    ...
    public static class VideoProvider {
        ...
        public synchronized VideoProvider(IVideoProvider videoProviderBinder, String callingPackage, int targetSdkVersion) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized RemoteConnection(String id, IConnectionService connectionService, ConnectionRequest request) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized RemoteConnection(String callId, IConnectionService connectionService, ParcelableConnection connection, String callingPackage, int targetSdkVersion) {
        this.mCallbackRecords = Collections.newSetFromMap(new ConcurrentHashMap(8, 0.9f, 1));
        this.mConferenceableConnections = new ArrayList();
        this.mUnmodifiableconferenceableConnections = Collections.unmodifiableList(this.mConferenceableConnections);
        this.mState = 1;
    ...
    synchronized RemoteConnection(DisconnectCause disconnectCause) {
        this.mCallbackRecords = Collections.newSetFromMap(new ConcurrentHashMap(8, 0.9f, 1));
        this.mConferenceableConnections = new ArrayList();
        this.mUnmodifiableconferenceableConnections = Collections.unmodifiableList(this.mConferenceableConnections);
        this.mState = 1;
    ...
    public synchronized void answer(int videoState) {
        try {
            if (this.mConnected) {
    ...
    public synchronized void startRtt(Connection.RttTextStream rttTextStream) {
        try {
            if (this.mConnected) {
    ...
    public synchronized void stopRtt() {
        try {
            if (this.mConnected) {
    ...
    public synchronized void sendRttUpgradeResponse(Connection.RttTextStream rttTextStream) {
        try {
            if (this.mConnected) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized IConnectionService getConnectionService() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setDisconnected(final DisconnectCause disconnectCause) {
        if (this.mState != 6) {
            this.mState = 6;
            this.mDisconnectCause = disconnectCause;
            for (CallbackRecord record : this.mCallbackRecords) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setRingbackRequested(final boolean ringback) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setConnectionCapabilities(final int connectionCapabilities) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setConnectionProperties(final int connectionProperties) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setPostDialWait(final String remainingDigits) {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onPostDialChar(final char nextChar) {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setVideoState(final int videoState) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setVideoProvider(final VideoProvider videoProvider) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setIsVoipAudioMode(final boolean isVoip) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setStatusHints(final StatusHints statusHints) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setAddress(final Uri address, final int presentation) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setCallerDisplayName(final String callerDisplayName, final int presentation) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setConferenceableConnections(List<RemoteConnection> conferenceableConnections) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setConference(final RemoteConference conference) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void putExtras(Bundle extras) {
        if (extras == null) {
            return;
        }
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void removeExtras(List<String> keys) {
    ...
    private synchronized void notifyExtrasChanged() {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onConnectionEvent(final String event, final Bundle extras) {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onRttInitiationSuccess() {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onRttInitiationFailure(final int reason) {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onRttSessionRemotelyTerminated() {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onRemoteRttRequest() {
        for (CallbackRecord record : this.mCallbackRecords) {
            final Callback callback = record.getCallback();
    ...
    public static synchronized RemoteConnection failure(DisconnectCause disconnectCause) {
    ...
    public static final class CallbackRecord extends Callback {
        ...
        public synchronized CallbackRecord(Callback callback, Handler handler) {

...
public class ParcelableRttCall implements Parcelable {
    ...
    public synchronized ParcelableRttCall(int rttMode, ParcelFileDescriptor transmitStream, ParcelFileDescriptor receiveStream) {
        this.mRttMode = rttMode;
        this.mTransmitStream = transmitStream;
        this.mReceiveStream = receiveStream;
    }

    protected synchronized ParcelableRttCall(Parcel in) {
    ...
    public synchronized int getRttMode() {
        return this.mRttMode;
    }

    public synchronized ParcelFileDescriptor getReceiveStream() {
        return this.mReceiveStream;
    }

    public synchronized ParcelFileDescriptor getTransmitStream() {

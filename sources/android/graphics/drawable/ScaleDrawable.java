...
public class ScaleDrawable extends DrawableWrapper {
    ...
    public protected ScaleState mState;
    private final Rect mTmpRect;

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized ScaleDrawable() {
    ...
    private static synchronized float getPercent(TypedArray a, int index, float defaultValue) {
    ...
    public void onBoundsChange(Rect bounds) {
        ...
        Gravity.apply(this.mState.mGravity, w2, h2, bounds, r, layoutDirection);
        if (w2 > 0 && h2 > 0) {
    ...
    public static final class ScaleState extends DrawableWrapper.DrawableWrapperState {
        ...
        synchronized ScaleState(ScaleState orig, Resources res) {
            super(orig, res);
    ...
    private synchronized ScaleDrawable(ScaleState state, Resources res) {
        super(state, res);

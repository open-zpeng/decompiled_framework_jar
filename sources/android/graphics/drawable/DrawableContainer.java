...
public class DrawableContainer extends Drawable implements Drawable.Callback {
    ...
    public protected DrawableContainerState mDrawableContainerState;
    private long mEnterAnimationEnd;
    private long mExitAnimationEnd;
    private boolean mHasAlpha;
    private Rect mHotspotBounds;
    public protected Drawable mLastDrawable;
    ...
    private synchronized void initializeDrawableForDisplay(Drawable d) {
    ...
    synchronized void animate(boolean schedule) {
        this.mHasAlpha = true;
        long now = SystemClock.uptimeMillis();
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public final synchronized void updateDensity(Resources res) {
    ...
    synchronized DrawableContainerState cloneConstantState() {
        return this.mDrawableContainerState;
    }
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public private protected Rect mConstantPadding;
        boolean mConstantSize;
        int mConstantWidth;
        int mDensity;
        boolean mDither;
        SparseArray<Drawable.ConstantState> mDrawableFutures;
        public private protected Drawable[] mDrawables;
        int mEnterFadeDuration;
        int mExitFadeDuration;
        public private protected boolean mHasColorFilter;
        ...
        public private DrawableContainerState(DrawableContainerState orig, DrawableContainer owner, Resources res) {
            this.mDensity = 160;
            ...
            if (orig != null) {
                ...
                if (origDf != null) {
                    this.mDrawableFutures = origDf.m57clone();
                } else {
        ...
        private synchronized void createAllFutures() {
        ...
        private synchronized Drawable prepareDrawable(Drawable child) {
        ...
        final synchronized boolean setLayoutDirection(int layoutDirection, int currentIndex) {
            boolean changed = false;
            int N = this.mNumChildren;
        ...
        final synchronized void updateDensity(Resources res) {
            if (res != null) {
                this.mSourceRes = res;
        ...
        final synchronized void applyTheme(Resources.Theme theme) {
            if (theme != null) {
                createAllFutures();
                int N = this.mNumChildren;
                Drawable[] drawables = this.mDrawables;
        ...
        final synchronized void clearMutated() {
            int N = this.mNumChildren;
            Drawable[] drawables = this.mDrawables;
            for (int i = 0; i < N; i++) {
                if (drawables[i] != null) {
    ...
    public static class BlockInvalidateCallback implements Drawable.Callback {
        ...
        private synchronized BlockInvalidateCallback() {
        }

        public synchronized BlockInvalidateCallback wrap(Drawable.Callback callback) {
            this.mCallback = callback;
            return this;
        }

        public synchronized Drawable.Callback unwrap() {

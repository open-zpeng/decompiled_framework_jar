...
public class BitmapDrawable extends Drawable {
    ...
    public BitmapDrawable(Resources res, String filepath) {
        ...
        try {
            ...
            bitmap = ImageDecoder.decodeBitmap(ImageDecoder.createSource(res, stream), new ImageDecoder.OnHeaderDecodedListener() { // from class: android.graphics.drawable.-$$Lambda$BitmapDrawable$23eAuhdkgEf5MIRJC-rMNbn4Pyg

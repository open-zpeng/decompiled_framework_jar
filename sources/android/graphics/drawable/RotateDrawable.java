...
public class RotateDrawable extends DrawableWrapper {
    ...
    public protected RotateState mState;
    ...
    public static final class RotateState extends DrawableWrapper.DrawableWrapperState {
        ...
        synchronized RotateState(RotateState orig, Resources res) {
            super(orig, res);
    ...
    private synchronized RotateDrawable(RotateState state, Resources res) {
        super(state, res);
        this.mState = state;
    }
}

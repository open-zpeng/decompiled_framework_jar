...
public class RippleForeground extends RippleComponent {
    ...
    public synchronized RippleForeground(RippleDrawable owner, Rect bounds, float startingX, float startingY, boolean forceSoftware) {
        super(owner, bounds);
        this.mTargetX = 0.0f;
        this.mTargetY = 0.0f;
        this.mOpacity = 0.0f;
    ...
    private synchronized void drawSoftware(Canvas c, Paint p) {
    ...
    private synchronized void startPending(DisplayListCanvas c) {
    ...
    public synchronized void pruneHwFinished() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void pruneSwFinished() {
    ...
    private synchronized void drawHardware(DisplayListCanvas c, Paint p) {
        startPending(c);
        pruneHwFinished();
    ...
    public synchronized boolean hasFinishedExit() {
        return this.mHasFinishedExit;
    }

    private synchronized long computeFadeOutDelay() {
    ...
    private synchronized void startSoftwareEnter() {
    ...
    private synchronized void startSoftwareExit() {
    ...
    private synchronized void startHardwareEnter() {
    ...
    private synchronized void startHardwareExit() {
    ...
    private synchronized void clampStartingPosition() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void onAnimationPropertyChanged() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void clearHwProps() {
    ...
    private synchronized void switchToUiThreadAnimation() {

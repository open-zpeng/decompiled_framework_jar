...
public class AnimatedStateListDrawable extends StateListDrawable {
    ...
    public protected AnimatedStateListState mState;
    ...
    private synchronized boolean selectTransition(int toIndex) {
        int fromIndex;
        int transitionIndex;
    ...
    public static abstract class Transition {
        public abstract synchronized void start();

        public abstract synchronized void stop();

        private synchronized Transition() {
        }
    ...
    public static class AnimatableTransition extends Transition {
        ...
        public synchronized AnimatableTransition(Animatable a) {
            super();
            this.mA = a;
        }
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        public synchronized AnimationDrawableTransition(AnimationDrawable ad, boolean reversed, boolean hasReversibleFlag) {
            super();
    ...
    public static class AnimatedVectorDrawableTransition extends Transition {
        ...
        public synchronized AnimatedVectorDrawableTransition(AnimatedVectorDrawable avd, boolean reversed, boolean hasReversibleFlag) {
            super();
            this.mAvd = avd;
    ...
    private synchronized int parseTransition(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        int type;
    ...
    private synchronized int parseItem(Resources r, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        int type;
    ...
    public synchronized AnimatedStateListState cloneConstantState() {
    ...
    public static class AnimatedStateListState extends StateListDrawable.StateListState {
        ...
        int[] mAnimThemeAttrs;
        public private protected SparseIntArray mStateIds;
        public private protected LongSparseLongArray mTransitions;

        synchronized AnimatedStateListState(AnimatedStateListState orig, AnimatedStateListDrawable owner, Resources res) {
        ...
        synchronized void mutate() {
            ...
            this.mStateIds = this.mStateIds.m59clone();
        }

        synchronized int addTransition(int fromId, int toId, Drawable anim, boolean reversible) {
        ...
        synchronized int addStateSet(int[] stateSet, Drawable drawable, int id) {
            int index = super.addStateSet(stateSet, drawable);
            this.mStateIds.put(index, id);
            return index;
        }

        synchronized int indexOfKeyframe(int[] stateSet) {
        ...
        synchronized int getKeyframeIdAt(int index) {
            if (index < 0) {
                return 0;
            }
        ...
        synchronized int indexOfTransition(int fromId, int toId) {
            long keyFromTo = generateTransitionKey(fromId, toId);
            return (int) this.mTransitions.get(keyFromTo, -1L);
        }

        synchronized boolean isTransitionReversed(int fromId, int toId) {
            long keyFromTo = generateTransitionKey(fromId, toId);
            return (this.mTransitions.get(keyFromTo, -1L) & 4294967296L) != 0;
        }

        synchronized boolean transitionHasReversibleFlag(int fromId, int toId) {
            long keyFromTo = generateTransitionKey(fromId, toId);
        ...
        private static synchronized long generateTransitionKey(int fromId, int toId) {
    ...
    private synchronized AnimatedStateListDrawable(AnimatedStateListState state, Resources res) {
        super(null);
        this.mTransitionToIndex = -1;
        this.mTransitionFromIndex = -1;
    ...
    private static class FrameInterpolator implements TimeInterpolator {
        ...
        public synchronized FrameInterpolator(AnimationDrawable d, boolean reversed) {
            updateFrames(d, reversed);
        }

        public synchronized int updateFrames(AnimationDrawable d, boolean reversed) {

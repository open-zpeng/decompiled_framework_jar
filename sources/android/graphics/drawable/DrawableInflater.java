...
public final class DrawableInflater {
    ...
    public protected final ClassLoader mClassLoader;
    private final Resources mRes;

    public static synchronized Drawable loadDrawable(Context context, int id) {
        return loadDrawable(context.getResources(), context.getTheme(), id);
    }

    public static synchronized Drawable loadDrawable(Resources resources, Resources.Theme theme, int id) {
        return resources.getDrawable(id, theme);
    }

    public synchronized DrawableInflater(Resources res, ClassLoader classLoader) {
        this.mRes = res;
        this.mClassLoader = classLoader;
    }

    public synchronized Drawable inflateFromXml(String name, XmlPullParser parser, AttributeSet attrs, Resources.Theme theme) throws XmlPullParserException, IOException {
        return inflateFromXmlForDensity(name, parser, attrs, 0, theme);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized Drawable inflateFromXmlForDensity(String name, XmlPullParser parser, AttributeSet attrs, int density, Resources.Theme theme) throws XmlPullParserException, IOException {
    ...
    private synchronized Drawable inflateFromTag(String name) {
        char c;
    ...
    private synchronized Drawable inflateFromClass(String className) {

...
public class AnimationDrawable extends DrawableContainer implements Runnable, Animatable {
    ...
    public protected int mCurFrame;
    ...
    private synchronized void nextFrame(boolean unschedule) {
    ...
    private synchronized void setFrame(int frame, boolean unschedule, boolean animate) {
    ...
    public synchronized AnimationState cloneConstantState() {
    ...
    public static final class AnimationState extends DrawableContainer.DrawableContainerState {
        ...
        synchronized AnimationState(AnimationState orig, AnimationDrawable owner, Resources res) {
        ...
        public synchronized void addFrame(Drawable dr, int dur) {
    ...
    private synchronized AnimationDrawable(AnimationState state, Resources res) {
        this.mCurFrame = 0;

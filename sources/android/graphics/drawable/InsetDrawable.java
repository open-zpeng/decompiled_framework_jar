...
public class InsetDrawable extends DrawableWrapper {
    ...
    public static final class InsetState extends DrawableWrapper.DrawableWrapperState {
        ...
        InsetState(InsetState orig, Resources res) {
            super(orig, res);
            if (orig != null) {
                this.mInsetLeft = orig.mInsetLeft.m23clone();
                this.mInsetTop = orig.mInsetTop.m23clone();
                this.mInsetRight = orig.mInsetRight.m23clone();
                this.mInsetBottom = orig.mInsetBottom.m23clone();

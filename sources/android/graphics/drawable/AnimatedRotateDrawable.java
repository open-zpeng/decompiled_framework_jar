...
public class AnimatedRotateDrawable extends DrawableWrapper implements Animatable {
    ...
    public synchronized AnimatedRotateDrawable() {
    ...
    private protected void setFramesCount(int framesCount) {
        this.mState.mFramesCount = framesCount;
        this.mIncrement = 360.0f / this.mState.mFramesCount;
    }

    private protected void setFramesDuration(int framesDuration) {
    ...
    public static final class AnimatedRotateState extends DrawableWrapper.DrawableWrapperState {
        ...
        public synchronized AnimatedRotateState(AnimatedRotateState orig, Resources res) {
            super(orig, res);
    ...
    private synchronized AnimatedRotateDrawable(AnimatedRotateState state, Resources res) {
        super(state, res);

...
public class LevelListDrawable extends DrawableContainer {
    ...
    public synchronized LevelListState cloneConstantState() {
    ...
    public static final class LevelListState extends DrawableContainer.DrawableContainerState {
        ...
        synchronized LevelListState(LevelListState orig, LevelListDrawable owner, Resources res) {
        ...
        public synchronized void addLevel(int low, int high, Drawable drawable) {
            int pos = addChild(drawable);
            this.mLows[pos] = low;
            this.mHighs[pos] = high;
        }

        public synchronized int indexOfLevel(int level) {
            int[] lows = this.mLows;
    ...
    private synchronized LevelListDrawable(LevelListState state, Resources res) {

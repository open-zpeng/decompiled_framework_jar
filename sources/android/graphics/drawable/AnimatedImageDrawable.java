...
public class AnimatedImageDrawable extends Drawable implements Animatable2 {
    ...
    @Deprecated
    private protected static final int LOOP_INFINITE = -1;
    ...
    @Deprecated
    private protected void setLoopCount(int loopCount) {
    ...
    @Deprecated
    private protected int getLoopCount(int loopCount) {
    ...
    public synchronized AnimatedImageDrawable(long nativeImageDecoder, ImageDecoder decoder, int width, int height, int srcDensity, int dstDensity, Rect cropRect, InputStream inputStream, AssetFileDescriptor afd) throws IOException {
        this.mAnimationCallbacks = null;
        ...
        this.mState = new State(nCreate(nativeImageDecoder, decoder, width2, height2, cropRect), inputStream, afd);
        long nativeSize = nNativeByteSize(this.mState.mNativePtr);
        NativeAllocationRegistry registry = new NativeAllocationRegistry(AnimatedImageDrawable.class.getClassLoader(), nGetNativeFinalizer(), nativeSize);
    ...
    private synchronized void postOnAnimationStart() {
        if (this.mAnimationCallbacks == null) {
            return;
        }
    ...
    public static /* synthetic */ void lambda$postOnAnimationStart$1(AnimatedImageDrawable animatedImageDrawable) {
        if (animatedImageDrawable.mAnimationCallbacks != null) {
    ...
    private synchronized void postOnAnimationEnd() {
        if (this.mAnimationCallbacks == null) {
            return;
        }
    ...
    public protected void onAnimationEnd() {
        if (this.mAnimationCallbacks != null) {

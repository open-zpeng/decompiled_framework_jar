...
public class ClipDrawable extends DrawableWrapper {
    ...
    public protected ClipState mState;
    private final Rect mTmpRect;

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized ClipDrawable() {
    ...
    public static final class ClipState extends DrawableWrapper.DrawableWrapperState {
        ...
        synchronized ClipState(ClipState orig, Resources res) {
            super(orig, res);
            this.mOrientation = 1;
            this.mGravity = 3;
            if (orig != null) {
    ...
    private synchronized ClipDrawable(ClipState state, Resources res) {
        super(state, res);

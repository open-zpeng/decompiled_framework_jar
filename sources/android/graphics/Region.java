...
public class Region implements Parcelable {
    ...
    private protected long mNativeRegion;
    ...
    public enum Op {
        ...
        private protected final int nativeInt;
    ...
    public static synchronized Region obtain() {
        Region region = sPool.acquire();
        return region != null ? region : new Region();
    }

    public static synchronized Region obtain(Region other) {
    ...
    public synchronized Region(long ni) {
        if (ni == 0) {
            throw new RuntimeException();
        }
    ...
    public protected Region(long ni, int dummy) {
        this(ni);
    }

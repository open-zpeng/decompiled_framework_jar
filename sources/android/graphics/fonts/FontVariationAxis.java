...
public final class FontVariationAxis {
    public protected final float mStyleValue;
    public protected final int mTag;
    ...
    public synchronized int getOpenTypeTagValue() {
        return this.mTag;
    }
    ...
    private static synchronized boolean isValidTag(String tagString) {
        return tagString != null && TAG_PATTERN.matcher(tagString).matches();
    }

    private static synchronized boolean isValidValueFormat(String valueString) {
        return valueString != null && STYLE_VALUE_PATTERN.matcher(valueString).matches();
    }

    public static synchronized int makeTag(String tagString) {

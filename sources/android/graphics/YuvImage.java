...
public class YuvImage {
    ...
    synchronized int[] calculateOffsets(int left, int top) {
        if (this.mFormat == 17) {
    ...
    private synchronized int[] calculateStrides(int width, int format) {
        if (format == 17) {
    ...
    private synchronized void adjustRectangle(Rect rect) {

...
public class Canvas extends BaseCanvas {
    ...
    private protected static final int CLIP_SAVE_FLAG = 2;
    private protected static final int CLIP_TO_LAYER_SAVE_FLAG = 16;
    private protected static final int FULL_COLOR_LAYER_SAVE_FLAG = 8;
    private protected static final int HAS_ALPHA_LAYER_SAVE_FLAG = 4;
    private protected static final int MATRIX_SAVE_FLAG = 1;
    ...
    private static class NoImagePreloadHolder {
        public static final NativeAllocationRegistry sRegistry = new NativeAllocationRegistry(Canvas.class.getClassLoader(), Canvas.access$000(), (long) Canvas.NATIVE_ALLOCATION_SIZE);
    ...
    private static synchronized void checkValidSaveFlags(int saveFlags) {
    ...
    public synchronized int saveUnclippedLayer(int left, int top, int right, int bottom) {
        return nSaveLayer(this.mNativeCanvasWrapper, left, top, right, bottom, 0L, 0);
    }

    public int saveLayer(float left, float top, float right, float bottom, Paint paint, int saveFlags) {
        checkValidSaveFlags(saveFlags);
        return nSaveLayer(this.mNativeCanvasWrapper, left, top, right, bottom, paint != null ? paint.getNativeInstance() : 0L, 31);
    }
    ...
    private static synchronized void checkValidClipOp(Region.Op op) {
    ...
    public synchronized boolean clipRectUnion(Rect rect) {
    ...
    @Deprecated
    private protected boolean clipRegion(Region region, Region.Op op) {
        return false;
    }

    @Deprecated
    private protected boolean clipRegion(Region region) {
        return false;
    }
    ...
    public static synchronized void setCompatibilityVersion(int apiLevel) {

...
public class BitmapFactory {
    ...
    public protected static native Bitmap nativeDecodeAsset(long j, Rect rect, Options options);

    public protected static native Bitmap nativeDecodeByteArray(byte[] bArr, int i, int i2, Options options);

    public protected static native Bitmap nativeDecodeFileDescriptor(FileDescriptor fileDescriptor, Rect rect, Options options);

    public protected static native Bitmap nativeDecodeStream(InputStream inputStream, byte[] bArr, Rect rect, Options options);
    ...
    public static class Options {
        ...
        public static synchronized void validate(Options opts) {
            if (opts == null) {
                return;
            }
    ...
    private static synchronized void setDensityFromOptions(Bitmap outputBitmap, Options opts) {
    ...
    private static synchronized Bitmap decodeStreamInternal(InputStream is, Rect outPadding, Options opts) {

...
public class Path {
    private protected boolean isSimplePath;
    private Direction mLastDirection;
    public final long mNativePath;
    private protected Region rects;
    ...
    private synchronized void detectSimplePath(float left, float top, float right, float bottom, Direction dir) {
    ...
    public final synchronized long readOnlyNI() {
        return this.mNativePath;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public final synchronized long mutateNI() {
        this.isSimplePath = false;
        return this.mNativePath;
    }

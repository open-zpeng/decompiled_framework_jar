...
public class LeakyTypefaceStorage {
    ...
    public static synchronized void writeTypefaceToParcel(Typeface typeface, Parcel parcel) {
        int id;
    ...
    public static synchronized Typeface readTypefaceFromParcel(Parcel parcel) {
        Typeface typeface;

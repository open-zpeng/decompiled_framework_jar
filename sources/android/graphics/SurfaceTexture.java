...
public class SurfaceTexture {
    ...
    public protected long mFrameAvailableListener;
    private boolean mIsSingleBuffered;
    public protected Handler mOnFrameAvailableHandler;
    public protected long mProducer;
    public protected long mSurfaceTexture;
    ...
    public protected native int nativeDetachFromGLContext();
    ...
    public protected static void postEventFromNative(WeakReference<SurfaceTexture> weakSelf) {
        Handler handler;

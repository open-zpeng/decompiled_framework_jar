...
public final class BitmapRegionDecoder {
    ...
    public protected static native BitmapRegionDecoder nativeNewInstance(byte[] bArr, int i, int i2, boolean z);
    ...
    public protected BitmapRegionDecoder(long decoder) {

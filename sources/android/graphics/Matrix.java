...
public class Matrix {
    private protected static final Matrix IDENTITY_MATRIX = new Matrix() { // from class: android.graphics.Matrix.1
        void oops() {
    ...
    private protected final long native_instance;
    ...
    private static class NoImagePreloadHolder {
        public static final NativeAllocationRegistry sRegistry = new NativeAllocationRegistry(Matrix.class.getClassLoader(), Matrix.access$000(), (long) Matrix.NATIVE_ALLOCATION_SIZE);
    ...
    private static synchronized void checkPointArrays(float[] src, int srcIndex, float[] dst, int dstIndex, int pointCount) {
    ...
    public synchronized void toShortString(StringBuilder sb) {
    ...
    public final synchronized long ni() {

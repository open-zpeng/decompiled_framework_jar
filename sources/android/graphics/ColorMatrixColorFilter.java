...
public class ColorMatrixColorFilter extends ColorFilter {
    public protected final ColorMatrix mMatrix = new ColorMatrix();
    ...
    private protected void setColorMatrix(ColorMatrix matrix) {
    ...
    private protected void setColorMatrixArray(float[] array) {
        discardNativeInstance();
        if (array == null) {
            this.mMatrix.reset();

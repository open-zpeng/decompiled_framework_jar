...
public class AccountManager {
    ...
    private protected AccountManager(Context context, IAccountManager service, Handler handler) {
        this.mContext = context;
        this.mService = service;
        this.mMainHandler = handler;
    }

    public static synchronized Bundle sanitizeResult(Bundle result) {
    ...
    public synchronized AuthenticatorDescription[] getAuthenticatorTypesAsUser(int userId) {
        try {
    ...
    public synchronized Account[] getAccountsAsUser(int userId) {
        try {
    ...
    public synchronized Account[] getAccountsForPackage(String packageName, int uid) {
        try {
    ...
    private protected Account[] getAccountsByTypeAsUser(String type, UserHandle userHandle) {
        try {
    ...
    public synchronized void updateAppPermission(Account account, String authTokenType, int uid, boolean value) {
        try {
    ...
    public synchronized AccountManagerFuture<String> getAuthTokenLabel(final String accountType, final String authTokenType, AccountManagerCallback<String> callback, Handler handler) {
        if (accountType == null) {
    ...
    @Deprecated
    public synchronized AccountManagerFuture<Boolean> removeAccountAsUser(final Account account, AccountManagerCallback<Boolean> callback, Handler handler, final UserHandle userHandle) {
        if (account == null) {
            throw new IllegalArgumentException("account is null");
        }
        if (userHandle == null) {
    ...
    public synchronized AccountManagerFuture<Bundle> removeAccountAsUser(final Account account, final Activity activity, AccountManagerCallback<Bundle> callback, Handler handler, final UserHandle userHandle) {
        if (account == null) {
            throw new IllegalArgumentException("account is null");
        }
        if (userHandle == null) {
    ...
    public void logoutExplicitly() {
        Account[] accounts = getAccountsByType(ACCOUNT_TYPE_XP_VEHICLE);
        Log.i(TAG, "logoutExplicitly accounts.length=" + accounts.length);
        for (Account account : accounts) {
            try {
                Log.i(TAG, "logoutExplicitly account=" + account.name);
                removeAccountExplicitly(account);
            } catch (Exception e) {
                Log.e(TAG, "logoutExplicitly err=" + e.getMessage());
            }
        }
    }
    ...
    public synchronized AccountManagerFuture<Bundle> addAccountAsUser(final String accountType, final String authTokenType, final String[] requiredFeatures, Bundle addAccountOptions, final Activity activity, AccountManagerCallback<Bundle> callback, Handler handler, final UserHandle userHandle) {
        if (accountType != null) {
            if (userHandle != null) {
                final Bundle optionsIn = new Bundle();
                if (addAccountOptions != null) {
    ...
    public synchronized void addSharedAccountsFromParentUser(UserHandle parentUser, UserHandle user) {
        try {
    ...
    public synchronized AccountManagerFuture<Boolean> copyAccountToUser(final Account account, final UserHandle fromUser, final UserHandle toUser, AccountManagerCallback<Boolean> callback, Handler handler) {
        if (account == null) {
            throw new IllegalArgumentException("account is null");
        }
    ...
    public synchronized boolean removeSharedAccount(Account account, UserHandle user) {
        try {
    ...
    public synchronized Account[] getSharedAccounts(UserHandle user) {
        try {
    ...
    private protected AccountManagerFuture<Bundle> confirmCredentialsAsUser(final Account account, final Bundle options, final Activity activity, AccountManagerCallback<Bundle> callback, Handler handler, UserHandle userHandle) {
        if (account == null) {
            throw new IllegalArgumentException("account is null");
        }
    ...
    public synchronized boolean someUserHasAccount(Account account) {
        try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void ensureNotOnMainThread() {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void postToHandler(Handler handler, final AccountManagerCallback<Bundle> callback, final AccountManagerFuture<Bundle> future) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void postToHandler(Handler handler, final OnAccountsUpdateListener listener, Account[] accounts) {
    ...
    public abstract class AmsTask extends FutureTask<Bundle> implements AccountManagerFuture<Bundle> {
        public private protected final Activity mActivity;
        final AccountManagerCallback<Bundle> mCallback;
        public private protected final Handler mHandler;
        public private protected final IAccountManagerResponse mResponse;

        public abstract synchronized void doWork() throws RemoteException;
        ...
        public final synchronized AccountManagerFuture<Bundle> start() {
            try {
                doWork();
            } catch (RemoteException e) {
                setException(e);
        ...
        private synchronized Bundle internalGetResult(Long timeout, TimeUnit unit) throws OperationCanceledException, IOException, AuthenticatorException {
            if (!isDone()) {
        ...
        private class Response extends IAccountManagerResponse.Stub {
            ...
            public synchronized void onResult(Bundle bundle) {
                if (bundle == null) {
    ...
    public abstract class BaseFutureTask<T> extends FutureTask<T> {
        ...
        public abstract synchronized T bundleToResult(Bundle bundle) throws AuthenticatorException;
        ...
        protected synchronized void postRunnableToHandler(Runnable runnable) {
    ...
    private abstract class Future2Task<T> extends BaseFutureTask<T> implements AccountManagerFuture<T> {
        ...
        public synchronized Future2Task<T> start() {
            startTask();
            return this;
        }

        private synchronized T internalGetResult(Long timeout, TimeUnit unit) throws OperationCanceledException, IOException, AuthenticatorException {
            if (!isDone()) {
                AccountManager.this.ensureNotOnMainThread();
            }
            try {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized Exception convertErrorToException(int code, String message) {
        if (code == 3) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void getAccountByTypeAndFeatures(final String accountType, final String[] features, AccountManagerCallback<Bundle> callback, Handler handler) {
    ...
    private class GetAuthTokenByTypeAndFeaturesTask extends AmsTask implements AccountManagerCallback<Bundle> {
        ...
        public private protected final String mAuthTokenType;
        final String[] mFeatures;
        volatile AccountManagerFuture<Bundle> mFuture;
        public private protected final Bundle mLoginOptions;
        public private protected final AccountManagerCallback<Bundle> mMyCallback;
        ...
        @Override // android.accounts.AccountManagerCallback
        public synchronized void run(AccountManagerFuture<Bundle> future) {
            try {
                Bundle result = future.getResult();
    ...
    public synchronized boolean hasAccountAccess(Account account, String packageName, UserHandle userHandle) {
        try {
    ...
    public synchronized IntentSender createRequestAccountAccessIntentSenderAsUser(Account account, String packageName, UserHandle userHandle) {
        try {

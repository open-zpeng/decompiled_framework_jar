...
public class GrantCredentialsPermissionActivity extends Activity implements View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            final TextView authTokenTypeView = (TextView) findViewById(16908820);
            ...
            findViewById(16908800).setOnClickListener(this);
            findViewById(16908936).setOnClickListener(this);
            LinearLayout packagesListView = (LinearLayout) findViewById(16909253);
            ...
            ((TextView) findViewById(16908750)).setText(this.mAccount.name);
            ((TextView) findViewById(16908753)).setText(accountTypeLabel);
    ...
    private synchronized String getAccountLabel(Account account) {
    ...
    private synchronized View newPackageView(String packageLabel) {
        View view = this.mInflater.inflate(R.layout.permissions_package_list_item, (ViewGroup) null);
        ((TextView) view.findViewById(16909252)).setText(packageLabel);
        return view;
    }
    ...
    public final synchronized void setAccountAuthenticatorResult(Bundle result) {

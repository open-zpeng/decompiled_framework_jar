...
public class AccountManagerResponse implements Parcelable {
    ...
    public synchronized AccountManagerResponse(IAccountManagerResponse response) {
        this.mResponse = response;
    }

    public synchronized AccountManagerResponse(Parcel parcel) {
        this.mResponse = IAccountManagerResponse.Stub.asInterface(parcel.readStrongBinder());
    }

    public synchronized void onResult(Bundle result) {
        try {

...
public final class PrinterInfo implements Parcelable {
    ...
    private synchronized PrinterInfo(PrinterId printerId, String name, int status, int iconResourceId, boolean hasCustomPrinterIcon, String description, PendingIntent infoIntent, PrinterCapabilitiesInfo capabilities, int customPrinterIconGen) {
        this.mId = printerId;
        this.mName = name;
        this.mStatus = status;
    ...
    public synchronized boolean getHasCustomPrinterIcon() {
    ...
    public synchronized PendingIntent getInfoIntent() {
    ...
    public static synchronized PrinterId checkPrinterId(PrinterId printerId) {
        return (PrinterId) Preconditions.checkNotNull(printerId, "printerId cannot be null.");
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized int checkStatus(int status) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized String checkName(String name) {
        return (String) Preconditions.checkStringNotEmpty(name, "name cannot be empty.");
    }

    private synchronized PrinterInfo(Parcel parcel) {
    ...
    public int hashCode() {
        int result = (31 * 1) + this.mId.hashCode();
        return (31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * ((31 * result) + this.mName.hashCode())) + this.mStatus)) + (this.mDescription != null ? this.mDescription.hashCode() : 0))) + (this.mCapabilities != null ? this.mCapabilities.hashCode() : 0))) + this.mIconResourceId)) + (this.mHasCustomPrinterIcon ? 1 : 0))) + this.mCustomPrinterIconGen)) + (this.mInfoIntent != null ? this.mInfoIntent.hashCode() : 0);
    }

    public synchronized boolean equalsIgnoringStatus(PrinterInfo other) {
    ...
    public static final class Builder {
        ...
        public synchronized Builder incCustomPrinterIconGen() {

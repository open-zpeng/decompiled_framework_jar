        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    onCancelPrintJobResult(_arg0, _arg12);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                    int _arg13 = data.readInt();
                    onSetPrintJobStateResult(_arg0, _arg13);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                    int _arg14 = data.readInt();
                    onSetPrintJobTagResult(_arg0, _arg14);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    onGetPrintJobInfoResult(_arg02, _arg15);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                        _arg03 = Icon.CREATOR.createFromParcel(data);
                    } else {
                        _arg03 = null;
                    }
                    int _arg16 = data.readInt();
                    onGetCustomPrinterIconResult(_arg03, _arg16);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);

...
public final class PrintAttributes implements Parcelable {
    ...
    private synchronized PrintAttributes(Parcel parcel) {
    ...
    public synchronized void setMediaSize(MediaSize mediaSize) {
    ...
    public synchronized void setMinMargins(Margins margins) {
    ...
    public synchronized void setColorMode(int colorMode) {
    ...
    public synchronized void setDuplexMode(int duplexMode) {
        enforceValidDuplexMode(duplexMode);
        this.mDuplexMode = duplexMode;
    }

    public synchronized PrintAttributes asPortrait() {
        if (isPortrait()) {
            return this;
        }
    ...
    public synchronized PrintAttributes asLandscape() {
        if (!isPortrait()) {
            return this;
        }
        PrintAttributes attributes = new PrintAttributes();
    ...
    public int hashCode() {
        ...
        return (31 * ((31 * ((31 * ((31 * result) + this.mDuplexMode)) + (this.mMinMargins == null ? 0 : this.mMinMargins.hashCode()))) + (this.mMediaSize == null ? 0 : this.mMediaSize.hashCode()))) + (this.mResolution != null ? this.mResolution.hashCode() : 0);
    }
    ...
    public synchronized void copyFrom(PrintAttributes other) {
    ...
    public static final class MediaSize {
        ...
        public synchronized MediaSize(String id, String packageName, int labelResId, int widthMils, int heightMils) {
        ...
        public static synchronized ArraySet<MediaSize> getAllPredefinedSizes() {
        ...
        public synchronized MediaSize(String id, String label, String packageName, int widthMils, int heightMils, int labelResId) {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static synchronized MediaSize createFromParcel(Parcel parcel) {
        ...
        public static synchronized MediaSize getStandardMediaSizeById(String id) {
    ...
    public static final class Resolution {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static synchronized Resolution createFromParcel(Parcel parcel) {
    ...
    public static final class Margins {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static synchronized Margins createFromParcel(Parcel parcel) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized String colorModeToString(int colorMode) {
        switch (colorMode) {
            case 1:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized String duplexModeToString(int duplexMode) {
        if (duplexMode != 4) {
            switch (duplexMode) {
                case 1:
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized void enforceValidColorMode(int colorMode) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized void enforceValidDuplexMode(int duplexMode) {

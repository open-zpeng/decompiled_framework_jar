...
public interface IPrintServicesChangeListener extends IInterface {
    synchronized void onPrintServicesChanged() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IPrintServicesChangeListener {
        ...
        public static synchronized IPrintServicesChangeListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IPrintServicesChangeListener {
            ...
            public synchronized void onPrintServicesChanged() throws RemoteException {

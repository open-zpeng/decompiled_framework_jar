...
public class SettingsValidators {
    ...
    public interface Validator {
        synchronized boolean validate(String str);
    }
    ...
    public static final class DiscreteValueValidator implements Validator {
        ...
        public synchronized DiscreteValueValidator(String[] values) {
            this.mValues = values;
        }

        @Override // android.provider.SettingsValidators.Validator
        public synchronized boolean validate(String value) {
    ...
    public static final class InclusiveIntegerRangeValidator implements Validator {
        ...
        public synchronized InclusiveIntegerRangeValidator(int min, int max) {
            this.mMin = min;
            this.mMax = max;
        }
    ...
    public static final class InclusiveFloatRangeValidator implements Validator {
        ...
        public synchronized InclusiveFloatRangeValidator(float min, float max) {
            this.mMin = min;
            this.mMax = max;
        }
    ...
    public static final class ComponentNameListValidator implements Validator {
        ...
        public synchronized ComponentNameListValidator(String separator) {
    ...
    public static final class PackageNameListValidator implements Validator {
        ...
        public synchronized PackageNameListValidator(String separator) {
            this.mSeparator = separator;
        }

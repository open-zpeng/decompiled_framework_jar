...
public class ContactsInternal {
    ...
    private synchronized ContactsInternal() {
    }
    ...
    public static synchronized void startQuickContactWithErrorToastForUser(Context context, Intent intent, UserHandle user) {
        try {
    ...
    private static synchronized boolean maybeStartManagedQuickContact(Context context, Intent originalIntent) {
        long parseId;

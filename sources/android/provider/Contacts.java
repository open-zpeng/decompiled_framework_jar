...
public class Contacts {
    ...
    public static final class People implements BaseColumns, PeopleColumns, PhonesColumns, PresenceColumns {
        ...
        @Deprecated
        public static synchronized long tryGetMyContactsGroupId(ContentResolver resolver) {
        ...
        private static synchronized Bitmap loadPlaceholderPhoto(int placeholderImageResource, Context context, BitmapFactory.Options options) {
        ...
        public static final class ContactMethods implements BaseColumns, ContactMethodsColumns, PeopleColumns {
            ...
            private synchronized ContactMethods() {
            }
        }
        ...
        public static class Extensions implements BaseColumns, ExtensionsColumns {
            ...
            @Deprecated
            private synchronized Extensions() {
            }
        }
    }
    ...
    public static final class ContactMethods implements BaseColumns, ContactMethodsColumns, PeopleColumns {
        ...
        @Deprecated
        public static synchronized String lookupProviderNameFromId(int protocol) {
            switch (protocol) {
                case 0:
    ...
    public static final class Presence implements BaseColumns, PresenceColumns, PeopleColumns {
        ...
        @Deprecated
        public static final synchronized int getPresenceIconResourceId(int status) {
            switch (status) {
                case 1:
                    return 17301609;
                case 2:
        ...
        @Deprecated
        public static final synchronized void setPresenceIcon(ImageView icon, int serverStatus) {
    ...
    public static final class Organizations implements BaseColumns, OrganizationColumns {
        ...
        private synchronized Organizations() {
        }

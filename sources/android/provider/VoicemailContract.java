...
public class VoicemailContract {
    ...
    private synchronized VoicemailContract() {
    }
    ...
    public static final class Voicemails implements BaseColumns, OpenableColumns {
        ...
        private synchronized Voicemails() {
        }
        ...
        public static synchronized Uri insert(Context context, Voicemail voicemail) {
            ContentResolver contentResolver = context.getContentResolver();
            ContentValues contentValues = getContentValues(voicemail);
            return contentResolver.insert(buildSourceUri(context.getPackageName()), contentValues);
        }

        public static synchronized int insert(Context context, List<Voicemail> voicemails) {
            ContentResolver contentResolver = context.getContentResolver();
        ...
        private static synchronized ContentValues getContentValues(Voicemail voicemail) {

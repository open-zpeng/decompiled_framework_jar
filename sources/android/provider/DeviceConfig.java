...
public final class DeviceConfig {
    ...
    public interface WindowManager {
        ...
        public static final String KEY_SYSTEM_GESTURE_EXCLUSION_LOG_DEBOUNCE_MILLIS = "system_gesture_exclusion_log_debounce_millis";
    }
                    ...
                    if (namespace.equals(sListeners.valueAt(i).first)) {
                        ...
                        sListeners.valueAt(i).second.execute(new Runnable() { // from class: android.provider.DeviceConfig.2
                            ...
                            public void run() {
                                ...
                                ((OnPropertiesChangedListener) DeviceConfig.sListeners.keyAt(j)).onPropertiesChanged(new Properties(namespace, propertyMap));
                            }
                        });
                    }
                }

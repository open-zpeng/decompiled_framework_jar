...
public final class MetadataReader {
    ...
    private synchronized MetadataReader() {
    }
    ...
    public static synchronized boolean isSupportedMimeType(String mimeType) {
        return JPG_MIME_TYPE.equals(mimeType) || JPEG_MIME_TYPE.equals(mimeType);
    }

    public static synchronized void getMetadata(Bundle metadata, InputStream stream, String mimeType, String[] tags) throws IOException {
    ...
    private static synchronized Bundle getExifData(InputStream stream, String[] tags) throws IOException {
        String data;
        if (tags == null) {

...
public final class Settings {
    ...
    private protected static final String ACTION_TRUSTED_CREDENTIALS_USER = "com.android.settings.TRUSTED_CREDENTIALS_USER";
    public static final String ACTION_USAGE_ACCESS_SETTINGS = "android.settings.USAGE_ACCESS_SETTINGS";
    private protected static final String ACTION_USER_DICTIONARY_INSERT = "com.android.settings.USER_DICTIONARY_INSERT";
    ...
    private protected static final String EXTRA_APP_UID = "app_uid";
    ...
    public static synchronized void setInSystemServer() {
        synchronized (sInSystemServerLock) {
            sInSystemServer = true;
        }
    }

    public static synchronized boolean isInSystemServer() {
        boolean z;
        synchronized (sInSystemServerLock) {
            z = sInSystemServer;
        }
    ...
    public static final class GenerationTracker {
        ...
        public synchronized GenerationTracker(MemoryIntArray array, int index, int generation, Runnable errorHandler) {
            this.mArray = array;
            this.mIndex = index;
        ...
        public synchronized boolean isGenerationChanged() {
        ...
        private synchronized int readCurrentGeneration() {
            try {
    ...
    public static final class ContentProviderHolder {
        @GuardedBy("mLock")
        public protected IContentProvider mContentProvider;
        private final Object mLock = new Object();
        @GuardedBy("mLock")
        private final Uri mUri;

        public synchronized ContentProviderHolder(Uri uri) {
            this.mUri = uri;
        }

        public synchronized IContentProvider getProvider(ContentResolver contentResolver) {
        ...
        public synchronized void clearProviderForTest() {
            synchronized (this.mLock) {
    ...
    public static class NameValueCache {
        ...
        public protected final ContentProviderHolder mProviderHolder;
        private final Uri mUri;
        private final HashMap<String, String> mValues = new HashMap<>();

        public synchronized NameValueCache(Uri uri, String getCommand, String setCommand, ContentProviderHolder providerHolder) {
            this.mUri = uri;
        ...
        public synchronized boolean putStringForUser(ContentResolver cr, String name, String value, String tag, boolean makeDefault, int userHandle) {
            try {
        ...
        /* JADX WARN: Can't wrap try/catch for region: R(14:1|(1:3)(1:173)|4|(1:14)|27|(8:29|(2:73|74)|31|6a|41|(1:72)(3:45|46|47)|48|(3:50|(2:c4|67)|71))|75|(2:76|77)|(6:(3:130|131|(13:133|134|135|136|137|138|139|140|141|142|143|86|(3:88|(1:90)|91)(6:92|(1:94)(1:111)|95|1d8|(1:105)|106)))|83|84|85|86|(0)(0))|79|80|81|82|(2:(0)|(1:154))) */
        ...
        /* JADX WARN: Removed duplicated region for block: B:123:0x01a0 A[Catch: RemoteException -> 0x01c7, all -> 0x023d, TRY_ENTER, TRY_LEAVE, TryCatch #8 {RemoteException -> 0x01c7, blocks: (B:123:0x01a0, B:129:0x01c9, B:131:0x01cf, B:134:0x01d8, B:146:0x01f4), top: B:167:0x019e }] */
        /* JADX WARN: Removed duplicated region for block: B:129:0x01c9 A[Catch: RemoteException -> 0x01c7, all -> 0x023d, TRY_ENTER, TryCatch #8 {RemoteException -> 0x01c7, blocks: (B:123:0x01a0, B:129:0x01c9, B:131:0x01cf, B:134:0x01d8, B:146:0x01f4), top: B:167:0x019e }] */
        ...
        */
        private protected java.lang.String getStringForUser(android.content.ContentResolver r23, java.lang.String r24, int r25) {
            /*
        ...
        public synchronized void clearGenerationTrackerForTest() {
    ...
    public static final class System extends NameValueTable {
        ...
        @Deprecated
        private protected static final String AIRPLANE_MODE_TOGGLEABLE_RADIOS = "airplane_mode_toggleable_radios";
        ...
        private protected static final String APPEND_FOR_LAST_AUDIBLE = "_last_audible";
        @Deprecated
        ...
        @Deprecated
        private protected static final String CAR_DOCK_SOUND = "car_dock_sound";
        @Deprecated
        private protected static final String CAR_UNDOCK_SOUND = "car_undock_sound";
        public static final Map<String, String> CLONE_FROM_PARENT_ON_VALUE;
        public protected static final Set<String> CLONE_TO_MANAGED_PROFILE;
        @Deprecated
        ...
        @Deprecated
        private protected static final String DESK_DOCK_SOUND = "desk_dock_sound";
        @Deprecated
        private protected static final String DESK_UNDOCK_SOUND = "desk_undock_sound";
        @Deprecated
        ...
        @Deprecated
        private protected static final String DOCK_SOUNDS_ENABLED = "dock_sounds_enabled";
        ...
        private protected static final String HEARING_AID = "hearing_aid";
        public static final SettingsValidators.Validator HEARING_AID_VALIDATOR;
        private protected static final String HIDE_ROTATION_LOCK_TOGGLE_FOR_ACCESSIBILITY = "hide_rotation_lock_toggle_for_accessibility";
        ...
        private protected static final String LOCKSCREEN_SOUNDS_ENABLED = "lockscreen_sounds_enabled";
        ...
        @Deprecated
        private protected static final String LOCK_SOUND = "lock_sound";
        ...
        private protected static final String MASTER_MONO = "master_mono";
        ...
        public protected static final HashSet<String> MOVED_TO_GLOBAL;
        public protected static final HashSet<String> MOVED_TO_SECURE_THEN_GLOBAL;
        ...
        private protected static final String NOTIFICATION_LIGHT_PULSE = "notification_light_pulse";
        ...
        private protected static final String POINTER_LOCATION = "pointer_location";
        public static final SettingsValidators.Validator POINTER_LOCATION_VALIDATOR;
        private protected static final String POINTER_SPEED = "pointer_speed";
        ...
        private protected static final Set<String> PRIVATE_SETTINGS;
        private protected static final Set<String> PUBLIC_SETTINGS;
        @Deprecated
        ...
        private protected static final String SCREEN_AUTO_BRIGHTNESS_ADJ = "screen_auto_brightness_adj";
        ...
        public static final String SCREEN_DUTYCYCLE = "screen_dutycycle";
        public static final String SCREEN_OFF_TIMEOUT = "screen_off_timeout";
        private static final SettingsValidators.Validator SCREEN_OFF_TIMEOUT_VALIDATOR;
        @Deprecated
        public static final String SETTINGS_CLASSNAME = "settings_classname";
        private protected static final String[] SETTINGS_TO_BACKUP;
        ...
        private protected static final String SHOW_TOUCHES = "show_touches";
        ...
        private protected static final String TTY_MODE = "tty_mode";
        public static final SettingsValidators.Validator TTY_MODE_VALIDATOR;
        @Deprecated
        private protected static final String UNLOCK_SOUND = "unlock_sound";
        @Deprecated
        ...
        private protected static final Map<String, SettingsValidators.Validator> VALIDATORS;
        public static final String VIBRATE_INPUT_DEVICES = "vibrate_input_devices";
        private static final SettingsValidators.Validator VIBRATE_INPUT_DEVICES_VALIDATOR;
        private protected static final String VIBRATE_IN_SILENT = "vibrate_in_silent";
        ...
        private protected static final String VOLUME_ALARM = "volume_alarm";
        private protected static final String VOLUME_BLUETOOTH_SCO = "volume_bluetooth_sco";
        public static final String VOLUME_MASTER = "volume_master";
        private protected static final String VOLUME_MUSIC = "volume_music";
        private protected static final String VOLUME_NOTIFICATION = "volume_notification";
        private protected static final String VOLUME_RING = "volume_ring";
        private protected static final String[] VOLUME_SETTINGS;
        public static final String[] VOLUME_SETTINGS_INT;
        private protected static final String VOLUME_SYSTEM = "volume_system";
        private protected static final String VOLUME_VOICE = "volume_voice";
        @Deprecated
        ...
        public protected static final ContentProviderHolder sProviderHolder = new ContentProviderHolder(CONTENT_URI);
        public protected static final NameValueCache sNameValueCache = new NameValueCache(CONTENT_URI, Settings.CALL_METHOD_GET_SYSTEM, Settings.CALL_METHOD_PUT_SYSTEM, sProviderHolder);
        public protected static final HashSet<String> MOVED_TO_SECURE = new HashSet<>(30);
        ...
        static {
            ...
            WALLPAPER_ACTIVITY_VALIDATOR = new SettingsValidators.Validator() { // from class: android.provider.Settings.System.4
                private static final int MAX_LENGTH = 1000;
            ...
            DATE_FORMAT_VALIDATOR = new SettingsValidators.Validator() { // from class: android.provider.Settings.System.5
                @Override // android.provider.SettingsValidators.Validator
                public boolean validate(String value) {
                    try {
            ...
            EGG_MODE_VALIDATOR = new SettingsValidators.Validator() { // from class: android.provider.Settings.System.6
                @Override // android.provider.SettingsValidators.Validator
                public boolean validate(String value) {
                    try {
        ...
        public static synchronized void getMovedToGlobalSettings(Set<String> outKeySet) {
            outKeySet.addAll(MOVED_TO_GLOBAL);
            outKeySet.addAll(MOVED_TO_SECURE_THEN_GLOBAL);
        }

        public static synchronized void getMovedToSecureSettings(Set<String> outKeySet) {
            outKeySet.addAll(MOVED_TO_SECURE);
        }

        public static synchronized void getNonLegacyMovedKeys(HashSet<String> outKeySet) {
            outKeySet.addAll(MOVED_TO_GLOBAL);
        }

        public static synchronized void clearProviderForTest() {
        ...
        private protected static int getIntForUser(ContentResolver cr, String name, int userHandle) throws SettingNotFoundException {
            String v = getStringForUser(cr, name, userHandle);
            try {
                return Integer.parseInt(v);
            } catch (NumberFormatException e) {
        ...
        public static synchronized long getLongForUser(ContentResolver cr, String name, long def, int userHandle) {
        ...
        public static synchronized long getLongForUser(ContentResolver cr, String name, int userHandle) throws SettingNotFoundException {
            String valString = getStringForUser(cr, name, userHandle);
            try {
        ...
        public static synchronized boolean putLongForUser(ContentResolver cr, String name, long value, int userHandle) {
        ...
        public static synchronized float getFloatForUser(ContentResolver cr, String name, float def, int userHandle) {
            String v = getStringForUser(cr, name, userHandle);
            if (v == null) {
                return def;
            }
        ...
        public static synchronized float getFloatForUser(ContentResolver cr, String name, int userHandle) throws SettingNotFoundException {
            String v = getStringForUser(cr, name, userHandle);
            if (v == null) {
                throw new SettingNotFoundException(name);
            }
        ...
        public static synchronized boolean putFloatForUser(ContentResolver cr, String name, float value, int userHandle) {
        ...
        public static synchronized void adjustConfigurationForUser(ContentResolver cr, Configuration outConfig, int userHandle, boolean updateSettingsIfEmpty) {
        ...
        public static synchronized void clearConfiguration(Configuration inoutConfig) {
        ...
        public static synchronized boolean putConfigurationForUser(ContentResolver cr, Configuration config, int userHandle) {
        ...
        public static synchronized boolean hasInterestingConfigurationChanges(int changes) {
        ...
        @Deprecated
        public static synchronized boolean getShowGTalkServiceStatusForUser(ContentResolver cr, int userHandle) {
        ...
        @Deprecated
        public static synchronized void setShowGTalkServiceStatusForUser(ContentResolver cr, boolean flag, int userHandle) {
            putIntForUser(cr, SHOW_GTALK_SERVICE_STATUS, flag ? 1 : 0, userHandle);
        }

        public static synchronized void getCloneToManagedProfileSettings(Set<String> outKeySet) {
            outKeySet.addAll(CLONE_TO_MANAGED_PROFILE);
        }

        public static synchronized void getCloneFromParentOnValueSettings(Map<String, String> outMap) {
    ...
    public static final class Secure extends NameValueTable {
        ...
        private protected static final String ACCESSIBILITY_AUTOCLICK_ENABLED = "accessibility_autoclick_enabled";
        ...
        private protected static final String ACCESSIBILITY_CAPTIONING_TYPEFACE = "accessibility_captioning_typeface";
        ...
        private protected static final String ACCESSIBILITY_DISPLAY_DALTONIZER = "accessibility_display_daltonizer";
        private protected static final String ACCESSIBILITY_DISPLAY_DALTONIZER_ENABLED = "accessibility_display_daltonizer_enabled";
        ...
        private protected static final String ACCESSIBILITY_LARGE_POINTER_ICON = "accessibility_large_pointer_icon";
        ...
        public static final String ANDROID_ID = "android_id";
        private protected static final String ANR_SHOW_BACKGROUND = "anr_show_background";
        private protected static final String ASSISTANT = "assistant";
        ...
        private protected static final String BACKUP_AUTO_RESTORE = "backup_auto_restore";
        private protected static final String BACKUP_ENABLED = "backup_enabled";
        ...
        private protected static final String BACKUP_PROVISIONED = "backup_provisioned";
        private protected static final String BACKUP_TRANSPORT = "backup_transport";
        @Deprecated
        public static final String BLUETOOTH_ON = "bluetooth_on";
        private static final SettingsValidators.Validator BLUETOOTH_ON_VALIDATOR;
        ...
        @Deprecated
        public static final String DEVICE_PROVISIONED = "device_provisioned";
        private protected static final String DIALER_DEFAULT_APPLICATION = "dialer_default_application";
        ...
        private protected static final String DOZE_ENABLED = "doze_enabled";
        ...
        @Deprecated
        private protected static final String ENABLED_NOTIFICATION_LISTENERS = "enabled_notification_listeners";
        ...
        private protected static final String ENABLED_PRINT_SERVICES = "enabled_print_services";
        ...
        private protected static final String IMMERSIVE_MODE_CONFIRMATIONS = "immersive_mode_confirmations";
        ...
        private protected static final String INCALL_POWER_BUTTON_BEHAVIOR = "incall_power_button_behavior";
        ...
        @Deprecated
        public static final String LOCK_PATTERN_VISIBLE = "lock_pattern_visible_pattern";
        private protected static final String LOCK_SCREEN_ALLOW_PRIVATE_NOTIFICATIONS = "lock_screen_allow_private_notifications";
        ...
        private protected static final String LOCK_SCREEN_LOCK_AFTER_TIMEOUT = "lock_screen_lock_after_timeout";
        @Deprecated
        public static final String LOCK_SCREEN_OWNER_INFO = "lock_screen_owner_info";
        @Deprecated
        private protected static final String LOCK_SCREEN_OWNER_INFO_ENABLED = "lock_screen_owner_info_enabled";
        private protected static final String LOCK_SCREEN_SHOW_NOTIFICATIONS = "lock_screen_show_notifications";
        @Deprecated
        public static final String LOCK_SCREEN_STICKY_APPWIDGET = "lock_screen_sticky_appwidget";
        public static final String LOCK_TO_APP_EXIT_LOCKED = "lock_to_app_exit_locked";
        @Deprecated
        public static final String LOGGING_ID = "logging_id";
        private protected static final String LONG_PRESS_TIMEOUT = "long_press_timeout";
        ...
        @Deprecated
        public static final String NETWORK_PREFERENCE = "network_preference";
        private protected static final String NFC_PAYMENT_DEFAULT_COMPONENT = "nfc_payment_default_component";
        ...
        private protected static final String PACKAGE_VERIFIER_USER_CONSENT = "package_verifier_user_consent";
        ...
        private protected static final String SELECTED_SPELL_CHECKER = "selected_spell_checker";
        private protected static final String SELECTED_SPELL_CHECKER_SUBTYPE = "selected_spell_checker_subtype";
        ...
        private protected static final String SMS_DEFAULT_APPLICATION = "sms_default_application";
        ...
        private protected static final String VOICE_RECOGNITION_SERVICE = "voice_recognition_service";
        ...
        public protected static final ContentProviderHolder sProviderHolder = new ContentProviderHolder(CONTENT_URI);
        public protected static final NameValueCache sNameValueCache = new NameValueCache(CONTENT_URI, Settings.CALL_METHOD_GET_SECURE, Settings.CALL_METHOD_PUT_SECURE, sProviderHolder);
        private static ILockSettings sLockSettings = null;
        public protected static final HashSet<String> MOVED_TO_LOCK_SETTINGS = new HashSet<>(3);
        ...
        private protected static boolean putStringForUser(ContentResolver resolver, String name, String value, String tag, boolean makeDefault, int userHandle) {
        ...
        public static synchronized void resetToDefaultsAsUser(ContentResolver resolver, String tag, int mode, int userHandle) {
            try {
                Bundle arg = new Bundle();
                arg.putInt(Settings.CALL_METHOD_USER_KEY, userHandle);
                if (tag != null) {
                ...
                cp.call(resolver.getPackageName(), Settings.CALL_METHOD_RESET_SECURE, null, arg);
            } catch (RemoteException e) {
        ...
        public static synchronized int getIntForUser(ContentResolver cr, String name, int userHandle) throws SettingNotFoundException {
            if (LOCATION_MODE.equals(name)) {
                return getLocationModeForUser(cr, userHandle);
            }
            String v = getStringForUser(cr, name, userHandle);
        ...
        private protected static long getLongForUser(ContentResolver cr, String name, long def, int userHandle) {
            String valString = getStringForUser(cr, name, userHandle);
            if (valString == null) {
                return def;
            }
        ...
        private protected static boolean putLongForUser(ContentResolver cr, String name, long value, int userHandle) {
            return putStringForUser(cr, name, Long.toString(value), userHandle);
        }
        ...
        @Deprecated
        public static final synchronized boolean isLocationProviderEnabledForUser(ContentResolver cr, String provider, int userId) {
        ...
        @Deprecated
        public static final synchronized boolean setLocationProviderEnabledForUser(ContentResolver cr, String provider, boolean enabled, int userId) {
            String provider2;
        ...
        @Deprecated
        private static synchronized boolean setLocationModeForUser(ContentResolver cr, int mode, int userId) {
            boolean z;
            synchronized (Settings.mLocationSettingsLock) {
                boolean gps = false;
        ...
        private static final synchronized int getLocationModeForUser(ContentResolver cr, int userId) {
            synchronized (Settings.mLocationSettingsLock) {
    ...
    public static final class Global extends NameValueTable {
        ...
        @Deprecated
        private protected static final String CONTACT_METADATA_SYNC = "contact_metadata_sync";
        ...
        private protected static final String ENABLE_ACCESSIBILITY_GLOBAL_GESTURE_ENABLED = "enable_accessibility_global_gesture_enabled";
        ...
        private protected static final String HEADS_UP_NOTIFICATIONS_ENABLED = "heads_up_notifications_enabled";
        private protected static final int HEADS_UP_OFF = 0;
        private protected static final int HEADS_UP_ON = 1;
        ...
        private protected static final String MOBILE_DATA = "mobile_data";
        public static final String MOBILE_DATA_ALWAYS_ON = "mobile_data_always_on";
        public static final String MODE_RINGER = "mode_ringer";
        public protected static final HashSet<String> MOVED_TO_SECURE;
        public static final String MULTI_SIM_DATA_CALL_SUBSCRIPTION = "multi_sim_data_call";
        public static final String MULTI_SIM_SMS_PROMPT = "multi_sim_sms_prompt";
        public static final String MULTI_SIM_SMS_SUBSCRIPTION = "multi_sim_sms";
        private protected static final String[] MULTI_SIM_USER_PREFERRED_SUBS;
        public static final String MULTI_SIM_VOICE_CALL_SUBSCRIPTION = "multi_sim_voice_call";
        private protected static final String MULTI_SIM_VOICE_PROMPT = "multi_sim_voice_prompt";
        ...
        private protected static final String NETWORK_SCORER_APP = "network_scorer_app";
        ...
        private protected static final String PACKAGE_VERIFIER_ENABLE = "package_verifier_enable";
        ...
        public static final String POWER_SOUNDS_ENABLED = "power_sounds_enabled";
        private protected static final String PREFERRED_NETWORK_MODE = "preferred_network_mode";
        ...
        private protected static final String REQUIRE_PASSWORD_TO_DECRYPT = "require_password_to_decrypt";
        ...
        private protected static final String WEBVIEW_PROVIDER = "webview_provider";
        @Deprecated
        ...
        private protected static final String WIFI_SAVED_STATE = "wifi_saved_state";
        ...
        private protected static final String ZEN_MODE = "zen_mode";
        private protected static final int ZEN_MODE_ALARMS = 3;
        private protected static final String ZEN_MODE_CONFIG_ETAG = "zen_mode_config_etag";
        private protected static final int ZEN_MODE_IMPORTANT_INTERRUPTIONS = 1;
        private protected static final int ZEN_MODE_NO_INTERRUPTIONS = 2;
        private protected static final int ZEN_MODE_OFF = 0;
        ...
        public protected static final NameValueCache sNameValueCache;
        public protected static final ContentProviderHolder sProviderHolder;
        ...
        private protected static final String WIFI_WATCHDOG_POOR_NETWORK_TEST_ENABLED = "wifi_watchdog_poor_network_test_enabled";
        ...
        public static final synchronized String getBluetoothHeadsetPriorityKey(String address) {
            return BLUETOOTH_HEADSET_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothA2dpSinkPriorityKey(String address) {
            return BLUETOOTH_A2DP_SINK_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothA2dpSrcPriorityKey(String address) {
            return BLUETOOTH_A2DP_SRC_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothA2dpSupportsOptionalCodecsKey(String address) {
            return BLUETOOTH_A2DP_SUPPORTS_OPTIONAL_CODECS_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothA2dpOptionalCodecsEnabledKey(String address) {
            return BLUETOOTH_A2DP_OPTIONAL_CODECS_ENABLED_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothHidHostPriorityKey(String address) {
            return BLUETOOTH_INPUT_DEVICE_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothPanPriorityKey(String address) {
            return BLUETOOTH_PAN_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothHearingAidPriorityKey(String address) {
            return BLUETOOTH_HEARING_AID_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothMapPriorityKey(String address) {
            return BLUETOOTH_MAP_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothMapClientPriorityKey(String address) {
            return BLUETOOTH_MAP_CLIENT_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothPbapClientPriorityKey(String address) {
            return BLUETOOTH_PBAP_CLIENT_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static final synchronized String getBluetoothSapPriorityKey(String address) {
            return BLUETOOTH_SAP_PRIORITY_PREFIX + address.toUpperCase(Locale.ROOT);
        }

        public static synchronized String zenModeToString(int mode) {
            return mode == 1 ? "ZEN_MODE_IMPORTANT_INTERRUPTIONS" : mode == 3 ? "ZEN_MODE_ALARMS" : mode == 2 ? "ZEN_MODE_NO_INTERRUPTIONS" : "ZEN_MODE_OFF";
        }

        public static synchronized boolean isValidZenMode(int value) {
            switch (value) {
                case 0:
                case 1:
                case 2:
        ...
        private protected static String getStringForUser(ContentResolver resolver, String name, int userHandle) {
            if (MOVED_TO_SECURE.contains(name)) {
        ...
        public static synchronized void resetToDefaultsAsUser(ContentResolver resolver, String tag, int mode, int userHandle) {
            try {
                ...
                arg.putInt(Settings.CALL_METHOD_RESET_MODE_KEY, mode);
                IContentProvider cp = sProviderHolder.getProvider(resolver);
                cp.call(resolver.getPackageName(), Settings.CALL_METHOD_RESET_GLOBAL, null, arg);
            } catch (RemoteException e) {
                Log.w(Settings.TAG, "Can't reset do defaults for " + CONTENT_URI, e);
            }
        }

        private protected static boolean putStringForUser(ContentResolver resolver, String name, String value, int userHandle) {
            return putStringForUser(resolver, name, value, null, false, userHandle);
        }

        public static synchronized boolean putStringForUser(ContentResolver resolver, String name, String value, String tag, boolean makeDefault, int userHandle) {
            if (MOVED_TO_SECURE.contains(name)) {
    ...
    public static final class Bookmarks implements BaseColumns {
        ...
        private protected static final Uri CONTENT_URI = Uri.parse("content://settings/bookmarks");
        private static final String[] sIntentProjection = {"intent"};
        private static final String[] sShortcutProjection = {"_id", "shortcut"};

        public static synchronized Intent getIntentForShortcut(ContentResolver cr, char shortcut) {
            Intent intent = null;
        ...
        private protected static Uri add(ContentResolver cr, Intent intent, String title, String folder, char shortcut, int ordering) {
            if (shortcut != 0) {
        ...
        public static synchronized CharSequence getLabelForFolder(Resources r, String folder) {
            return folder;
        }

        public static synchronized CharSequence getTitle(Context context, Cursor cursor) {
    ...
    public static synchronized String getGTalkDeviceId(long androidId) {
        return "android-" + Long.toHexString(androidId);
    }

    private protected static boolean isCallingPackageAllowedToWriteSettings(Context context, int uid, String callingPackage, boolean throwException) {
    ...
    public static synchronized boolean checkAndNoteWriteSettingsOperation(Context context, int uid, String callingPackage, boolean throwException) {
    ...
    public static synchronized boolean checkAndNoteChangeNetworkStateOperation(Context context, int uid, String callingPackage, boolean throwException) {
    ...
    private protected static boolean isCallingPackageAllowedToDrawOverlays(Context context, int uid, String callingPackage, boolean throwException) {
    ...
    public static synchronized boolean checkAndNoteDrawOverlaysOperation(Context context, int uid, String callingPackage, boolean throwException) {
    ...
    private protected static boolean isCallingPackageAllowedToPerformAppOpsProtectedOperation(Context context, int uid, String callingPackage, boolean throwException, int appOpsOpCode, String[] permissions, boolean makeNote) {
        int mode;
        int i = 0;
    ...
    public static synchronized String getPackageNameForUid(Context context, int uid) {

...
public final class Settings {
    ...
    public static class NameValueCache {
        ...
        /* JADX WARN: Removed duplicated region for block: B:61:0x00e5 A[Catch: RemoteException -> 0x013f, TryCatch #10 {RemoteException -> 0x013f, blocks: (B:32:0x005c, B:35:0x006b, B:48:0x008d, B:50:0x0093, B:52:0x009d, B:55:0x00bd, B:61:0x00e5, B:63:0x00ef, B:59:0x00c8, B:87:0x013e, B:54:0x00a3, B:65:0x00f2, B:68:0x0105, B:70:0x010f, B:71:0x0114, B:72:0x0120, B:74:0x0124, B:76:0x012c, B:77:0x0131), top: B:156:0x005c }] */
        /* JADX WARN: Unsupported multi-entry loop pattern (BACK_EDGE: B:44:0x0085 -> B:86:0x013d). Please submit an issue!!! */
    ...
    public static final class System extends NameValueTable {
        ...
        public static final String ICM_BRIGHTNESS_MODE = "screen_brightness_mode_2";
        @Deprecated
        ...
        public static final int PASSENGER_SCREEN_BRIGHTNESS_MODE_AUTO = 1;
        ...
        public static final String SCREEN_BRIGHTNESS_FOR_ICM = "screen_brightness_for_2";
        public static final String SCREEN_BRIGHTNESS_FOR_MODE = "screen_brightness_mode_0";
        public static final String SCREEN_BRIGHTNESS_FOR_VR = "screen_brightness_for_vr";
        private static final SettingsValidators.Validator SCREEN_BRIGHTNESS_FOR_VR_VALIDATOR;
        public static final String SCREEN_BRIGHTNESS_MODE = "screen_brightness_mode";
        public static final int SCREEN_BRIGHTNESS_MODE_AUTO = 1;
        ...
        static {
            ...
            FONT_SCALE_VALIDATOR = new SettingsValidators.InclusiveFloatRangeValidator(0.25f, 5.0f);
            DIM_SCREEN_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
            DISPLAY_COLOR_MODE_VALIDATOR = new SettingsValidators.Validator() { // from class: android.provider.Settings.System.3
                @Override // android.provider.SettingsValidators.Validator
                public boolean validate(String value) {
        ...
        public static int getInt(ContentResolver cr, String name, int def) {
            if (FeatureOption.FO_SHARED_DISPLAY_ENABLED && SCREEN_BRIGHTNESS.equals(name)) {
                boolean isPrimaryId = isPrimaryId();
                if (!isPrimaryId) {
                    return getIntForUser(cr, PASSENGER_SCREEN_BRIGHTNESS, def, cr.getUserId());
                }
            }
        ...
        public static int getInt(ContentResolver cr, String name) throws SettingNotFoundException {
            if (FeatureOption.FO_SHARED_DISPLAY_ENABLED && SCREEN_BRIGHTNESS.equals(name)) {
                boolean isPrimaryId = isPrimaryId();
                if (!isPrimaryId) {
                    return getIntForUser(cr, PASSENGER_SCREEN_BRIGHTNESS, cr.getUserId());
                }
            }
        ...
        private static boolean isPrimaryId() {
            try {
        ...
        public static boolean putInt(ContentResolver cr, String name, int value) {
            if (FeatureOption.FO_SHARED_DISPLAY_ENABLED) {
                if (SCREEN_BRIGHTNESS.equals(name)) {
                    boolean isPrimaryId = isPrimaryId();
                    if (!isPrimaryId) {
                        return putIntForUser(cr, PASSENGER_SCREEN_BRIGHTNESS, value, cr.getUserId());
                    }
                }
                if (SCREEN_BRIGHTNESS_MODE.equals(name)) {
                    int pid = Binder.getCallingPid();
                    String packageName = getPackageName(pid);
                    if (packageName != null && !packageName.equals("com.android.systemui")) {
                        boolean isPrimaryId2 = isPrimaryId();
                        if (isPrimaryId2) {
                            return putIntForUser(cr, SCREEN_BRIGHTNESS_FOR_MODE, value, cr.getUserId());
                        }
                        return putIntForUser(cr, PASSENGER_SCREEN_BRIGHTNESS_MODE, value, cr.getUserId());
                    }
                }
            }
            int pid2 = cr.getUserId();
            return putIntForUser(cr, name, value, pid2);
        }
    ...
    public static final class Secure extends NameValueTable {
        ...
        private static final SettingsValidators.Validator DOZE_WAKE_DISPLAY_GESTURE_VALIDATOR;
        public static final String DOZE_WAKE_LOCK_SCREEN_GESTURE = "doze_wake_screen_gesture";
        private static final SettingsValidators.Validator DOZE_WAKE_LOCK_SCREEN_GESTURE_VALIDATOR;
        ...
        private static final SettingsValidators.Validator SHOW_MEDIA_WHEN_BYPASSING_VALIDATOR;
        ...
        private static final SettingsValidators.Validator SKIP_DIRECTION_VALIDATOR;
        ...
        private static final SettingsValidators.Validator TAP_GESTURE_VALIDATOR;
        @SystemApi
        ...
        static {
            ...
            LOCK_SCREEN_CUSTOM_CLOCK_FACE_VALIDATOR = SettingsValidators.JSON_OBJECT_VALIDATOR;
            USB_MASS_STORAGE_ENABLED_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
            ...
            DOZE_WAKE_LOCK_SCREEN_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
            DOZE_WAKE_DISPLAY_GESTURE_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
            ...
            SKIP_DIRECTION_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
            ...
            SHOW_MEDIA_WHEN_BYPASSING_VALIDATOR = SettingsValidators.BOOLEAN_VALIDATOR;
            ...
            NAVIGATION_MODE_VALIDATOR = new SettingsValidators.DiscreteValueValidator(new String[]{WifiEnterpriseConfig.ENGINE_DISABLE, WifiEnterpriseConfig.ENGINE_ENABLE, "2"});
    ...
    public static final class Global extends NameValueTable {
        ...
        public static final String SECOND_BLUETOOTH_ON = "second_bluetooth_on";
        ...
        public static final String USB_MASS_STORAGE_ENABLED = "usb_mass_storage_enabled";
        public static final String USB_MODE_DEVICE = "usb_device";
        public static final String USB_MODE_HOST = "usb_host";
        ...
        public static final String XP_USB_MODE = "xp_usb_mode";
        @Deprecated
        public static final String ZEN_DURATION = "zen_duration";
        @Deprecated
        public static final int ZEN_DURATION_FOREVER = 0;
        ...
        private static final SettingsValidators.Validator EUICC_UNSUPPORTED_COUNTRIES_VALIDATOR = new SettingsValidators.ComponentNameListValidator(SmsManager.REGEX_PREFIX_DELIMITER);
    ...
    public static final class Config extends NameValueTable {
        ...
        /* JADX INFO: Access modifiers changed from: package-private */
        public static boolean putString(ContentResolver resolver, String name, String value, boolean makeDefault) {
            return sNameValueCache.putStringForUser(resolver, name, value, null, makeDefault, resolver.getUserId());
        }

        /* JADX INFO: Access modifiers changed from: package-private */
        public static void resetToDefaults(ContentResolver resolver, int resetMode, String prefix) {
            try {
                Bundle arg = new Bundle();

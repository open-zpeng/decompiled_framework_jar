...
public final class ContactsContract {
    ...
    interface ContactCounts {
        private protected static final String EXTRA_ADDRESS_BOOK_INDEX = "android.provider.extra.ADDRESS_BOOK_INDEX";
        private protected static final String EXTRA_ADDRESS_BOOK_INDEX_COUNTS = "android.provider.extra.ADDRESS_BOOK_INDEX_COUNTS";
        private protected static final String EXTRA_ADDRESS_BOOK_INDEX_TITLES = "android.provider.extra.ADDRESS_BOOK_INDEX_TITLES";
    }
    ...
    protected interface StreamItemPhotosColumns {
        @Deprecated
        private protected static final String PHOTO_FILE_ID = "photo_file_id";
        @Deprecated
        private protected static final String PHOTO_URI = "photo_uri";
        @Deprecated
        private protected static final String SORT_INDEX = "sort_index";
        @Deprecated
        private protected static final String STREAM_ITEM_ID = "stream_item_id";
        @Deprecated
        private protected static final String SYNC1 = "stream_item_photo_sync1";
        @Deprecated
        private protected static final String SYNC2 = "stream_item_photo_sync2";
        @Deprecated
        private protected static final String SYNC3 = "stream_item_photo_sync3";
        @Deprecated
        private protected static final String SYNC4 = "stream_item_photo_sync4";
    }
    ...
    protected interface StreamItemsColumns {
        @Deprecated
        private protected static final String ACCOUNT_NAME = "account_name";
        @Deprecated
        private protected static final String ACCOUNT_TYPE = "account_type";
        @Deprecated
        private protected static final String COMMENTS = "comments";
        @Deprecated
        private protected static final String CONTACT_ID = "contact_id";
        @Deprecated
        private protected static final String CONTACT_LOOKUP_KEY = "contact_lookup";
        @Deprecated
        private protected static final String DATA_SET = "data_set";
        @Deprecated
        private protected static final String RAW_CONTACT_ID = "raw_contact_id";
        @Deprecated
        private protected static final String RAW_CONTACT_SOURCE_ID = "raw_contact_source_id";
        @Deprecated
        private protected static final String RES_ICON = "icon";
        @Deprecated
        private protected static final String RES_LABEL = "label";
        @Deprecated
        private protected static final String RES_PACKAGE = "res_package";
        @Deprecated
        private protected static final String SYNC1 = "stream_item_sync1";
        @Deprecated
        private protected static final String SYNC2 = "stream_item_sync2";
        @Deprecated
        private protected static final String SYNC3 = "stream_item_sync3";
        @Deprecated
        private protected static final String SYNC4 = "stream_item_sync4";
        @Deprecated
        private protected static final String TEXT = "text";
        @Deprecated
    ...
    public static final class Directory implements BaseColumns {
        ...
        private synchronized Directory() {
        }
        ...
        public static synchronized boolean isRemoteDirectory(long directoryId) {
    ...
    public static final class ProfileSyncState implements SyncStateContract.Columns {
        ...
        private synchronized ProfileSyncState() {
        }
    ...
    public static class Contacts implements BaseColumns, ContactsColumns, ContactOptionsColumns, ContactNameColumns, ContactStatusColumns, ContactCounts {
        ...
        private protected static final Uri CORP_CONTENT_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "contacts_corp");
        ...
        public static final class StreamItems implements StreamItemsColumns {
            @Deprecated
            private protected static final String CONTENT_DIRECTORY = "stream_items";

            @Deprecated
            private synchronized StreamItems() {
            }
        }
        ...
        public static final class AggregationSuggestions implements BaseColumns, ContactsColumns, ContactOptionsColumns, ContactStatusColumns {
            ...
            private synchronized AggregationSuggestions() {
            }
            ...
            private protected static final Builder builder() {
                return new Builder();
            }
        }
    ...
    public static final class DeletedContacts implements DeletedContactsColumns {
        ...
        private synchronized DeletedContacts() {
        }
    }
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns, ContactOptionsColumns, ContactNameColumns, SyncColumns {
        ...
        private synchronized RawContacts() {
        }
        ...
        public static final class DisplayPhoto {
            ...
            private synchronized DisplayPhoto() {
            }
        }
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public synchronized EntityIteratorImpl(Cursor cursor) {
                super(cursor);
            }

            @Override // android.content.CursorEntityIterator
            public synchronized android.content.Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                String[] strArr;
                ...
                while (rawContactId == cursor.getLong(columnRawContactId)) {
                    ...
                    DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv2, DataColumns.MIMETYPE);
    ...
    public static final class StreamItems implements BaseColumns, StreamItemsColumns {
        @Deprecated
        private protected static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/stream_item";
        @Deprecated
        private protected static final String CONTENT_TYPE = "vnd.android.cursor.dir/stream_item";
        @Deprecated
        private protected static final String MAX_ITEMS = "max_items";
        @Deprecated
        private protected static final Uri CONTENT_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "stream_items");
        @Deprecated
        private protected static final Uri CONTENT_PHOTO_URI = Uri.withAppendedPath(CONTENT_URI, "photo");
        @Deprecated
        private protected static final Uri CONTENT_LIMIT_URI = Uri.withAppendedPath(ContactsContract.AUTHORITY_URI, "stream_items_limit");
        ...
        public static final class StreamItemPhotos implements BaseColumns, StreamItemPhotosColumns {
            @Deprecated
            private protected static final String CONTENT_DIRECTORY = "photo";
            @Deprecated
            private protected static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/stream_item_photo";
            @Deprecated
            private protected static final String CONTENT_TYPE = "vnd.android.cursor.dir/stream_item_photo";

            @Deprecated
            private synchronized StreamItemPhotos() {
            }
        }
    }
    ...
    public static final class StreamItemPhotos implements BaseColumns, StreamItemPhotosColumns {
        @Deprecated
        private protected static final String PHOTO = "photo";
    ...
    public static final class PhotoFiles implements BaseColumns, PhotoFilesColumns {
        private synchronized PhotoFiles() {
        }
    }
    ...
    public static final class RawContactsEntity implements BaseColumns, DataColumns, RawContactsColumns {
        ...
        private synchronized RawContactsEntity() {
        }
    }
    ...
    public static final class PhoneLookup implements BaseColumns, PhoneLookupColumns, ContactsColumns, ContactOptionsColumns, ContactNameColumns {
        ...
        private synchronized PhoneLookup() {
        }
    }
    ...
    public static class StatusUpdates implements StatusColumns, PresenceColumns {
        ...
        private synchronized StatusUpdates() {
        }
    ...
    public static final class CommonDataKinds {
        ...
        private synchronized CommonDataKinds() {
        }
        ...
        public static final class StructuredName implements DataColumnsWithJoins, ContactCounts {
            ...
            private synchronized StructuredName() {
            }
        }
        ...
        public static final class Phone implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            private synchronized Phone() {
            }

            @Deprecated
            public static final synchronized CharSequence getDisplayLabel(Context context, int type, CharSequence label, CharSequence[] labelArray) {
        ...
        public static final class StructuredPostal implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            private synchronized StructuredPostal() {
            }
        ...
        public static final class Organization implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            private synchronized Organization() {
            }
        ...
        public static final class GroupMembership implements DataColumnsWithJoins, ContactCounts {
            ...
            private synchronized GroupMembership() {
            }
        }
        ...
        public static final class SipAddress implements DataColumnsWithJoins, CommonColumns, ContactCounts {
            ...
            private synchronized SipAddress() {
            }
    ...
    public static final class Groups implements BaseColumns, GroupsColumns, SyncColumns {
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            @Override // android.content.CursorEntityIterator
            public synchronized Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                ContentValues values = new ContentValues();
    ...
    public static final class AggregationExceptions implements BaseColumns {
        ...
        private synchronized AggregationExceptions() {
        }
    }
    ...
    public static final class ProviderStatus {
        ...
        private synchronized ProviderStatus() {
        }
    }
    ...
    public static final class QuickContact {
        ...
        public static synchronized Intent composeQuickContactsIntent(Context context, View target, Uri lookupUri, int mode, String[] excludeMimes) {
        ...
        private protected static Intent composeQuickContactsIntent(Context context, Rect target, Uri lookupUri, int mode, String[] excludeMimes) {
            ...
            int intentFlags = (actualContext instanceof Activity ? 0 : AudioManager.FORCE_CHANGEVOL_FLAG) | 536870912;
        ...
        public static synchronized Intent rebuildManagedQuickContactsIntent(String lookupKey, long contactId, boolean isContactIdIgnored, long directoryId, Intent originalIntent) {
            Uri lookupUri;
    ...
    public static final class MetadataSync implements BaseColumns, MetadataSyncColumns {
        ...
        private synchronized MetadataSync() {
        }
    }
    ...
    public static final class MetadataSyncState implements BaseColumns, MetadataSyncStateColumns {
        ...
        private synchronized MetadataSyncState() {
        }
    }
}

...
public final class CalendarContract {
    ...
    private synchronized CalendarContract() {
    }
    ...
    public static final class CalendarEntity implements BaseColumns, SyncColumns, CalendarColumns {
        ...
        private synchronized CalendarEntity() {
        }
    ...
    public static final class Calendars implements BaseColumns, SyncColumns, CalendarColumns {
        ...
        private synchronized Calendars() {
        }
    }
    ...
    public static final class Attendees implements BaseColumns, AttendeesColumns, EventsColumns {
        ...
        private synchronized Attendees() {
        }
    ...
    public static final class EventsEntity implements BaseColumns, SyncColumns, EventsColumns {
        ...
        private synchronized EventsEntity() {
        }
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public synchronized EntityIteratorImpl(Cursor cursor, ContentResolver resolver) {
                super(cursor);
                this.mResolver = resolver;
                this.mProvider = null;
            }

            public synchronized EntityIteratorImpl(Cursor cursor, ContentProviderClient provider) {
                super(cursor);
                this.mResolver = null;
            ...
            public synchronized Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                ...
                DatabaseUtils.cursorStringToContentValuesIfPresent(cursor, cv, CalendarSyncColumns.CAL_SYNC10);
                Entity entity = new Entity(cv);
                Cursor subCursor2 = this.mResolver != null ? this.mResolver.query(Reminders.CONTENT_URI, REMINDERS_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null) : this.mProvider.query(Reminders.CONTENT_URI, REMINDERS_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                while (true) {
                ...
                subCursor.close();
                Cursor subCursor3 = this.mResolver != null ? this.mResolver.query(Attendees.CONTENT_URI, ATTENDEES_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null) : this.mProvider.query(Attendees.CONTENT_URI, ATTENDEES_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                subCursor = subCursor3;
                ...
                subCursor.close();
                Cursor subCursor4 = this.mResolver != null ? this.mResolver.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null) : this.mProvider.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(eventId)}, null);
                subCursor = subCursor4;
                while (subCursor.moveToNext()) {
                    try {
    ...
    public static final class Instances implements BaseColumns, EventsColumns, CalendarColumns {
        ...
        private synchronized Instances() {
        }
    ...
    public static final class EventDays implements EventDaysColumns {
        ...
        private synchronized EventDays() {
        }
    ...
    public static final class Reminders implements BaseColumns, RemindersColumns, EventsColumns {
        ...
        private synchronized Reminders() {
        }
    ...
    public static final class CalendarAlerts implements BaseColumns, CalendarAlertsColumns, EventsColumns, CalendarColumns {
        ...
        private synchronized CalendarAlerts() {
        }

        public static final synchronized Uri insert(ContentResolver cr, long eventId, long begin, long end, long alarmTime, int minutes) {
        ...
        private protected static final long findNextAlarmTime(ContentResolver cr, long millis) {
        ...
        private protected static final void rescheduleMissedAlarms(ContentResolver cr, Context context, AlarmManager manager) {
        ...
        private protected static void scheduleAlarm(Context context, AlarmManager manager, long alarmTime) {
            if (manager == null) {
        ...
        public static final synchronized boolean alarmExists(ContentResolver cr, long eventId, long begin, long alarmTime) {
            String[] projection = {CalendarAlertsColumns.ALARM_TIME};
    ...
    public static final class ExtendedProperties implements BaseColumns, ExtendedPropertiesColumns, EventsColumns {
        ...
        private synchronized ExtendedProperties() {
        }
    }
    ...
    public static final class EventsRawTimes implements BaseColumns, EventsRawTimesColumns {
        private synchronized EventsRawTimes() {
        }
    }
}

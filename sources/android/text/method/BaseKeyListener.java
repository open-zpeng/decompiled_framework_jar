            ...
            switch (state) {
                ...
                case 2:
                    if (isVariationSelector(codePoint)) {
                        int lastSeenVSCharCount = Character.charCount(codePoint);
                        state = 3;
                ...
                case 3:
                    if (Emoji.isKeycapBase(codePoint)) {
                        deleteCharCount += state2 + Character.charCount(codePoint);
                    }
                    state = 13;
                    break;
                case 4:
                ...
                case 8:
                    if (Emoji.isEmoji(codePoint)) {
                        ...
                        state2 = Character.charCount(codePoint);
                        state = 9;
                        break;
                    } else {
                        state = 13;
                ...
                case 9:
                    if (Emoji.isEmoji(codePoint)) {
                        deleteCharCount += state2 + 1 + Character.charCount(codePoint);
                        state2 = 0;
                        state = 7;
                        break;
                    } else {

...
public class TextKeyListener extends BaseKeyListener implements SpanWatcher {
    ...
    private synchronized KeyListener getKeyListener(KeyEvent event) {
    ...
    public static class NullKeyListener implements KeyListener {
        ...
        private synchronized NullKeyListener() {
        }
        ...
        public static synchronized NullKeyListener getInstance() {
            if (sInstance != null) {
                return sInstance;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized void updatePrefs(ContentResolver resolver) {
    ...
    public synchronized int getPrefs(Context context) {

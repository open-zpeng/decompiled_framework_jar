...
public class BaseMovementMethod implements MovementMethod {
    ...
    protected synchronized boolean leftWord(TextView widget, Spannable buffer) {
        return false;
    }

    protected synchronized boolean rightWord(TextView widget, Spannable buffer) {
        return false;
    }
    ...
    private synchronized int getScrollBoundsLeft(TextView widget) {
        ...
        for (int left2 = topLine; left2 <= bottomLine; left2++) {
            int lineLeft = (int) Math.floor(layout.getLineLeft(left2));
            if (lineLeft < left) {
                left = lineLeft;
            }
        }
    ...
    private synchronized int getScrollBoundsRight(TextView widget) {
        Layout layout = widget.getLayout();
        int topLine = getTopLine(widget);
        int bottomLine = getBottomLine(widget);
        if (topLine > bottomLine) {
        ...
        for (int right2 = topLine; right2 <= bottomLine; right2++) {
            int lineRight = (int) Math.ceil(layout.getLineRight(right2));
            if (lineRight > right) {
                right = lineRight;
            }
        }
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollLeft(TextView widget, Spannable buffer, int amount) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollRight(TextView widget, Spannable buffer, int amount) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollUp(TextView widget, Spannable buffer, int amount) {
        Layout layout = widget.getLayout();
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollDown(TextView widget, Spannable buffer, int amount) {
        Layout layout = widget.getLayout();
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollPageUp(TextView widget, Spannable buffer) {
        Layout layout = widget.getLayout();
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollPageDown(TextView widget, Spannable buffer) {
        Layout layout = widget.getLayout();
        int innerHeight = getInnerHeight(widget);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollTop(TextView widget, Spannable buffer) {
        Layout layout = widget.getLayout();
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollBottom(TextView widget, Spannable buffer) {
        Layout layout = widget.getLayout();
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollLineStart(TextView widget, Spannable buffer) {
        int minScrollX = getScrollBoundsLeft(widget);
        int scrollX = widget.getScrollX();
        if (scrollX > minScrollX) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized boolean scrollLineEnd(TextView widget, Spannable buffer) {
        int maxScrollX = getScrollBoundsRight(widget) - getInnerWidth(widget);
        int scrollX = widget.getScrollX();
        if (scrollX < maxScrollX) {

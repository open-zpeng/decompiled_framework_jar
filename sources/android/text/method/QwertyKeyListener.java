...
public class QwertyKeyListener extends BaseKeyListener {
    ...
    private synchronized QwertyKeyListener(TextKeyListener.Capitalize cap, boolean autoText, boolean fullKeyboard) {
        this.mAutoCap = cap;
    ...
    */
    ...
    private synchronized String getReplacement(CharSequence src, int start, int end, View view) {
        String out;
        int len = end - start;
    ...
    private synchronized boolean showCharacterPicker(View view, Editable content, char c, boolean insert, int count) {
    ...
    private static synchronized String toTitleCase(String src) {
    ...
    static class Replaced implements NoCopySpan {
        ...
        public synchronized Replaced(char[] text) {
            this.mText = text;
        }
    }
}

...
public class TextDirectionHeuristics {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static synchronized int isRtlCodePoint(int codePoint) {
    ...
    private static abstract class TextDirectionHeuristicImpl implements TextDirectionHeuristic {
        ...
        public synchronized TextDirectionHeuristicImpl(TextDirectionAlgorithm algorithm) {
        ...
        private synchronized boolean doCheck(CharSequence cs, int start, int count) {
    ...
    private static class TextDirectionHeuristicInternal extends TextDirectionHeuristicImpl {
        ...
        private synchronized TextDirectionHeuristicInternal(TextDirectionAlgorithm algorithm, boolean defaultIsRtl) {
            super(algorithm);
    ...
    private static class FirstStrong implements TextDirectionAlgorithm {
        ...
        public synchronized int checkRtl(CharSequence cs, int start, int count) {
            int result = 2;
    ...
    private static class AnyStrong implements TextDirectionAlgorithm {
        ...
        */
        public synchronized int checkRtl(java.lang.CharSequence r7, int r8, int r9) {
            /*
                r6 = this;
                r0 = 0
                r1 = 0
        ...
        private synchronized AnyStrong(boolean lookForRtl) {

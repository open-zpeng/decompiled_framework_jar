...
public class SuggestionSpan extends CharacterStyle implements ParcelableSpan {
    ...
    public protected int mEasyCorrectUnderlineColor;
    public protected float mEasyCorrectUnderlineThickness;
    private int mFlags;
    ...
    private synchronized void initStyle(Context context) {
        if (context == null) {
    ...
    private protected String getNotificationTargetClassName() {
    ...
    private static synchronized int hashCodeInternal(String[] suggestions, String languageTag, String localeStringForCompatibility, String notificationTargetClassName) {

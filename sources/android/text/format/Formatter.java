...
public final class Formatter {
    ...
    public static class BytesResult {
        ...
        public synchronized BytesResult(String value, String units, long roundedBytes) {
            this.value = value;
            this.units = units;
    ...
    private static synchronized Locale localeFromContext(Context context) {
        return context.getResources().getConfiguration().getLocales().get(0);
    }

    private static synchronized String bidiWrap(Context context, String source) {
    ...
    private protected static BytesResult formatBytes(Resources res, long sizeBytes, int flags) {
        int roundFactor;
        String roundFormat;
    ...
    private protected static String formatShortElapsedTime(Context context, long millis) {
    ...
    private protected static String formatShortElapsedTimeRoundingUpToMinutes(Context context, long millis) {

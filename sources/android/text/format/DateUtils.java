...
public class DateUtils {
    ...
    private static synchronized void initFormatStrings() {
        synchronized (sLock) {
            initFormatStringsLocked();
        }
    }

    private static synchronized void initFormatStringsLocked() {
    ...
    private protected static CharSequence formatDuration(long millis) {
        return formatDuration(millis, 10);
    }

    private protected static CharSequence formatDuration(long millis, int abbrev) {

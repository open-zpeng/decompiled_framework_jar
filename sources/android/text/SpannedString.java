...
public final class SpannedString extends SpannableStringInternal implements CharSequence, GetChars, Spanned {
    ...
    public synchronized SpannedString(CharSequence source, boolean ignoreNoCopySpan) {
    ...
    private synchronized SpannedString(CharSequence source, int start, int end) {

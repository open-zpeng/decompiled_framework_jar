...
public class SpannableString extends SpannableStringInternal implements CharSequence, GetChars, Spannable {
    ...
    public synchronized SpannableString(CharSequence source, boolean ignoreNoCopySpan) {
    ...
    private synchronized SpannableString(CharSequence source, int start, int end) {

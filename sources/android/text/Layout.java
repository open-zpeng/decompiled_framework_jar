...
public abstract class Layout {
                    ...
                    if (end < spanEnd2) {
                        ...
                        if (start2 == end && start2 != 0) {
                            ...
                            for (int j = 0; j < this.mLineBackgroundSpans.numberOfSpans; j++) {
                                if (this.mLineBackgroundSpans.spanStarts[j] < end && this.mLineBackgroundSpans.spanEnds[j] > start2) {
                                    spans3 = (ParagraphStyle[]) GrowingArrayUtils.append((LineBackgroundSpan[]) spans3, spansLength4, this.mLineBackgroundSpans.spans[j]);
                                    spansLength4++;
                                }
                            }
                            spans = spans3;
    ...
    */
    ...
    public float getLineLeft(int line) {
        ...
        if (i == 1) {
            ...
            resultAlign = dir == -1 ? Alignment.ALIGN_LEFT : Alignment.ALIGN_RIGHT;
        } else if (i == 3) {
    ...
    */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:19:0x0068, code lost:
        if ((r24 instanceof android.text.Spanned) == false) goto L38;
     */

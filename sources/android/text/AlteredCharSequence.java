...
public class AlteredCharSequence implements CharSequence, GetChars {
    ...
    private synchronized AlteredCharSequence(CharSequence source, char[] sub, int substart, int subend) {
        this.mSource = source;
        this.mChars = sub;
    ...
    synchronized void update(char[] sub, int substart, int subend) {
        this.mChars = sub;
        this.mStart = substart;
        this.mEnd = subend;
    }
    ...
    public static class AlteredSpanned extends AlteredCharSequence implements Spanned {
        ...
        private synchronized AlteredSpanned(CharSequence source, char[] sub, int substart, int subend) {

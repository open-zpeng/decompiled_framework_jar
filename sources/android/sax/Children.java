...
class Children {
    ...
    public synchronized Element getOrCreate(Element parent, String uri, String localName) {
        Child previous;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized Element get(String uri, String localName) {
        int hash = (uri.hashCode() * 31) + localName.hashCode();
        int index = hash & 15;
        Child current = this.children[index];
        if (current == null) {
    ...
    static class Child extends Element {
        ...
        synchronized Child(Element parent, String uri, String localName, int depth, int hash) {

...
public class Element {
    ...
    public synchronized Element(Element parent, String uri, String localName, int depth) {
        this.parent = parent;
        this.uri = uri;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized String toString(String uri, String localName) {
        String str;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void resetRequiredChildren() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void checkRequiredChildren(Locator locator) throws SAXParseException {
        ArrayList<Element> requiredChildren = this.requiredChilden;
        if (requiredChildren != null) {
            for (int i = requiredChildren.size() - 1; i >= 0; i--) {

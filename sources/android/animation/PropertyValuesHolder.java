...
public class PropertyValuesHolder implements Cloneable {
    ...
    private synchronized PropertyValuesHolder(String propertyName) {
        this.mSetter = null;
        this.mGetter = null;
    ...
    private synchronized PropertyValuesHolder(Property property) {
        this.mSetter = null;
        this.mGetter = null;
        this.mKeyframes = null;
        this.mTmpValueArray = new Object[1];
    ...
    public static synchronized PropertyValuesHolder ofKeyframes(String propertyName, Keyframes keyframes) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public static synchronized PropertyValuesHolder ofKeyframes(Property property, Keyframes keyframes) {
        if (keyframes instanceof Keyframes.IntKeyframes) {
    ...
    private synchronized Method getPropertyFunction(Class targetClass, String prefix, Class valueType) {
        Class[] typeVariants;
    ...
    private synchronized Method setupSetterOrGetter(Class targetClass, HashMap<Class, HashMap<String, Method>> propertyMapMap, String prefix, Class valueType) {
    ...
    synchronized void setupSetter(Class targetClass) {
    ...
    private synchronized void setupGetter(Class targetClass) {
        this.mGetter = setupSetterOrGetter(targetClass, sGetterPropertyMap, "get", null);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setupSetterAndGetter(Object target) {
    ...
    private synchronized Object convertBack(Object value) {
        if (this.mConverter != null) {
    ...
    private synchronized void setupValue(Object target, Keyframe kf) {
        if (this.mProperty != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setupStartValue(Object target) {
        List<Keyframe> keyframes = this.mKeyframes.getKeyframes();
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setupEndValue(Object target) {
        List<Keyframe> keyframes = this.mKeyframes.getKeyframes();
        if (!keyframes.isEmpty()) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setAnimatedValue(Object target) {
        if (this.mProperty != null) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void calculateValue(float fraction) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized Object getAnimatedValue() {
        return this.mAnimatedValue;
    }

    public synchronized void getPropertyValues(PropertyValues values) {
        init();
    ...
    static synchronized String getMethodName(String prefix, String propertyName) {
    ...
    public static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        public synchronized IntPropertyValuesHolder(String propertyName, Keyframes.IntKeyframes keyframes) {
            super(propertyName);
            this.mValueType = Integer.TYPE;
        ...
        public synchronized IntPropertyValuesHolder(Property property, Keyframes.IntKeyframes keyframes) {
            super(property);
            this.mValueType = Integer.TYPE;
            this.mKeyframes = keyframes;
            this.mIntKeyframes = keyframes;
        ...
        @Override // android.animation.PropertyValuesHolder
        synchronized void calculateValue(float fraction) {
            this.mIntAnimatedValue = this.mIntKeyframes.getIntValue(fraction);
        }

        @Override // android.animation.PropertyValuesHolder
        synchronized Object getAnimatedValue() {
        ...
        @Override // android.animation.PropertyValuesHolder
        synchronized void setAnimatedValue(Object target) {
    ...
    public static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        public synchronized FloatPropertyValuesHolder(String propertyName, Keyframes.FloatKeyframes keyframes) {
            super(propertyName);
            this.mValueType = Float.TYPE;
            this.mKeyframes = keyframes;
        ...
        public synchronized FloatPropertyValuesHolder(Property property, Keyframes.FloatKeyframes keyframes) {
            super(property);
            this.mValueType = Float.TYPE;
            this.mKeyframes = keyframes;
            this.mFloatKeyframes = keyframes;
    ...
    public static class MultiFloatValuesHolder extends PropertyValuesHolder {
        ...
        public synchronized MultiFloatValuesHolder(String propertyName, TypeConverter converter, TypeEvaluator evaluator, Keyframes keyframes) {
            super(propertyName);
            setConverter(converter);
            this.mKeyframes = keyframes;
            setEvaluator(evaluator);
        ...
        @Override // android.animation.PropertyValuesHolder
        synchronized void setupSetterAndGetter(Object target) {
    ...
    public static class MultiIntValuesHolder extends PropertyValuesHolder {
        ...
        public synchronized MultiIntValuesHolder(String propertyName, TypeConverter converter, TypeEvaluator evaluator, Keyframes keyframes) {
            super(propertyName);
            setConverter(converter);
            this.mKeyframes = keyframes;
            setEvaluator(evaluator);
    ...
    public static class PointFToIntArray extends TypeConverter<PointF, int[]> {
        ...
        public synchronized PointFToIntArray() {
            super(PointF.class, int[].class);
            this.mCoordinates = new int[2];
        }

        @Override // android.animation.TypeConverter
        public synchronized int[] convert(PointF value) {
    ...
    public static class PropertyValues {
        ...
        public interface DataSource {
            synchronized Object getValueAtFraction(float f);
        }

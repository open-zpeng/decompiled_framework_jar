...
public final class ObjectAnimator extends ValueAnimator {
    ...
    public String getPropertyName() {
        ...
        if (this.mPropertyName != null) {
            ...
            String propertyName3 = this.mProperty.getName();
    ...
    private synchronized ObjectAnimator(Object target, String propertyName) {
        setTarget(target);
        setPropertyName(propertyName);
    }

    private synchronized <T> ObjectAnimator(T target, Property<T, ?> property) {
        setTarget(target);
    ...
    private synchronized boolean hasSameTargetAndProperties(Animator anim) {
    ...
    public synchronized boolean shouldAutoCancel(AnimationHandler.AnimationFrameCallback anim) {
    ...
    @Override // android.animation.ValueAnimator
    synchronized void initAnimation() {

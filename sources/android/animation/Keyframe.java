...
public abstract class Keyframe implements Cloneable {
    ...
    public synchronized boolean valueWasSetOnStart() {
        return this.mValueWasSetOnStart;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setValueWasSetOnStart(boolean valueWasSetOnStart) {
    ...
    static class ObjectKeyframe extends Keyframe {
        ...
        synchronized ObjectKeyframe(float fraction, Object value) {
            this.mFraction = fraction;
            this.mValue = value;
    ...
    static class IntKeyframe extends Keyframe {
        ...
        synchronized IntKeyframe(float fraction, int value) {
            this.mFraction = fraction;
            this.mValue = value;
        ...
        synchronized IntKeyframe(float fraction) {
            this.mFraction = fraction;
            this.mValueType = Integer.TYPE;
        }
    ...
    static class FloatKeyframe extends Keyframe {
        ...
        synchronized FloatKeyframe(float fraction, float value) {
            this.mFraction = fraction;
            this.mValue = value;
        ...
        synchronized FloatKeyframe(float fraction) {
            this.mFraction = fraction;
            this.mValueType = Float.TYPE;
        }

...
public class LayoutTransition {
    ...
    private synchronized void runChangeTransition(ViewGroup parent, View newView, int changeReason) {
        ...
        while (true) {
            ...
            if (i2 < numChildren2) {
                ...
                if (child != newView) {
                    setupChangeAnimation(parent, changeReason, baseAnimator2, duration, child);
                }
                i = i2 + 1;
            } else {
    ...
    private synchronized void setupChangeAnimation(final ViewGroup parent, final int changeReason, Animator baseAnimator, final long duration, final View child) {
    ...
    public synchronized void startChangingAnimations() {
    ...
    public synchronized void endChangingAnimations() {
        LinkedHashMap<View, Animator> currentAnimCopy = (LinkedHashMap) this.currentChangingAnimations.clone();
        for (Animator anim : currentAnimCopy.values()) {
            anim.start();
            anim.end();
    ...
    private synchronized void runAppearingTransition(final ViewGroup parent, final View child) {
    ...
    private synchronized void runDisappearingTransition(final ViewGroup parent, final View child) {
    ...
    private synchronized void addChild(ViewGroup parent, View child, boolean changesLayout) {
    ...
    public synchronized void layoutChange(ViewGroup parent) {
    ...
    private synchronized void removeChild(ViewGroup parent, View child, boolean changesLayout) {
        if (parent.getWindowVisibility() != 0) {
            return;
        }
    ...
    public static final class CleanupCallback implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
        ...
        synchronized CleanupCallback(Map<View, View.OnLayoutChangeListener> listenerMap, ViewGroup parent) {

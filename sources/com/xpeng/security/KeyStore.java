...
public class KeyStore {
    ...
    private static final String TAG = "XpKeyStore";
    ...
    public int[] listUidsOfAuthBoundKeys() {
        ...
        try {
            ...
            return uidsOut.stream().mapToInt(new ToIntFunction() { // from class: com.xpeng.security.-$$Lambda$wddj3-hVVrg0MkscpMtYt3BzY8Y

...
import com.xpeng.security.keystore.KeyStoreCryptoOperationChunkedStreamer;
...
abstract class AndroidKeyStoreCipherSpiBase extends CipherSpi implements KeyStoreCryptoOperation {
    ...
    */
    private void init(int r4, java.security.Key r5, java.security.SecureRandom r6) throws java.security.InvalidKeyException {
        ...
        L2b:
            r3.initKey(r4, r5)
            com.xpeng.security.keystore.AndroidKeyStoreKey r0 = r3.mKey
            if (r0 == 0) goto L35
            r3.mRng = r6
            return
        L35:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xpeng.security.keystore.AndroidKeyStoreCipherSpiBase.init(int, java.security.Key, java.security.SecureRandom):void");
    }
    ...
    @Override // com.xpeng.security.keystore.KeyStoreCryptoOperation

...
public class AndroidKeyStoreSpi extends KeyStoreSpi {
    ...
    public Key engineGetKey(String alias, char[] password) throws NoSuchAlgorithmException, UnrecoverableKeyException {
        ...
        return XpengAndroidKeyStoreProvider.loadAndroidKeyStoreKeyFromKeystore(this.mKeyStore, userKeyAlias, this.mUid);
    }
    ...
    */
    private void setPrivateKeyEntry(java.lang.String r26, java.security.PrivateKey r27, java.security.cert.Certificate[] r28, java.security.KeyStore.ProtectionParameter r29) throws java.security.KeyStoreException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.xpeng.security.keystore.AndroidKeyStoreSpi.setPrivateKeyEntry(java.lang.String, java.security.PrivateKey, java.security.cert.Certificate[], java.security.KeyStore$ProtectionParameter):void");
    }
    ...
    private void setWrappedKeyEntry(String alias, WrappedKeyEntry entry, KeyStore.ProtectionParameter param) throws KeyStoreException {
        ...
        int errorCode = this.mKeyStore.importWrappedKey("USRSKEY_" + alias, entry.getWrappedKeyBytes(), "USRPKEY_" + entry.getWrappingKeyAlias(), maskingKey, args, GateKeeper.getSecureUserId(), 0L, this.mUid, new KeyCharacteristics());
        if (errorCode == -100) {
    ...
    public void engineSetCertificateEntry(String alias, Certificate cert) throws KeyStoreException {
        ...
        try {
            ...
            com.xpeng.security.KeyStore keyStore = this.mKeyStore;
    ...
    public boolean engineContainsAlias(String alias) {
        ...
        if (!keyStore.contains("USRPKEY_" + alias, this.mUid)) {
            com.xpeng.security.KeyStore keyStore2 = this.mKeyStore;
            if (!keyStore2.contains("USRSKEY_" + alias, this.mUid)) {
                com.xpeng.security.KeyStore keyStore3 = this.mKeyStore;
                if (!keyStore3.contains("USRCERT_" + alias, this.mUid)) {
                    com.xpeng.security.KeyStore keyStore4 = this.mKeyStore;
    ...
    public void engineLoad(InputStream stream, char[] password) throws IOException, NoSuchAlgorithmException, CertificateException {
        ...
        this.mKeyStore = com.xpeng.security.KeyStore.getInstance();
        this.mUid = -1;
    }
    ...
    public static class KeyStoreX509Certificate extends DelegatingX509Certificate {
        ...
        @Override // com.xpeng.security.keystore.DelegatingX509Certificate, java.security.cert.Certificate
        public PublicKey getPublicKey() {
            PublicKey original = super.getPublicKey();
            return XpengAndroidKeyStoreProvider.getAndroidKeyStorePublicKey(this.mPrivateKeyAlias, this.mPrivateKeyUid, original.getAlgorithm(), original.getEncoded());
        }
    }
}

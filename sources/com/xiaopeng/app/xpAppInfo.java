...
public class xpAppInfo implements Parcelable {
    ...
    public String toString() {
        return "xpAppInfo{pkgName=" + this.pkgName + DateFormat.QUOTE + "} ,mXpAppTitle=" + this.mXpAppTitle + " ,mXpAppId=" + this.mXpAppId + " ,mXpAppPage=" + this.mXpAppPage + " ,supportScreenId=" + this.supportScreenId + " ,mLaunchMode=" + this.mLaunchMode + " ,mLaunchParam=" + this.mLaunchParam;
    }
}

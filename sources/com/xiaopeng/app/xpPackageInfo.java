...
public class xpPackageInfo implements Parcelable {
    ...
    public static final int MODE_MULTISCREEN_CLONE = 1;
    public static final int MODE_MULTISCREEN_TRANSFER = 0;
    ...
    private xpPackageInfo(Parcel source) {
        ...
        this.multiscreenMode = source.readInt();
    }
    ...
    public void writeToParcel(Parcel dest, int parcelableFlags) {
        ...
        dest.writeInt(this.multiscreenMode);
    }
    ...
    public static void setXpGameModeEnable(boolean enable) {
        SystemProperties.set("xp.key.gamemode.flag", enable ? "1" : "0");
    }

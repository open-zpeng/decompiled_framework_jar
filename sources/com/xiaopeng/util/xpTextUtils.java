...
public class xpTextUtils {
    ...
    public static int[] toIntArray(String[] arrays) {
        if (arrays != null) {
            try {
                if (arrays.length > 0) {
                    return Arrays.asList(arrays).stream().mapToInt(new ToIntFunction() { // from class: com.xiaopeng.util.-$$Lambda$xpTextUtils$wddj3-hVVrg0MkscpMtYt3BzY8Y
    ...
    public static double[] toDoubleArray(String[] arrays) {
        if (arrays != null) {
            try {
                if (arrays.length > 0) {
                    return Arrays.asList(arrays).stream().mapToDouble(new ToDoubleFunction() { // from class: com.xiaopeng.util.-$$Lambda$xpTextUtils$KeqLprO1LGYsuaXq6E-hGlF2J2A

...
public class PhoneWindow extends Window implements MenuBuilder.Callback {
    ...
    protected void onIntChanged(int featureId, int value) {
        ...
        } else if (featureId == 7 && (titleContainer = (FrameLayout) findViewById(16909510)) != null) {
    ...
    protected ViewGroup generateLayout(DecorView decor) {
        ...
        if (a.getBoolean(49, false)) {
            decor.setSystemUiVisibility(16 | decor.getSystemUiVisibility());
        }
        if (a.hasValue(51)) {
        ...
        if ((features & 2048) != 0) {
            ...
            int layoutResource4 = features & 24;
            if (layoutResource4 != 0) {
                if (this.mIsFloating) {
                    ...
                    layoutResource3 = R.layout.screen_title_icons;
                }
                ...
                if (this.mIsFloating) {
                    ...
                    layoutResource2 = R.layout.screen_custom_title;
                }
                ...
                if (this.mIsFloating) {
                    ...
                    layoutResource = a.getResourceId(52, R.layout.screen_action_bar);
                } else {
        ...
        if (contentParent != null) {
            ...
            if (getContainer() == null) {
                ...
                if (this.mFrameResource != 0) {
                    ...
                    int layoutResource5 = this.mFrameResource;
                    frame = context2.getDrawable(layoutResource5);
                } else {
                    frame = null;
                }
    ...
    private void installDecor() {
        ...
        if (this.mContentParent == null) {
            ...
            if (decorContentParent != null) {
                ...
                } else if ((1 & this.mResourcesSetFlags) == 0 && this.mIconRes == 0 && !this.mDecorContentParent.hasIcon()) {
                    this.mDecorContentParent.setIcon(getContext().getPackageManager().getDefaultActivityIcon());
                    this.mResourcesSetFlags |= 4;
                }
                ...
                if (this.mTitleView != null) {
                    if ((getLocalFeatures() & 2) != 0) {
                        View titleContainer = findViewById(16909510);
    ...
    private ImageView getRightIconView() {
        ...
        ImageView imageView = (ImageView) findViewById(16909334);
    ...
    private void registerSwipeCallbacks(ViewGroup contentParent) {
        ...
        swipeDismiss.setOnDismissedListener(new SwipeDismissLayout.OnDismissedListener() { // from class: com.android.internal.policy.PhoneWindow.2
        ...
        swipeDismiss.setOnSwipeProgressChangedListener(new SwipeDismissLayout.OnSwipeProgressChangedListener() { // from class: com.android.internal.policy.PhoneWindow.3
    ...
    public static final class PanelFeatureState {
        ...
        void setStyle(Context context) {
            ...
            this.listPresenterTheme = a.getResourceId(310, R.style.Theme_ExpandedMenu);
            a.recycle();
        }

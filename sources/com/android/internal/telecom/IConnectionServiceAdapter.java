        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 8:
                    ...
                    _arg18 = data.readInt() != 0;
                    if (data.readInt() != 0) {
                        _arg23 = Session.Info.CREATOR.createFromParcel(data);
                    } else {
                        _arg23 = null;
                    }
                    setRingbackRequested(_arg09, _arg18, _arg23);
                    return true;
                case 9:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 12:
                    ...
                    setConferenceMergeFailed(_arg013, _arg19);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    addConferenceCall(_arg014, _arg110, _arg27);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 20:
                    ...
                    setIsVoipAudioMode(_arg021, _arg18, _arg213);
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setStatusHints(_arg022, _arg112, _arg214);
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setAddress(_arg023, _arg113, _arg223, _arg32);
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 25:
                    ...
                    addExistingConnection(_arg026, _arg114, _arg216);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    putExtras(_arg027, _arg115, _arg217);
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 30:
                    ...
                    onRttInitiationSuccess(_arg031, _arg116);
                    return true;
                case 31:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 32:
                    ...
                    onRttSessionRemotelyTerminated(_arg033, _arg117);
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onRemoteRttRequest(_arg034, _arg118);
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    onPhoneAccountChanged(_arg035, _arg119, _arg221);
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                ...
                case 36:
                    ...
                    resetConnectionTime(_arg036, _arg120);
                    return true;
                case 37:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setConferenceState(_arg037, _arg18, _arg222);
                    return true;
                default:

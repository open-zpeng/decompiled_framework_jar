        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 3:
                    ...
                    createConnection(_arg0, _arg124, _arg2, _arg35, _arg42, _arg5);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 5:
                    ...
                    createConnectionFailed(_arg02, _arg125, _arg22, _arg36, _arg4);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 7:
                    ...
                    answerVideo(_arg09, _arg126, _arg23);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 11:
                    ...
                    rejectWithMessage(_arg013, _arg127, _arg25);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 17:
                    ...
                    char _arg128 = (char) data.readInt();
                    if (data.readInt() != 0) {
                        _arg27 = Session.Info.CREATOR.createFromParcel(data);
                    } else {
                        _arg27 = null;
                    }
                    playDtmfTone(_arg019, _arg128, _arg27);
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 19:
                    ...
                    conference(_arg021, _arg129, _arg28);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 23:
                    ...
                    onPostDialContinue(_arg025, _arg130, _arg29);
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);

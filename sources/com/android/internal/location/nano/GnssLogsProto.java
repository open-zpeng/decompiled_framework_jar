...
public interface GnssLogsProto {
    ...
    public static final class GnssLog extends MessageNano {
        ...
        public GnssLog clear() {
            ...
            this.meanL5TopFourAverageCn0DbHz = FeatureOption.FO_BOOT_POLICY_CPU;
            this.standardDeviationL5TopFourAverageCn0DbHz = FeatureOption.FO_BOOT_POLICY_CPU;
            this.cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (Double.doubleToLongBits(this.meanL5TopFourAverageCn0DbHz) != Double.doubleToLongBits(FeatureOption.FO_BOOT_POLICY_CPU)) {
                output.writeDouble(19, this.meanL5TopFourAverageCn0DbHz);
            }
            if (Double.doubleToLongBits(this.standardDeviationL5TopFourAverageCn0DbHz) != Double.doubleToLongBits(FeatureOption.FO_BOOT_POLICY_CPU)) {

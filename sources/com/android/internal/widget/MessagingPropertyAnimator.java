...
public class MessagingPropertyAnimator implements View.OnLayoutChangeListener {
    ...
    private static final int TAG_LAYOUT_TOP = 16909527;
    private static final int TAG_TOP = 16909529;
    private static final int TAG_TOP_ANIMATOR = 16909528;
    ...
    private static void setLayoutTop(View view, int top) {
        view.setTagInternal(16909527, Integer.valueOf(top));
    }

    public static int getLayoutTop(View view) {
        Integer tag = (Integer) view.getTag(16909527);
        if (tag == null) {
            return getTop(view);
        }
        return tag.intValue();
    ...
    public static int getTop(View v) {
        Integer tag = (Integer) v.getTag(16909529);
        if (tag == null) {
            return v.getTop();
        }
        return tag.intValue();
    ...
    public static void setTop(View v, int value) {
        v.setTagInternal(16909529, Integer.valueOf(value));
    ...
    private static void startTopAnimation(final View v, int start, int end, Interpolator interpolator) {
        ObjectAnimator existing = (ObjectAnimator) v.getTag(16909528);
        if (existing != null) {
            existing.cancel();
        }
        ...
        animator.addListener(new AnimatorListenerAdapter() { // from class: com.android.internal.widget.MessagingPropertyAnimator.2
            ...
            public void onAnimationEnd(Animator animation) {
                View.this.setTagInternal(16909528, null);
        ...
        v.setTagInternal(16909528, animator);
        animator.start();
    }

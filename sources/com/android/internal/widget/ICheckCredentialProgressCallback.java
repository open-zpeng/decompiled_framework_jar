...
public interface ICheckCredentialProgressCallback extends IInterface {
    synchronized void onCredentialVerified() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ICheckCredentialProgressCallback {
        ...
        public static synchronized ICheckCredentialProgressCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ICheckCredentialProgressCallback {
            ...
            public synchronized void onCredentialVerified() throws RemoteException {

...
public final class FloatingToolbar {
    ...
    public static final class FloatingToolbarPopup {
        ...
        private void refreshCoordinatesAndOverflowDirection(Rect contentRectOnScreen) {
            ...
            if (!hasOverflow()) {
                if (availableHeightAboveContent >= toolbarHeightWithVerticalMargin) {
                    y2 = contentRectOnScreen.top - toolbarHeightWithVerticalMargin;
                } else if (availableHeightBelowContent >= toolbarHeightWithVerticalMargin) {
                    y2 = contentRectOnScreen.bottom;
                } else if (availableHeightBelowContent < this.mLineHeight) {
                    y2 = Math.max(this.mViewPortOnScreen.top, contentRectOnScreen.top - toolbarHeightWithVerticalMargin);
                } else {
                    y2 = contentRectOnScreen.bottom - this.mMarginVertical;
                }
                y = y2;
            } else {
        ...
        private int getAdjustedToolbarWidth(int suggestedWidth) {
            ...
            refreshViewPort();
            int maximumWidth = this.mViewPortOnScreen.width() - (2 * this.mParent.getResources().getDimensionPixelSize(R.dimen.floating_toolbar_horizontal_margin));
            if (width <= 0) {
        ...
        public List<MenuItem> layoutMainPanelItems(List<MenuItem> menuItems, int toolbarWidth) {
            ...
            while (!remainingMenuItems.isEmpty()) {
                ...
                boolean showIcon = (isFirstItem && menuItem2.getItemId() == i) ? z2 : z;
                ...
                if (isLastItem) {
                    menuItemButton.setPaddingRelative(menuItemButton.getPaddingStart(), menuItemButton.getPaddingTop(), (int) (1.5d * menuItemButton.getPaddingEnd()), menuItemButton.getPaddingBottom());
                }
                menuItemButton.measure(0, 0);
                int menuItemButtonWidth = Math.min(menuItemButton.getMeasuredWidth(), toolbarWidth);
                boolean canFitWithOverflow = menuItemButtonWidth <= lastGroupId2 - this.mOverflowButtonSize.getWidth();
                boolean canFitNoOverflow = isLastItem && menuItemButtonWidth <= lastGroupId2;
                ...
                lastGroupId2 -= menuItemButtonWidth;
                remainingMenuItems.pop();
                int lastGroupId3 = menuItem2.getGroupId();
                isFirstItem = false;
        ...
        private ImageButton createOverflowButton() {
            ...
            overflowButton.setOnClickListener(new View.OnClickListener() { // from class: com.android.internal.widget.-$$Lambda$FloatingToolbar$FloatingToolbarPopup$-uEfRwR-_1oHxMvRVdmbNRdukDM
                ...
                public final void onClick(View view) {
                    FloatingToolbar.FloatingToolbarPopup.lambda$createOverflowButton$1(FloatingToolbar.FloatingToolbarPopup.this, overflowButton, view);
                }
            });
        ...
        private OverflowPanel createOverflowPanel() {
            ...
            overflowPanel.setOnItemClickListener(new AdapterView.OnItemClickListener() { // from class: com.android.internal.widget.-$$Lambda$FloatingToolbar$FloatingToolbarPopup$E8FwnPCl7gZpcTlX_UaRPIBRnT0
                ...
                public final void onItemClick(AdapterView adapterView, View view, int i, long j) {
                    FloatingToolbar.FloatingToolbarPopup.lambda$createOverflowPanel$2(FloatingToolbar.FloatingToolbarPopup.this, overflowPanel, adapterView, view, i, j);
                }
            });
            ...
            public void onAnimationEnd(Animation animation) {
                FloatingToolbarPopup.this.mContentContainer.post(new Runnable() { // from class: com.android.internal.widget.-$$Lambda$FloatingToolbar$FloatingToolbarPopup$13$7WTSUuAWkzil48e0QxuKTn0YOXI
                    ...
                    public final void run() {
                        FloatingToolbar.FloatingToolbarPopup.AnonymousClass13.lambda$onAnimationEnd$0(FloatingToolbar.FloatingToolbarPopup.AnonymousClass13.this);
                    }
                });
            }

...
public class DialogViewAnimator extends ViewAnimator {
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        while (true) {
            ...
            if (getMeasureAllChildren() || child.getVisibility() != 8) {
                ...
                if (measureMatchParentChildren && !matchHeight) {
                    maxHeight2 = Math.max(maxHeight3, child.getMeasuredHeight() + lp.topMargin + lp.bottomMargin);
        ...
        int maxHeight4 = Math.max(maxHeight2 + getPaddingTop() + getPaddingBottom(), getSuggestedMinimumHeight());
        ...
        setMeasuredDimension(resolveSizeAndState(maxWidth3, widthMeasureSpec, childState3), resolveSizeAndState(maxHeight4, heightMeasureSpec, childState3 << 16));

        ...
        while (true) {
            ...
            if (child.getVisibility() != 8) {
                ...
                if (lp.isDecor) {
                    ...
                    child.layout(childLeft8, childTop, child.getMeasuredWidth() + childLeft8, paddingTop3);
                    decorCount++;
            ...
            if (child2.getVisibility() == i) {
                ...
                if (lp2.isDecor) {
                    ...
                    if (ii == null) {
                        ...
                        paddingLeft = paddingLeft2;
                        int paddingLeft4 = childTop2 + child2.getMeasuredHeight();
                        child2.layout(childLeft, childTop2, childLeft + childMeasuredWidth, paddingLeft4);
                    }
                }
            }
            i4++;

...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemClickListener {
    ...
    private synchronized boolean isCollapsed() {
    ...
    private synchronized void performCollapse() {
        if (isCollapsed()) {
            return;
        }
    ...
    private synchronized boolean performExpand() {
        if (isCollapsed()) {
    ...
    public synchronized void setContentHeight(int contentHeight) {
        this.mContentHeight = contentHeight;
        requestLayout();
    }

    private synchronized LinearLayout createTabLayout() {
    ...
    private synchronized Spinner createSpinner() {
    ...
    private protected void animateToVisibility(int visibility) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public synchronized TabView createTabView(Context context, ActionBar.Tab tab, boolean forAdapter) {
    ...
    public class TabView extends LinearLayout {
        ...
        public synchronized void bindTab(ActionBar.Tab tab) {
            this.mTab = tab;
            update();
        }
        ...
        public synchronized ActionBar.Tab getTab() {
            return this.mTab;
        }
    }
    ...
    public class TabAdapter extends BaseAdapter {
        ...
        public synchronized void setDropDownViewContext(Context context) {
    ...
    protected class VisibilityAnimListener implements Animator.AnimatorListener {
        ...
        public synchronized VisibilityAnimListener withFinalVisibility(int visibility) {

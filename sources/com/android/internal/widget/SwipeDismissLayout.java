...
public class SwipeDismissLayout extends FrameLayout {
    ...
    public void setProgress(float deltaX) {
        ...
        if (onSwipeProgressChangedListener != null && deltaX >= 0.0f) {
            onSwipeProgressChangedListener.onSwipeProgressChanged(this, progressToAlpha(deltaX / getWidth()), deltaX);
        }
    }
    ...
    private void updateSwiping(MotionEvent ev) {
        ...
        if (!this.mSwiping) {
            ...
            boolean z = false;
            if (f > i * i) {
                if (deltaX > i * 2 && Math.abs(deltaY) < Math.abs(deltaX)) {
                    z = true;
                }
                this.mSwiping = z;
            } else {
    ...
    public class DismissAnimator implements ValueAnimator.AnimatorUpdateListener, Animator.AnimatorListener {
        ...
        public void onAnimationUpdate(ValueAnimator animation) {
            ...
            swipeDismissLayout.setProgress(swipeDismissLayout.getWidth() * value);
        }

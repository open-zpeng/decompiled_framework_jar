...
public class DumpUtils {
    ...
    public static void writePrinterCapabilities(Context context, DualDumpOutputStream proto, String idName, long id, PrinterCapabilitiesInfo cap) {
        ...
        while (true) {
            ...
            writeMediaSize(context, proto, "media_sizes", 2246267895810L, cap.getMediaSizes().get(i3));
            i2 = i3 + 1;
        }
        ...
        if ((cap.getColorModes() & 1) != 0) {
            proto.write("color_modes", PolicyProto.SUPPRESSED_VISUAL_EFFECTS, 1);
        }
        if ((cap.getColorModes() & 2) != 0) {
            proto.write("color_modes", PolicyProto.SUPPRESSED_VISUAL_EFFECTS, 2);
        }
        if ((cap.getDuplexModes() & 1) != 0) {
            proto.write("duplex_modes", 2259152797701L, 1);
        }
        if ((cap.getDuplexModes() & 2) != 0) {
            proto.write("duplex_modes", 2259152797701L, 2);
        }
        if ((cap.getDuplexModes() & 4) != 0) {
            proto.write("duplex_modes", 2259152797701L, 4);
        }
        proto.end(token);
    }
    ...
    public static void writePrinterInfo(Context context, DualDumpOutputStream proto, String idName, long id, PrinterInfo info) {
        long token = proto.start(idName, id);
        writePrinterId(proto, Instrumentation.REPORT_KEY_IDENTIFIER, 1146756268033L, info.getId());
    ...
    public static void writeMediaSize(Context context, DualDumpOutputStream proto, String idName, long id, PrintAttributes.MediaSize mediaSize) {
        long token = proto.start(idName, id);
        proto.write(Instrumentation.REPORT_KEY_IDENTIFIER, 1138166333441L, mediaSize.getId());
    ...
    public static void writeResolution(DualDumpOutputStream proto, String idName, long id, PrintAttributes.Resolution res) {
        long token = proto.start(idName, id);
        proto.write(Instrumentation.REPORT_KEY_IDENTIFIER, 1138166333441L, res.getId());
    ...
    public static void writePrintJobInfo(Context context, DualDumpOutputStream proto, String idName, long id, PrintJobInfo printJobInfo) {
        ...
        proto.write("has_advanced_options", SystemPropertiesProto.HAL_INSTRUMENTATION_ENABLE, printJobInfo.getAdvancedOptions() != null);
        proto.write(Notification.CATEGORY_PROGRESS, WindowLayoutParamsProto.ALPHA, printJobInfo.getProgress());

...
public class ReferrerIntent extends Intent {
    ...
    private protected final String mReferrer;
    ...
    synchronized ReferrerIntent(Parcel in) {
        readFromParcel(in);
    ...
    public int hashCode() {
        int result = (31 * 17) + filterHashCode();
        return (31 * result) + Objects.hashCode(this.mReferrer);
    }
}

...
public interface IInputContentUriToken extends IInterface {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    synchronized void take() throws RemoteException;

    /* loaded from: classes3.dex */
    public static abstract class Stub extends Binder implements IInputContentUriToken {
        public protected static final String DESCRIPTOR = "com.android.internal.inputmethod.IInputContentUriToken";
        public private protected static final int TRANSACTION_release = 2;
        public private protected static final int TRANSACTION_take = 1;
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IInputContentUriToken asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements IInputContentUriToken {
            ...
            private protected synchronized void take() throws RemoteException {
            ...
            private protected synchronized void release() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

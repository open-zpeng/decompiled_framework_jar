...
public class VpnConfig implements Parcelable {
    ...
    public static synchronized Intent getIntentForConfirmation() {
    ...
    public static synchronized PendingIntent getIntentForStatusPanel(Context context) {
        Intent intent = new Intent();
    ...
    public static synchronized CharSequence getVpnLabel(Context context, String packageName) throws PackageManager.NameNotFoundException {
    ...
    public synchronized void updateAllowedFamilies(InetAddress address) {
    ...
    public synchronized void addLegacyRoutes(String routesStr) {
    ...
    public synchronized void addLegacyAddresses(String addressesStr) {

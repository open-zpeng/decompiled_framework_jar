...
public class VpnProfile implements Cloneable, Parcelable {
    ...
    private protected final String key;
    public String l2tpSecret;
    public boolean mppe;
    private protected String name;
    public String password;
    public String routes;
    private protected boolean saveLogin;
    public String searchDomains;
    private protected String server;
    private protected int type;
    private protected String username;

    public synchronized VpnProfile(String key) {
        this.name = "";
        this.type = 0;
        this.server = "";
        this.username = "";
    ...
    private protected VpnProfile(Parcel in) {
        boolean z;
        this.name = "";
        this.type = 0;
        this.server = "";
    ...
    private protected static VpnProfile decode(String key, byte[] value) {
        if (key == null) {
            return null;
        }
        try {
    ...
    public synchronized boolean isValidLockdownProfile() {
        return isTypeValidForLockdown() && isServerAddressNumeric() && hasDns() && areDnsAddressesNumeric();
    }

    public synchronized boolean isTypeValidForLockdown() {
        return this.type != 0;
    }

    public synchronized boolean isServerAddressNumeric() {
        try {
    ...
    public synchronized boolean hasDns() {
        return !TextUtils.isEmpty(this.dnsServers);
    }

    public synchronized boolean areDnsAddressesNumeric() {
        String[] split;
        try {

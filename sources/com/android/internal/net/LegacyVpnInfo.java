...
public class LegacyVpnInfo implements Parcelable {
    private protected static final Parcelable.Creator<LegacyVpnInfo> CREATOR = new Parcelable.Creator<LegacyVpnInfo>() { // from class: com.android.internal.net.LegacyVpnInfo.1
    ...
    private protected int state = -1;

    private protected LegacyVpnInfo() {
    }
    ...
    public static synchronized int stateFromNetworkInfo(NetworkInfo info) {

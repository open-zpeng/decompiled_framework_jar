...
public final class RpmStats {
    ...
    public synchronized PowerStatePlatformSleepState getAndUpdatePlatformState(String name, long timeMs, int count) {
    ...
    public synchronized PowerStateSubsystem getSubsystem(String name) {
    ...
    public static class PowerStateElement {
        ...
        private synchronized PowerStateElement(long timeMs, int count) {
            this.mTimeMs = timeMs;
            this.mCount = count;
        }
    }
    ...
    public static class PowerStatePlatformSleepState {
        ...
        public synchronized void putVoter(String name, long timeMs, int count) {
    ...
    public static class PowerStateSubsystem {
        ...
        public synchronized void putState(String name, long timeMs, int count) {

...
public interface IResultReceiver extends IInterface {
    synchronized void send(int i, Bundle bundle) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IResultReceiver {
        ...
        public static synchronized IResultReceiver asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public static class Proxy implements IResultReceiver {
            ...
            public synchronized void send(int resultCode, Bundle resultData) throws RemoteException {

...
public class BatteryStatsHelper {
    ...
    private void processAppUsage(SparseArray<UserHandle> asUsers) {
        ...
        while (iu < NU) {
            ...
            BatterySipper app2 = new BatterySipper(BatterySipper.DrainType.APP, u, FeatureOption.FO_BOOT_POLICY_CPU);
    ...
    private void addScreenUsage() {
        ...
        double power = FeatureOption.FO_BOOT_POLICY_CPU + (screenOnTimeMs * this.mPowerProfile.getAveragePower(PowerProfile.POWER_SCREEN_ON));

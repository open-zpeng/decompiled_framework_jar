...
public interface IOnSubscriptionsChangedListener extends IInterface {
    synchronized void onSubscriptionsChanged() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IOnSubscriptionsChangedListener {
        ...
        public static synchronized IOnSubscriptionsChangedListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IOnSubscriptionsChangedListener {
            ...
            public synchronized void onSubscriptionsChanged() throws RemoteException {

...
public class SmsRawData implements Parcelable {
    private protected static final Parcelable.Creator<SmsRawData> CREATOR = new Parcelable.Creator<SmsRawData>() { // from class: com.android.internal.telephony.SmsRawData.1
    ...
    private protected SmsRawData(byte[] data) {
        this.data = data;
    }

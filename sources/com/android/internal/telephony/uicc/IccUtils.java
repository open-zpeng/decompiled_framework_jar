...
public class IccUtils {
    ...
    public static String bcdPlmnToString(byte[] data, int offset) {
        ...
        byte[] trans = {(byte) ((data[0 + offset] << 4) | ((data[0 + offset] >> 4) & 15)), (byte) ((data[1 + offset] << 4) | (data[2 + offset] & MidiConstants.STATUS_CHANNEL_MASK)), (byte) (((data[1 + offset] >> 4) & 15) | (data[2 + offset] & 240))};

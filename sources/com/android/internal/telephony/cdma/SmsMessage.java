                ...
                switch (parameterId) {
                    ...
                    case 4:
                        ...
                        if (addr.digitMode == 0) {
                            ...
                            while (true) {
                                int index3 = index2;
                                if (index3 < addr.numberOfDigits) {
                                    byte b = (byte) (15 & addrBis.read(4));
                                    data[index3] = convertDtmfToAscii(b);
                                    index2 = index3 + 1;
                                }
                            }
                            ...
                            if (addr.numberMode == 0) {
                                ...
                                while (true) {
                                    int index5 = index4;
                                    if (index5 < addr.numberOfDigits) {
                                        byte b2 = (byte) (255 & addrBis.read(8));
                                        data[index5] = b2;
                                        index4 = index5 + 1;
                                    }
                                }
                    ...
                    case 5:
                        ...
                        while (true) {
                            int index6 = index;
                            if (index6 < subAddrLen) {
                                byte b3 = (byte) (subAddrBis.read(4) & 255);
                                subdata[index6] = convertDtmfToAscii(b3);
                                index = index6 + 1;
                            } else {

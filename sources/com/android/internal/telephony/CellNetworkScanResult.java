...
public class CellNetworkScanResult implements Parcelable {
    ...
    public synchronized CellNetworkScanResult(int status, List<OperatorInfo> operators) {
        this.mStatus = status;
        this.mOperators = operators;
    }

    private synchronized CellNetworkScanResult(Parcel in) {
    ...
    public synchronized List<OperatorInfo> getOperators() {

...
public class CallerInfo {
    ...
    private protected long contactIdOrZero;
    ...
    private protected String numberLabel;
    public int numberPresentation;
    private protected int numberType;
    ...
    public static synchronized CallerInfo getCallerInfo(Context context, Uri contactRef, Cursor cursor) {
        boolean z;
        int typeColumnIndex;
    ...
    private protected static CallerInfo getCallerInfo(Context context, Uri contactRef) {
    ...
    private protected static CallerInfo getCallerInfo(Context context, String number) {
        if (VDBG) {
    ...
    private protected static CallerInfo getCallerInfo(Context context, String number, int subId) {
    ...
    public static synchronized CallerInfo doSecondaryLookupIfNecessary(Context context, String number, CallerInfo previousResult) {
    ...
    public synchronized boolean isEmergencyNumber() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized CallerInfo markAsEmergency(Context context) {
    ...
    synchronized CallerInfo markAsVoiceMail() {
        int subId = SubscriptionManager.getDefaultSubscriptionId();
        return markAsVoiceMail(subId);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized CallerInfo markAsVoiceMail(int subId) {
    ...
    private static synchronized String normalize(String s) {
    ...
    private static synchronized int getColumnIndexForPersonId(Uri contactRef, Cursor cursor) {
        if (VDBG) {
    ...
    public synchronized void updateGeoDescription(Context context, String fallbackNumber) {
    ...
    public static synchronized String getGeoDescription(Context context, String number) {
        if (VDBG) {
    ...
    private static synchronized String getCurrentCountryIso(Context context, Locale locale) {
    ...
    public static synchronized String getCurrentCountryIso(Context context) {

...
public interface ILoadBoundProfilePackageCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ILoadBoundProfilePackageCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.ILoadBoundProfilePackageCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized ILoadBoundProfilePackageCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }

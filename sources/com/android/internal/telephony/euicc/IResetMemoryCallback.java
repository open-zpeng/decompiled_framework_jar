...
public interface IResetMemoryCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IResetMemoryCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IResetMemoryCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IResetMemoryCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }

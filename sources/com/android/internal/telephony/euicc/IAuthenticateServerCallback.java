...
public interface IAuthenticateServerCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAuthenticateServerCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IAuthenticateServerCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IAuthenticateServerCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }

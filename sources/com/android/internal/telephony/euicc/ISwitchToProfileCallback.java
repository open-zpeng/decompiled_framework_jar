...
public interface ISwitchToProfileCallback extends IInterface {
    private protected synchronized void onComplete(int i, EuiccProfileInfo euiccProfileInfo) throws RemoteException;

    /* loaded from: classes3.dex */
    public static abstract class Stub extends Binder implements ISwitchToProfileCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.ISwitchToProfileCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized ISwitchToProfileCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ISwitchToProfileCallback {
            ...
            private protected synchronized void onComplete(int resultCode, EuiccProfileInfo profile) throws RemoteException {

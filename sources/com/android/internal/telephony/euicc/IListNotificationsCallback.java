...
public interface IListNotificationsCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IListNotificationsCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IListNotificationsCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IListNotificationsCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }

...
public interface IGetEuiccInfo1Callback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetEuiccInfo1Callback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IGetEuiccInfo1Callback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IGetEuiccInfo1Callback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IGetEuiccInfo1Callback {
            ...
            private protected synchronized void onComplete(int resultCode, byte[] info) throws RemoteException {

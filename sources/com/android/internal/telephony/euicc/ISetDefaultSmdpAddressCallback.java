...
public interface ISetDefaultSmdpAddressCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ISetDefaultSmdpAddressCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.ISetDefaultSmdpAddressCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized ISetDefaultSmdpAddressCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }

...
public interface ICancelSessionCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements ICancelSessionCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.ICancelSessionCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized ICancelSessionCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }

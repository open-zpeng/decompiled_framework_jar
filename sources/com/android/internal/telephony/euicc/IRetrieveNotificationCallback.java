...
public interface IRetrieveNotificationCallback extends IInterface {
    private protected synchronized void onComplete(int i, EuiccNotification euiccNotification) throws RemoteException;

    /* loaded from: classes3.dex */
    public static abstract class Stub extends Binder implements IRetrieveNotificationCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IRetrieveNotificationCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IRetrieveNotificationCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IRetrieveNotificationCallback {
            ...
            private protected synchronized void onComplete(int resultCode, EuiccNotification notification) throws RemoteException {

...
public interface IRetrieveNotificationListCallback extends IInterface {
    private protected synchronized void onComplete(int i, EuiccNotification[] euiccNotificationArr) throws RemoteException;

    /* loaded from: classes3.dex */
    public static abstract class Stub extends Binder implements IRetrieveNotificationListCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IRetrieveNotificationListCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IRetrieveNotificationListCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IRetrieveNotificationListCallback {
            ...
            private protected synchronized void onComplete(int resultCode, EuiccNotification[] notifications) throws RemoteException {

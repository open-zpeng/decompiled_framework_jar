...
public interface IGetSmdsAddressCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetSmdsAddressCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IGetSmdsAddressCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IGetSmdsAddressCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }

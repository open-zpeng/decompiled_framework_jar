...
public interface IGetEuiccChallengeCallback extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IGetEuiccChallengeCallback {
        public protected static final String DESCRIPTOR = "com.android.internal.telephony.euicc.IGetEuiccChallengeCallback";
        ...
        /* JADX INFO: Access modifiers changed from: private */
        public static synchronized IGetEuiccChallengeCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IGetEuiccChallengeCallback {
            ...
            private protected synchronized void onComplete(int resultCode, byte[] challenge) throws RemoteException {

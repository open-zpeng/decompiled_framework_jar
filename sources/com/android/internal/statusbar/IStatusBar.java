        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 9:
                    ...
                    setSystemUiVisibility(_arg09, _arg13, _arg22, _arg3, _arg4, _arg5, _arg6, _arg7);
                    return true;
                case 10:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg010 = data.readInt();
                    _arg0 = data.readInt() != 0;
                    topAppWindowChanged(_arg010, _arg0);
                    return true;
                case 11:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setImeWindowStatus(_arg011, _arg14, _arg23, _arg32, _arg42);
                    return true;
                case 12:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    setWindowState(_arg012, _arg15, _arg24);
                    return true;
                case 13:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                ...
                case 24:
                    ...
                    appTransitionStarting(_arg014, _arg16, _arg25);
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 31:
                    ...
                    _arg0 = data.readInt() != 0;
                    onProposedRotationChanged(_arg015, _arg0);
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                ...
                case 40:
                    ...
                    IBiometricServiceReceiverInternal _arg18 = IBiometricServiceReceiverInternal.Stub.asInterface(data.readStrongBinder());
                    int _arg26 = data.readInt();
                    boolean _arg33 = data.readInt() != 0;
                    int _arg43 = data.readInt();
                    showBiometricDialog(_arg06, _arg18, _arg26, _arg33, _arg43);
                    return true;
                case 41:
                    data.enforceInterface(DESCRIPTOR);
                    _arg0 = data.readInt() != 0;
                    String _arg19 = data.readString();
                    onBiometricAuthenticated(_arg0, _arg19);
                    return true;
                case 42:
                    data.enforceInterface(DESCRIPTOR);

...
public class StatusBarIcon implements Parcelable {
    ...
    public synchronized StatusBarIcon(UserHandle user, String resPackage, Icon icon, int iconLevel, int number, CharSequence contentDescription) {
        this.visible = true;
    ...
    public synchronized StatusBarIcon(String iconPackage, UserHandle user, int iconId, int iconLevel, int number, CharSequence contentDescription) {
    ...
    public synchronized StatusBarIcon(Parcel in) {
        this.visible = true;
        readFromParcel(in);
    }

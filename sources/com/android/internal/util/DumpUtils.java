...
public final class DumpUtils {
    ...
    public static boolean isPlatformPackage(String packageName) {
        return packageName != null && (packageName.equals(ZenModeConfig.SYSTEM_AUTHORITY) || packageName.startsWith("android.") || packageName.startsWith("com.android."));
    }
    ...
    public static <TRec extends ComponentName.WithComponentName> Predicate<TRec> filterRecord(final String filterString) {
        ...
        if ("all".equals(filterString)) {
            return new Predicate() { // from class: com.android.internal.util.-$$Lambda$DumpUtils$eRa1rlfDk6Og2yFeXGHqUGPzRF0
                ...
                public final boolean test(Object obj) {
                    boolean nonNull;
                    nonNull = Objects.nonNull((ComponentName.WithComponentName) obj);
                    return nonNull;
                }
            };
        }

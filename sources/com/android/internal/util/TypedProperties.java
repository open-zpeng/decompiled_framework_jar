...
public class TypedProperties extends HashMap<String, Object> {
    ...
    static synchronized StreamTokenizer initTokenizer(Reader r) {
    ...
    public static class ParseException extends IllegalArgumentException {
        synchronized ParseException(StreamTokenizer state, String expected) {
            super("expected " + expected + ", saw " + state.toString());
        }
    }

    static synchronized int interpretType(String typeName) {
    ...
    static synchronized void parse(Reader r, Map<String, Object> map) throws ParseException, IOException {
    ...
    static synchronized Object parseValue(StreamTokenizer st, int type) throws IOException {
        int token = st.nextToken();
        if (type == 90) {
            if (token != -3) {
            ...
            try {
                ...
                if (((type >> 8) & 255) == 4) {
                    ...
                    if (absValue != FeatureOption.FO_BOOT_POLICY_CPU && !Double.isInfinite(value2) && !Double.isNaN(value2) && (absValue < 1.401298464324817E-45d || absValue > 3.4028234663852886E38d)) {
    ...
    public static class TypeException extends IllegalArgumentException {
        synchronized TypeException(String property, Object value, String requestedType) {
            super(property + " has type " + value.getClass().getName() + ", not " + requestedType);
        }
    }

    public synchronized boolean getBoolean(String property, boolean def) {
    ...
    public synchronized byte getByte(String property, byte def) {
        Object value = super.get(property);
        if (value == null) {
            return def;
        }
    ...
    public synchronized short getShort(String property, short def) {
        Object value = super.get(property);
        if (value == null) {
            return def;
        }
    ...
    public synchronized int getInt(String property, int def) {
        Object value = super.get(property);
        if (value == null) {
            return def;
        }
    ...
    public synchronized long getLong(String property, long def) {
        Object value = super.get(property);
        if (value == null) {
            return def;
        }
    ...
    public synchronized float getFloat(String property, float def) {
        Object value = super.get(property);
        if (value == null) {
            return def;
        }
    ...
    public synchronized double getDouble(String property, double def) {
        Object value = super.get(property);
        if (value == null) {
            return def;
        }
    ...
    public synchronized String getString(String property, String def) {
        Object value = super.get(property);
        if (value == null) {
            return def;
        }
    ...
    public synchronized byte getByte(String property) {
        return getByte(property, (byte) 0);
    }

    public synchronized short getShort(String property) {
    ...
    public synchronized double getDouble(String property) {
        return getDouble(property, FeatureOption.FO_BOOT_POLICY_CPU);
    }

    public synchronized String getString(String property) {
        return getString(property, "");
    }

    public synchronized int getStringInfo(String property) {
        Object value = super.get(property);
        if (value == null) {
            return -1;
        }

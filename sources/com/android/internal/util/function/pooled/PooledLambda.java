...
public interface PooledLambda {
    ...
    static <A> Message obtainMessage(Consumer<? super A> function, A arg1) {
        ...
        synchronized (Message.sPoolSync) {
            PooledRunnable callback2 = (PooledRunnable) PooledLambdaImpl.acquire(PooledLambdaImpl.sMessageCallbacksPool, function, 1, 0, 1, arg1, null, null, null, null, null);
    ...
    static <A, B> Message obtainMessage(BiConsumer<? super A, ? super B> function, A arg1, B arg2) {
        Message callback;
        synchronized (Message.sPoolSync) {
            PooledRunnable callback2 = (PooledRunnable) PooledLambdaImpl.acquire(PooledLambdaImpl.sMessageCallbacksPool, function, 2, 0, 1, arg1, arg2, null, null, null, null);
            callback = Message.obtain().setCallback(callback2.recycleOnUse());
        }
        return callback;
    }
    ...
    static <A, B, C> Message obtainMessage(TriConsumer<? super A, ? super B, ? super C> function, A arg1, B arg2, C arg3) {
        Message callback;
        synchronized (Message.sPoolSync) {
            PooledRunnable callback2 = (PooledRunnable) PooledLambdaImpl.acquire(PooledLambdaImpl.sMessageCallbacksPool, function, 3, 0, 1, arg1, arg2, arg3, null, null, null);
            callback = Message.obtain().setCallback(callback2.recycleOnUse());
        }
        return callback;
    }
    ...
    static <A, B, C, D> Message obtainMessage(QuadConsumer<? super A, ? super B, ? super C, ? super D> function, A arg1, B arg2, C arg3, D arg4) {
        Message callback;
        synchronized (Message.sPoolSync) {
            PooledRunnable callback2 = (PooledRunnable) PooledLambdaImpl.acquire(PooledLambdaImpl.sMessageCallbacksPool, function, 4, 0, 1, arg1, arg2, arg3, arg4, null, null);
            callback = Message.obtain().setCallback(callback2.recycleOnUse());
        }
        return callback;
    }
    ...
    static <A, B, C, D, E> Message obtainMessage(QuintConsumer<? super A, ? super B, ? super C, ? super D, ? super E> function, A arg1, B arg2, C arg3, D arg4, E arg5) {
        Message callback;
        synchronized (Message.sPoolSync) {
            PooledRunnable callback2 = (PooledRunnable) PooledLambdaImpl.acquire(PooledLambdaImpl.sMessageCallbacksPool, function, 5, 0, 1, arg1, arg2, arg3, arg4, arg5, null);
            callback = Message.obtain().setCallback(callback2.recycleOnUse());
        }
        return callback;
    }
    ...
    static <A, B, C, D, E, F> Message obtainMessage(HexConsumer<? super A, ? super B, ? super C, ? super D, ? super E, ? super F> function, A arg1, B arg2, C arg3, D arg4, E arg5, F arg6) {
        Message callback;
        synchronized (Message.sPoolSync) {
            PooledRunnable callback2 = (PooledRunnable) PooledLambdaImpl.acquire(PooledLambdaImpl.sMessageCallbacksPool, function, 6, 0, 1, arg1, arg2, arg3, arg4, arg5, arg6);
            callback = Message.obtain().setCallback(callback2.recycleOnUse());
        }
        return callback;
    }

...
public interface IDragAndDropPermissions extends IInterface {
    ...
    synchronized void take(IBinder iBinder) throws RemoteException;

    synchronized void takeTransient(IBinder iBinder) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IDragAndDropPermissions {
        ...
        public static synchronized IDragAndDropPermissions asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IDragAndDropPermissions {
            ...
            public synchronized void take(IBinder activityToken) throws RemoteException {
            ...
            @Override // com.android.internal.view.IDragAndDropPermissions
            public synchronized void takeTransient(IBinder transientToken) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

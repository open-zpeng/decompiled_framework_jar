...
public final class InputBindResult implements Parcelable {
    ...
    private protected final IInputMethodSession method;
    public final int result;
    public final int sequence;
    public final int userActionNotificationSequenceNumber;
    private protected static final Parcelable.Creator<InputBindResult> CREATOR = new Parcelable.Creator<InputBindResult>() { // from class: com.android.internal.view.InputBindResult.1
    ...
    public synchronized InputBindResult(int _result, IInputMethodSession _method, InputChannel _channel, String _id, int _sequence, int _userActionNotificationSequenceNumber) {
        this.result = _result;
        this.method = _method;
    ...
    synchronized InputBindResult(Parcel source) {
    ...
    private static synchronized InputBindResult error(int result) {

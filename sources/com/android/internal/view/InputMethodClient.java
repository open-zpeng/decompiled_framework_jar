...
public final class InputMethodClient {
    ...
    public static synchronized String getStartInputReason(int reason) {
        switch (reason) {
            case 0:
                return "UNSPECIFIED";
            case 1:
    ...
    public static synchronized String getUnbindReason(int reason) {
        switch (reason) {
            case 0:
                return "UNSPECIFIED";
            case 1:
    ...
    public static synchronized String softInputModeToString(int softInputMode) {

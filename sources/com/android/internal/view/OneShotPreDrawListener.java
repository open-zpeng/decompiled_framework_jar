...
public class OneShotPreDrawListener implements ViewTreeObserver.OnPreDrawListener, View.OnAttachStateChangeListener {
    ...
    private synchronized OneShotPreDrawListener(View view, boolean returnValue, Runnable runnable) {
        this.mView = view;
    ...
    public static synchronized OneShotPreDrawListener add(View view, Runnable runnable) {
        return add(view, true, runnable);
    }

    public static synchronized OneShotPreDrawListener add(View view, boolean returnValue, Runnable runnable) {

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    getTextBeforeCursor(_arg08, _arg12, _arg22, _arg3);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    getTextAfterCursor(_arg09, _arg13, _arg23, _arg32);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg010 = data.readInt();
                    int _arg14 = data.readInt();
                    IInputContextCallback _arg24 = IInputContextCallback.Stub.asInterface(data.readStrongBinder());
                    getCursorCapsMode(_arg010, _arg14, _arg24);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    getExtractedText(_arg0, _arg15, _arg25, _arg33);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 21:
                    ...
                    getSelectedText(_arg019, _arg112, _arg26);
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg020 = data.readInt();
                    int _arg113 = data.readInt();
                    IInputContextCallback _arg27 = IInputContextCallback.Stub.asInterface(data.readStrongBinder());
                    requestUpdateCursorAnchorInfo(_arg020, _arg113, _arg27);
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {
                    ...
                    commitContent(_arg07, _arg114, _arg2, _arg34, _arg4);
                    return true;
                default:

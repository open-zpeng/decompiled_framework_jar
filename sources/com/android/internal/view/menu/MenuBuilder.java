...
public class MenuBuilder implements Menu {
    ...
    public interface Callback {
        private protected boolean onMenuItemSelected(MenuBuilder menuBuilder, MenuItem menuItem);
    ...
    public interface ItemInvoker {
        synchronized boolean invokeItem(MenuItemImpl menuItemImpl);
    }
    ...
    private synchronized void dispatchPresenterUpdate(boolean cleared) {
    ...
    private synchronized boolean dispatchSubMenuSelected(SubMenuBuilder subMenu, MenuPresenter preferredPresenter) {
        if (this.mPresenters.isEmpty()) {
            return false;
        }
    ...
    private synchronized void dispatchSaveInstanceState(Bundle outState) {
        Parcelable state;
        if (this.mPresenters.isEmpty()) {
            return;
        }
    ...
    private synchronized void dispatchRestoreInstanceState(Bundle state) {
        Parcelable parcel;
    ...
    public synchronized void savePresenterStates(Bundle outState) {
        dispatchSaveInstanceState(outState);
    }

    public synchronized void restorePresenterStates(Bundle state) {
        dispatchRestoreInstanceState(state);
    }

    public synchronized void saveActionViewStates(Bundle outStates) {
    ...
    public synchronized void restoreActionViewStates(Bundle states) {
    ...
    private synchronized MenuItem addInternal(int group, int id, int categoryOrder, CharSequence title) {
    ...
    private synchronized MenuItemImpl createNewMenuItem(int group, int id, int categoryOrder, int ordering, CharSequence title, int defaultShowAsAction) {
    ...
    private synchronized void removeItemAtInt(int index, boolean updateChildrenOnMenuViews) {
    ...
    public synchronized void setExclusiveItemChecked(MenuItem item) {
    ...
    public synchronized int findItemIndex(int id) {
        int size = size();
        for (int i = 0; i < size; i++) {
            MenuItemImpl item = this.mItems.get(i);
            if (item.getItemId() == id) {
    ...
    public synchronized int findGroupIndex(int group) {
        return findGroupIndex(group, 0);
    }

    public synchronized int findGroupIndex(int group, int start) {
        int size = size();
        if (start < 0) {
            start = 0;
        }
    ...
    private static synchronized int getOrdering(int categoryOrder) {
    ...
    private synchronized void setShortcutsVisibleInner(boolean shortcutsVisible) {
        boolean z = true;
        this.mShortcutsVisible = (shortcutsVisible && this.mResources.getConfiguration().keyboard != 1 && ViewConfiguration.get(this.mContext).shouldShowMenuShortcutsWhenKeyboardPresent()) ? false : false;
    }
    ...
    public synchronized void changeMenuMode() {
        if (this.mCallback != null) {
            this.mCallback.onMenuModeChange(this);
        }
    }

    private static synchronized int findInsertIndex(ArrayList<MenuItemImpl> items, int ordering) {
    ...
    synchronized void findItemsWithShortcutForKey(List<MenuItemImpl> items, int keyCode, KeyEvent event) {
        int i;
        char c;
    ...
    synchronized MenuItemImpl findItemWithShortcutForKey(int keyCode, KeyEvent event) {
    ...
    public synchronized boolean performItemAction(MenuItem item, int flags) {
        return performItemAction(item, null, flags);
    }

    public synchronized boolean performItemAction(MenuItem item, MenuPresenter preferredPresenter, int flags) {
    ...
    public final synchronized void close(boolean closeAllMenus) {
        if (this.mIsClosing) {
            return;
        }
    ...
    public synchronized void onItemsChanged(boolean structureChanged) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onItemVisibleChanged(MenuItemImpl item) {
        this.mIsVisibleItemsStale = true;
        onItemsChanged(true);
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void onItemActionRequestChanged(MenuItemImpl item) {
        this.mIsActionItemsStale = true;
        onItemsChanged(true);
    }
    ...
    public synchronized void flagActionItems() {
    ...
    public synchronized ArrayList<MenuItemImpl> getActionItems() {
        flagActionItems();
    ...
    public synchronized void clearHeader() {
    ...
    private synchronized void setHeaderInternal(int titleRes, CharSequence title, int iconRes, Drawable icon, View view) {
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized MenuBuilder setHeaderTitleInt(CharSequence title) {
        setHeaderInternal(0, title, 0, null, null);
        return this;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized MenuBuilder setHeaderTitleInt(int titleRes) {
        setHeaderInternal(titleRes, null, 0, null, null);
        return this;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized MenuBuilder setHeaderIconInt(Drawable icon) {
        setHeaderInternal(0, null, 0, icon, null);
        return this;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized MenuBuilder setHeaderIconInt(int iconRes) {
        setHeaderInternal(0, null, iconRes, null, null);
        return this;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public synchronized MenuBuilder setHeaderViewInt(View view) {
    ...
    public synchronized View getHeaderView() {
    ...
    public private protected void setOptionalIconsVisible(boolean visible) {
        this.mOptionalIconsVisible = visible;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean getOptionalIconsVisible() {
    ...
    public synchronized MenuItemImpl getExpandedItem() {

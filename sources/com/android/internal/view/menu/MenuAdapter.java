...
public class MenuAdapter extends BaseAdapter {
    ...
    public synchronized MenuAdapter(MenuBuilder menu, LayoutInflater inflater, boolean overflowOnly, int itemLayoutRes) {
    ...
    public synchronized boolean getForceShowIcon() {
        return this.mForceShowIcon;
    }

    public synchronized void setForceShowIcon(boolean forceShow) {
    ...
    public synchronized MenuBuilder getAdapterMenu() {
    ...
    synchronized void findExpandedIndex() {

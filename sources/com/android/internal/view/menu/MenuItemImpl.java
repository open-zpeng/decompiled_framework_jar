...
public final class MenuItemImpl implements MenuItem {
    ...
    public protected int mIconResId = 0;
    ...
    public synchronized MenuItemImpl(MenuBuilder menu, int group, int id, int categoryOrder, int ordering, CharSequence title, int showAsAction) {
    ...
    synchronized Runnable getCallback() {
        return this.mItemCallback;
    }

    public synchronized MenuItem setCallback(Runnable callback) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized char getShortcut() {
        return this.mMenu.isQwertyMode() ? this.mShortcutAlphabeticChar : this.mShortcutNumericChar;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized String getShortcutLabel() {
    ...
    private static synchronized void appendModifier(StringBuilder sb, int mask, int modifier, String label) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean shouldShowShortcut() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setSubMenu(SubMenuBuilder subMenu) {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized CharSequence getTitleForItemView(MenuView.ItemView itemView) {
    ...
    private synchronized Drawable applyIconTintIfNecessary(Drawable icon) {
    ...
    public synchronized boolean isExclusiveCheckable() {
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized void setCheckedInt(boolean checked) {
        int oldFlags = this.mFlags;
    ...
    /* JADX INFO: Access modifiers changed from: package-private */
    public synchronized boolean setVisibleInt(boolean shown) {
        int oldFlags = this.mFlags;
    ...
    public private protected void setMenuInfo(ContextMenu.ContextMenuInfo menuInfo) {
    ...
    public synchronized void actionFormatChanged() {
        this.mMenu.onItemActionRequestChanged(this);
    }

    public synchronized boolean shouldShowIcon() {
    ...
    @Override // android.view.MenuItem
    public synchronized boolean requiresOverflow() {
        return (requiresActionButton() || requestsActionButton()) ? false : true;
    }

    public synchronized void setIsActionButton(boolean isActionButton) {
        if (isActionButton) {
            this.mFlags |= 32;
        } else {
            this.mFlags &= -33;
    ...
    public synchronized boolean showsTextAsAction() {
    ...
    public synchronized boolean hasCollapsibleActionView() {
        if ((this.mShowAsAction & 8) != 0) {

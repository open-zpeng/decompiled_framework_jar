...
public abstract class BaseSurfaceHolder implements SurfaceHolder {
    ...
    public abstract synchronized boolean onAllowLockCanvas();

    public abstract synchronized void onRelayoutContainer();

    public abstract synchronized void onUpdateSurface();

    public synchronized int getRequestedWidth() {
        return this.mRequestedWidth;
    }

    public synchronized int getRequestedHeight() {
        return this.mRequestedHeight;
    }

    public synchronized int getRequestedFormat() {
        return this.mRequestedFormat;
    }

    public synchronized int getRequestedType() {
    ...
    public synchronized SurfaceHolder.Callback[] getCallbacks() {
    ...
    public synchronized void ungetCallbacks() {
    ...
    private final synchronized Canvas internalLockCanvas(Rect dirty, boolean hardware) {
        if (this.mType == 3) {
    ...
    public synchronized void setSurfaceFrameSize(int width, int height) {

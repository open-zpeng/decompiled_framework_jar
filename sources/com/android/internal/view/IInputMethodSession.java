...
public interface IInputMethodSession extends IInterface {
    ...
    synchronized void displayCompletions(CompletionInfo[] completionInfoArr) throws RemoteException;

    synchronized void finishInput() throws RemoteException;

    synchronized void finishSession() throws RemoteException;

    synchronized void toggleSoftInput(int i, int i2) throws RemoteException;

    synchronized void updateCursor(Rect rect) throws RemoteException;

    synchronized void updateCursorAnchorInfo(CursorAnchorInfo cursorAnchorInfo) throws RemoteException;

    synchronized void updateExtractedText(int i, ExtractedText extractedText) throws RemoteException;

    synchronized void updateSelection(int i, int i2, int i3, int i4, int i5, int i6) throws RemoteException;

    synchronized void viewClicked(boolean z) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IInputMethodSession {
        ...
        private static class Proxy implements IInputMethodSession {
            ...
            public synchronized void finishInput() throws RemoteException {
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void updateExtractedText(int token, ExtractedText text) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void updateSelection(int oldSelStart, int oldSelEnd, int newSelStart, int newSelEnd, int candidatesStart, int candidatesEnd) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void viewClicked(boolean focusChanged) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void updateCursor(Rect newCursor) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    if (newCursor != null) {
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void displayCompletions(CompletionInfo[] completions) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void toggleSoftInput(int showFlags, int hideFlags) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void finishSession() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.view.IInputMethodSession
            public synchronized void updateCursorAnchorInfo(CursorAnchorInfo cursorAnchorInfo) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

...
public final class AssociationState {
    ...
    long dumpTime(PrintWriter pw, String prefix, SourceState src, long overallTime, long now, boolean dumpDetails, boolean dumpAll) {
        ...
        while (iprocstate < 14) {
            ...
            long totalTime4 = src.mActiveStartUptime;
            if (totalTime4 != 0 && src.mActiveProcState == iprocstate) {
                running = " (running)";
                isRunning = true;
            ...
            if (time == 0) {
                ...
                totalTime2 = totalTime3 + time;
            }
            iprocstate++;
        }
        long totalTime5 = totalTime2;
        if (totalTime5 == 0 || pw == null) {
        ...
        while (isrc < NSRC2) {
            ...
            if (src.mDurations != null) {
                ...
                if (duration4 != 0) {
                    ...
                    protoOutputStream.write(1112396529666L, duration4);

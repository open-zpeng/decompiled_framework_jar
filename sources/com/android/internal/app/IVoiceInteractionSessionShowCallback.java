...
public interface IVoiceInteractionSessionShowCallback extends IInterface {
    synchronized void onFailed() throws RemoteException;

    synchronized void onShown() throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IVoiceInteractionSessionShowCallback {
        ...
        public static synchronized IVoiceInteractionSessionShowCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IVoiceInteractionSessionShowCallback {
            ...
            public synchronized void onFailed() throws RemoteException {
            ...
            @Override // com.android.internal.app.IVoiceInteractionSessionShowCallback
            public synchronized void onShown() throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

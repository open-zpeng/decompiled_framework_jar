...
public interface IAppOpsCallback extends IInterface {
    synchronized void opChanged(int i, int i2, String str) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IAppOpsCallback {
        ...
        public static synchronized IAppOpsCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IAppOpsCallback {
            ...
            public synchronized void opChanged(int op, int uid, String packageName) throws RemoteException {

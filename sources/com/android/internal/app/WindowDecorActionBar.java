...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View decor) {
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, R.styleable.ActionBar, android.R.attr.actionBarStyle, 0);
    ...
    public void doShow(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            anim.setInterpolator(AnimationUtils.loadInterpolator(this.mContext, android.R.interpolator.decelerate_cubic));
    ...
    public void doHide(boolean fromSystem) {
        ...
        if (this.mCurWindowVisibility == 0 && (this.mShowHideAnimationEnabled || fromSystem)) {
            ...
            anim.setInterpolator(AnimationUtils.loadInterpolator(this.mContext, android.R.interpolator.accelerate_cubic));
            anim.setDuration(250L);

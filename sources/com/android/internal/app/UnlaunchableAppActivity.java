...
public class UnlaunchableAppActivity extends Activity implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mUserId = intent.getIntExtra(Intent.EXTRA_USER_HANDLE, UserInfo.NO_PROFILE_GROUP_ID);
        ...
        if (this.mUserId != -10000) {
            if (this.mReason == 1) {
                ...
                if (this.mReason == 1) {
                    builder.setPositiveButton(R.string.work_mode_turn_on, this).setNegativeButton(android.R.string.cancel, (DialogInterface.OnClickListener) null);
                } else {

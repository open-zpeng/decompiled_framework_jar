    ...
    private String checkUserCreationRequirements() {
        ...
        try {
            ...
            if (cantCreateUser) {
                ...
                String message = getString(com.android.internal.R.string.user_creation_account_exists, appName, this.mAccountName);
                return message;
            } else {
                String message2 = getString(com.android.internal.R.string.user_creation_adding, appName, this.mAccountName);
                return message2;
            }

...
public interface IMediaContainerService extends IInterface {
    synchronized long calculateInstalledSize(String str, String str2) throws RemoteException;

    synchronized void clearDirectory(String str) throws RemoteException;

    synchronized int copyPackage(String str, IParcelFileDescriptorFactory iParcelFileDescriptorFactory) throws RemoteException;

    synchronized PackageInfoLite getMinimalPackageInfo(String str, int i, String str2) throws RemoteException;

    synchronized ObbInfo getObbInfo(String str) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IMediaContainerService {
        ...
        private protected static IMediaContainerService asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 5:
                    ...
                    long _result4 = calculateInstalledSize(_arg05, _arg13);
                    reply.writeNoException();
        ...
        private static class Proxy implements IMediaContainerService {
            ...
            public synchronized int copyPackage(String packagePath, IParcelFileDescriptorFactory target) throws RemoteException {
            ...
            @Override // com.android.internal.app.IMediaContainerService
            public synchronized PackageInfoLite getMinimalPackageInfo(String packagePath, int flags, String abiOverride) throws RemoteException {
            ...
            @Override // com.android.internal.app.IMediaContainerService
            public synchronized ObbInfo getObbInfo(String filename) throws RemoteException {
                ObbInfo _result;
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
            ...
            @Override // com.android.internal.app.IMediaContainerService
            public synchronized void clearDirectory(String directory) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // com.android.internal.app.IMediaContainerService
            public synchronized long calculateInstalledSize(String packagePath, String abiOverride) throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);

        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 2:
                    ...
                    deliverPickOptionResult(_arg02, _arg1, _arg23, _arg3);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    deliverCompleteVoiceResult(_arg03, _arg12);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    deliverAbortVoiceResult(_arg04, _arg13);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    deliverCommandResult(_arg05, _arg1, _arg22);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);

...
public final class CodedOutputByteBufferNano {
    ...
    private static int encodedLength(CharSequence sequence) {
        ...
        if (utf8Length < utf16Length) {
            throw new IllegalArgumentException("UTF-8 length does not fit in int: " + (utf8Length + ProtoOutputStream.FIELD_TYPE_DOUBLE));
        }
        return utf8Length;
    }
    ...
    */
    private static int encode(java.lang.CharSequence r12, byte[] r13, int r14, int r15) {
        /*

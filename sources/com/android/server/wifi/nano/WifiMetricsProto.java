...
public interface WifiMetricsProto {
    ...
    public static final class WifiLog extends MessageNano {
        ...
        public WifiLog clear() {
            ...
            this.txLinkSpeedCount2G = Int32Count.emptyArray();
            this.txLinkSpeedCount5GLow = Int32Count.emptyArray();
            this.txLinkSpeedCount5GMid = Int32Count.emptyArray();
            this.txLinkSpeedCount5GHigh = Int32Count.emptyArray();
            this.rxLinkSpeedCount2G = Int32Count.emptyArray();
            this.rxLinkSpeedCount5GLow = Int32Count.emptyArray();
            this.rxLinkSpeedCount5GMid = Int32Count.emptyArray();
            this.rxLinkSpeedCount5GHigh = Int32Count.emptyArray();
            this.cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            Int32Count[] int32CountArr = this.txLinkSpeedCount2G;
            if (int32CountArr != null && int32CountArr.length > 0) {
                int i123 = 0;
                while (true) {
                    Int32Count[] int32CountArr2 = this.txLinkSpeedCount2G;
                    if (i123 >= int32CountArr2.length) {
                        break;
                    }
                    Int32Count element42 = int32CountArr2[i123];
                    if (element42 != null) {
                        output.writeMessage(149, element42);
                    }
                    i123++;
                }
            }
            Int32Count[] int32CountArr3 = this.txLinkSpeedCount5GLow;
            if (int32CountArr3 != null && int32CountArr3.length > 0) {
                int i124 = 0;
                while (true) {
                    Int32Count[] int32CountArr4 = this.txLinkSpeedCount5GLow;
                    if (i124 >= int32CountArr4.length) {
                        break;
                    }
                    Int32Count element43 = int32CountArr4[i124];
                    if (element43 != null) {
                        output.writeMessage(150, element43);
                    }
                    i124++;
                }
            }
            Int32Count[] int32CountArr5 = this.txLinkSpeedCount5GMid;
            if (int32CountArr5 != null && int32CountArr5.length > 0) {
                int i125 = 0;
                while (true) {
                    Int32Count[] int32CountArr6 = this.txLinkSpeedCount5GMid;
                    if (i125 >= int32CountArr6.length) {
                        break;
                    }
                    Int32Count element44 = int32CountArr6[i125];
                    if (element44 != null) {
                        output.writeMessage(151, element44);
                    }
                    i125++;
                }
            }
            Int32Count[] int32CountArr7 = this.txLinkSpeedCount5GHigh;
            if (int32CountArr7 != null && int32CountArr7.length > 0) {
                int i126 = 0;
                while (true) {
                    Int32Count[] int32CountArr8 = this.txLinkSpeedCount5GHigh;
                    if (i126 >= int32CountArr8.length) {
                        break;
                    }
                    Int32Count element45 = int32CountArr8[i126];
                    if (element45 != null) {
                        output.writeMessage(152, element45);
                    }
                    i126++;
                }
            }
            Int32Count[] int32CountArr9 = this.rxLinkSpeedCount2G;
            if (int32CountArr9 != null && int32CountArr9.length > 0) {
                int i127 = 0;
                while (true) {
                    Int32Count[] int32CountArr10 = this.rxLinkSpeedCount2G;
                    if (i127 >= int32CountArr10.length) {
                        break;
                    }
                    Int32Count element46 = int32CountArr10[i127];
                    if (element46 != null) {
                        output.writeMessage(153, element46);
                    }
                    i127++;
                }
            }
            Int32Count[] int32CountArr11 = this.rxLinkSpeedCount5GLow;
            if (int32CountArr11 != null && int32CountArr11.length > 0) {
                int i128 = 0;
                while (true) {
                    Int32Count[] int32CountArr12 = this.rxLinkSpeedCount5GLow;
                    if (i128 >= int32CountArr12.length) {
                        break;
                    }
                    Int32Count element47 = int32CountArr12[i128];
                    if (element47 != null) {
                        output.writeMessage(154, element47);
                    }
                    i128++;
                }
            }
            Int32Count[] int32CountArr13 = this.rxLinkSpeedCount5GMid;
            if (int32CountArr13 != null && int32CountArr13.length > 0) {
                int i129 = 0;
                while (true) {
                    Int32Count[] int32CountArr14 = this.rxLinkSpeedCount5GMid;
                    if (i129 >= int32CountArr14.length) {
                        break;
                    }
                    Int32Count element48 = int32CountArr14[i129];
                    if (element48 != null) {
                        output.writeMessage(155, element48);
                    }
                    i129++;
                }
            }
            Int32Count[] int32CountArr15 = this.rxLinkSpeedCount5GHigh;
            if (int32CountArr15 != null && int32CountArr15.length > 0) {
                int i130 = 0;
                while (true) {
                    Int32Count[] int32CountArr16 = this.rxLinkSpeedCount5GHigh;
                    if (i130 >= int32CountArr16.length) {
                        break;
                    }
                    Int32Count element49 = int32CountArr16[i130];
                    if (element49 != null) {
                        output.writeMessage(156, element49);
                    }
                    i130++;
                }
            }
        ...
        public int computeSerializedSize() {
            ...
            if (int32CountArr != null && int32CountArr.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element42 = int32CountArr2[i123];
                    if (element42 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(149, element42);
                    }
                    i123++;
                }
            }
            ...
            if (int32CountArr3 != null && int32CountArr3.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element43 = int32CountArr4[i124];
                    if (element43 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(150, element43);
                    }
                    i124++;
                }
            }
            ...
            if (int32CountArr5 != null && int32CountArr5.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element44 = int32CountArr6[i125];
                    if (element44 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(151, element44);
                    }
                    i125++;
                }
            }
            ...
            if (int32CountArr7 != null && int32CountArr7.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element45 = int32CountArr8[i126];
                    if (element45 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(152, element45);
                    }
                    i126++;
                }
            }
            ...
            if (int32CountArr9 != null && int32CountArr9.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element46 = int32CountArr10[i127];
                    if (element46 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(153, element46);
                    }
                    i127++;
                }
            }
            ...
            if (int32CountArr11 != null && int32CountArr11.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element47 = int32CountArr12[i128];
                    if (element47 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(154, element47);
                    }
                    i128++;
                }
            }
            ...
            if (int32CountArr13 != null && int32CountArr13.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element48 = int32CountArr14[i129];
                    if (element48 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(155, element48);
                    }
                    i129++;
                }
            }
            ...
            if (int32CountArr15 != null && int32CountArr15.length > 0) {
                ...
                while (true) {
                    ...
                    Int32Count element49 = int32CountArr16[i130];
                    if (element49 != null) {
                        size += CodedOutputByteBufferNano.computeMessageSize(156, element49);
                    }
                    i130++;
                }
            }
        ...
        /*  JADX ERROR: JadxRuntimeException in pass: BlockProcessor
            ...
            */
        @Override // com.android.framework.protobuf.nano.MessageNano
        public com.android.server.wifi.nano.WifiMetricsProto.WifiLog mergeFrom(com.android.framework.protobuf.nano.CodedInputByteBufferNano r7) throws java.io.IOException {
            /*
                Method dump skipped, instructions count: 4764
                To view this dump change 'Code comments level' option to 'DEBUG'
            */
            throw new UnsupportedOperationException("Method not decompiled: com.android.server.wifi.nano.WifiMetricsProto.WifiLog.mergeFrom(com.android.framework.protobuf.nano.CodedInputByteBufferNano):com.android.server.wifi.nano.WifiMetricsProto$WifiLog");
        }
    ...
    public static final class RouterFingerPrint extends MessageNano {
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            int i6 = this.eapMethod;
            if (i6 != 0) {
                output.writeInt32(9, i6);
            }
            int i7 = this.authPhase2Method;
            if (i7 != 0) {
        ...
        public int computeSerializedSize() {
            ...
            int i7 = this.authPhase2Method;
            if (i7 != 0) {
                return size + CodedOutputByteBufferNano.computeInt32Size(10, i7);
            }
            return size;
        }
    ...
    public static final class WifiPowerStats extends MessageNano {
        ...
        public WifiPowerStats clear() {
            ...
            this.sleepTimeMs = 0L;
            this.scanTimeMs = 0L;
            this.monitoredRailEnergyConsumedMah = FeatureOption.FO_BOOT_POLICY_CPU;
            this.cachedSize = -1;
            return this;
        }
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            if (Double.doubleToLongBits(this.monitoredRailEnergyConsumedMah) != Double.doubleToLongBits(FeatureOption.FO_BOOT_POLICY_CPU)) {
    ...
    public static final class ExperimentValues extends MessageNano {
        ...
        public int dataStallRxTputThrMbps;
        public int dataStallTxPerThr;
        public int dataStallTxTputThrMbps;
        ...
        public ExperimentValues clear() {
            ...
            this.dataStallTxTputThrMbps = 0;
            this.dataStallRxTputThrMbps = 0;
        ...
        public void writeTo(CodedOutputByteBufferNano output) throws IOException {
            ...
            int i3 = this.dataStallDurationMs;
            if (i3 != 0) {
                output.writeInt32(5, i3);
            }
            int i4 = this.dataStallTxTputThrMbps;
            if (i4 != 0) {
                output.writeInt32(6, i4);
            }
            int i5 = this.dataStallRxTputThrMbps;
            if (i5 != 0) {
                output.writeInt32(7, i5);
            }
            int i6 = this.dataStallTxPerThr;
            if (i6 != 0) {
                output.writeInt32(8, i6);
            }
            int i7 = this.dataStallCcaLevelThr;
            if (i7 != 0) {
                output.writeInt32(9, i7);
            }
            super.writeTo(output);
        ...
        public ExperimentValues mergeFrom(CodedInputByteBufferNano input) throws IOException {
            while (true) {
                ...
                if (tag == 8) {
                    ...
                    this.dataStallDurationMs = input.readInt32();
                } else if (tag == 48) {
                    this.dataStallTxTputThrMbps = input.readInt32();
                } else if (tag == 56) {
                    this.dataStallRxTputThrMbps = input.readInt32();
                } else if (tag == 64) {
                    this.dataStallTxPerThr = input.readInt32();
                } else if (tag != 72) {
                    if (!WireFormatNano.parseUnknownField(input, tag)) {
                        return this;
                    }
                } else {
                    this.dataStallCcaLevelThr = input.readInt32();
                }
            }
        }

...
public interface IProxyPortListener extends IInterface {
    private protected synchronized void setProxyPort(int i) throws RemoteException;

    /* loaded from: classes3.dex */
    public static abstract class Stub extends Binder implements IProxyPortListener {
        public protected static final String DESCRIPTOR = "com.android.net.IProxyPortListener";
        public private protected static final int TRANSACTION_setProxyPort = 1;

        private protected synchronized Stub() {
            attachInterface(this, DESCRIPTOR);
        }

        private protected static synchronized IProxyPortListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IProxyPortListener {
            ...
            private protected synchronized void setProxyPort(int port) throws RemoteException {

...
public interface IProxyCallback extends IInterface {
    private protected synchronized void getProxyPort(IBinder iBinder) throws RemoteException;

    /* loaded from: classes3.dex */
    public static abstract class Stub extends Binder implements IProxyCallback {
        public protected static final String DESCRIPTOR = "com.android.net.IProxyCallback";
        public private protected static final int TRANSACTION_getProxyPort = 1;

        private protected synchronized Stub() {
            attachInterface(this, DESCRIPTOR);
        }

        private protected static synchronized IProxyCallback asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IProxyCallback {
            ...
            private protected synchronized void getProxyPort(IBinder callback) throws RemoteException {

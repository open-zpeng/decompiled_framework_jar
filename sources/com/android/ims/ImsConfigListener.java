...
public interface ImsConfigListener extends IInterface {
    synchronized void onGetFeatureResponse(int i, int i2, int i3, int i4) throws RemoteException;

    synchronized void onGetVideoQuality(int i, int i2) throws RemoteException;

    private protected void onSetFeatureResponse(int i, int i2, int i3, int i4) throws RemoteException;

    synchronized void onSetVideoQuality(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements ImsConfigListener {
        ...
        public static synchronized ImsConfigListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements ImsConfigListener {
            ...
            public synchronized void onGetFeatureResponse(int feature, int network, int value, int status) throws RemoteException {
            ...
            public synchronized void onSetFeatureResponse(int feature, int network, int value, int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(feature);
            ...
            @Override // com.android.ims.ImsConfigListener
            public synchronized void onGetVideoQuality(int status, int quality) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(status);
            ...
            @Override // com.android.ims.ImsConfigListener
            public synchronized void onSetVideoQuality(int status) throws RemoteException {
                Parcel _data = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
                    _data.writeInt(status);

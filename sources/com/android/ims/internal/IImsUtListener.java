        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                case 1:
                    ...
                    utConfigurationUpdated(_arg02, _arg1);
                    return true;
                case 2:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    utConfigurationUpdateFailed(_arg03, _arg12, _arg2);
                    return true;
                case 3:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    utConfigurationQueried(_arg04, _arg13, _arg22);
                    return true;
                case 4:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    utConfigurationQueryFailed(_arg05, _arg14, _arg23);
                    return true;
                case 5:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    utConfigurationCallBarringQueried(_arg06, _arg15, _arg24);
                    return true;
                case 6:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    utConfigurationCallForwardQueried(_arg07, _arg16, _arg25);
                    return true;
                case 7:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    utConfigurationCallWaitingQueried(_arg08, _arg17, _arg26);
                    return true;
                case 8:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {

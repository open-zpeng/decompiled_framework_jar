        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            ...
            switch (code) {
                ...
                case 13:
                    ...
                    callSessionMergeFailed(_arg015, _arg111);
                    return true;
                case 14:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionUpdated(_arg016, _arg112);
                    return true;
                case 15:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionUpdateFailed(_arg017, _arg113);
                    return true;
                case 16:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionUpdateReceived(_arg018, _arg114);
                    return true;
                case 17:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionConferenceExtended(_arg019, _arg122, _arg22);
                    return true;
                case 18:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionConferenceExtendFailed(_arg020, _arg115);
                    return true;
                case 19:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionConferenceExtendReceived(_arg021, _arg123, _arg23);
                    return true;
                case 20:
                    data.enforceInterface(DESCRIPTOR);
                    IImsCallSession _arg022 = IImsCallSession.Stub.asInterface(data.readStrongBinder());
                    callSessionInviteParticipantsRequestDelivered(_arg022);
                    return true;
                case 21:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionInviteParticipantsRequestFailed(_arg023, _arg116);
                    return true;
                case 22:
                    data.enforceInterface(DESCRIPTOR);
                    IImsCallSession _arg024 = IImsCallSession.Stub.asInterface(data.readStrongBinder());
                    callSessionRemoveParticipantsRequestDelivered(_arg024);
                    return true;
                case 23:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionRemoveParticipantsRequestFailed(_arg025, _arg117);
                    return true;
                case 24:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionConferenceStateUpdated(_arg026, _arg118);
                    return true;
                case 25:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionUssdMessageReceived(_arg027, _arg124, _arg24);
                    return true;
                case 26:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionHandover(_arg028, _arg125, _arg25, _arg3);
                    return true;
                case 27:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionHandoverFailed(_arg029, _arg126, _arg26, _arg32);
                    return true;
                case 28:
                    data.enforceInterface(DESCRIPTOR);
                ...
                case 31:
                    ...
                    callSessionSuppServiceReceived(_arg033, _arg119);
                    return true;
                case 32:
                    data.enforceInterface(DESCRIPTOR);
                    ...
                    callSessionRttModifyRequestReceived(_arg034, _arg120);
                    return true;
                case 33:
                    data.enforceInterface(DESCRIPTOR);
                    int _arg035 = data.readInt();
                    callSessionRttModifyResponseReceived(_arg035);
                    return true;
                case 34:
                    data.enforceInterface(DESCRIPTOR);
                    String _arg036 = data.readString();
                    callSessionRttMessageReceived(_arg036);
                    return true;
                case 35:
                    data.enforceInterface(DESCRIPTOR);
                    if (data.readInt() != 0) {

...
public interface IUceListener extends IInterface {
    private protected void setStatus(int i) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IUceListener {
        ...
        public static synchronized IUceListener asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IUceListener {
            ...
            public synchronized void setStatus(int serviceStatusValue) throws RemoteException {

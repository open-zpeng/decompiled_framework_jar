...
public class PresPublishTriggerType implements Parcelable {
    ...
    public synchronized int getPublishTrigeerType() {
        return this.mPublishTriggerType;
    }

    private protected void setPublishTrigeerType(int nPublishTriggerType) {
        this.mPublishTriggerType = nPublishTriggerType;
    }

    private protected PresPublishTriggerType() {
    ...
    private synchronized PresPublishTriggerType(Parcel source) {
        this.mPublishTriggerType = 9;

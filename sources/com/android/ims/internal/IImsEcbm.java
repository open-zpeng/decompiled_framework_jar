...
public interface IImsEcbm extends IInterface {
    synchronized void exitEmergencyCallbackMode() throws RemoteException;

    synchronized void setListener(IImsEcbmListener iImsEcbmListener) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IImsEcbm {
        ...
        public static synchronized IImsEcbm asInterface(IBinder obj) {
            if (obj == null) {
                return null;
            }
        ...
        private static class Proxy implements IImsEcbm {
            ...
            public synchronized void setListener(IImsEcbmListener listener) throws RemoteException {
            ...
            @Override // com.android.ims.internal.IImsEcbm
            public synchronized void exitEmergencyCallbackMode() throws RemoteException {
                Parcel _data = Parcel.obtain();
                Parcel _reply = Parcel.obtain();
                try {
                    _data.writeInterfaceToken(Stub.DESCRIPTOR);
